...
VL_ATTR_COLD void Vswitch_testbench_v1_switch_if___ctor_var_reset(Vswitch_testbench_v1_switch_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vswitch_testbench_v1_switch_if___ctor_var_reset\n"); );
