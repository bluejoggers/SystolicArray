...
void Vswitch_testbench_v1_std__03a__03asemaphore::init(Vswitch_testbench_v1__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vswitch_testbench_v1_std__03a__03asemaphore::new\n"); );
    // Body
...
void Vswitch_testbench_v1_std__03a__03asemaphore::__VnoInFunc_put(Vswitch_testbench_v1__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vswitch_testbench_v1_std__03a__03asemaphore::__VnoInFunc_put\n"); );
    // Body
    this->__PVT__m_keyCount = (this->__PVT__m_keyCount 
                               + keyCount);
}

VlCoroutine Vswitch_testbench_v1_std__03a__03asemaphore::__VnoInFunc_get(Vswitch_testbench_v1__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vswitch_testbench_v1_std__03a__03asemaphore::__VnoInFunc_get\n"); );
    // Locals
...
void Vswitch_testbench_v1_std__03a__03asemaphore::__VnoInFunc_try_get(Vswitch_testbench_v1__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount, IData/*31:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vswitch_testbench_v1_std__03a__03asemaphore::__VnoInFunc_try_get\n"); );
    // Body
    {
...
void Vswitch_testbench_v1_std__03a__03asemaphore::_ctor_var_reset(Vswitch_testbench_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vswitch_testbench_v1_std__03a__03asemaphore::_ctor_var_reset\n"); );
    // Body
