...
Vswitch_testbench_v0__Syms::Vswitch_testbench_v0__Syms(VerilatedContext* contextp, const char* namep, Vswitch_testbench_v0* modelp)
...
Vswitch_testbench_v0__Syms::~Vswitch_testbench_v0__Syms() {
...
void Vswitch_testbench_v0__Syms::_traceDump() {
    const VerilatedLockGuard lock{__Vm_dumperMutex};
    __Vm_dumperp->dump(VL_TIME_Q());
}

void Vswitch_testbench_v0__Syms::_traceDumpOpen() {
    const VerilatedLockGuard lock{__Vm_dumperMutex};
...
void Vswitch_testbench_v0__Syms::_traceDumpClose() {
    const VerilatedLockGuard lock{__Vm_dumperMutex};
    __Vm_dumping = false;
