...
VL_ATTR_COLD void Vswitch_testbench_v1___024root___eval_static(Vswitch_testbench_v1___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v1___024root___eval_static\n"); );
...
VL_ATTR_COLD void Vswitch_testbench_v1___024root___eval_final(Vswitch_testbench_v1___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v1___024root___eval_final\n"); );
    Vswitch_testbench_v1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vswitch_testbench_v1___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vswitch_testbench_v1___024root___eval_phase__stl(Vswitch_testbench_v1___024root* vlSelf);

VL_ATTR_COLD void Vswitch_testbench_v1___024root___eval_settle(Vswitch_testbench_v1___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v1___024root___eval_settle\n"); );
    Vswitch_testbench_v1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
#ifdef VL_DEBUG
            Vswitch_testbench_v1___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
#endif
            VL_FATAL_MT("switch_testbench_v1.sv", 272, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        vlSelfRef.__VstlPhaseResult = Vswitch_testbench_v1___024root___eval_phase__stl(vlSelf);
        vlSelfRef.__VstlFirstIteration = 0U;
    } while (vlSelfRef.__VstlPhaseResult);
}

VL_ATTR_COLD bool Vswitch_testbench_v1___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in);

#ifdef VL_DEBUG
VL_ATTR_COLD void Vswitch_testbench_v1___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v1___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(Vswitch_testbench_v1___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool Vswitch_testbench_v1___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v1___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
VL_ATTR_COLD bool Vswitch_testbench_v1___024root___eval_phase__stl(Vswitch_testbench_v1___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v1___024root___eval_phase__stl\n"); );
    Vswitch_testbench_v1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
...
#endif
    __VstlExecute = Vswitch_testbench_v1___024root___trigger_anySet__stl(vlSelfRef.__VstlTriggered);
    if (__VstlExecute) {
        {
...
VL_ATTR_COLD void Vswitch_testbench_v1___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 2> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v1___024root___dump_triggers__act\n"); );
    // Body
    if ((1U & (~ (IData)(Vswitch_testbench_v1___024root___trigger_anySet__act(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
...
VL_ATTR_COLD void Vswitch_testbench_v1___024root___ctor_var_reset(Vswitch_testbench_v1___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v1___024root___ctor_var_reset\n"); );
    Vswitch_testbench_v1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
