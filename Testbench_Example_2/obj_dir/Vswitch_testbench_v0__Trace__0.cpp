...
void Vswitch_testbench_v0___024root__trace_chg_0_sub_0(Vswitch_testbench_v0___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vswitch_testbench_v0___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v0___024root__trace_chg_0\n"); );
    // Body
    ...
    Vswitch_testbench_v0___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vswitch_testbench_v0___024root__trace_chg_0_sub_0(Vswitch_testbench_v0___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v0___024root__trace_chg_0_sub_0\n"); );
    Vswitch_testbench_v0__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vswitch_testbench_v0___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vswitch_testbench_v0___024root__trace_cleanup\n"); );
    // Body
    Vswitch_testbench_v0___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vswitch_testbench_v0___024root*>(voidSelf);
    Vswitch_testbench_v0__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
