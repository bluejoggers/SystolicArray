...
VP10_std::VP10_std() = default;
VP10_std::~VP10_std() = default;

void VP10_std::ctor(VP10__Syms* symsp, const char* namep) {
    vlSymsp = symsp;
    vlNamep = strdup(Verilated::catName(vlSymsp->name(), namep));
    // Reset structure values
}

void VP10_std___configure_coverage(VP10_std* vlSelf, bool first);

void VP10_std::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    VP10_std___configure_coverage(this, first);
}
...
// Coverage
void VP10_std::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
...
// Toggle Coverage
void VP10_std::__vlCoverToggleInsert(int begin, int end, bool ranged, uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
