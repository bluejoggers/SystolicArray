...
void VP10___024root___ctor_var_reset(VP10___024root* vlSelf);

VP10___024root::VP10___024root(VP10__Syms* symsp, const char* namep)
    : __VdlySched{*symsp->_vm_contextp__}
 {
    vlSymsp = symsp;
    vlNamep = strdup(namep);
    // Reset structure values
    VP10___024root___ctor_var_reset(this);
}

void VP10___024root___configure_coverage(VP10___024root* vlSelf, bool first);

void VP10___024root::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    VP10___024root___configure_coverage(this, first);
}

VP10___024root::~VP10___024root() {
    VL_DO_DANGLING(std::free(const_cast<char*>(vlNamep)), vlNamep);
}

// Coverage
void VP10___024root::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
...
// Toggle Coverage
void VP10___024root::__vlCoverToggleInsert(int begin, int end, bool ranged, uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
