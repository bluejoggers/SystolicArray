...
void VP8_std__03a__03aprocess__Vclpkg::__VnoInFunc_self(VlProcessRef vlProcess, VP8__Syms* __restrict vlSymsp, VlClassRef<VP8_std__03a__03aprocess> &self__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VP8_std__03a__03aprocess__Vclpkg::__VnoInFunc_self\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VP8_std__03a__03aprocess> p;
    p = VL_NEW(VP8_std__03a__03aprocess, vlSymsp);
...
void VP8_std__03a__03aprocess__Vclpkg::__VnoInFunc_killQueue(VP8__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VP8_std__03a__03aprocess>> &processQueue) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VP8_std__03a__03aprocess__Vclpkg::__VnoInFunc_killQueue\n"); );
    // Body
...
void VP8_std__03a__03aprocess::__VnoInFunc_set_status(VP8__Syms* __restrict vlSymsp, IData/*31:0*/ s) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VP8_std__03a__03aprocess::__VnoInFunc_set_status\n"); );
    // Body
...
void VP8_std__03a__03aprocess::__VnoInFunc_status(VP8__Syms* __restrict vlSymsp, IData/*31:0*/ &status__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VP8_std__03a__03aprocess::__VnoInFunc_status\n"); );
    // Body
    status__Vfuncrtn = 0U;
    status__Vfuncrtn = 
...
void VP8_std__03a__03aprocess::__VnoInFunc_kill(VP8__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VP8_std__03a__03aprocess::__VnoInFunc_kill\n"); );
    // Body
    this->__VnoInFunc_set_status(vlSymsp, 4U);
}

void VP8_std__03a__03aprocess::__VnoInFunc_suspend(VP8__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VP8_std__03a__03aprocess::__VnoInFunc_suspend\n"); );
    // Body
...
void VP8_std__03a__03aprocess::__VnoInFunc_resume(VP8__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VP8_std__03a__03aprocess::__VnoInFunc_resume\n"); );
    // Body
    this->__VnoInFunc_set_status(vlSymsp, 1U);
}

VlCoroutine VP8_std__03a__03aprocess::__VnoInFunc_await(VP8__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VP8_std__03a__03aprocess::__VnoInFunc_await\n"); );
    // Locals
...
void VP8_std__03a__03aprocess::__VnoInFunc_get_randstate(VP8__Syms* __restrict vlSymsp, std::string &get_randstate__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VP8_std__03a__03aprocess::__VnoInFunc_get_randstate\n"); );
    // Body
    std::string s;
...
void VP8_std__03a__03aprocess::__VnoInFunc_set_randstate(VP8__Syms* __restrict vlSymsp, std::string s) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VP8_std__03a__03aprocess::__VnoInFunc_set_randstate\n"); );
    // Body
...
void VP8_std__03a__03aprocess::init(VP8__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VP8_std__03a__03aprocess::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void VP8_std__03a__03aprocess::_ctor_var_reset(VP8__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VP8_std__03a__03aprocess::_ctor_var_reset\n"); );
    // Body
