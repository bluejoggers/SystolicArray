...
void VP10_cover_tb___ctor_var_reset(VP10_cover_tb* vlSelf);

VP10_cover_tb::VP10_cover_tb() = default;
VP10_cover_tb::~VP10_cover_tb() = default;

void VP10_cover_tb::ctor(VP10__Syms* symsp, const char* namep) {
    vlSymsp = symsp;
    vlNamep = strdup(Verilated::catName(vlSymsp->name(), namep));
    // Reset structure values
    VP10_cover_tb___ctor_var_reset(this);
}

void VP10_cover_tb___configure_coverage(VP10_cover_tb* vlSelf, bool first);

void VP10_cover_tb::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    VP10_cover_tb___configure_coverage(this, first);
}

void VP10_cover_tb::dtor() {
    VL_DO_DANGLING(std::free(const_cast<char*>(vlNamep)), vlNamep);
}

// Coverage
void VP10_cover_tb::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
...
// Toggle Coverage
void VP10_cover_tb::__vlCoverToggleInsert(int begin, int end, bool ranged, uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
