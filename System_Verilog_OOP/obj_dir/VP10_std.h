...
#ifndef VERILATED_VP10_STD_H_
#define VERILATED_VP10_STD_H_  // guard
...
class VP10__Syms;
struct VP10_vl_covergroup_options_t__struct__0 {
    ...
    bool operator==(const VP10_vl_covergroup_options_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<VP10_vl_covergroup_options_t__struct__0> : public std::true_type {};
struct VP10_vl_covergroup_type_options_t__struct__0 {
    IData/*31:0*/ __PVT__weight;
    IData/*31:0*/ __PVT__goal;
    std::string __PVT__comment;
    ...
    bool operator==(const VP10_vl_covergroup_type_options_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<VP10_vl_covergroup_type_options_t__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) VP10_std final {
  public:
