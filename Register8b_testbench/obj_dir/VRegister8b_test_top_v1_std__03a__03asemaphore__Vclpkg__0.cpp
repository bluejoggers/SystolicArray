...
void VRegister8b_test_top_v1_std__03a__03asemaphore::init(VRegister8b_test_top_v1__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VRegister8b_test_top_v1_std__03a__03asemaphore::new\n"); );
    // Body
...
void VRegister8b_test_top_v1_std__03a__03asemaphore::__VnoInFunc_put(VRegister8b_test_top_v1__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VRegister8b_test_top_v1_std__03a__03asemaphore::__VnoInFunc_put\n"); );
    // Body
    this->__PVT__m_keyCount = (this->__PVT__m_keyCount 
                               + keyCount);
}

VlCoroutine VRegister8b_test_top_v1_std__03a__03asemaphore::__VnoInFunc_get(VRegister8b_test_top_v1__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VRegister8b_test_top_v1_std__03a__03asemaphore::__VnoInFunc_get\n"); );
    // Locals
...
void VRegister8b_test_top_v1_std__03a__03asemaphore::__VnoInFunc_try_get(VRegister8b_test_top_v1__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount, IData/*31:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VRegister8b_test_top_v1_std__03a__03asemaphore::__VnoInFunc_try_get\n"); );
    // Body
    {
...
void VRegister8b_test_top_v1_std__03a__03asemaphore::_ctor_var_reset(VRegister8b_test_top_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VRegister8b_test_top_v1_std__03a__03asemaphore::_ctor_var_reset\n"); );
    // Body
