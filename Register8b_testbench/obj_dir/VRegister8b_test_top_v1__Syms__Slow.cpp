...
VRegister8b_test_top_v1__Syms::VRegister8b_test_top_v1__Syms(VerilatedContext* contextp, const char* namep, VRegister8b_test_top_v1* modelp)
    ...
    , TOP{this, namep}
{
    ...
    TOP__tb__DOT__rif.ctor(this, "tb.rif");
    ...
    TOP.__PVT__tb__DOT__rif = &TOP__tb__DOT__rif;
    ...
    TOP__tb__DOT__rif.__Vconfigure(true);
...
VRegister8b_test_top_v1__Syms::~VRegister8b_test_top_v1__Syms() {
...
void VRegister8b_test_top_v1__Syms::_traceDump() {
    const VerilatedLockGuard lock{__Vm_dumperMutex};
    __Vm_dumperp->dump(VL_TIME_Q());
}

void VRegister8b_test_top_v1__Syms::_traceDumpOpen() {
    const VerilatedLockGuard lock{__Vm_dumperMutex};
...
void VRegister8b_test_top_v1__Syms::_traceDumpClose() {
    const VerilatedLockGuard lock{__Vm_dumperMutex};
    __Vm_dumping = false;
