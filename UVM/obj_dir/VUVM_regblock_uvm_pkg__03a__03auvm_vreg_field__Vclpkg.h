...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_VREG_FIELD__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_VREG_FIELD__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi31;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi31> &get_type__Vfuncrtn);
};
...
class VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field : public VUVM_regblock_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> __PVT__parent;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_vreg_field"; }
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field(*this); }
    ...
    void __VnoInFunc_configure(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> parent, IData/*31:0*/ size, IData/*31:0*/ lsb_pos);
    ...
    virtual void __VnoInFunc_get_lsb_pos_in_register(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &get_lsb_pos_in_register__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_parent(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> &get_parent__Vfuncrtn);
    virtual void __VnoInFunc_get_register(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> &get_register__Vfuncrtn);
    virtual void __VnoInFunc_get_type_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn);
    virtual VlCoroutine __VnoInFunc_peek(VUVM_regblock__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual VlCoroutine __VnoInFunc_poke(VUVM_regblock__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field();
};
