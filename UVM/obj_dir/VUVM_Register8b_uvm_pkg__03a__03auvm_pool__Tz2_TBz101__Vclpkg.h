...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ101__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ101__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101> &get_global_pool__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101 : public VUVM_Register8b_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz101();
};
