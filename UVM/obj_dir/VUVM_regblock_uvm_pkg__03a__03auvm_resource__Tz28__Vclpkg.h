...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_RESOURCE__TZ28__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_RESOURCE__TZ28__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28> __PVT__my_type;
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28__Vclpkg);
    ...
    void __VnoInFunc_get_by_type(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28> &get_by_type__Vfuncrtn);
    void __VnoInFunc_get_highest_precedence(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz5> &q, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28> &get_highest_precedence__Vfuncrtn);
    void __VnoInFunc_get_type(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28> &get_type__Vfuncrtn);
};
...
class VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28 : public VUVM_regblock_uvm_pkg__03a__03auvm_resource_base {
  public:
    ...
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28(*this); }
    ...
    void __VnoInFunc_read(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read__Vfuncrtn);
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, std::string scope);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz28();
};
