...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_FACTORY__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_FACTORY__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_factory__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_factory__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_factory__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_factory__Vclpkg);
    ...
    void __VnoInFunc_get(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_factory> &get__Vfuncrtn);
};


class VUVM_Register8b__Syms;

class VUVM_Register8b_uvm_pkg__03a__03auvm_factory : public virtual VlClass {
  public:
    ...
    VUVM_Register8b_uvm_pkg__03a__03auvm_factory() = default;
    void init(VUVM_Register8b__Syms* __restrict vlSymsp) {}
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_factory();
};
