...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_turn_on_tracing(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_turn_on_tracing\n"); );
    // Body
    ...
    if ((1U & (~ (IData)(this->__PVT__ready)))) {
        {
            ...
            VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_cmdline_processor> __Vinline_0___VnoInFunc_init_clp;
            ...
            VL_NULL_CHECK(__Vinline_0___VnoInFunc_init_clp, "../../uvm/distrib/src/base/uvm_resource_db.svh", 392)->__VnoInFunc_get_arg_matches(vlSymsp, "+UVM_RESOURCE_DB_TRACE"s, __Vinline_0___VnoInFunc_init_trace_args, __Vinline_0___VnoInFunc_init___Vtask_get_arg_matches__4__Vfuncout);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_turn_off_tracing(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_turn_off_tracing\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    if ((1U & (~ (IData)(this->__PVT__ready)))) {
        {
            ...
            VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_cmdline_processor> __Vinline_1___VnoInFunc_init_clp;
            ...
            VL_NULL_CHECK(__Vinline_1___VnoInFunc_init_clp, "../../uvm/distrib/src/base/uvm_resource_db.svh", 392)->__VnoInFunc_get_arg_matches(vlSymsp, "+UVM_RESOURCE_DB_TRACE"s, __Vinline_1___VnoInFunc_init_trace_args, __Vinline_1___VnoInFunc_init___Vtask_get_arg_matches__4__Vfuncout);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_is_tracing(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &is_tracing__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_is_tracing\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    if ((1U & (~ (IData)(this->__PVT__ready)))) {
        {
            ...
            VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_cmdline_processor> __Vinline_2___VnoInFunc_init_clp;
            ...
            VL_NULL_CHECK(__Vinline_2___VnoInFunc_init_clp, "../../uvm/distrib/src/base/uvm_resource_db.svh", 392)->__VnoInFunc_get_arg_matches(vlSymsp, "+UVM_RESOURCE_DB_TRACE"s, __Vinline_2___VnoInFunc_init_trace_args, __Vinline_2___VnoInFunc_init___Vtask_get_arg_matches__4__Vfuncout);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_init(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_init\n"); );
    // Locals
    ...
    VL_NULL_CHECK(clp, "../../uvm/distrib/src/base/uvm_resource_db.svh", 392)->__VnoInFunc_get_arg_matches(vlSymsp, "+UVM_RESOURCE_DB_TRACE"s, trace_args, __Vtask_get_arg_matches__4__Vfuncout);
