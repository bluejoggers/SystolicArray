...
void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_check_data_width(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ width, CData/*0:0*/ &check_data_width__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_check_data_width\n"); );
    // Locals
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__1__Vfuncout;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_get_root_blocks(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>> &blks) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_get_root_blocks\n"); );
    // Body
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk624__DOT__blk;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk624__DOT__blk__Vnext;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_blocks(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>> &blks, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> root, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor, IData/*31:0*/ &find_blocks__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_blocks\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> __VlefCall_4__read;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz111> unnamedblk625__DOT__unnamedblk626__DOT__blk;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource_pool> rpl;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz5> rs;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_block(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> root, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> &find_block__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_block\n"); );
    // Locals
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__20__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__21__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
    IData/*31:0*/ __VlefCall_0__find_blocks;
    VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>> blks;
    {
        blks.clear();
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample(VUVM_regblock__Syms* __restrict vlSymsp, QData/*63:0*/ offset, CData/*0:0*/ is_read, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample\n"); );
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ has_coverage) {
        VUVM_regblock_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::new\n"); );
        // Body
        VlProcess::currentp(vlProcess.get());
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_reg_block__Vclpkg.__PVT__m_roots
                    .at(VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>{this}) = 0U;
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_configure(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> parent, std::string hdl_path) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_configure\n"); );
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_0__get_full_name;
        ...
        if ((VlNull{} != parent)) {
            VL_NULL_CHECK(this->__PVT__parent, "../../uvm/distrib/src/reg/uvm_reg_block.svh", 968)
                    ->__VnoInFunc_add_block(vlSymsp, 
                                            VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>{this});
        }
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz111__Vclpkg.__VnoInFunc_set(vlSymsp, "uvm_reg::*"s, 
                                                                                VL_CVT_PACK_STR_NN(__VlefCall_0__get_full_name), 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>{this}, VlNull{});
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_block(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> blk) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_block\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__8__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__9__Vfuncout;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_reg(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> rg) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_reg\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__27__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__28__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__31__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__32__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__41__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__42__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_4__get_name;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_vreg(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> vreg) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_vreg\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__46__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__47__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__54__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__55__Vfuncout;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_mem(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> mem) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_mem\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__73__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__74__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__79__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__80__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_4__get_name;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_parent(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> parent) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_parent\n"); );
        // Body
        if ((VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>{this} 
             != parent)) {
            this->__PVT__parent = parent;
        }
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_locked(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &is_locked__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_locked\n"); );
        // Body
        is_locked__Vfuncrtn = this->__PVT__locked;
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_lock_model(VUVM_regblock__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_lock_model\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__92__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__93__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__96__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__97__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__103__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__104__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__108__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__109__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        ...
        CData/*0:0*/ __VlefCall_0__is_locked;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk594__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk594__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk594__DOT__rg___Vmore;
        unnamedblk594__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk594__DOT__unnamedblk595__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk596__DOT__mem_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk596__DOT__mem___Vnext;
        CData/*0:0*/ unnamedblk596__DOT__mem___Vmore;
        unnamedblk596__DOT__mem___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk596__DOT__unnamedblk597__DOT__mem;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk598__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk598__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk598__DOT__blk___Vmore;
        unnamedblk598__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk598__DOT__unnamedblk599__DOT__blk;
        IData/*31:0*/ unnamedblk600__DOT__max_size;
        IData/*31:0*/ unnamedblk600__DOT__unnamedblk601__DOT__n;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk600__DOT__unnamedblk601__DOT__unnamedblk602__DOT___blk;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk600__DOT__unnamedblk601__DOT__unnamedblk602__DOT___blk__Vnext;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk600__DOT__unnamedblk601__DOT__unnamedblk602__DOT__unnamedblk603__DOT__blk;
        {
            this->__VnoInFunc_is_locked(vlSymsp, __VlefCall_0__is_locked);
            if (__VlefCall_0__is_locked) {
                goto __Vlabel0;
            ...
            if ((VlNull{} == this->__PVT__parent)) {
                ...
                }
                {
                    ...
                    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> __Vinline_0___VnoInFunc_Xinit_address_mapsX_unnamedblk694__DOT__map_;
                    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> __Vinline_0___VnoInFunc_Xinit_address_mapsX_unnamedblk694__DOT__map___Vnext;
                    ...
                    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> __Vinline_0___VnoInFunc_Xinit_address_mapsX_unnamedblk694__DOT__unnamedblk695__DOT__map;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_name(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_name\n"); );
        // Body
        VlProcess::currentp(vlProcess.get());
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_fields(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_field>> &fields, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_fields\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk604__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk604__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk604__DOT__rg___Vmore;
        unnamedblk604__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk604__DOT__unnamedblk605__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk606__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk606__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk606__DOT__blk___Vmore;
        unnamedblk606__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk606__DOT__unnamedblk607__DOT__blk;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_fields(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field>> &fields, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_fields\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk608__DOT__vreg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk608__DOT__vreg___Vnext;
        CData/*0:0*/ unnamedblk608__DOT__vreg___Vmore;
        unnamedblk608__DOT__vreg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk608__DOT__unnamedblk609__DOT__vreg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk610__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk610__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk610__DOT__blk___Vmore;
        unnamedblk610__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk610__DOT__unnamedblk611__DOT__blk;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_registers(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg>> &regs, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_registers\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk612__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk612__DOT__rg__Vnext;
        CData/*0:0*/ unnamedblk612__DOT__rg__Vmore;
        unnamedblk612__DOT__rg__Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk613__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk613__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk613__DOT__blk___Vmore;
        unnamedblk613__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk613__DOT__unnamedblk614__DOT__blk;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_registers(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg>> &regs, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_registers\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk615__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk615__DOT__rg__Vnext;
        CData/*0:0*/ unnamedblk615__DOT__rg__Vmore;
        unnamedblk615__DOT__rg__Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk616__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk616__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk616__DOT__blk___Vmore;
        unnamedblk616__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk616__DOT__unnamedblk617__DOT__blk;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_memories(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem>> &mems, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_memories\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk618__DOT__mem_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk618__DOT__mem___Vnext;
        CData/*0:0*/ unnamedblk618__DOT__mem___Vmore;
        unnamedblk618__DOT__mem___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk618__DOT__unnamedblk619__DOT__mem;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk620__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk620__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk620__DOT__blk___Vmore;
        unnamedblk620__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk620__DOT__unnamedblk621__DOT__blk;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_blocks(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>> &blks, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_blocks\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk622__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk622__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk622__DOT__blk___Vmore;
        unnamedblk622__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk622__DOT__unnamedblk623__DOT__blk;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_maps(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map>> &maps) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_maps\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> unnamedblk627__DOT__map;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> unnamedblk627__DOT__map__Vnext;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_parent(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> &get_parent__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_parent\n"); );
        // Body
        get_parent__Vfuncrtn = this->__PVT__parent;
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_block_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> &get_block_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_block_by_name\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__127__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__128__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__132__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__133__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk628__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk628__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk628__DOT__blk___Vmore;
        unnamedblk628__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk628__DOT__unnamedblk629__DOT__blk;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk630__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk630__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk630__DOT__blk___Vmore;
        unnamedblk630__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>> unnamedblk630__DOT__unnamedblk631__DOT__subblks;
        ...
        unnamedblk630__DOT__unnamedblk631__DOT__unnamedblk632__DOT__j__Vloopsize = 0;
        {
            ...
            if ((__VlefCall_0__get_name == name)) {
                get_block_by_name__Vfuncrtn = VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>{this};
                goto __Vlabel0;
            }
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_reg_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> &get_reg_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_reg_by_name\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__139__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__140__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__144__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__145__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk633__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk633__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk633__DOT__rg___Vmore;
        unnamedblk633__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk633__DOT__unnamedblk634__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk635__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk635__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk635__DOT__blk___Vmore;
        unnamedblk635__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg>> unnamedblk635__DOT__unnamedblk636__DOT__subregs;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vreg_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> &get_vreg_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vreg_by_name\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__151__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__152__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__156__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__157__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_3__get_full_name;
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk638__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk638__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk638__DOT__rg___Vmore;
        unnamedblk638__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk638__DOT__unnamedblk639__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk640__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk640__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk640__DOT__blk___Vmore;
        unnamedblk640__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg>> unnamedblk640__DOT__unnamedblk641__DOT__subvregs;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_mem_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> &get_mem_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_mem_by_name\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__163__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__164__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__168__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__169__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_3__get_full_name;
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk643__DOT__mem_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk643__DOT__mem___Vnext;
        CData/*0:0*/ unnamedblk643__DOT__mem___Vmore;
        unnamedblk643__DOT__mem___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk643__DOT__unnamedblk644__DOT__mem;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk645__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk645__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk645__DOT__blk___Vmore;
        unnamedblk645__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem>> unnamedblk645__DOT__unnamedblk646__DOT__submems;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_field_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_field> &get_field_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_field_by_name\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__177__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__178__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__182__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__183__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_3__get_full_name;
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk648__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk648__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk648__DOT__rg___Vmore;
        unnamedblk648__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk648__DOT__unnamedblk649__DOT__rg;
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_field>> unnamedblk648__DOT__unnamedblk649__DOT__fields;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk651__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk651__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk651__DOT__blk___Vmore;
        unnamedblk651__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg>> unnamedblk651__DOT__unnamedblk652__DOT__subregs;
        ...
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_field>> unnamedblk651__DOT__unnamedblk652__DOT__unnamedblk653__DOT__unnamedblk654__DOT__fields;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vfield_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field> &get_vfield_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vfield_by_name\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__196__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__197__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_3__get_full_name;
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk656__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk656__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk656__DOT__rg___Vmore;
        unnamedblk656__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk656__DOT__unnamedblk657__DOT__rg;
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field>> unnamedblk656__DOT__unnamedblk657__DOT__fields;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk659__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk659__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk659__DOT__blk___Vmore;
        unnamedblk659__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg>> unnamedblk659__DOT__unnamedblk660__DOT__subvregs;
        ...
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field>> unnamedblk659__DOT__unnamedblk660__DOT__unnamedblk661__DOT__unnamedblk662__DOT__fields;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_coverage(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ is_on, IData/*31:0*/ &set_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_coverage\n"); );
        // Locals
        ...
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk664__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk664__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk664__DOT__rg___Vmore;
        unnamedblk664__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk664__DOT__unnamedblk665__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk666__DOT__mem_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk666__DOT__mem___Vnext;
        CData/*0:0*/ unnamedblk666__DOT__mem___Vmore;
        unnamedblk666__DOT__mem___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk666__DOT__unnamedblk667__DOT__mem;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk668__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk668__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk668__DOT__blk___Vmore;
        unnamedblk668__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk668__DOT__unnamedblk669__DOT__blk;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample_values(VUVM_regblock__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample_values\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk670__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk670__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk670__DOT__rg___Vmore;
        unnamedblk670__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk670__DOT__unnamedblk671__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk672__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk672__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk672__DOT__blk___Vmore;
        unnamedblk672__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk672__DOT__unnamedblk673__DOT__blk;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_XsampleX(VUVM_regblock__Syms* __restrict vlSymsp, QData/*63:0*/ addr, CData/*0:0*/ is_read, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_XsampleX\n"); );
        // Body
        this->__VnoInFunc_sample(vlSymsp, addr, (IData)(is_read), map);
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_build_coverage(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ models, IData/*31:0*/ &build_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_build_coverage\n"); );
        // Locals
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg.__VnoInFunc_read_by_name(vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                VL_CONCATN_NNN("uvm_reg::"s, __VlefCall_0__get_full_name)), "include_coverage"s, __Vtask_read_by_name__206__val, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>{this}, __Vtask_read_by_name__206__Vfuncout);
        build_coverage__Vfuncrtn = __Vtask_read_by_name__206__val;
        build_coverage__Vfuncrtn = (build_coverage__Vfuncrtn 
                                    & models);
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_coverage(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ models) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_coverage\n"); );
        // Body
        this->__PVT__has_cover = (this->__PVT__has_cover 
                                  | models);
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_coverage(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ models, CData/*0:0*/ &has_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_coverage\n"); );
        // Body
        has_coverage__Vfuncrtn = ((this->__PVT__has_cover 
                                   & models) == models);
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_coverage(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ is_on, CData/*0:0*/ &get_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_coverage\n"); );
        // Body
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_reset(VUVM_regblock__Syms* __restrict vlSymsp, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_reset\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk674__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk674__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk674__DOT__rg___Vmore;
        unnamedblk674__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk674__DOT__unnamedblk675__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk676__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk676__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk676__DOT__blk___Vmore;
        unnamedblk676__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk676__DOT__unnamedblk677__DOT__blk;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_needs_update(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &needs_update__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_needs_update\n"); );
        // Body
        CData/*0:0*/ __VlefCall_1__needs_update;
        CData/*0:0*/ __VlefCall_0__needs_update;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk678__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk678__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk678__DOT__rg___Vmore;
        unnamedblk678__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk678__DOT__unnamedblk679__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk680__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk680__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk680__DOT__blk___Vmore;
        unnamedblk680__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk680__DOT__unnamedblk681__DOT__blk;
        {
    ...
    VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_update(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_update\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__214__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__215__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__219__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__220__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__223__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__224__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__228__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__229__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__234__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__235__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__239__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__240__Vfuncout;
        ...
        IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
        CData/*0:0*/ __VlefCall_0__needs_update;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk682__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk682__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk682__DOT__rg___Vmore;
        unnamedblk682__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk682__DOT__unnamedblk683__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk684__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk684__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk684__DOT__blk___Vmore;
        unnamedblk684__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk684__DOT__unnamedblk685__DOT__blk;
        {
            status = 0U;
            status = 0U;
            ...
            if ((0U != __VlefCall_3__uvm_report_enabled)) {
                ...
                __Vtemp_1 = VUVM_regblock___024unit::__Venumtab_enum_name75
                    [(3U & path)];
    ...
    VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_mirror(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ check, IData/*31:0*/ path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_mirror\n"); );
        // Locals
        ...
        VlProcess::currentp(vlProcess.get());
        VL_KEEP_THIS;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk686__DOT__rg_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk686__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk686__DOT__rg___Vmore;
        unnamedblk686__DOT__rg___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk686__DOT__unnamedblk687__DOT__rg;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk688__DOT__blk_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk688__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk688__DOT__blk___Vmore;
        unnamedblk688__DOT__blk___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk688__DOT__unnamedblk689__DOT__blk;
        status = 0U;
    ...
    VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_write_reg_by_name(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ data, IData/*31:0*/ path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_write_reg_by_name\n"); );
        // Locals
        ...
        VlProcess::currentp(vlProcess.get());
        VL_KEEP_THIS;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> rg;
    ...
    VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_reg_by_name(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ &data, IData/*31:0*/ path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_reg_by_name\n"); );
        // Locals
    ...
    VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_write_mem_by_name(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ offset, QData/*63:0*/ data, IData/*31:0*/ path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_write_mem_by_name\n"); );
        // Locals
        ...
        VlProcess::currentp(vlProcess.get());
        VL_KEEP_THIS;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> mem;
        this->__PVT__fname = fname;
        this->__PVT__lineno = lineno;
        status = 1U;
    ...
    VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_mem_by_name(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ offset, QData/*63:0*/ &data, IData/*31:0*/ path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_mem_by_name\n"); );
        // Locals
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_readmemh(VUVM_regblock__Syms* __restrict vlSymsp, std::string filename) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_readmemh\n"); );
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_writememh(VUVM_regblock__Syms* __restrict vlSymsp, std::string filename) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_writememh\n"); );
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_create_map(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ base_addr, IData/*31:0*/ n_bytes, IData/*31:0*/ endian, CData/*0:0*/ byte_addressing, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> &create_map__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_create_map\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__254__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__255__Vfuncout;
        ...
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map;
        {
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi32__Vclpkg.__VnoInFunc_create(vlSymsp, name, VlNull{}, 
            ...
            VL_NULL_CHECK(map, "../../uvm/distrib/src/reg/uvm_reg_block.svh", 1830)
                    ->__VnoInFunc_configure(vlSymsp, 
                                            VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block>{this}, base_addr, n_bytes, endian, (IData)(byte_addressing));
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_map(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_map\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__265__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__266__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__269__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__270__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__273__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__274__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__279__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__280__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_3__get_full_name;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_map_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> &get_map_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_map_by_name\n"); );
        // Locals
        ...
        VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map>> unnamedblk691__DOT__unnamedblk692__DOT__submaps;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_map(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_map\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__295__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__296__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__300__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__301__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_1__get_full_name;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_map(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> &get_default_map__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_map\n"); );
        // Body
        get_default_map__Vfuncrtn = this->__PVT__default_map;
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_path(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &get_default_path__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_path\n"); );
        // Body
        {
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_Xinit_address_mapsX(VUVM_regblock__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_Xinit_address_mapsX\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> unnamedblk694__DOT__map_;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> unnamedblk694__DOT__map___Vnext;
        CData/*0:0*/ unnamedblk694__DOT__map___Vmore;
        unnamedblk694__DOT__map___Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> unnamedblk694__DOT__unnamedblk695__DOT__map;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_backdoor(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_backdoor> bkdr, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_backdoor\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__307__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__308__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__311__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__312__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_backdoor(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ inherited, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_backdoor> &get_backdoor__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_backdoor\n"); );
        // Body
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk696__DOT__blk;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_backdoor> unnamedblk696__DOT__unnamedblk697__DOT__bkdr;
        {
            if (inherited) {
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clear_hdl_path(VUVM_regblock__Syms* __restrict vlSymsp, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clear_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__321__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__322__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__325__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__326__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_hdl_path(VUVM_regblock__Syms* __restrict vlSymsp, std::string path, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_hdl_path\n"); );
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_hdl_path(VUVM_regblock__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &has_hdl_path__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_hdl_path\n"); );
        // Body
        IData/*31:0*/ __VlefCall_0__exists;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_hdl_path(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__336__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__337__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__340__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__341__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind, std::string separator) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__350__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__351__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__354__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__355__Vfuncout;
        // Body
        VlProcess::currentp(vlProcess.get());
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz2> unnamedblk699__DOT__hdl_paths;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_hdl_path(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_default_hdl_path__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_hdl_path\n"); );
        // Body
        {
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_hdl_path(VUVM_regblock__Syms* __restrict vlSymsp, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__363__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__364__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__367__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__368__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_hdl_path_root(VUVM_regblock__Syms* __restrict vlSymsp, std::string path, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_hdl_path_root\n"); );
        // Body
        if ((""s == kind)) {
            this->__VnoInFunc_get_default_hdl_path(vlSymsp, kind);
        }
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_hdl_path_root(VUVM_regblock__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &is_hdl_path_root__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_hdl_path_root\n"); );
        // Body
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_print(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_printer> printer) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_print\n"); );
        // Body
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_4__get_name;
        std::string __VlefCall_3__get_name;
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk703__DOT__i;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk703__DOT__i__Vnext;
        CData/*0:0*/ unnamedblk703__DOT__i__Vmore;
        unnamedblk703__DOT__i__Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_block> unnamedblk703__DOT__unnamedblk704__DOT__b;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> unnamedblk703__DOT__unnamedblk704__DOT__obj;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk705__DOT__i;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk705__DOT__i__Vnext;
        CData/*0:0*/ unnamedblk705__DOT__i__Vmore;
        unnamedblk705__DOT__i__Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> unnamedblk705__DOT__unnamedblk706__DOT__r;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> unnamedblk705__DOT__unnamedblk706__DOT__obj;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk707__DOT__i;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk707__DOT__i__Vnext;
        CData/*0:0*/ unnamedblk707__DOT__i__Vmore;
        unnamedblk707__DOT__i__Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> unnamedblk707__DOT__unnamedblk708__DOT__r;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> unnamedblk707__DOT__unnamedblk708__DOT__obj;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk709__DOT__i;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk709__DOT__i__Vnext;
        CData/*0:0*/ unnamedblk709__DOT__i__Vmore;
        unnamedblk709__DOT__i__Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem> unnamedblk709__DOT__unnamedblk710__DOT__m;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> unnamedblk709__DOT__unnamedblk710__DOT__obj;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> unnamedblk711__DOT__i;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> unnamedblk711__DOT__i__Vnext;
        CData/*0:0*/ unnamedblk711__DOT__i__Vmore;
        unnamedblk711__DOT__i__Vmore = 0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> unnamedblk711__DOT__unnamedblk712__DOT__m;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> unnamedblk711__DOT__unnamedblk712__DOT__obj;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clone(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clone\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__385__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__386__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__389__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__390__Vfuncout;
        // Body
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_copy(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> rhs) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_copy\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__393__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__394__Vfuncout;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_compare(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_compare\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__401__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__402__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__405__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__406__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_pack(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_packer> packer) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_pack\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__409__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__410__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__413__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__414__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_unpack(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_packer> packer) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_unpack\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__417__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__418__Vfuncout;
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__421__Vfuncout;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__422__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_convert2string(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_convert2string\n"); );
        // Body
        VlProcess::currentp(vlProcess.get());
        convert2string__Vfuncrtn = ""s;
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_randomize(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_randomize\n"); );
        // Body
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___Vsetup_constraints(VUVM_regblock__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___Vsetup_constraints\n"); );
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___VBasicRand\n"); );
        // Body
        __VBasicRand__Vfuncrtn = 1U;
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::_ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::_ctor_var_reset\n"); );
        // Body
    ...
    VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::~VUVM_regblock_uvm_pkg__03a__03auvm_reg_block() {
        VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_block::~\n"); );
    }
