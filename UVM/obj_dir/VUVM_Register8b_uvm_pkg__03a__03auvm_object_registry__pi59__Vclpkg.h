...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI59__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI59__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59> __PVT__me;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59__Vclpkg);
    ...
    void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59> &get__Vfuncrtn);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59 : public VUVM_Register8b_uvm_pkg__03a__03auvm_object_wrapper {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_object_registry__pi59"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59(*this); }
    ...
    VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59() = default;
    void init(VUVM_Register8b__Syms* __restrict vlSymsp);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi59();
};
