...
void VUVM_Register8b_uvm_pkg__03a__03auvm_spell_chkr__Tz13__Vclpkg::__VnoInFunc_check(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz5>> &strtab, std::string s, CData/*0:0*/ &check__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_spell_chkr__Tz13__Vclpkg::__VnoInFunc_check\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_spell_chkr__Tz13__Vclpkg::__VnoInFunc_levenshtein_distance(VUVM_Register8b__Syms* __restrict vlSymsp, std::string s, std::string t, IData/*31:0*/ &levenshtein_distance__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_spell_chkr__Tz13__Vclpkg::__VnoInFunc_levenshtein_distance\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_spell_chkr__Tz13__Vclpkg::__VnoInFunc_minimum(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ a, IData/*31:0*/ b, IData/*31:0*/ c, IData/*31:0*/ &minimum__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_spell_chkr__Tz13__Vclpkg::__VnoInFunc_minimum\n"); );
    // Body
    IData/*31:0*/ min;
    min = a;
