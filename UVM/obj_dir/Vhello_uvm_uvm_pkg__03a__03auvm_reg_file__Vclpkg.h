...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_REG_FILE__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_REG_FILE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_reg_file__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_reg_file__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_reg_file__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_reg_file__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_reg_file : public Vhello_uvm_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_file> __PVT__m_rf;
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_reg_file() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_reg_file();
};
