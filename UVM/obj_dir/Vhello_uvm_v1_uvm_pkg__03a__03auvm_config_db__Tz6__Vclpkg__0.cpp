...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlWide<128>/*4095:0*/ &value, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__2__Vfuncout;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz6> __Vfunc_get_highest_precedence__8__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_3__is_tracing;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz6> __VlefCall_2__get_type;
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz6__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __VlefCall_2__get_type);
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz6__Vclpkg.__VnoInFunc_get_highest_precedence(vlProcess, vlSymsp, rq, __Vfunc_get_highest_precedence__8__Vfuncout);
        ...
        if (__VlefCall_3__is_tracing) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz6__Vclpkg.__VnoInFunc_m_show_msg(vlProcess, vlSymsp, "CFGDB/GET"s, "Configuration"s, "read"s, inst_name, field_name, cntxt, r);
        }
        if ((VlNull{} == r)) {
            get__Vfuncrtn = 0U;
            goto __Vlabel0;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6__Vclpkg::__VnoInFunc_set(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlWide<128>/*4095:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz47> __VlefCall_2__new;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    ...
    CData/*0:0*/ exists;
    std::string lookup;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz47> pool;
    std::string rstate;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> cs;
    ...
    if ((! this->__PVT__m_rsc.exists(cntxt))) {
        __VlefCall_2__new = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz47, vlProcess, vlSymsp, ""s);
    ...
    if ((0U != __VlefCall_3__exists)) {
        ...
        r = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz6, vlProcess, vlSymsp, field_name, inst_name);
    ...
    if (__VlefCall_11__is_tracing) {
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz6__Vclpkg.__VnoInFunc_m_show_msg(vlProcess, vlSymsp, "CFGDB/SET"s, "Configuration"s, "set"s, inst_name, field_name, cntxt, r);
    }
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6__Vclpkg::__VnoInFunc_exists(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, CData/*0:0*/ spell_chk, CData/*0:0*/ &exists__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6__Vclpkg::__VnoInFunc_exists\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__38__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz6> __VlefCall_2__get_by_name;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> cs;
    exists__Vfuncrtn = 0U;
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz6__Vclpkg.__VnoInFunc_get_by_name(vlSymsp, inst_name, field_name, (IData)(spell_chk), __VlefCall_2__get_by_name);
    exists__Vfuncrtn = (VlNull{} != __VlefCall_2__get_by_name);
}

VlCoroutine Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6__Vclpkg::__VnoInFunc_wait_modified(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6__Vclpkg::__VnoInFunc_wait_modified\n"); );
    // Locals
    ...
    CData/*0:0*/ __VdynTrigger_h8813ff50__0;
    __VdynTrigger_h8813ff50__0 = 0;
    __VdynTrigger_h8813ff50__0 = 0U;
    if ((VlNull{} != waiter)) {
        VL_NULL_CHECK(waiter, "../../uvm/distrib/src/base/uvm_config_db.svh", 294)->__PVT__trigger.clearFired();
    }
    while ((1U & (~ (IData)(__VdynTrigger_h8813ff50__0)))) {
        co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                     vlProcess, 
                                                     "@([event] uvm_pkg::uvm_config_db__Tz6__Vclpkg.waiter.trigger)", 
                                                     "../../uvm/distrib/src/base/uvm_config_db.svh", 
                                                     294);
        __VdynTrigger_h8813ff50__0 = ((VlNull{} != waiter) 
                                      && VL_NULL_CHECK(waiter, "../../uvm/distrib/src/base/uvm_config_db.svh", 294)
                                      ->__PVT__trigger.isFired());
        vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_h8813ff50__0);
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6::init(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_db__Tz6::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6::new\n"); );
    // Body
    /*super.new*/;
}

Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6::~Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz6::~\n"); );
}
