...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_REG_FIFO__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_REG_FIFO__VCLPKG_H_  // guard
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_fifo;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_fifo__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_fifo__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_fifo__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_fifo__Vclpkg);
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_fifo : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg {
  public:
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_field> __PVT__value;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_fifo"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_fifo(*this); }
    ...
    void __VnoInFunc_capacity(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &capacity__Vfuncrtn);
    ...
    void __VnoInFunc_valid_fifo_size_resize_constrained_array(Vhello_uvm_v1__Syms* __restrict vlSymsp);
    void __VnoInFunc_valid_fifo_size_setup_constraint(Vhello_uvm_v1__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(Vhello_uvm_v1__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_fifo() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ size, IData/*31:0*/ n_bits, IData/*31:0*/ has_cover);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_fifo();
};
