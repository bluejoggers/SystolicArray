...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_PORT_BASE__TZ81__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_PORT_BASE__TZ81__VCLPKG_H_  // guard
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_port_component__Tz90;
class Vuvm_pkg_uvm_pkg__03a__03auvm_port_component_base;
class Vuvm_pkg_uvm_pkg__03a__03auvm_root;
class Vuvm_pkg_uvm_pkg__03a__03auvm_sqr_if_base__Tz42_TBz42;


class Vuvm_pkg__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81__Vclpkg);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81 : public Vuvm_pkg_uvm_pkg__03a__03auvm_sqr_if_base__Tz42_TBz42 {
  public:
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81> __PVT__m_if;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_port_component__Tz90> __PVT__m_comp;
    VlAssocArray<std::string, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81>> __PVT__m_provided_by;
    VlAssocArray<std::string, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81>> __PVT__m_provided_to;
    VlAssocArray<std::string, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81>> __PVT__m_imp_list;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_port_base__Tz81"; }
    virtual void __VnoInFunc_connect(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81> provider);
    ...
    void __VnoInFunc_get_if(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81> &get_if__Vfuncrtn);
    ...
    void __VnoInFunc_m_add_list(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81> provider);
    void __VnoInFunc_m_check_relationship(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81> provider, CData/*0:0*/ &m_check_relationship__Vfuncrtn);
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81() = default;
    ...
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81();
};
