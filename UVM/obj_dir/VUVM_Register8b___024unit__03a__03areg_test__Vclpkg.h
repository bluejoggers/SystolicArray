...
#ifndef VERILATED_VUVM_REGISTER8B___024UNIT__03A__03AREG_TEST__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B___024UNIT__03A__03AREG_TEST__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_test;


class VUVM_Register8b__Syms;

class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b___024unit__03a__03areg_test__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b___024unit__03a__03areg_test__Vclpkg();
    ~VUVM_Register8b___024unit__03a__03areg_test__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b___024unit__03a__03areg_test__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19> &get_type__Vfuncrtn);
};

#include "VUVM_Register8b_uvm_pkg__03a__03auvm_test__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b___024unit__03a__03areg_test : public VUVM_Register8b_uvm_pkg__03a__03auvm_test {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<VUVM_Register8b___024unit__03a__03areg_env> __PVT__env_in_test;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "$unit::reg_test"; }
    VlClass* clone() const { return new VUVM_Register8b___024unit__03a__03areg_test(*this); }
  ...
  public:
    VUVM_Register8b___024unit__03a__03areg_test() = default;
    ...
    virtual ~VUVM_Register8b___024unit__03a__03areg_test();
};
