...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs::__VnoInFunc_get_radix_str(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ radix, std::string &get_radix_str__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs::__VnoInFunc_get_radix_str\n"); );
    // Body
    {
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs::init(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs::new\n"); );
    // Body
