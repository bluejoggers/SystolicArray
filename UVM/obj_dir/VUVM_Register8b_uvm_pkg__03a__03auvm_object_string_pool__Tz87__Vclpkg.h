...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_OBJECT_STRING_POOL__TZ87__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_OBJECT_STRING_POOL__TZ87__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87> &get_global_pool__Vfuncrtn);
};

#include "VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz87__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87 : public VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz87 {
  public:
    ...
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz87();
};
