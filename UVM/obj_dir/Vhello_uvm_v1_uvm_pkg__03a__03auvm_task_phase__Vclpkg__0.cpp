...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name) {
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_phase::init(vlProcess, vlSymsp, name, 0U, VlNull{});
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::new\n"); );
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_traverse(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> comp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_phase> phase, IData/*31:0*/ state) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_traverse\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_m_traverse(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> comp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_phase> phase, IData/*31:0*/ state) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_m_traverse\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequencer_base> seqr;
    name = ""s;
    ...
    if (((phase_domain == __VlefCall_8__get_common_domain) 
        ...
        if ((8U == state)) {
            ...
            unnamedblk1__DOT__ph = VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase>{this};
            if (VL_NULL_CHECK(comp, "../../uvm/distrib/src/base/uvm_task_phase.svh", 114)
                ->__PVT__m_phase_imps.exists(VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase>{this})) {
                unnamedblk1__DOT__ph = VL_NULL_CHECK(comp, "../../uvm/distrib/src/base/uvm_task_phase.svh", 115)
                    ->__PVT__m_phase_imps.at(VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase>{this});
            }
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_execute(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> comp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_execute\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03a__VDynScope_8> __VDynScope_execute_0;
    __VDynScope_execute_0 = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03a__VDynScope_8, vlSymsp);
...
VlCoroutine Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_execute____Vfork_1__0(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03a__VDynScope_8> __VDynScope_execute_0) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_execute____Vfork_1__0\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03a__VDynScope_8> __Vtask___VforkTask_0__37____VDynScope_execute_0;
    ...
    VlClassRef<Vhello_uvm_v1_std__03a__03aprocess> __Vtask___VforkTask_0__37__proc;
    VlClassRef<Vhello_uvm_v1_std__03a__03aprocess> __Vfunc_self__38__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_seed_map> __Vfunc_uvm_create_random_seed__41____VlefCall_0__new;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_randomize(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc___Vsetup_constraints(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc___VBasicRand(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::_ctor_var_reset(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::~Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_task_phase::~\n"); );
}
