...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_POOL__TZ5_TBZ31__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_POOL__TZ5_TBZ31__VCLPKG_H_  // guard
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31;
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_global(Vuvm_pkg__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz4> &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31> &get_global_pool__Vfuncrtn);
};
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31 : public Vuvm_pkg_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<std::string, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz4>> __PVT__pool;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_pool__Tz5_TBz31"; }
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31(*this); }
    virtual void __VnoInFunc___VBasicRand(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(Vuvm_pkg__Syms* __restrict vlSymsp);
    virtual void __VnoInFunc_add(Vuvm_pkg__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz4> item);
    ...
    virtual void __VnoInFunc_get(Vuvm_pkg__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz4> &get__Vfuncrtn);
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31();
};
