...
void VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VUVM_regblock_reg_if* &value, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__2__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz1> __Vfunc_get_highest_precedence__8__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_3__is_tracing;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz1> __VlefCall_2__get_type;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz1__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __VlefCall_2__get_type);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1__Vclpkg::__VnoInFunc_set(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VUVM_regblock_reg_if* value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz3> __VlefCall_2__new;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    ...
    CData/*0:0*/ exists;
    std::string lookup;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz3> pool;
    std::string rstate;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> cs;
    ...
    if ((! this->__PVT__m_rsc.exists(cntxt))) {
        __VlefCall_2__new = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz3, vlProcess, vlSymsp, ""s);
    ...
    if ((0U != __VlefCall_3__exists)) {
        ...
        r = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz1, vlProcess, vlSymsp, field_name, inst_name);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1__Vclpkg::__VnoInFunc_exists(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, CData/*0:0*/ spell_chk, CData/*0:0*/ &exists__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1__Vclpkg::__VnoInFunc_exists\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__38__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz1> __VlefCall_2__get_by_name;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> cs;
    exists__Vfuncrtn = 0U;
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz1__Vclpkg.__VnoInFunc_get_by_name(vlSymsp, inst_name, field_name, (IData)(spell_chk), __VlefCall_2__get_by_name);
    exists__Vfuncrtn = (VlNull{} != __VlefCall_2__get_by_name);
}

VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1__Vclpkg::__VnoInFunc_wait_modified(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1__Vclpkg::__VnoInFunc_wait_modified\n"); );
    // Locals
...
void VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1::init(VUVM_regblock__Syms* __restrict vlSymsp) {
    VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz1::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+                        VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1::new\n"); );
    // Body
    /*super.new*/;
}

VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1::~VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                        VUVM_regblock_uvm_pkg__03a__03auvm_config_db__Tz1::~\n"); );
}
