...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_BARRIER__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_BARRIER__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_barrier__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_barrier__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_barrier__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_barrier__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_barrier : public Vhello_uvm_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_barrier(*this); }
    ...
    virtual void __VnoInFunc_get_threshold(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_threshold__Vfuncrtn);
    virtual void __VnoInFunc_get_type_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn);
    VlCoroutine __VnoInFunc_m_trigger(Vhello_uvm__Syms* __restrict vlSymsp);
    ...
    virtual void __VnoInFunc_set_auto_reset(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ value);
    virtual void __VnoInFunc_set_threshold(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ threshold);
    virtual VlCoroutine __VnoInFunc_wait_for(Vhello_uvm__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_barrier() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ threshold);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_barrier();
};
