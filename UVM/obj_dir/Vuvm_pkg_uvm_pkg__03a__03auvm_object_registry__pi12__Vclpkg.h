...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI12__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI12__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi12__Vclpkg final {
  public:
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi12> __PVT__me;
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi12__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi12__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi12__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_create(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_message_element_container> &create__Vfuncrtn);
    void __VnoInFunc_get(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi12> &get__Vfuncrtn);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi12 : public Vuvm_pkg_uvm_pkg__03a__03auvm_object_wrapper {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_object_registry__pi12"; }
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi12(*this); }
    ...
    Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi12() = default;
    void init(Vuvm_pkg__Syms* __restrict vlSymsp);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi12();
};
