...
void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93__Vclpkg::__VnoInFunc_m_initialize(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93> &m_initialize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93__Vclpkg::__VnoInFunc_m_initialize\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base> __Vtask_m_initialize__0__Vfuncout;
    // Body
    ...
    if ((VlNull{} == this->__PVT__m_t_inst)) {
        ...
        this->__PVT__m_t_inst = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93, vlProcess, vlSymsp);
        this->__PVT__m_tw_cb_q = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50, vlProcess, vlSymsp, "typewide_queue"s);
    }
    m_initialize__Vfuncrtn = this->__PVT__m_t_inst;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93__Vclpkg::__VnoInFunc_m_cb_find(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> q, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ &m_cb_find__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93__Vclpkg::__VnoInFunc_m_cb_find\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93__Vclpkg::__VnoInFunc_m_cb_find_name(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> q, std::string name, std::string where, IData/*31:0*/ &m_cb_find_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93__Vclpkg::__VnoInFunc_m_cb_find_name\n"); );
    // Locals
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93__Vclpkg::__VnoInFunc_display(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_backdoor> obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93__Vclpkg::__VnoInFunc_display\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_backdoor> me;
        VlQueue<std::string> cbq;
        VlQueue<std::string> inst_q;
        VlQueue<std::string> mode_q;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb;
        std::string blanks;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> bobj;
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc_m_am_i_a(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ &m_am_i_a__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc_m_am_i_a\n"); );
        // Body
        IData/*31:0*/ __VlefExpr_0;
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_backdoor> this_type;
        {
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc_m_get_tw_cb_q(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> &m_get_tw_cb_q__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc_m_get_tw_cb_q\n"); );
        // Body
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base> unnamedblk1__DOT__unnamedblk2__DOT__dt;
        {
            this->__VnoInFunc_m_am_i_a(vlSymsp, obj, __VlefCall_0__m_am_i_a);
            if (__VlefCall_0__m_am_i_a) {
                unnamedblk1__DOT__i = 0U;
                while (VL_LTS_III(32, unnamedblk1__DOT__i, VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
                    unnamedblk1__DOT__i__Vloopsize 
                        = VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size();
                    unnamedblk1__DOT__unnamedblk2__DOT__dt 
                        = vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid_base__Vclpkg.__PVT__typeid_map
                        .at(VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.at(unnamedblk1__DOT__i));
                    if (((VlNull{} != unnamedblk1__DOT__unnamedblk2__DOT__dt) 
                         & (unnamedblk1__DOT__unnamedblk2__DOT__dt 
                            != VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93>{this}))) {
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc_m_add_tw_cbs(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc_m_add_tw_cbs\n"); );
        // Locals
        ...
        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base> cb_pair;
        ...
        while (VL_LTS_III(32, unnamedblk5__DOT__i, VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            unnamedblk5__DOT__i__Vloopsize = VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size();
            cb_pair = vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid_base__Vclpkg.__PVT__typeid_map
                .at(VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.at(unnamedblk5__DOT__i));
            if ((cb_pair != VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93>{this})) {
                VL_NULL_CHECK(cb_pair, "../../uvm/distrib/src/base/uvm_callback.svh", 282)
                        ->__VnoInFunc_m_add_tw_cbs(vlSymsp, cb, ordering);
            }
            if ((unnamedblk5__DOT__i__Vloopsize <= VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc_m_delete_tw_cbs(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_delete_tw_cbs__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc_m_delete_tw_cbs\n"); );
        // Locals
        ...
        while (VL_LTS_III(32, unnamedblk6__DOT__i, VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            unnamedblk6__DOT__i__Vloopsize = VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size();
            cb_pair = vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid_base__Vclpkg.__PVT__typeid_map
                .at(VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.at(unnamedblk6__DOT__i));
            if ((cb_pair != VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93>{this})) {
            ...
            if ((unnamedblk6__DOT__i__Vloopsize <= VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
        VUVM_regblock_uvm_pkg__03a__03auvm_callbacks_base::init(vlProcess, vlSymsp);
        VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::new\n"); );
        // Body
        VlProcess::currentp(vlProcess.get());
        /*super.new*/;
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc_randomize(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc_randomize\n"); );
        // Body
    ...
    void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc___Vsetup_constraints(VUVM_regblock__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc___Vsetup_constraints\n"); );
    }

    void VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::__VnoInFunc___VBasicRand\n"); );
        // Body
        __VBasicRand__Vfuncrtn = 1U;
    }

    VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::~VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93() {
        VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz93::~\n"); );
    }
