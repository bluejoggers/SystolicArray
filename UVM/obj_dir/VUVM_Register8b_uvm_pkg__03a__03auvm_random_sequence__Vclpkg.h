...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_RANDOM_SEQUENCE__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_RANDOM_SEQUENCE__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi38;
class VUVM_Register8b_uvm_pkg__03a__03auvm_object_wrapper;
class VUVM_Register8b_uvm_pkg__03a__03auvm_printer;
class VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi38> &get_type__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence : public VUVM_Register8b_uvm_pkg__03a__03auvm_sequence_ {
  public:
    ...
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence(*this); }
    virtual void __VnoInFunc___VBasicRand(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    void __VnoInFunc___Vrandwith_h509d7fc5__0(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence> __Vthis, IData/*31:0*/ &__Vrandwith_h509d7fc5__0__Vfuncrtn);
    void __VnoInFunc___Vrandwith_h509d7fc5__1(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence> __Vthis, IData/*31:0*/ &__Vrandwith_h509d7fc5__1__Vfuncrtn);
    ...
    void __VnoInFunc_get_count(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &get_count__Vfuncrtn);
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_random_sequence();
};
