...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_SET_GET_DAP_BASE__TZ21__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_SET_GET_DAP_BASE__TZ21__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21 : public VUVM_Activator_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21();
};
