...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_current_item(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> &get_current_item__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_current_item\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> __Vtask_try_peek__0__t;
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_last_req(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> &last_req__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_last_req\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_last_rsp(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ n, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> &last_rsp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_last_rsp\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> parent) {
    Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base::init(vlProcess, vlSymsp, name, parent);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    /*super.new*/;
    this->__PVT__rsp_export = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz42, vlProcess, vlSymsp, "rsp_export"s, 
                                     VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_>{this});
    this->__PVT__sqr_rsp_analysis_fifo = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_analysis_fifo_, vlProcess, vlSymsp, "sqr_rsp_analysis_fifo"s, 
                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_>{this});
    ...
    this->__PVT__m_req_fifo = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_tlm_fifo__Tz42, vlProcess, vlSymsp, "req_fifo"s, 
                                     VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_>{this}, 1U);
    VL_NULL_CHECK(this->__PVT__m_req_fifo, "../../uvm/distrib/src/seq/uvm_sequencer_param_base.svh", 232)->__PVT__print_enabled = 0U;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_do_print(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_do_print\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_connect_phase(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_connect_phase\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_build_phase(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_build_phase\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_send_request(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> t, CData/*0:0*/ rerandomize) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_send_request\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    __Vincrement1 = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> param_t;
    ...
    VL_NULL_CHECK(sequence_ptr, "../../uvm/distrib/src/seq/uvm_sequencer_param_base.svh", 295)->__VnoInFunc_m_get_sqr_sequence_id(vlSymsp, Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base::__PVT__m_sequencer_id, 1U, __VlefCall_4__m_get_sqr_sequence_id);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_put_response(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_put_response\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_analysis_write(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_analysis_write\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> response;
    response = t;
    this->__VnoInFunc_put_response(vlProcess, vlSymsp, response);
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_reqs_sent(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_reqs_sent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_reqs_sent\n"); );
    // Body
    get_num_reqs_sent__Vfuncrtn = this->__PVT__m_num_reqs_sent;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_rsps_received(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_rsps_received__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_rsps_received\n"); );
    // Body
    get_num_rsps_received__Vfuncrtn = this->__PVT__m_num_rsps_received;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_set_num_last_reqs(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_set_num_last_reqs\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    if ((0x00000400U < max)) {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_last_reqs(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_last_reqs__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_last_reqs\n"); );
    // Body
    get_num_last_reqs__Vfuncrtn = this->__PVT__m_num_last_reqs;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_m_last_req_push_front(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_m_last_req_push_front\n"); );
    // Body
    {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_set_num_last_rsps(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_set_num_last_rsps\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    if ((0x00000400U < max)) {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_last_rsps(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_last_rsps__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_get_num_last_rsps\n"); );
    // Body
    get_num_last_rsps__Vfuncrtn = this->__PVT__m_num_last_rsps;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_m_last_rsp_push_front(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_m_last_rsp_push_front\n"); );
    // Body
    {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_randomize(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc_randomize\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc___Vsetup_constraints(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc___VBasicRand(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::__VnoInFunc___VBasicRand\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::_ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::_ctor_var_reset\n"); );
    // Body
...
Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::~Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_param_base_::~\n"); );
}
