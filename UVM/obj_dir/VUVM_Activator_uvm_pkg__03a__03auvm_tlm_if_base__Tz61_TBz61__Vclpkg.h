...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_TLM_IF_BASE__TZ61_TBZ61__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_TLM_IF_BASE__TZ61_TBZ61__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_tlm_if_base__Tz61_TBz61__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_tlm_if_base__Tz61_TBz61__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_tlm_if_base__Tz61_TBz61__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_tlm_if_base__Tz61_TBz61__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_tlm_if_base__Tz61_TBz61 : public virtual VlClass {
  public:
    ...
    virtual void __VnoInFunc_nb_transport(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> req, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> &rsp, CData/*0:0*/ &nb_transport__Vfuncrtn);
    ...
    virtual void __VnoInFunc_transport(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> req, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> &rsp);
    virtual void __VnoInFunc_try_get(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> &t, CData/*0:0*/ &try_get__Vfuncrtn);
    ...
    virtual void __VnoInFunc_try_put(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> t, CData/*0:0*/ &try_put__Vfuncrtn);
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_tlm_if_base__Tz61_TBz61() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_tlm_if_base__Tz61_TBz61();
};
