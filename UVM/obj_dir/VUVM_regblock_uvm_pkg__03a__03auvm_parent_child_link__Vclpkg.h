...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_PARENT_CHILD_LINK__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_PARENT_CHILD_LINK__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_parent_child_link__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_parent_child_link__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_parent_child_link__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_parent_child_link__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_link(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> lhs, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> rhs, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_parent_child_link> &get_link__Vfuncrtn);
    void __VnoInFunc_get_type(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi10> &get_type__Vfuncrtn);
};
...
class VUVM_regblock_uvm_pkg__03a__03auvm_parent_child_link : public VUVM_regblock_uvm_pkg__03a__03auvm_link_base {
  public:
    ...
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_parent_child_link(*this); }
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_parent_child_link() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_parent_child_link();
};
