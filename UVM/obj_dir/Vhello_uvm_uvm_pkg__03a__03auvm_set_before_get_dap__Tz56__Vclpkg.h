...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ56__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ56__VCLPKG_H_  // guard
...
class Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz86;
...
class Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz56;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz86> &get_type__Vfuncrtn);
};

#include "Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz56__Vclpkg.h"

class Vhello_uvm__Syms;

class Vhello_uvm_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56 : public Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz56 {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __PVT__m_value;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_set_before_get_dap__Tz56"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56(*this); }
    ...
    virtual void __VnoInFunc_get(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> &get__Vfuncrtn);
    ...
    virtual void __VnoInFunc_set(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> value);
    virtual void __VnoInFunc_try_get(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> &value, CData/*0:0*/ &try_get__Vfuncrtn);
    virtual void __VnoInFunc_try_set(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> value, CData/*0:0*/ &try_set__Vfuncrtn);
  private:
    void _ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56();
};
