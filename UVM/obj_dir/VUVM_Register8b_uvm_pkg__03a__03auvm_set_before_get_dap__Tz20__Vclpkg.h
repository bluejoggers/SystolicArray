...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ20__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ20__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_set_get_dap_base__Tz20;
class VUVM_Register8b_uvm_pkg__03a__03auvm_status_container;


class VUVM_Register8b__Syms;

class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__Tz53> &get_type__Vfuncrtn);
};

#include "VUVM_Register8b_uvm_pkg__03a__03auvm_set_get_dap_base__Tz20__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20 : public VUVM_Register8b_uvm_pkg__03a__03auvm_set_get_dap_base__Tz20 {
  public:
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __PVT__m_value;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_set_before_get_dap__Tz20"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20();
};
