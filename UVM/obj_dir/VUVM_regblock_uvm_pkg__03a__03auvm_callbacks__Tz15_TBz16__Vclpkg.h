...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_CALLBACKS__TZ15_TBZ16__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_CALLBACKS__TZ15_TBZ16__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15;
class VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16;
...
class VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz15;
class VUVM_regblock_uvm_pkg__03a__03auvm_typeid__Tz15;
class VUVM_regblock_uvm_pkg__03a__03auvm_typeid__Tz16;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16> __PVT__m_inst;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15> __PVT__m_base_inst;
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_add(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering);
    ...
    void __VnoInFunc_delete(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb);
    ...
    void __VnoInFunc_display(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> obj);
    void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16> &get__Vfuncrtn);
    void __VnoInFunc_get_first(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase_cb> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase_cb> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase_cb> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase_cb> &get_prev__Vfuncrtn);
    void __VnoInFunc_m_get_q(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> &q, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> obj);
...
#include "VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz15__Vclpkg.h"

class VUVM_regblock__Syms;

class VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16 : public VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz15 {
  public:
    ...
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16(*this); }
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz15_TBz16();
};
