...
void Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlWide<128>/*4095:0*/ &value, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__2__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz4> __Vfunc_get_highest_precedence__8__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_3__is_tracing;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz4> __VlefCall_2__get_type;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4__Vclpkg::__VnoInFunc_set(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlWide<128>/*4095:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31> __VlefCall_2__new;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    ...
    CData/*0:0*/ exists;
    std::string lookup;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31> pool;
    std::string rstate;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> cs;
    ...
    if ((! this->__PVT__m_rsc.exists(cntxt))) {
        __VlefCall_2__new = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz31, vlProcess, vlSymsp, ""s);
    ...
    if ((0U != __VlefCall_3__exists)) {
        ...
        r = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz4, vlProcess, vlSymsp, field_name, inst_name);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4__Vclpkg::__VnoInFunc_exists(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, CData/*0:0*/ spell_chk, CData/*0:0*/ &exists__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4__Vclpkg::__VnoInFunc_exists\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__38__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz4> __VlefCall_2__get_by_name;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> cs;
    exists__Vfuncrtn = 0U;
...
VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4__Vclpkg::__VnoInFunc_wait_modified(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4__Vclpkg::__VnoInFunc_wait_modified\n"); );
    // Locals
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4::init(Vuvm_pkg__Syms* __restrict vlSymsp) {
    Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz4::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4::new\n"); );
    // Body
    /*super.new*/;
}

Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4::~Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz4::~\n"); );
}
