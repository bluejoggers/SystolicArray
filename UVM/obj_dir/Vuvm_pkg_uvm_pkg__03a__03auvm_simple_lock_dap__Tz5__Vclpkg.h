...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ5__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ5__VCLPKG_H_  // guard
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz5;
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_simple_lock_dap__Tz5__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_simple_lock_dap__Tz5__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_simple_lock_dap__Tz5__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_simple_lock_dap__Tz5__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__Tz89> &get_type__Vfuncrtn);
};
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_simple_lock_dap__Tz5 : public Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz5 {
  public:
    ...
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_simple_lock_dap__Tz5(*this); }
    ...
    void __VnoInFunc_lock(Vuvm_pkg__Syms* __restrict vlSymsp);
    ...
    void __VnoInFunc_unlock(Vuvm_pkg__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp);
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_simple_lock_dap__Tz5() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_simple_lock_dap__Tz5();
};
