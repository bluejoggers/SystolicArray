...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_TLM_TIME__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_TLM_TIME__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_tlm_time__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_tlm_time__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_tlm_time__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_tlm_time__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_set_time_resolution(VUVM_regblock__Syms* __restrict vlSymsp, double res);
};


class VUVM_regblock__Syms;

class VUVM_regblock_uvm_pkg__03a__03auvm_tlm_time : public virtual VlClass {
  public:
    ...
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_tlm_time(*this); }
    void __VnoInFunc_decr(VUVM_regblock__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs);
    void __VnoInFunc_get_abstime(VUVM_regblock__Syms* __restrict vlSymsp, double secs, double &get_abstime__Vfuncrtn);
    void __VnoInFunc_get_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_name__Vfuncrtn);
    void __VnoInFunc_get_realtime(VUVM_regblock__Syms* __restrict vlSymsp, QData/*63:0*/ scaled, double secs, double &get_realtime__Vfuncrtn);
    void __VnoInFunc_incr(VUVM_regblock__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs);
    void __VnoInFunc_reset(VUVM_regblock__Syms* __restrict vlSymsp);
    void __VnoInFunc_set_abstime(VUVM_regblock__Syms* __restrict vlSymsp, double t, double secs);
    void __VnoInFunc_to_m_res(VUVM_regblock__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs, double &to_m_res__Vfuncrtn);
  private:
    void _ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp);
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_tlm_time() = default;
    void init(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, double res);
    ~VUVM_regblock_uvm_pkg__03a__03auvm_tlm_time() {}
};
