...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI44__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI44__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi44__Vclpkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi44> __PVT__me;
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi44__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi44__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi44__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_create(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq> &create__Vfuncrtn);
    void __VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi44> &get__Vfuncrtn);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi44 : public Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_object_registry__pi44"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi44(*this); }
    ...
    Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi44() = default;
    void init(Vhello_uvm__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi44();
};
