...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_VISITOR_ADAPTER___VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_VISITOR_ADAPTER___VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_visitor_adapter___Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_visitor_adapter___Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_visitor_adapter___Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_visitor_adapter___Vclpkg);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_visitor_adapter_ : public Vuvm_pkg_uvm_pkg__03a__03auvm_object {
  public:
    ...
    Vuvm_pkg_uvm_pkg__03a__03auvm_visitor_adapter_() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_visitor_adapter_();
};
