...
void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time__Vclpkg::__VnoInFunc_set_time_resolution(VUVM_Register8b__Syms* __restrict vlSymsp, double res) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time__Vclpkg::__VnoInFunc_set_time_resolution\n"); );
    // Body
    this->__PVT__m_resolution = res;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::init(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, double res) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::new\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_get_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string &get_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_get_name\n"); );
    // Body
    get_name__Vfuncrtn = this->__PVT__m_name;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_reset\n"); );
    // Body
    this->__PVT__m_time = 0ULL;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_to_m_res(VUVM_Register8b__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs, double &to_m_res__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_to_m_res\n"); );
    // Body
    to_m_res__Vfuncrtn = ((t / VL_ITOR_D_Q(64, scaled)) 
                          * (secs / this->__PVT__m_res));
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_get_realtime(VUVM_Register8b__Syms* __restrict vlSymsp, QData/*63:0*/ scaled, double secs, double &get_realtime__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_get_realtime\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_incr(VUVM_Register8b__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_incr\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_decr(VUVM_Register8b__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_decr\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__36__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_root> __Vtask_get_root__37__Vfuncout;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_get_abstime(VUVM_Register8b__Syms* __restrict vlSymsp, double secs, double &get_abstime__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_get_abstime\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_set_abstime(VUVM_Register8b__Syms* __restrict vlSymsp, double t, double secs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::__VnoInFunc_set_abstime\n"); );
    // Body
    this->__PVT__m_time = VL_RTOIROUND_Q_D(((t * secs) 
                                            / this->__PVT__m_res));
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::_ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_time::_ctor_var_reset\n"); );
    // Body
