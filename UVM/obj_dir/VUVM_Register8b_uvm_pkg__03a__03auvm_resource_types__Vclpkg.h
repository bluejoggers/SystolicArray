...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_RESOURCE_TYPES__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_RESOURCE_TYPES__VCLPKG_H_  // guard
...
template <>
struct VlIsCustomStruct<VUVM_Register8b_access_t__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_resource_types__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_resource_types__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_resource_types__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_resource_types__Vclpkg);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_resource_types : public virtual VlClass {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_resource_types"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_resource_types(*this); }
    VUVM_Register8b_uvm_pkg__03a__03auvm_resource_types() = default;
    void init(VUVM_Register8b__Syms* __restrict vlSymsp) {}
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_resource_types() {}
};
