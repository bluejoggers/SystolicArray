...
void VUVM_regblock_uvm_pkg__03a__03auvm_factory_override::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string full_inst_path, std::string orig_type_name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> orig_type, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> ovrd_type) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_factory_override::new\n"); );
    // Locals
...
void VUVM_regblock_uvm_pkg__03a__03auvm_factory_override::_ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_factory_override::_ctor_var_reset\n"); );
    // Body
