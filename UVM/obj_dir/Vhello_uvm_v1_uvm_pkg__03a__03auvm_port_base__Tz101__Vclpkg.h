...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_PORT_BASE__TZ101__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_PORT_BASE__TZ101__VCLPKG_H_  // guard
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_component__Tz103;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101__Vclpkg);
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101 : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_tlm_if_base__Tz88_TBz88 {
  public:
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101> __PVT__m_if;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_component__Tz103> __PVT__m_comp;
    VlAssocArray<std::string, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101>> __PVT__m_provided_by;
    VlAssocArray<std::string, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101>> __PVT__m_provided_to;
    VlAssocArray<std::string, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101>> __PVT__m_imp_list;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_port_base__Tz101"; }
    virtual void __VnoInFunc_connect(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101> provider);
    ...
    void __VnoInFunc_get_if(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101> &get_if__Vfuncrtn);
    ...
    void __VnoInFunc_m_add_list(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101> provider);
    void __VnoInFunc_m_check_relationship(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101> provider, CData/*0:0*/ &m_check_relationship__Vfuncrtn);
  ...
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101() = default;
    ...
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz101();
};
