...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_PORT__PI6__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_PORT__PI6__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_seq_item_pull_port__pi6__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_seq_item_pull_port__pi6__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_seq_item_pull_port__pi6__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_seq_item_pull_port__pi6__Vclpkg);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_seq_item_pull_port__pi6 : public Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz81 {
  public:
    ...
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_seq_item_pull_port__pi6(*this); }
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_seq_item_pull_port__pi6() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ min_size, IData/*31:0*/ max_size);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_seq_item_pull_port__pi6();
};
