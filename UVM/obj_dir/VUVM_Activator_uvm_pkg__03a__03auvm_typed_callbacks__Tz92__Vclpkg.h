...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ92__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ92__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz92__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz92> __PVT__m_t_inst;
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz92__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz92__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz92__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz92> &m_initialize__Vfuncrtn);
};
...
class VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz92 : public VUVM_Activator_uvm_pkg__03a__03auvm_callbacks_base {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_typed_callbacks__Tz92"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz92(*this); }
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz92() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz92();
};
