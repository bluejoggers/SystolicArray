...
void Vhello_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_check(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz29>> &strtab, std::string s, CData/*0:0*/ &check__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_check\n"); );
    // Locals
    ...
    VlQueue<std::string> min_key;
    {
        ...
        if ((0xffffffffU == min)) {
            ...
            if ((0U != __VlefCall_0__uvm_report_enabled)) {
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__7__Vfuncout);
            ...
            if ((0U != __VlefCall_1__uvm_report_enabled)) {
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__16__Vfuncout);
                vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__top 
...
void Vhello_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_levenshtein_distance(Vhello_uvm__Syms* __restrict vlSymsp, std::string s, std::string t, IData/*31:0*/ &levenshtein_distance__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_levenshtein_distance\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_minimum(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ a, IData/*31:0*/ b, IData/*31:0*/ c, IData/*31:0*/ &minimum__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_minimum\n"); );
    // Body
    IData/*31:0*/ min;
    min = a;
