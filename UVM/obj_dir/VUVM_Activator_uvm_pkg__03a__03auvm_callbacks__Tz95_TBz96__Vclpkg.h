...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_CALLBACKS__TZ95_TBZ96__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_CALLBACKS__TZ95_TBZ96__VCLPKG_H_  // guard
...
class VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95;
class VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96;
...
class VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz95;
class VUVM_Activator_uvm_pkg__03a__03auvm_typeid__Tz50;
class VUVM_Activator_uvm_pkg__03a__03auvm_typeid__Tz95;
class VUVM_Activator_uvm_pkg__03a__03auvm_typeid__Tz96;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96> __PVT__m_inst;
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95> __PVT__m_base_inst;
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96__Vclpkg);
    ...
    void __VnoInFunc_add(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering);
    ...
    void __VnoInFunc_delete(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback> cb);
    ...
    void __VnoInFunc_display(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> obj);
    void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96> &get__Vfuncrtn);
    void __VnoInFunc_get_first(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_prev__Vfuncrtn);
    void __VnoInFunc_m_get_q(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50> &q, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> obj);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96 : public VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz95 {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_callbacks__Tz95_TBz96"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96(*this); }
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_callbacks__Tz95_TBz96();
};
