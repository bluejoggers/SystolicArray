...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_TASK_PHASE__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_TASK_PHASE__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03a__VDynScope_11;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_task_phase__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_task_phase__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_task_phase__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_task_phase__Vclpkg);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_task_phase : public VUVM_Register8b_uvm_pkg__03a__03auvm_phase {
  public:
  ...
  private:
    VlCoroutine __VnoInFunc_execute____Vfork_1__0(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03a__VDynScope_11> __VDynScope_execute_0);
  public:
    void __VnoInFunc_m_traverse(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> comp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> phase, IData/*31:0*/ state);
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_task_phase() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_task_phase();
};
