...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG_H_  // guard
...
class VUVM_Activator_uvm_pkg__03a__03auvm_table_printer;
class VUVM_Activator_uvm_pkg__03a__03auvm_tree_printer;


class VUVM_Activator__Syms;
struct VUVM_Activator_uvm_printer_row_info__struct__0 {
    ...
    bool operator==(const VUVM_Activator_uvm_printer_row_info__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<VUVM_Activator_uvm_printer_row_info__struct__0> : public std::true_type {};
struct VUVM_Activator_uvm_hdl_path_slice__struct__0 {
    std::string __PVT__path;
    IData/*31:0*/ __PVT__offset;
    IData/*31:0*/ __PVT__size;

    bool operator==(const VUVM_Activator_uvm_hdl_path_slice__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<VUVM_Activator_uvm_hdl_path_slice__struct__0> : public std::true_type {};
struct VUVM_Activator_uvm_reg_bus_op__struct__0 {
    ...
    bool operator==(const VUVM_Activator_uvm_reg_bus_op__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<VUVM_Activator_uvm_reg_bus_op__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg final {
  public:
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_printer> __PVT__uvm_default_printer;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_packer> __PVT__uvm_default_packer;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_comparer> __PVT__uvm_default_comparer;
    VlAssocArray<std::string, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_seed_map>> __PVT__uvm_random_seed_table_lookup;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_seed_map> __PVT__uvm_create_random_seed__Vstatic__seed_map;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_phase> __PVT__end_of_elaboration_ph;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_phase> __PVT__run_ph;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __PVT__uvm_top;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> run_test__Vstatic__top;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> run_test__Vstatic__cs;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __PVT__uvm_report_enabled__Vstatic__top;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report_enabled__Vstatic__cs;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __PVT__uvm_report__Vstatic__top;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report__Vstatic__cs;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __PVT__uvm_report_info__Vstatic__top;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report_info__Vstatic__cs;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __PVT__uvm_report_warning__Vstatic__top;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report_warning__Vstatic__cs;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __PVT__uvm_report_error__Vstatic__top;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report_error__Vstatic__cs;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __PVT__uvm_report_fatal__Vstatic__top;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report_fatal__Vstatic__cs;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_cmdline_processor> __PVT__uvm_cmdline_proc;
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg();
    ~VUVM_Activator_uvm_pkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg);
