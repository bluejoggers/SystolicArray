...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg::__VnoInFunc_get(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_object_wrapper> &value, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__2__Vfuncout;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz7> __Vfunc_get_highest_precedence__8__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_3__is_tracing;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz7> __VlefCall_2__get_type;
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz7__Vclpkg.__VnoInFunc_get_highest_precedence(vlSymsp, rq, __Vfunc_get_highest_precedence__8__Vfuncout);
        ...
        if (__VlefCall_3__is_tracing) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz7__Vclpkg.__VnoInFunc_m_show_msg(vlSymsp, "CFGDB/GET"s, "Configuration"s, "read"s, inst_name, field_name, cntxt, r);
        }
        if ((VlNull{} == r)) {
            get__Vfuncrtn = 0U;
            goto __Vlabel0;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg::__VnoInFunc_set(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_object_wrapper> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz50> __VlefCall_2__new;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_pool> unnamedblk1__DOT__rp;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_waiter> unnamedblk2__DOT__w;
    IData/*31:0*/ unnamedblk2__DOT__unnamedblk3__DOT__i;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> top;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_phase> curr_phase;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz7> r;
    CData/*0:0*/ exists;
    std::string lookup;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz50> pool;
    std::string rstate;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> cs;
    ...
    if ((! this->__PVT__m_rsc.exists(cntxt))) {
        __VlefCall_2__new = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz50, vlProcess, vlSymsp, ""s);
    ...
    if ((0U != __VlefCall_3__exists)) {
        ...
        r = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz7, vlProcess, vlSymsp, field_name, inst_name);
    ...
    if (__VlefCall_11__is_tracing) {
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz7__Vclpkg.__VnoInFunc_m_show_msg(vlSymsp, "CFGDB/SET"s, "Configuration"s, "set"s, inst_name, field_name, cntxt, r);
    }
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg::__VnoInFunc_exists(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, CData/*0:0*/ spell_chk, CData/*0:0*/ &exists__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg::__VnoInFunc_exists\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__38__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz7> __VlefCall_2__get_by_name;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> cs;
    exists__Vfuncrtn = 0U;
...
VlCoroutine Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg::__VnoInFunc_wait_modified(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg::__VnoInFunc_wait_modified\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__46__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_waiter> __VlefCall_4__get;
    IData/*31:0*/ __VlefCall_3__size;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz48> __VlefCall_2__new;
    std::string __VlefCall_1__get_full_name;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __VlefCall_0__get_root;
    IData/*31:0*/ unnamedblk4__DOT__i;
    VlClassRef<Vhello_uvm_v1_std__03a__03aprocess> p;
    std::string rstate;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_waiter> waiter;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> cs;
    vlSymsp->TOP__std__03a__03aprocess__Vclpkg.__VnoInFunc_self(vlProcess, vlSymsp, p);
    ...
    waiter = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_waiter, vlSymsp, inst_name, field_name);
    if ((! this->__PVT__m_waiters.exists(field_name))) {
        __VlefCall_2__new = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz48, vlProcess, vlSymsp, ""s);
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7::init(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_db__Tz7::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7::new\n"); );
    // Body
    /*super.new*/;
}

Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7::~Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_config_db__Tz7::~\n"); );
}
