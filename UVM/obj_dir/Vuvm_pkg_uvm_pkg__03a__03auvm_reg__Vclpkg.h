...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_REG__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_REG__VCLPKG_H_  // guard
...
class Vuvm_pkg_std__03a__03asemaphore;
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_reg__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_reg__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_reg__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_reg__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_max_size(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_max_size__Vfuncrtn);
    void __VnoInFunc_include_coverage(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, IData/*31:0*/ models, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor);
};
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_reg : public Vuvm_pkg_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_file> __PVT__m_regfile_parent;
    VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_field>> __PVT__m_fields;
    VlClassRef<Vuvm_pkg_std__03a__03asemaphore> __PVT__m_atomic;
    VlClassRef<Vuvm_pkg_std__03a__03aprocess> __PVT__m_process;
    ...
    VlCoroutine __VnoInFunc_XatomicX(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ on);
    virtual void __VnoInFunc_Xcheck_accessX(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> &map_info, std::string caller, CData/*0:0*/ &Xcheck_accessX__Vfuncrtn);
    void __VnoInFunc_Xget_fields_accessX(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> map, std::string &Xget_fields_accessX__Vfuncrtn);
    void __VnoInFunc_Xis_locked_by_fieldX(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ &Xis_locked_by_fieldX__Vfuncrtn);
    ...
    void __VnoInFunc_XsampleX(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ data, QData/*63:0*/ byte_en, CData/*0:0*/ is_read, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> map);
    void __VnoInFunc_Xset_busyX(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ busy);
    ...
    virtual void __VnoInFunc_backdoor_watch(Vuvm_pkg__Syms* __restrict vlSymsp);
    ...
    virtual void __VnoInFunc_do_check(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ expected, QData/*63:0*/ actual, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> map, CData/*0:0*/ &do_check__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_address(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn);
    virtual void __VnoInFunc_get_addresses(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> map, VlQueue<QData/*63:0*/> &addr, IData/*31:0*/ &get_addresses__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_default_map(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string caller, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> &get_default_map__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_fields(Vuvm_pkg__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_field>> &fields);
    ...
    virtual void __VnoInFunc_get_n_bytes(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bytes__Vfuncrtn);
    virtual void __VnoInFunc_get_n_maps(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_maps__Vfuncrtn);
    virtual void __VnoInFunc_get_offset(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_offset__Vfuncrtn);
    ...
    void __VnoInFunc_is_busy(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ &is_busy__Vfuncrtn);
    ...
    virtual void __VnoInFunc_predict(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ value, CData/*7:0*/ be, IData/*31:0*/ kind, IData/*31:0*/ path, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> map, std::string fname, IData/*31:0*/ lineno, CData/*0:0*/ &predict__Vfuncrtn);
    ...
    virtual void __VnoInFunc_sample(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ data, QData/*63:0*/ byte_en, CData/*0:0*/ is_read, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> map);
    ...
    virtual void __VnoInFunc_set_parent(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> blk_parent, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_file> regfile_parent);
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_reg() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ n_bits, IData/*31:0*/ has_coverage);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_reg();
};
