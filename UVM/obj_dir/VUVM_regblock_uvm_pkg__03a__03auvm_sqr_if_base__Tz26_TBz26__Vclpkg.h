...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ26_TBZ26__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ26_TBZ26__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26__Vclpkg);
...
class VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26 : public virtual VlClass {
  public:
    ...
    virtual void __VnoInFunc_item_done(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_item> t);
    ...
    virtual void __VnoInFunc_put_response(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_item> t);
    ...
    virtual VlCoroutine __VnoInFunc_wait_for_sequences(VUVM_regblock__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp);
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26();
};
