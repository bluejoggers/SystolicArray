...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ86__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ86__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz86__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz86> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz86__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz86__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz86__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz86> &get_global_pool__Vfuncrtn);
};
...
class VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz86 : public VUVM_Activator_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<std::string, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_barrier>> __PVT__pool;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_pool__Tz2_TBz86"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz86(*this); }
    ...
    virtual void __VnoInFunc_add(VUVM_Activator__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_barrier> item);
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz86() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz86();
};
