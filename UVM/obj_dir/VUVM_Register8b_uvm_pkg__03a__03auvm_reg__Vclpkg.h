...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_REG__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_REG__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_callback_iter__Tz93_TBz90;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_reg__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_reg__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_reg__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_reg__Vclpkg);
    ...
    void __VnoInFunc_include_coverage(VUVM_Register8b__Syms* __restrict vlSymsp, std::string scope, IData/*31:0*/ models, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> accessor);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_reg : public VUVM_Register8b_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_file> __PVT__m_regfile_parent;
    VlQueue<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_field>> __PVT__m_fields;
    VlClassRef<VUVM_Register8b_std__03a__03asemaphore> __PVT__m_atomic;
    VlClassRef<VUVM_Register8b_std__03a__03aprocess> __PVT__m_process;
    ...
    VlCoroutine __VnoInFunc_XatomicX(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, CData/*0:0*/ on);
    virtual void __VnoInFunc_Xcheck_accessX(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map_info> &map_info, std::string caller, CData/*0:0*/ &Xcheck_accessX__Vfuncrtn);
    void __VnoInFunc_Xget_fields_accessX(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map, std::string &Xget_fields_accessX__Vfuncrtn);
    void __VnoInFunc_Xis_locked_by_fieldX(VUVM_Register8b__Syms* __restrict vlSymsp, CData/*0:0*/ &Xis_locked_by_fieldX__Vfuncrtn);
    ...
    void __VnoInFunc_XsampleX(VUVM_Register8b__Syms* __restrict vlSymsp, QData/*63:0*/ data, QData/*63:0*/ byte_en, CData/*0:0*/ is_read, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map);
    void __VnoInFunc_Xset_busyX(VUVM_Register8b__Syms* __restrict vlSymsp, CData/*0:0*/ busy);
    ...
    virtual void __VnoInFunc_backdoor_watch(VUVM_Register8b__Syms* __restrict vlSymsp);
    ...
    void __VnoInFunc_configure(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block> blk_parent, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_file> regfile_parent, std::string hdl_path);
    ...
    virtual void __VnoInFunc_do_check(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, QData/*63:0*/ expected, QData/*63:0*/ actual, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map, CData/*0:0*/ &do_check__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_address(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn);
    virtual void __VnoInFunc_get_addresses(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map, VlQueue<QData/*63:0*/> &addr, IData/*31:0*/ &get_addresses__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_default_map(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string caller, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> &get_default_map__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_fields(VUVM_Register8b__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_field>> &fields);
    ...
    virtual void __VnoInFunc_get_mirrored_value(VUVM_Register8b__Syms* __restrict vlSymsp, std::string fname, IData/*31:0*/ lineno, QData/*63:0*/ &get_mirrored_value__Vfuncrtn);
    virtual void __VnoInFunc_get_n_bits(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bits__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_offset(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_offset__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_regfile(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_file> &get_regfile__Vfuncrtn);
    virtual void __VnoInFunc_get_reset(VUVM_Register8b__Syms* __restrict vlSymsp, std::string kind, QData/*63:0*/ &get_reset__Vfuncrtn);
    ...
    virtual void __VnoInFunc_has_reset(VUVM_Register8b__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ __SYM__delete, CData/*0:0*/ &has_reset__Vfuncrtn);
    void __VnoInFunc_is_busy(VUVM_Register8b__Syms* __restrict vlSymsp, CData/*0:0*/ &is_busy__Vfuncrtn);
    ...
    virtual void __VnoInFunc_pre_write(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_item> rw);
    virtual void __VnoInFunc_predict(VUVM_Register8b__Syms* __restrict vlSymsp, QData/*63:0*/ value, CData/*7:0*/ be, IData/*31:0*/ kind, IData/*31:0*/ path, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map, std::string fname, IData/*31:0*/ lineno, CData/*0:0*/ &predict__Vfuncrtn);
    ...
    virtual void __VnoInFunc_sample(VUVM_Register8b__Syms* __restrict vlSymsp, QData/*63:0*/ data, QData/*63:0*/ byte_en, CData/*0:0*/ is_read, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map);
    ...
    virtual void __VnoInFunc_set_parent(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block> blk_parent, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_file> regfile_parent);
    virtual void __VnoInFunc_set_reset(VUVM_Register8b__Syms* __restrict vlSymsp, QData/*63:0*/ value, std::string kind);
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_reg() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ n_bits, IData/*31:0*/ has_coverage);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_reg();
};
