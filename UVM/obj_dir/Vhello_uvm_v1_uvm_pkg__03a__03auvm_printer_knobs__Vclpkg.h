...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_PRINTER_KNOBS__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_PRINTER_KNOBS__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg);
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs : public virtual VlClass {
  public:
    ...
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs(*this); }
    void __VnoInFunc_get_radix_str(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ radix, std::string &get_radix_str__Vfuncrtn);
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs() = default;
    void init(Vhello_uvm_v1__Syms* __restrict vlSymsp);
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer_knobs() {}
};
