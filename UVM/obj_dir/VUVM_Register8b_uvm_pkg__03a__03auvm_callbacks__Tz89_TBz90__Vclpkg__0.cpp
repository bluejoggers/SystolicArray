...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz89> __Vtask_m_initialize__1__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_typeid__Tz50> __Vfunc_get__2__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_typeid__Tz90> __Vfunc_get__3__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_typeid__Tz89> __Vfunc_get__4__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89> __Vfunc_get__6__Vfuncout;
    ...
    if ((VlNull{} == this->__PVT__m_inst)) {
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__VnoInFunc_m_initialize(vlProcess, vlSymsp, __Vtask_m_initialize__1__Vfuncout);
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz90__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__3__Vfuncout);
        this->__PVT__m_cb_typeid = __Vfunc_get__3__Vfuncout;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz89__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__4__Vfuncout);
        this->__PVT__m_typeid = __Vfunc_get__4__Vfuncout;
        this->__PVT__m_inst = VL_NEW(VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90, vlProcess, vlSymsp);
        if (VL_UNLIKELY(((unnamedblk1__DOT__cb_base_type 
                          == this->__PVT__m_cb_typeid)))) {
            VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:521: Assertion failed in %m: '$cast' failed.\n",3, 'M',vlSymsp->name(),"uvm_pkg.uvm_callbacks__Tz89_TBz90.get.unnamedblk1", 'T',-12
                         , '#',64,VL_TIME_UNITED_Q(1));
            VL_STOP_MT("../../uvm/distrib/src/base/uvm_callback.svh", 521, "");
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__PVT__m_t_inst 
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz89__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vfunc_get__6__Vfuncout);
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_m_register_pair(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string tname, std::string cbname, CData/*0:0*/ &m_register_pair__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_m_register_pair\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> inst;
    m_register_pair__Vfuncrtn = 0U;
    this->__VnoInFunc_get(vlProcess, vlSymsp, inst);
    this->__PVT__m_typename = tname;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__PVT__m_typename 
        = tname;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_add(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_add\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> __Vtask_get__16__Vfuncout;
    ...
    std::string tnm;
    {
        ...
        if ((VlNull{} == cb)) {
            ...
            if ((""s != vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz89__Vclpkg.__PVT__m_typename)) {
                tnm = vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz89__Vclpkg.__PVT__m_typename;
            } else if ((VlNull{} != obj)) {
        ...
        if ((VlNull{} == obj)) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__PVT__m_tw_cb_q, cb, __VlefCall_3__m_cb_find);
            if ((0xffffffffU != __VlefCall_3__m_cb_find)) {
                tnm = ((""s != vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz89__Vclpkg.__PVT__m_typename)
                        ? vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz89__Vclpkg.__PVT__m_typename
                        : "uvm_object"s);
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__PVT__m_t_inst, "../../uvm/distrib/src/base/uvm_callback.svh", 650)->__VnoInFunc_m_add_tw_cbs(vlSymsp, cb, ordering);
            }
        } else {
            ...
            if ((0U == __VlefCall_5__size)) {
                ...
                unnamedblk2__DOT__unnamedblk5__DOT__i = 0U;
                while (true) {
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__PVT__m_tw_cb_q, "../../uvm/distrib/src/base/uvm_callback.svh", 679)->__VnoInFunc_size(vlSymsp, __VlefCall_6__size);
                    if (!(VL_LTS_III(32, unnamedblk2__DOT__unnamedblk5__DOT__i, __VlefCall_6__size))) break;
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__PVT__m_tw_cb_q, "../../uvm/distrib/src/base/uvm_callback.svh", 680)->__VnoInFunc_get(vlProcess, vlSymsp, unnamedblk2__DOT__unnamedblk5__DOT__i, __VlefCall_7__get);
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, q, cb, __VlefCall_8__m_cb_find);
            if ((0xffffffffU != __VlefCall_8__m_cb_find)) {
                ...
                vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__VnoInFunc_m_cb_find_name(vlSymsp, q, 
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_add_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> root, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_add_by_name\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> __Vtask_get__58__Vfuncout;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_delete(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callback> cb) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_delete\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> __Vtask_get__71__Vfuncout;
    ...
    if ((VlNull{} == obj)) {
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__PVT__m_t_inst, "../../uvm/distrib/src/base/uvm_callback.svh", 761)->__VnoInFunc_m_delete_tw_cbs(vlSymsp, cb, found);
    } else {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, q, cb, pos);
        if ((0xffffffffU != pos)) {
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_delete_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> root) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_delete_by_name\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> __Vtask_get__82__Vfuncout;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_m_get_q(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz50> &q, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_m_get_q\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    if ((0U != __VlefCall_0__exists)) {
        ...
        if ((VlNull{} == obj)) {
            __VlefCall_1__m_get_tw_cb_q = vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__PVT__m_tw_cb_q;
        } else {
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__PVT__m_t_inst, "../../uvm/distrib/src/base/uvm_callback.svh", 825)->__VnoInFunc_m_get_tw_cb_q(vlSymsp, obj, __VlefCall_1__m_get_tw_cb_q);
        }
        q = __VlefCall_1__m_get_tw_cb_q;
    }
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_get_first(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_cbs> &get_first__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_get_first\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> __Vtask_get__96__Vfuncout;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_get_last(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_cbs> &get_last__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_get_last\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> __Vtask_get__101__Vfuncout;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_get_next(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_cbs> &get_next__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_get_next\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> __Vtask_get__106__Vfuncout;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_get_prev(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_cbs> &get_prev__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_get_prev\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> __Vtask_get__111__Vfuncout;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_display(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90__Vclpkg::__VnoInFunc_display\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90> __Vtask_get__115__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    this->__VnoInFunc_get(vlProcess, vlSymsp, __Vtask_get__115__Vfuncout);
    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz89__Vclpkg.__VnoInFunc_display(vlSymsp, obj);
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::__VnoInFunc_m_is_registered(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_registered__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::__VnoInFunc_m_is_registered\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::__VnoInFunc_m_is_for_me(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_for_me__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::__VnoInFunc_m_is_for_me\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp) {
    VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz89::init(vlProcess, vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::__VnoInFunc_randomize(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::__VnoInFunc___Vsetup_constraints(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::__VnoInFunc___VBasicRand(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::_ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_registered = 0;
}

VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::~VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz89_TBz90::~\n"); );
}
