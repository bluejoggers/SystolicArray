...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SET_GET_DAP_BASE__TZ11__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SET_GET_DAP_BASE__TZ11__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11 : public Vhello_uvm_uvm_pkg__03a__03auvm_object {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_set_get_dap_base__Tz11"; }
    ...
    Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11();
};
