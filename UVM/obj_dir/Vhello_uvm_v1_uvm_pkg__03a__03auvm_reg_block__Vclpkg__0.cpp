...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_check_data_width(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ width, CData/*0:0*/ &check_data_width__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_check_data_width\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__5__Vfuncout;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__6__Vfuncout;
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_get_root_blocks(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>> &blks) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_get_root_blocks\n"); );
    // Body
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk624__DOT__blk;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk624__DOT__blk__Vnext;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_blocks(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>> &blks, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> root, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> accessor, IData/*31:0*/ &find_blocks__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_blocks\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> __VlefCall_4__read;
    IData/*31:0*/ __VlefExpr_3;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_base> __VlefCall_2__get;
    IData/*31:0*/ __VlefCall_1__size;
    std::string __VlefCall_0__get_full_name;
    IData/*31:0*/ unnamedblk625__DOT__i;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85> unnamedblk625__DOT__unnamedblk626__DOT__blk;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_pool> rpl;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz8> rs;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_block(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> root, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> &find_block__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block__Vclpkg::__VnoInFunc_find_block\n"); );
    // Locals
    ...
    VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>> blks;
    {
        blks.clear();
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample(Vhello_uvm_v1__Syms* __restrict vlSymsp, QData/*63:0*/ offset, CData/*0:0*/ is_read, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample\n"); );
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ has_coverage) {
        Vhello_uvm_v1_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::new\n"); );
        // Body
        VlProcess::currentp(vlProcess.get());
        ...
        /*super.new*/;
        this->__PVT__hdl_paths_pool = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_string_pool__Tz84, vlProcess, vlSymsp, "hdl_paths"s);
        this->__PVT__has_cover = has_coverage;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_reg_block__Vclpkg.__PVT__m_roots
                    .at(VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>{this}) = 0U;
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_configure(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> parent, std::string hdl_path) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_configure\n"); );
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_0__get_full_name;
        ...
        if ((VlNull{} != parent)) {
            VL_NULL_CHECK(this->__PVT__parent, "../../uvm/distrib/src/reg/uvm_reg_block.svh", 968)
                    ->__VnoInFunc_add_block(vlSymsp, 
                                            VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>{this});
        }
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz85__Vclpkg.__VnoInFunc_set(vlSymsp, "uvm_reg::*"s, 
                                                                                VL_CVT_PACK_STR_NN(__VlefCall_0__get_full_name), 
                                                                                VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>{this}, VlNull{});
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_block(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> blk) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_block\n"); );
        // Locals
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_reg(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> rg) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_reg\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__27__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__28__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__31__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__32__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__41__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__42__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_4__get_name;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_vreg(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> vreg) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_vreg\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__54__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__55__Vfuncout;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_mem(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> mem) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_mem\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__65__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__66__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__69__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__70__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__73__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__74__Vfuncout;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_parent(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> parent) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_parent\n"); );
        // Body
        if ((VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>{this} 
             != parent)) {
            this->__PVT__parent = parent;
        }
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_locked(Vhello_uvm_v1__Syms* __restrict vlSymsp, CData/*0:0*/ &is_locked__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_locked\n"); );
        // Body
        is_locked__Vfuncrtn = this->__PVT__locked;
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_lock_model(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_lock_model\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__92__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__93__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__96__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__97__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__108__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__109__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        ...
        CData/*0:0*/ __VlefCall_0__is_locked;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk594__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk594__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk594__DOT__rg___Vmore;
        unnamedblk594__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk594__DOT__unnamedblk595__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk596__DOT__mem_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk596__DOT__mem___Vnext;
        CData/*0:0*/ unnamedblk596__DOT__mem___Vmore;
        unnamedblk596__DOT__mem___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk596__DOT__unnamedblk597__DOT__mem;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk598__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk598__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk598__DOT__blk___Vmore;
        unnamedblk598__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk598__DOT__unnamedblk599__DOT__blk;
        IData/*31:0*/ unnamedblk600__DOT__max_size;
        IData/*31:0*/ unnamedblk600__DOT__unnamedblk601__DOT__n;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk600__DOT__unnamedblk601__DOT__unnamedblk602__DOT___blk;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk600__DOT__unnamedblk601__DOT__unnamedblk602__DOT___blk__Vnext;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk600__DOT__unnamedblk601__DOT__unnamedblk602__DOT__unnamedblk603__DOT__blk;
        {
            this->__VnoInFunc_is_locked(vlSymsp, __VlefCall_0__is_locked);
            if (__VlefCall_0__is_locked) {
                goto __Vlabel0;
            ...
            if ((VlNull{} == this->__PVT__parent)) {
                ...
                }
                {
                    ...
                    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> __Vinline_0___VnoInFunc_Xinit_address_mapsX_unnamedblk694__DOT__map_;
                    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> __Vinline_0___VnoInFunc_Xinit_address_mapsX_unnamedblk694__DOT__map___Vnext;
                    ...
                    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> __Vinline_0___VnoInFunc_Xinit_address_mapsX_unnamedblk694__DOT__unnamedblk695__DOT__map;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_name\n"); );
        // Body
        VlProcess::currentp(vlProcess.get());
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_fields(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_field>> &fields, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_fields\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk604__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk604__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk604__DOT__rg___Vmore;
        unnamedblk604__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk604__DOT__unnamedblk605__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk606__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk606__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk606__DOT__blk___Vmore;
        unnamedblk606__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk606__DOT__unnamedblk607__DOT__blk;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_fields(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg_field>> &fields, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_fields\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk608__DOT__vreg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk608__DOT__vreg___Vnext;
        CData/*0:0*/ unnamedblk608__DOT__vreg___Vmore;
        unnamedblk608__DOT__vreg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk608__DOT__unnamedblk609__DOT__vreg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk610__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk610__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk610__DOT__blk___Vmore;
        unnamedblk610__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk610__DOT__unnamedblk611__DOT__blk;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_registers(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg>> &regs, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_registers\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk612__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk612__DOT__rg__Vnext;
        CData/*0:0*/ unnamedblk612__DOT__rg__Vmore;
        unnamedblk612__DOT__rg__Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk613__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk613__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk613__DOT__blk___Vmore;
        unnamedblk613__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk613__DOT__unnamedblk614__DOT__blk;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_registers(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg>> &regs, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_virtual_registers\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk615__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk615__DOT__rg__Vnext;
        CData/*0:0*/ unnamedblk615__DOT__rg__Vmore;
        unnamedblk615__DOT__rg__Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk616__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk616__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk616__DOT__blk___Vmore;
        unnamedblk616__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk616__DOT__unnamedblk617__DOT__blk;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_memories(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem>> &mems, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_memories\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk618__DOT__mem_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk618__DOT__mem___Vnext;
        CData/*0:0*/ unnamedblk618__DOT__mem___Vmore;
        unnamedblk618__DOT__mem___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk618__DOT__unnamedblk619__DOT__mem;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk620__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk620__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk620__DOT__blk___Vmore;
        unnamedblk620__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk620__DOT__unnamedblk621__DOT__blk;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_blocks(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>> &blks, IData/*31:0*/ hier) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_blocks\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk622__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk622__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk622__DOT__blk___Vmore;
        unnamedblk622__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk622__DOT__unnamedblk623__DOT__blk;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_maps(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map>> &maps) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_maps\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> unnamedblk627__DOT__map;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> unnamedblk627__DOT__map__Vnext;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_parent(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> &get_parent__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_parent\n"); );
        // Body
        get_parent__Vfuncrtn = this->__PVT__parent;
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_block_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> &get_block_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_block_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__127__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__128__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__132__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__133__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk628__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk628__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk628__DOT__blk___Vmore;
        unnamedblk628__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk628__DOT__unnamedblk629__DOT__blk;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk630__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk630__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk630__DOT__blk___Vmore;
        unnamedblk630__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>> unnamedblk630__DOT__unnamedblk631__DOT__subblks;
        ...
        unnamedblk630__DOT__unnamedblk631__DOT__unnamedblk632__DOT__j__Vloopsize = 0;
        {
            ...
            if ((__VlefCall_0__get_name == name)) {
                get_block_by_name__Vfuncrtn = VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>{this};
                goto __Vlabel0;
            }
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_reg_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> &get_reg_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_reg_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__139__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__140__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__144__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__145__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk633__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk633__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk633__DOT__rg___Vmore;
        unnamedblk633__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk633__DOT__unnamedblk634__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk635__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk635__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk635__DOT__blk___Vmore;
        unnamedblk635__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg>> unnamedblk635__DOT__unnamedblk636__DOT__subregs;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vreg_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> &get_vreg_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vreg_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__151__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__152__Vfuncout;
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk638__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk638__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk638__DOT__rg___Vmore;
        unnamedblk638__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk638__DOT__unnamedblk639__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk640__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk640__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk640__DOT__blk___Vmore;
        unnamedblk640__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg>> unnamedblk640__DOT__unnamedblk641__DOT__subvregs;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_mem_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> &get_mem_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_mem_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__163__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__164__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__168__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__169__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_3__get_full_name;
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk643__DOT__mem_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk643__DOT__mem___Vnext;
        CData/*0:0*/ unnamedblk643__DOT__mem___Vmore;
        unnamedblk643__DOT__mem___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk643__DOT__unnamedblk644__DOT__mem;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk645__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk645__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk645__DOT__blk___Vmore;
        unnamedblk645__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem>> unnamedblk645__DOT__unnamedblk646__DOT__submems;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_field_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_field> &get_field_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_field_by_name\n"); );
        // Locals
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk648__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk648__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk648__DOT__rg___Vmore;
        unnamedblk648__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk648__DOT__unnamedblk649__DOT__rg;
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_field>> unnamedblk648__DOT__unnamedblk649__DOT__fields;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk651__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk651__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk651__DOT__blk___Vmore;
        unnamedblk651__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg>> unnamedblk651__DOT__unnamedblk652__DOT__subregs;
        ...
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_field>> unnamedblk651__DOT__unnamedblk652__DOT__unnamedblk653__DOT__unnamedblk654__DOT__fields;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vfield_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg_field> &get_vfield_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_vfield_by_name\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__196__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__197__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_3__get_full_name;
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk656__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk656__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk656__DOT__rg___Vmore;
        unnamedblk656__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk656__DOT__unnamedblk657__DOT__rg;
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg_field>> unnamedblk656__DOT__unnamedblk657__DOT__fields;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk659__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk659__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk659__DOT__blk___Vmore;
        unnamedblk659__DOT__blk___Vmore = 0;
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg>> unnamedblk659__DOT__unnamedblk660__DOT__subvregs;
        ...
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg_field>> unnamedblk659__DOT__unnamedblk660__DOT__unnamedblk661__DOT__unnamedblk662__DOT__fields;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_coverage(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ is_on, IData/*31:0*/ &set_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_coverage\n"); );
        // Locals
        ...
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk664__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk664__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk664__DOT__rg___Vmore;
        unnamedblk664__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk664__DOT__unnamedblk665__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk666__DOT__mem_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk666__DOT__mem___Vnext;
        CData/*0:0*/ unnamedblk666__DOT__mem___Vmore;
        unnamedblk666__DOT__mem___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk666__DOT__unnamedblk667__DOT__mem;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk668__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk668__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk668__DOT__blk___Vmore;
        unnamedblk668__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk668__DOT__unnamedblk669__DOT__blk;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample_values(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_sample_values\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk670__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk670__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk670__DOT__rg___Vmore;
        unnamedblk670__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk670__DOT__unnamedblk671__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk672__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk672__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk672__DOT__blk___Vmore;
        unnamedblk672__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk672__DOT__unnamedblk673__DOT__blk;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_XsampleX(Vhello_uvm_v1__Syms* __restrict vlSymsp, QData/*63:0*/ addr, CData/*0:0*/ is_read, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_XsampleX\n"); );
        // Body
        this->__VnoInFunc_sample(vlSymsp, addr, (IData)(is_read), map);
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_build_coverage(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ models, IData/*31:0*/ &build_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_build_coverage\n"); );
        // Locals
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz64__Vclpkg.__VnoInFunc_read_by_name(vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
                                                                                VL_CONCATN_NNN("uvm_reg::"s, __VlefCall_0__get_full_name)), "include_coverage"s, __Vtask_read_by_name__206__val, 
                                                                                VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>{this}, __Vtask_read_by_name__206__Vfuncout);
        build_coverage__Vfuncrtn = __Vtask_read_by_name__206__val;
        build_coverage__Vfuncrtn = (build_coverage__Vfuncrtn 
                                    & models);
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_coverage(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ models) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_coverage\n"); );
        // Body
        this->__PVT__has_cover = (this->__PVT__has_cover 
                                  | models);
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_coverage(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ models, CData/*0:0*/ &has_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_coverage\n"); );
        // Body
        has_coverage__Vfuncrtn = ((this->__PVT__has_cover 
                                   & models) == models);
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_coverage(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ is_on, CData/*0:0*/ &get_coverage__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_coverage\n"); );
        // Body
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_reset(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_reset\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk674__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk674__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk674__DOT__rg___Vmore;
        unnamedblk674__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk674__DOT__unnamedblk675__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk676__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk676__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk676__DOT__blk___Vmore;
        unnamedblk676__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk676__DOT__unnamedblk677__DOT__blk;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_needs_update(Vhello_uvm_v1__Syms* __restrict vlSymsp, CData/*0:0*/ &needs_update__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_needs_update\n"); );
        // Body
        CData/*0:0*/ __VlefCall_1__needs_update;
        CData/*0:0*/ __VlefCall_0__needs_update;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk678__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk678__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk678__DOT__rg___Vmore;
        unnamedblk678__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk678__DOT__unnamedblk679__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk680__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk680__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk680__DOT__blk___Vmore;
        unnamedblk680__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk680__DOT__unnamedblk681__DOT__blk;
        {
    ...
    VlCoroutine Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_update(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ path, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_update\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__214__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__215__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__219__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__220__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__223__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__224__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__228__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__229__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__234__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__235__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__239__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__240__Vfuncout;
        ...
        IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
        CData/*0:0*/ __VlefCall_0__needs_update;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk682__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk682__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk682__DOT__rg___Vmore;
        unnamedblk682__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk682__DOT__unnamedblk683__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk684__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk684__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk684__DOT__blk___Vmore;
        unnamedblk684__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk684__DOT__unnamedblk685__DOT__blk;
        {
            status = 0U;
            status = 0U;
            ...
            if ((0U != __VlefCall_3__uvm_report_enabled)) {
                ...
                __Vtemp_1 = Vhello_uvm_v1___024unit::__Venumtab_enum_name75
                    [(3U & path)];
    ...
    VlCoroutine Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_mirror(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ check, IData/*31:0*/ path, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        ...
        VlProcess::currentp(vlProcess.get());
        VL_KEEP_THIS;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk686__DOT__rg_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk686__DOT__rg___Vnext;
        CData/*0:0*/ unnamedblk686__DOT__rg___Vmore;
        unnamedblk686__DOT__rg___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk686__DOT__unnamedblk687__DOT__rg;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk688__DOT__blk_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk688__DOT__blk___Vnext;
        CData/*0:0*/ unnamedblk688__DOT__blk___Vmore;
        unnamedblk688__DOT__blk___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk688__DOT__unnamedblk689__DOT__blk;
        status = 0U;
    ...
    VlCoroutine Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_write_reg_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ data, IData/*31:0*/ path, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        ...
        VlProcess::currentp(vlProcess.get());
        VL_KEEP_THIS;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> rg;
    ...
    VlCoroutine Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_reg_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ &data, IData/*31:0*/ path, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_reg_by_name\n"); );
        // Locals
    ...
    VlCoroutine Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_write_mem_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ offset, QData/*63:0*/ data, IData/*31:0*/ path, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        ...
        VlProcess::currentp(vlProcess.get());
        VL_KEEP_THIS;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> mem;
        this->__PVT__fname = fname;
        this->__PVT__lineno = lineno;
        status = 1U;
    ...
    VlCoroutine Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_mem_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ offset, QData/*63:0*/ &data, IData/*31:0*/ path, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_read_mem_by_name\n"); );
        // Locals
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_readmemh(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string filename) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_readmemh\n"); );
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_writememh(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string filename) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_writememh\n"); );
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_create_map(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ base_addr, IData/*31:0*/ n_bytes, IData/*31:0*/ endian, CData/*0:0*/ byte_addressing, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> &create_map__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_create_map\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__254__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__255__Vfuncout;
        ...
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map;
        {
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi20__Vclpkg.__VnoInFunc_create(vlSymsp, name, VlNull{}, 
            ...
            VL_NULL_CHECK(map, "../../uvm/distrib/src/reg/uvm_reg_block.svh", 1830)
                    ->__VnoInFunc_configure(vlSymsp, 
                                            VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block>{this}, base_addr, n_bytes, endian, (IData)(byte_addressing));
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_map(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_map\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__265__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__266__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__269__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__270__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__273__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__274__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__279__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__280__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_3__get_full_name;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_map_by_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> &get_map_by_name__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_map_by_name\n"); );
        // Locals
        ...
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map>> unnamedblk691__DOT__unnamedblk692__DOT__submaps;
        ...
        VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map>> maps;
        {
            maps.clear();
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_map(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_map\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__295__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__296__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__300__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__301__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_1__get_full_name;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_map(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> &get_default_map__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_map\n"); );
        // Body
        get_default_map__Vfuncrtn = this->__PVT__default_map;
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_path(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &get_default_path__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_path\n"); );
        // Body
        {
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_Xinit_address_mapsX(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_Xinit_address_mapsX\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> unnamedblk694__DOT__map_;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> unnamedblk694__DOT__map___Vnext;
        CData/*0:0*/ unnamedblk694__DOT__map___Vmore;
        unnamedblk694__DOT__map___Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> unnamedblk694__DOT__unnamedblk695__DOT__map;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_backdoor(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_backdoor> bkdr, std::string fname, IData/*31:0*/ lineno) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_backdoor\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__307__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__308__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__311__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__312__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_backdoor(Vhello_uvm_v1__Syms* __restrict vlSymsp, CData/*0:0*/ inherited, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_backdoor> &get_backdoor__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_backdoor\n"); );
        // Body
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk696__DOT__blk;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_backdoor> unnamedblk696__DOT__unnamedblk697__DOT__bkdr;
        {
            if (inherited) {
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clear_hdl_path(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clear_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__321__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__322__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__325__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__326__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_hdl_path(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string path, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_add_hdl_path\n"); );
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz12> paths;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_hdl_path(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &has_hdl_path__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_has_hdl_path\n"); );
        // Body
        IData/*31:0*/ __VlefCall_0__exists;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_hdl_path(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__336__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__337__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__340__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__341__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz12> hdl_paths;
        {
            if ((""s == kind)) {
                this->__VnoInFunc_get_default_hdl_path(vlSymsp, kind);
            }
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind, std::string separator) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_full_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__350__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__351__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__354__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__355__Vfuncout;
        // Body
        VlProcess::currentp(vlProcess.get());
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz12> unnamedblk699__DOT__hdl_paths;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_hdl_path(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string &get_default_hdl_path__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_get_default_hdl_path\n"); );
        // Body
        {
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_hdl_path(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_default_hdl_path\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__363__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__364__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__367__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__368__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_hdl_path_root(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string path, std::string kind) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_set_hdl_path_root\n"); );
        // Body
        if ((""s == kind)) {
            this->__VnoInFunc_get_default_hdl_path(vlSymsp, kind);
        }
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_hdl_path_root(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &is_hdl_path_root__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_is_hdl_path_root\n"); );
        // Body
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_print(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer> printer) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_print\n"); );
        // Body
        VlProcess::currentp(vlProcess.get());
        std::string __VlefCall_4__get_name;
        std::string __VlefCall_3__get_name;
        ...
        std::string __VlefCall_1__get_name;
        std::string __VlefCall_0__get_name;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk703__DOT__i;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk703__DOT__i__Vnext;
        CData/*0:0*/ unnamedblk703__DOT__i__Vmore;
        unnamedblk703__DOT__i__Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> unnamedblk703__DOT__unnamedblk704__DOT__b;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> unnamedblk703__DOT__unnamedblk704__DOT__obj;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk705__DOT__i;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk705__DOT__i__Vnext;
        CData/*0:0*/ unnamedblk705__DOT__i__Vmore;
        unnamedblk705__DOT__i__Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg> unnamedblk705__DOT__unnamedblk706__DOT__r;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> unnamedblk705__DOT__unnamedblk706__DOT__obj;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk707__DOT__i;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk707__DOT__i__Vnext;
        CData/*0:0*/ unnamedblk707__DOT__i__Vmore;
        unnamedblk707__DOT__i__Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_vreg> unnamedblk707__DOT__unnamedblk708__DOT__r;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> unnamedblk707__DOT__unnamedblk708__DOT__obj;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk709__DOT__i;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk709__DOT__i__Vnext;
        CData/*0:0*/ unnamedblk709__DOT__i__Vmore;
        unnamedblk709__DOT__i__Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> unnamedblk709__DOT__unnamedblk710__DOT__m;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> unnamedblk709__DOT__unnamedblk710__DOT__obj;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> unnamedblk711__DOT__i;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> unnamedblk711__DOT__i__Vnext;
        CData/*0:0*/ unnamedblk711__DOT__i__Vmore;
        unnamedblk711__DOT__i__Vmore = 0;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> unnamedblk711__DOT__unnamedblk712__DOT__m;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> unnamedblk711__DOT__unnamedblk712__DOT__obj;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clone(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_clone\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__385__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__386__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__389__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__390__Vfuncout;
        // Body
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> rhs) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_copy\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__393__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__394__Vfuncout;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_compare(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_compare\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__401__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__402__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__405__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__406__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_pack(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_packer> packer) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_pack\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__409__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__410__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__413__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__414__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_unpack(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_packer> packer) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_do_unpack\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__417__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__418__Vfuncout;
        ...
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__421__Vfuncout;
        VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__422__Vfuncout;
        // Body
        VlProcessRef vlProcess = std::make_shared<VlProcess>();
        VlProcess::currentp(vlProcess.get());
        IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_convert2string\n"); );
        // Body
        VlProcess::currentp(vlProcess.get());
        convert2string__Vfuncrtn = ""s;
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_randomize(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc_randomize\n"); );
        // Body
    ...
    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___Vsetup_constraints(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___Vsetup_constraints\n"); );
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___VBasicRand(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::__VnoInFunc___VBasicRand\n"); );
        // Body
        __VBasicRand__Vfuncrtn = 1U;
    }

    void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::_ctor_var_reset(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::_ctor_var_reset\n"); );
        // Body
    ...
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::~Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block() {
        VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block::~\n"); );
    }
