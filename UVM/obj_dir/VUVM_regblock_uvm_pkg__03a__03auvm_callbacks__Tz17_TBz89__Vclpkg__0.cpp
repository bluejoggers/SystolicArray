...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_get(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz17> __Vtask_m_initialize__1__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_typeid__Tz50> __Vfunc_get__2__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_typeid__Tz89> __Vfunc_get__3__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_typeid__Tz17> __Vfunc_get__4__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17> __Vfunc_get__6__Vfuncout;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_typeid_base> unnamedblk1__DOT__cb_base_type;
    if ((VlNull{} == this->__PVT__m_inst)) {
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__VnoInFunc_m_initialize(vlProcess, vlSymsp, __Vtask_m_initialize__1__Vfuncout);
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz89__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__3__Vfuncout);
        this->__PVT__m_cb_typeid = __Vfunc_get__3__Vfuncout;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz17__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__4__Vfuncout);
        this->__PVT__m_typeid = __Vfunc_get__4__Vfuncout;
        this->__PVT__m_inst = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89, vlProcess, vlSymsp);
        if (VL_UNLIKELY(((unnamedblk1__DOT__cb_base_type 
                          == this->__PVT__m_cb_typeid)))) {
            VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:521: Assertion failed in %m: '$cast' failed.\n",3, 'M',vlSymsp->name(),"uvm_pkg.uvm_callbacks__Tz17_TBz89.get.unnamedblk1", 'T',-12
                         , '#',64,VL_TIME_UNITED_Q(1));
            VL_STOP_MT("../../uvm/distrib/src/base/uvm_callback.svh", 521, "");
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__PVT__m_t_inst 
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz17__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vfunc_get__6__Vfuncout);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_m_register_pair(VUVM_regblock__Syms* __restrict vlSymsp, std::string tname, std::string cbname, CData/*0:0*/ &m_register_pair__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_m_register_pair\n"); );
    // Body
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> inst;
    m_register_pair__Vfuncrtn = 0U;
    this->__VnoInFunc_get(vlSymsp, inst);
    this->__PVT__m_typename = tname;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__PVT__m_typename 
        = tname;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_add(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_add\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> __Vtask_get__16__Vfuncout;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__29__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__30__Vfuncout;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz51> __Vtask_get__43__Vfuncout;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> __VlefCall_9__get;
    IData/*31:0*/ __VlefCall_8__size;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> __VlefCall_7__get;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> unnamedblk2__DOT__unnamedblk3__DOT__qr;
    IData/*31:0*/ unnamedblk2__DOT__unnamedblk3__DOT__unnamedblk4__DOT__i;
    IData/*31:0*/ unnamedblk2__DOT__unnamedblk5__DOT__i;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> q;
    std::string nm;
    std::string tnm;
    {
        nm = ""s;
        tnm = ""s;
        this->__VnoInFunc_get(vlSymsp, __Vtask_get__16__Vfuncout);
        if ((VlNull{} == cb)) {
            if ((VlNull{} == obj)) {
                nm = "(*)"s;
            } else {
            ...
            if ((""s != vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz17__Vclpkg.__PVT__m_typename)) {
                tnm = vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz17__Vclpkg.__PVT__m_typename;
            } else if ((VlNull{} != obj)) {
        ...
        if ((VlNull{} == obj)) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__PVT__m_tw_cb_q, cb, __VlefCall_3__m_cb_find);
            if ((0xffffffffU != __VlefCall_3__m_cb_find)) {
                tnm = ((""s != vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz17__Vclpkg.__PVT__m_typename)
                        ? vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz17__Vclpkg.__PVT__m_typename
                        : "uvm_object"s);
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__PVT__m_t_inst, "../../uvm/distrib/src/base/uvm_callback.svh", 650)->__VnoInFunc_m_add_tw_cbs(vlSymsp, cb, ordering);
            }
        } else {
            ...
            if ((VlNull{} == q)) {
                q = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50, vlProcess, vlSymsp, ""s);
            ...
            if ((0U == __VlefCall_5__size)) {
                ...
                unnamedblk2__DOT__unnamedblk5__DOT__i = 0U;
                while (true) {
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__PVT__m_tw_cb_q, "../../uvm/distrib/src/base/uvm_callback.svh", 679)->__VnoInFunc_size(vlSymsp, __VlefCall_8__size);
                    if (!(VL_LTS_III(32, unnamedblk2__DOT__unnamedblk5__DOT__i, __VlefCall_8__size))) break;
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__PVT__m_tw_cb_q, "../../uvm/distrib/src/base/uvm_callback.svh", 680)->__VnoInFunc_get(vlProcess, vlSymsp, unnamedblk2__DOT__unnamedblk5__DOT__i, __VlefCall_9__get);
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, q, cb, __VlefCall_10__m_cb_find);
            if ((0xffffffffU != __VlefCall_10__m_cb_find)) {
                ...
                vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__VnoInFunc_m_cb_find_name(vlSymsp, q, 
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_add_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> root, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_add_by_name\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> __Vtask_get__62__Vfuncout;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__72__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__73__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component>> cq;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> top;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        cq.clear();
        this->__VnoInFunc_get(vlSymsp, __Vtask_get__62__Vfuncout);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_delete(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_delete\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> __Vtask_get__75__Vfuncout;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__83__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__84__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_0__get_name;
    std::string unnamedblk7__DOT__nm;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> b_obj;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> q;
    CData/*0:0*/ found;
    IData/*31:0*/ pos;
    b_obj = obj;
    found = 0U;
    pos = 0U;
    this->__VnoInFunc_get(vlSymsp, __Vtask_get__75__Vfuncout);
    if ((VlNull{} == obj)) {
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__PVT__m_t_inst, "../../uvm/distrib/src/base/uvm_callback.svh", 761)->__VnoInFunc_m_delete_tw_cbs(vlSymsp, cb, found);
    } else {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, q, cb, pos);
        if ((0xffffffffU != pos)) {
    ...
    if ((1U & (~ (IData)(found)))) {
        ...
        this->__Vtask_uvm_report_warning__82__context_name = ""s;
        __Vtask_uvm_report_warning__82__line = 0U;
        this->__Vtask_uvm_report_warning__82__filename = ""s;
        __Vtask_uvm_report_warning__82__verbosity = 0U;
        this->__Vtask_uvm_report_warning__82__message 
        ...
        this->__Vtask_uvm_report_warning__82__id = "CBUNREG"s;
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 201)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__84__Vfuncout);
        vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
            = __Vtask_get_root__84__Vfuncout;
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "../../uvm/distrib/src/base/uvm_globals.svh", 202)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, this->__Vtask_uvm_report_warning__82__id, this->__Vtask_uvm_report_warning__82__message, __Vtask_uvm_report_warning__82__verbosity, this->__Vtask_uvm_report_warning__82__filename, __Vtask_uvm_report_warning__82__line, this->__Vtask_uvm_report_warning__82__context_name, (IData)(__Vtask_uvm_report_warning__82__report_enabled_checked));
    }
}

void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_delete_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> root) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_delete_by_name\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> __Vtask_get__86__Vfuncout;
    IData/*31:0*/ __Vtask_uvm_report_warning__91__verbosity;
    __Vtask_uvm_report_warning__91__verbosity = 0;
    IData/*31:0*/ __Vtask_uvm_report_warning__91__line;
    __Vtask_uvm_report_warning__91__line = 0;
    CData/*0:0*/ __Vtask_uvm_report_warning__91__report_enabled_checked;
    __Vtask_uvm_report_warning__91__report_enabled_checked = 0;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> cs;
    cq.clear();
    this->__VnoInFunc_get(vlSymsp, __Vtask_get__86__Vfuncout);
    vlSymsp->TOP__uvm_pkg__03a__03auvm_coreservice_t__Vclpkg.__VnoInFunc_get(vlSymsp, cs);
    ...
    if ((0U == cq.size())) {
        ...
        __Vtask_uvm_report_warning__91__report_enabled_checked = 0U;
        this->__Vtask_uvm_report_warning__91__context_name = ""s;
        __Vtask_uvm_report_warning__91__line = 0U;
        this->__Vtask_uvm_report_warning__91__filename = ""s;
        __Vtask_uvm_report_warning__91__verbosity = 0U;
        this->__Vtask_uvm_report_warning__91__message 
            = VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                               VL_CONCATN_NNN(
        ...
        this->__Vtask_uvm_report_warning__91__id = "CBNOMTC"s;
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 201)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__93__Vfuncout);
        vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top 
            = __Vtask_get_root__93__Vfuncout;
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.__PVT__uvm_report_warning__Vstatic__top, "../../uvm/distrib/src/base/uvm_globals.svh", 202)->__VnoInFunc_uvm_report_warning(vlProcess, vlSymsp, this->__Vtask_uvm_report_warning__91__id, this->__Vtask_uvm_report_warning__91__message, __Vtask_uvm_report_warning__91__verbosity, this->__Vtask_uvm_report_warning__91__filename, __Vtask_uvm_report_warning__91__line, this->__Vtask_uvm_report_warning__91__context_name, (IData)(__Vtask_uvm_report_warning__91__report_enabled_checked));
    }
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_m_get_q(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> &q, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_objection> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_m_get_q\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> __VlefCall_1__m_get_tw_cb_q;
    ...
    if ((0U != __VlefCall_0__exists)) {
        ...
        if ((VlNull{} == obj)) {
            __VlefCall_1__m_get_tw_cb_q = vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__PVT__m_tw_cb_q;
        } else {
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__PVT__m_t_inst, "../../uvm/distrib/src/base/uvm_callback.svh", 825)->__VnoInFunc_m_get_tw_cb_q(vlSymsp, obj, __VlefCall_1__m_get_tw_cb_q);
        }
        q = __VlefCall_1__m_get_tw_cb_q;
    }
}

void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_get_first(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_heartbeat_callback> &get_first__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_get_first\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> __Vtask_get__100__Vfuncout;
    CData/*0:0*/ __Vtask_callback_mode__104__Vfuncout;
    __Vtask_callback_mode__104__Vfuncout = 0;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_2;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> __VlefCall_1__get;
    IData/*31:0*/ __VlefCall_0__size;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> q;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_heartbeat_callback> cb;
    {
        this->__VnoInFunc_get(vlSymsp, __Vtask_get__100__Vfuncout);
        ...
        while (true) {
            ...
            if (__VlefExpr_2) {
                VL_NULL_CHECK(cb, "../../uvm/distrib/src/base/uvm_callback.svh", 855)->__VnoInFunc_callback_mode(vlSymsp, 0xffffffffU, __Vtask_callback_mode__104__Vfuncout);
                __VlefExpr_2 = __Vtask_callback_mode__104__Vfuncout;
            }
            if (__VlefExpr_2) {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_get_last(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_heartbeat_callback> &get_last__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_get_last\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> __Vtask_get__105__Vfuncout;
    CData/*0:0*/ __Vtask_callback_mode__109__Vfuncout;
    __Vtask_callback_mode__109__Vfuncout = 0;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_2;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_heartbeat_callback> cb;
    {
        this->__VnoInFunc_get(vlSymsp, __Vtask_get__105__Vfuncout);
        this->__VnoInFunc_m_get_q(vlSymsp, q, obj);
        ...
        while (VL_LTES_III(32, 0U, itr)) {
            ...
            __VlefExpr_2 = VL_CAST_DYNAMIC(__VlefCall_1__get, cb);
            if (__VlefExpr_2) {
                VL_NULL_CHECK(cb, "../../uvm/distrib/src/base/uvm_callback.svh", 878)->__VnoInFunc_callback_mode(vlSymsp, 0xffffffffU, __Vtask_callback_mode__109__Vfuncout);
                __VlefExpr_2 = __Vtask_callback_mode__109__Vfuncout;
            }
            if (__VlefExpr_2) {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_get_next(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_heartbeat_callback> &get_next__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_get_next\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> __Vtask_get__110__Vfuncout;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_heartbeat_callback> cb;
    {
        this->__VnoInFunc_get(vlSymsp, __Vtask_get__110__Vfuncout);
        this->__VnoInFunc_m_get_q(vlSymsp, q, obj);
        itr = ((IData)(1U) + itr);
        while (true) {
            ...
            __VlefExpr_2 = VL_CAST_DYNAMIC(__VlefCall_1__get, cb);
            if (__VlefExpr_2) {
                VL_NULL_CHECK(cb, "../../uvm/distrib/src/base/uvm_callback.svh", 904)->__VnoInFunc_callback_mode(vlSymsp, 0xffffffffU, __Vtask_callback_mode__114__Vfuncout);
                __VlefExpr_2 = __Vtask_callback_mode__114__Vfuncout;
            }
            if (__VlefExpr_2) {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_get_prev(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_heartbeat_callback> &get_prev__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_get_prev\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> __Vtask_get__115__Vfuncout;
    CData/*0:0*/ __Vtask_callback_mode__118__Vfuncout;
    __Vtask_callback_mode__118__Vfuncout = 0;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_1;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> __VlefCall_0__get;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz50> q;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_heartbeat_callback> cb;
    {
        ...
        while (VL_LTES_III(32, 0U, itr)) {
            ...
            if (__VlefExpr_1) {
                VL_NULL_CHECK(cb, "../../uvm/distrib/src/base/uvm_callback.svh", 930)->__VnoInFunc_callback_mode(vlSymsp, 0xffffffffU, __Vtask_callback_mode__118__Vfuncout);
                __VlefExpr_1 = __Vtask_callback_mode__118__Vfuncout;
            }
            if (__VlefExpr_1) {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_display(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_objection> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89__Vclpkg::__VnoInFunc_display\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89> __Vtask_get__119__Vfuncout;
    // Body
    this->__VnoInFunc_get(vlSymsp, __Vtask_get__119__Vfuncout);
    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz17__Vclpkg.__VnoInFunc_display(vlSymsp, obj);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::__VnoInFunc_m_is_registered(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> obj, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_registered__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::__VnoInFunc_m_is_registered\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::__VnoInFunc_m_is_for_me(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_for_me__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::__VnoInFunc_m_is_for_me\n"); );
    // Body
    IData/*31:0*/ __VlefExpr_0;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_heartbeat_callback> this_cb;
    __VlefExpr_0 = VL_CAST_DYNAMIC(cb, this_cb);
    m_is_for_me__Vfuncrtn = (1U & __VlefExpr_0);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VUVM_regblock_uvm_pkg__03a__03auvm_typed_callbacks__Tz17::init(vlProcess, vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::__VnoInFunc_randomize(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::__VnoInFunc___Vsetup_constraints(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::__VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::_ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_registered = 0;
}

VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::~VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz89::~\n"); );
}
