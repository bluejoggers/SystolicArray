...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_POOL__TZ5_TBZ27__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_POOL__TZ5_TBZ27__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz27__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz27> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz27__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz27__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz27__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_global(Vhello_uvm__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz1> &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz27> &get_global_pool__Vfuncrtn);
};
...
class Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz27 : public Vhello_uvm_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<std::string, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz1>> __PVT__pool;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_pool__Tz5_TBz27"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz27(*this); }
    ...
    virtual void __VnoInFunc_add(Vhello_uvm__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz1> item);
    ...
    virtual void __VnoInFunc_get(Vhello_uvm__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz1> &get__Vfuncrtn);
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz27() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz27();
};
