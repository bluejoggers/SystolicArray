...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_TOPDOWN_PHASE__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_TOPDOWN_PHASE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase : public VUVM_Register8b_uvm_pkg__03a__03auvm_phase {
  public:
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase();
};
