...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ42_TBZ42__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ42_TBZ42__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz42_TBz42__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz42_TBz42__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz42_TBz42__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz42_TBz42__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz42_TBz42 : public virtual VlClass {
  public:
    ...
    virtual void __VnoInFunc_item_done(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_item> t);
    ...
    virtual void __VnoInFunc_put_response(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_item> t);
    ...
    virtual VlCoroutine __VnoInFunc_wait_for_sequences(Vhello_uvm__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz42_TBz42() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz42_TBz42();
};
