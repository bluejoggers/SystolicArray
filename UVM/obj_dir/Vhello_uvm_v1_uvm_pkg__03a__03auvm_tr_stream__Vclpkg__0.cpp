...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_get_stream_from_handle(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ id, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream> &get_stream_from_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_get_stream_from_handle\n"); );
    // Body
    {
        if ((0U == id)) {
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_m_free_id(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_m_free_id\n"); );
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name) {
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    _ctor_var_reset(vlSymsp);
    /*super.new*/;
    this->__PVT__m_cfg_dap = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20, vlProcess, vlSymsp, "cfg_dap"s);
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_db(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_database> &get_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_db\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__2__value;
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_tr_stream_cfg> m_cfg;
    {
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_scope(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string &get_scope__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_scope\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__12__value;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_stream_type_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string &get_stream_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_stream_type_name\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__22__value;
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__24__Vfuncout;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> __Vtask_get_root__25__Vfuncout;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_close(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_close\n"); );
    // Body
    CData/*0:0*/ __VlefCall_1__is_open;
    CData/*0:0*/ __VlefCall_0__is_open;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> unnamedblk1__DOT__idx;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> unnamedblk1__DOT__idx__Vnext;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_free(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_free\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    CData/*0:0*/ __VlefCall_0__is_open;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> unnamedblk2__DOT__idx;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> unnamedblk2__DOT__idx__Vnext;
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_database> db;
    {
        ...
        if (__VlefCall_2__is_open) {
            {
                ...
                VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> __Vinline_0___VnoInFunc_close_unnamedblk1__DOT__idx;
                VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> __Vinline_0___VnoInFunc_close_unnamedblk1__DOT__idx__Vnext;
        ...
        if (vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream.exists(
                                                                                VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream>{this})) {
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_do_open(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_database> db, std::string scope, std::string stream_type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_do_open\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__58__value;
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_tr_stream_cfg> m_cfg;
    {
        ...
        if (__VlefCall_2__try_get) {
            ...
            m_cfg = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03am_uvm_tr_stream_cfg, vlSymsp);
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_open(Vhello_uvm_v1__Syms* __restrict vlSymsp, CData/*0:0*/ &is_open__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_open\n"); );
    // Body
    is_open__Vfuncrtn = this->__PVT__m_is_opened;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_closed(Vhello_uvm_v1__Syms* __restrict vlSymsp, CData/*0:0*/ &is_closed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_closed\n"); );
    // Body
    is_closed__Vfuncrtn = this->__PVT__m_is_closed;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_open_recorder(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ open_time, std::string type_name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> &open_recorder__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_open_recorder\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_open;
    ...
    if (__VlefCall_0__is_open) {
        ...
        if ((VlNull{} != open_recorder__Vfuncrtn)) {
            ...
            VL_NULL_CHECK(open_recorder__Vfuncrtn, "../../uvm/distrib/src/base/uvm_tr_stream.svh", 343)->__VnoInFunc_m_do_open(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream>{this}, m_time, type_name);
        }
        if ((VlNull{} != unnamedblk3__DOT__p)) {
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_free_recorder(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> recorder) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_free_recorder\n"); );
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_recorders(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder>> &q, CData/*0:0*/ &get_recorders__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_recorders\n"); );
    // Body
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> unnamedblk4__DOT__idx;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> unnamedblk4__DOT__idx__Vnext;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_handle(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &get_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_handle\n"); );
    // Locals
    ...
    if ((1U & ((~ (IData)(__VlefCall_0__is_open)) & 
        ...
        if (__VlefExpr_2) {
            __VlefExpr_2 = (vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream
                            .at(VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream>{this}) 
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_get_handle(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &m_get_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_get_handle\n"); );
    // Body
    m_get_handle__Vfuncrtn = 0;
    this->__VnoInFunc_get_handle(vlSymsp, m_get_handle__Vfuncrtn);
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_database> db, std::string scope, std::string stream_type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open\n"); );
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_close(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_close\n"); );
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_free(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_free\n"); );
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open_recorder(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ open_time, std::string type_name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_recorder> &do_open_recorder__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open_recorder\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    do_open_recorder__Vfuncrtn = VlNull{};
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_randomize(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___Vsetup_constraints(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___VBasicRand(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::_ctor_var_reset(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::_ctor_var_reset\n"); );
    // Body
...
Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::~Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_tr_stream::~\n"); );
}
