...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_CALLBACKS__TZ96__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_CALLBACKS__TZ96__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96;
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz96;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96> __PVT__m_inst;
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96> __PVT__m_base_inst;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96__Vclpkg);
    ...
    void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96> &get__Vfuncrtn);
    void __VnoInFunc_get_first(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callback> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callback> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callback> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_callback> &get_prev__Vfuncrtn);
...
#include "VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz96__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96 : public VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz96 {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_callbacks__Tz96"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks__Tz96();
};
