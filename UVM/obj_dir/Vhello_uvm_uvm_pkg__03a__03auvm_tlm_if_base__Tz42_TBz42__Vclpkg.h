...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_TLM_IF_BASE__TZ42_TBZ42__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_TLM_IF_BASE__TZ42_TBZ42__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_tlm_if_base__Tz42_TBz42__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_tlm_if_base__Tz42_TBz42__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_tlm_if_base__Tz42_TBz42__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_tlm_if_base__Tz42_TBz42__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_tlm_if_base__Tz42_TBz42 : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_tlm_if_base__Tz42_TBz42"; }
    ...
    virtual void __VnoInFunc_nb_transport(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_item> req, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_item> &rsp, CData/*0:0*/ &nb_transport__Vfuncrtn);
    ...
    virtual void __VnoInFunc_transport(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_item> req, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_item> &rsp);
    ...
    virtual void __VnoInFunc_try_put(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_item> t, CData/*0:0*/ &try_put__Vfuncrtn);
    virtual void __VnoInFunc_write(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_item> t);
  private:
    void _ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_tlm_if_base__Tz42_TBz42() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_tlm_if_base__Tz42_TBz42();
};
