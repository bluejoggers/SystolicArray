...
void VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name) {
    VUVM_Register8b_uvm_pkg__03a__03auvm_phase::init(vlProcess, vlSymsp, name, 0U, VlNull{});
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::new\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::__VnoInFunc_traverse(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> comp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> phase, IData/*31:0*/ state) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::__VnoInFunc_traverse\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> __VlefCall_9__get_child;
    IData/*31:0*/ __VlefCall_8__get_first_child;
    IData/*31:0*/ __VlefCall_7__uvm_report_enabled;
    std::string __VlefCall_6__get_name;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_domain> __VlefCall_5__get_common_domain;
    ...
    if (((phase_domain == __VlefCall_5__get_common_domain) 
        ...
        if ((8U == state)) {
            ...
            if ((1U & (~ (("build"s == __VlefCall_6__get_name) 
                          ...
                          ->__PVT__m_build_done)))) {
                unnamedblk1__DOT__ph = VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase>{this};
                ...
                if (VL_NULL_CHECK(comp, "../../uvm/distrib/src/base/uvm_topdown_phase.svh", 76)
                    ->__PVT__m_phase_imps.exists(VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase>{this})) {
                    unnamedblk1__DOT__ph = VL_NULL_CHECK(comp, "../../uvm/distrib/src/base/uvm_topdown_phase.svh", 77)
                        ->__PVT__m_phase_imps.at(VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase>{this});
                }
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::__VnoInFunc_execute(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> comp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::__VnoInFunc_execute\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_seed_map> __Vfunc_uvm_create_random_seed__37____VlefCall_0__new;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::__VnoInFunc_randomize(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::__VnoInFunc___Vsetup_constraints(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::__VnoInFunc___VBasicRand(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::_ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::~VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase::~\n"); );
}
