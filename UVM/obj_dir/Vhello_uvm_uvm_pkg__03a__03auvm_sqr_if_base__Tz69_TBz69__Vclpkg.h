...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ69_TBZ69__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ69_TBZ69__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz69_TBz69__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz69_TBz69__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz69_TBz69__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz69_TBz69__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz69_TBz69 : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_sqr_if_base__Tz69_TBz69"; }
    ...
    virtual void __VnoInFunc_item_done(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> t);
    ...
    virtual void __VnoInFunc_put_response(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> t);
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz69_TBz69() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_sqr_if_base__Tz69_TBz69();
};
