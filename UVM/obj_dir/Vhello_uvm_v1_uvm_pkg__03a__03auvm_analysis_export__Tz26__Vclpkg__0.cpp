...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26::init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> parent) {
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz91::init(vlProcess, vlSymsp, name, parent, 1U, 1U, 0xffffffffU);
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    _ctor_var_reset(vlSymsp);
    /*super.new*/;
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz91::__PVT__m_if_mask = 0x00000100U;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26::__VnoInFunc_get_type_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_analysis_export"s;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26::__VnoInFunc_write(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26::__VnoInFunc_write\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_port_base__Tz91> __Vfunc_get_if__2__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_tlm_if_base__Tz26_TBz26> tif;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26::_ctor_var_reset(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26::~Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_export__Tz26::~\n"); );
}
