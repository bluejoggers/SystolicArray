...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_REG_READ_ONLY_CBS__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_REG_READ_ONLY_CBS__VCLPKG_H_  // guard
...
class Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi30;
...
class Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs> __PVT__m_me;
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_add(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg> rg);
    void __VnoInFunc_get(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs> &get__Vfuncrtn);
    void __VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi30> &get_type__Vfuncrtn);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs : public Vhello_uvm_uvm_pkg__03a__03auvm_reg_cbs {
  public:
    ...
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs(*this); }
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_reg_read_only_cbs();
};
