...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_BUILD_PHASE__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_BUILD_PHASE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase> __PVT__m_inst;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase__Vclpkg);
    ...
    void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase> &get__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase : public VUVM_Register8b_uvm_pkg__03a__03auvm_topdown_phase {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_build_phase"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase(*this); }
    ...
    VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase();
};
