...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    ...
    if ((VlNull{} == this->__PVT__me)) {
        ...
        this->__PVT__me = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43, vlSymsp);
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43__Vclpkg::__VnoInFunc_create(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_access_seq> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43> __VlefCall_0__get;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43__Vclpkg::__VnoInFunc_set_type_override(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43> __VlefCall_0__get;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43__Vclpkg::__VnoInFunc_set_inst_override(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43> __VlefCall_1__get;
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43::__VnoInFunc_create_object(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> &create_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43::__VnoInFunc_create_object\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_access_seq> obj;
    if ((""s == name)) {
        obj = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_access_seq, vlProcess, vlSymsp, "uvm_reg_mem_access_seq"s);
    } else {
        obj = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_access_seq, vlProcess, vlSymsp, name);
    }
    create_object__Vfuncrtn = obj;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43::__VnoInFunc_get_type_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_mem_access_seq"s;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43::init(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_wrapper::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43::new\n"); );
    // Body
    /*super.new*/;
}

Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43::~Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi43::~\n"); );
}
