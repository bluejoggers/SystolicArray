...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_COMPONENT_REGISTRY__PI19__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_COMPONENT_REGISTRY__PI19__VCLPKG_H_  // guard
...
class VUVM_Register8b___024unit__03a__03areg_test;
class VUVM_Register8b_uvm_pkg__03a__03auvm_component;
class VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19> __PVT__me;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19__Vclpkg);
    ...
    void __VnoInFunc_create(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<VUVM_Register8b___024unit__03a__03areg_test> &create__Vfuncrtn);
    void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19> &get__Vfuncrtn);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19 : public VUVM_Register8b_uvm_pkg__03a__03auvm_object_wrapper {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_component_registry__pi19"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19(*this); }
    ...
    VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19() = default;
    void init(VUVM_Register8b__Syms* __restrict vlSymsp);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi19();
};
