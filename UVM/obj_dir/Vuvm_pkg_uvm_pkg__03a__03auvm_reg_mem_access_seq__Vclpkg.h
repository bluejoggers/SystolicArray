...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_REG_MEM_ACCESS_SEQ__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_REG_MEM_ACCESS_SEQ__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_reg_mem_access_seq__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_reg_mem_access_seq__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_reg_mem_access_seq__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_reg_mem_access_seq__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi41> &get_type__Vfuncrtn);
};
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_reg_mem_access_seq : public Vuvm_pkg_uvm_pkg__03a__03auvm_reg_sequence_ {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_mem_access_seq"; }
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_reg_mem_access_seq(*this); }
    ...
    Vuvm_pkg_uvm_pkg__03a__03auvm_reg_mem_access_seq() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_reg_mem_access_seq();
};
