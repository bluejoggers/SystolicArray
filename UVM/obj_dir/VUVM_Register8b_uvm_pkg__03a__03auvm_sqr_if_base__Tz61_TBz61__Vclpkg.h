...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ61_TBZ61__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ61_TBZ61__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61__Vclpkg);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61 : public virtual VlClass {
  public:
    ...
    virtual void __VnoInFunc_item_done(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b___024unit__03a__03areg_txn> t);
    ...
    virtual void __VnoInFunc_put_response(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b___024unit__03a__03areg_txn> t);
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61();
};
