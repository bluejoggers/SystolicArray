...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_REG_INDIRECT_DATA__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_REG_INDIRECT_DATA__VCLPKG_H_  // guard
...
class Vhello_uvm_uvm_pkg__03a__03auvm_reg_indirect_data;
class Vhello_uvm_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_reg_indirect_data__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_reg_indirect_data__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_reg_indirect_data__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_reg_indirect_data__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_reg_indirect_data : public Vhello_uvm_uvm_pkg__03a__03auvm_reg {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg> __PVT__m_idx;
    VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg>> __PVT__m_tbl;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_indirect_data"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_reg_indirect_data(*this); }
    ...
    void __VnoInFunc_add_frontdoors(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map);
    ...
    virtual void __VnoInFunc_get_indirect_reg(Vhello_uvm__Syms* __restrict vlSymsp, std::string fname, IData/*31:0*/ lineno, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg> &get_indirect_reg__Vfuncrtn);
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_reg_indirect_data() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ n_bits, IData/*31:0*/ has_cover);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_reg_indirect_data();
};
