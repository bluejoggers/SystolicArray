...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_INT_RSRC__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_INT_RSRC__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc__Vclpkg);
    ...
    void __VnoInFunc_get_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc> &get_by_name__Vfuncrtn);
    void __VnoInFunc_get_by_type(VUVM_Register8b__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc> &get_by_type__Vfuncrtn);
};

#include "VUVM_Register8b_uvm_pkg__03a__03auvm_resource___Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc : public VUVM_Register8b_uvm_pkg__03a__03auvm_resource_ {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_int_rsrc"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc(*this); }
    ...
    VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, std::string s);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_int_rsrc();
};
