...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG_H_  // guard
...
class Vhello_uvm_uvm_pkg__03a__03auvm_table_printer;
class Vhello_uvm_uvm_pkg__03a__03auvm_tree_printer;


class Vhello_uvm__Syms;
struct Vhello_uvm_uvm_printer_row_info__struct__0 {
    ...
    bool operator==(const Vhello_uvm_uvm_printer_row_info__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vhello_uvm_uvm_printer_row_info__struct__0> : public std::true_type {};
struct Vhello_uvm_uvm_hdl_path_slice__struct__0 {
    std::string __PVT__path;
    IData/*31:0*/ __PVT__offset;
    IData/*31:0*/ __PVT__size;

    bool operator==(const Vhello_uvm_uvm_hdl_path_slice__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vhello_uvm_uvm_hdl_path_slice__struct__0> : public std::true_type {};
struct Vhello_uvm_uvm_reg_bus_op__struct__0 {
    ...
    bool operator==(const Vhello_uvm_uvm_reg_bus_op__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vhello_uvm_uvm_reg_bus_op__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_printer> __PVT__uvm_default_printer;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> __PVT__uvm_default_packer;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_comparer> __PVT__uvm_default_comparer;
    VlAssocArray<std::string, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_seed_map>> __PVT__uvm_random_seed_table_lookup;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_seed_map> __PVT__uvm_create_random_seed__Vstatic__seed_map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_phase> __PVT__end_of_elaboration_ph;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_phase> __PVT__run_ph;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __PVT__uvm_top;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> uvm_report_enabled__Vstatic__top;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> uvm_report_enabled__Vstatic__cs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __PVT__uvm_report__Vstatic__top;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report__Vstatic__cs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> uvm_report_info__Vstatic__top;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> uvm_report_info__Vstatic__cs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __PVT__uvm_report_warning__Vstatic__top;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report_warning__Vstatic__cs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __PVT__uvm_report_error__Vstatic__top;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report_error__Vstatic__cs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __PVT__uvm_report_fatal__Vstatic__top;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __PVT__uvm_report_fatal__Vstatic__cs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_cmdline_processor> __PVT__uvm_cmdline_proc;
    ...
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg);
