...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_OBJECT_WRAPPER__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_OBJECT_WRAPPER__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper : public virtual VlClass {
  public:
    ...
    Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper() = default;
    void init(Vhello_uvm__Syms* __restrict vlSymsp) {}
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper();
};
