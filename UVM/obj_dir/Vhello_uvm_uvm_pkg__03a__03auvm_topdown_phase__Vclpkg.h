...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_TOPDOWN_PHASE__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_TOPDOWN_PHASE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_topdown_phase : public Vhello_uvm_uvm_pkg__03a__03auvm_phase {
  public:
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_topdown_phase() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_topdown_phase();
};
