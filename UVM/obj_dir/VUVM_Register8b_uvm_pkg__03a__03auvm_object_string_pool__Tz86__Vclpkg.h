...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_OBJECT_STRING_POOL__TZ86__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_OBJECT_STRING_POOL__TZ86__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86;
class VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz86;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86> &get_global_pool__Vfuncrtn);
};

#include "VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz86__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86 : public VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz86 {
  public:
    ...
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz86();
};
