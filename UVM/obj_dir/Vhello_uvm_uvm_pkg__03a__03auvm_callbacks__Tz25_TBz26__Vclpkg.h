...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_CALLBACKS__TZ25_TBZ26__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_CALLBACKS__TZ25_TBZ26__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vhello_uvm_uvm_pkg__03a__03auvm_callback;
class Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25;
class Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26;
...
class Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz25;
class Vhello_uvm_uvm_pkg__03a__03auvm_typeid__Tz25;
class Vhello_uvm_uvm_pkg__03a__03auvm_typeid__Tz26;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26__Vclpkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26> __PVT__m_inst;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25> __PVT__m_base_inst;
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_add(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering);
    ...
    void __VnoInFunc_delete(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callback> cb);
    ...
    void __VnoInFunc_display(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> obj);
    void __VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26> &get__Vfuncrtn);
    void __VnoInFunc_get_first(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_cbs> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_cbs> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_cbs> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> obj, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_cbs> &get_prev__Vfuncrtn);
    void __VnoInFunc_m_get_q(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz34> &q, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> obj);
...
#include "Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz25__Vclpkg.h"

class Vhello_uvm__Syms;

class Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26 : public Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz25 {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_callbacks__Tz25_TBz26"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26(*this); }
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_callbacks__Tz25_TBz26();
};
