...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ2__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ2__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__Tz58;
...
class VUVM_regblock_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2;
class VUVM_regblock_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2;
class VUVM_regblock_uvm_pkg__03a__03auvm_status_container;


class VUVM_regblock__Syms;

class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__Tz58> &get_type__Vfuncrtn);
};

#include "VUVM_regblock_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2__Vclpkg.h"

class VUVM_regblock__Syms;

class VUVM_regblock_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2 : public VUVM_regblock_uvm_pkg__03a__03auvm_set_get_dap_base__Tz2 {
  public:
    ...
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2(*this); }
    ...
    void __VnoInFunc_lock(VUVM_regblock__Syms* __restrict vlSymsp);
    ...
    void __VnoInFunc_unlock(VUVM_regblock__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp);
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2();
};
