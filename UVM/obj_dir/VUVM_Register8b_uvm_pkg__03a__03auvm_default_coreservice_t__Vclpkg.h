...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_DEFAULT_CORESERVICE_T__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_DEFAULT_CORESERVICE_T__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_component_name_check_visitor;
class VUVM_Register8b_uvm_pkg__03a__03auvm_coreservice_t;
class VUVM_Register8b_uvm_pkg__03a__03auvm_default_factory;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_default_coreservice_t__Vclpkg);
...
#include "VUVM_Register8b_uvm_pkg__03a__03auvm_coreservice_t__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b_uvm_pkg__03a__03auvm_default_coreservice_t : public VUVM_Register8b_uvm_pkg__03a__03auvm_coreservice_t {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_factory> __PVT__factory;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_tr_database> __PVT__tr_database;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_report_server> __PVT__report_server;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_visitor_> __PVT___visitor;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_default_coreservice_t"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_default_coreservice_t(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_default_coreservice_t() = default;
    void init(VUVM_Register8b__Syms* __restrict vlSymsp);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_default_coreservice_t();
};
