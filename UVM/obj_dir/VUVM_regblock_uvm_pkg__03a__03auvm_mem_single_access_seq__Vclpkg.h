...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_MEM_SINGLE_ACCESS_SEQ__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_MEM_SINGLE_ACCESS_SEQ__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_mem_single_access_seq__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_mem_single_access_seq__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_mem_single_access_seq__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_mem_single_access_seq__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi51> &get_type__Vfuncrtn);
};
...
class VUVM_regblock_uvm_pkg__03a__03auvm_mem_single_access_seq : public VUVM_regblock_uvm_pkg__03a__03auvm_reg_sequence_ {
  public:
    ...
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_mem_single_access_seq(*this); }
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_mem_single_access_seq() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_mem_single_access_seq();
};
