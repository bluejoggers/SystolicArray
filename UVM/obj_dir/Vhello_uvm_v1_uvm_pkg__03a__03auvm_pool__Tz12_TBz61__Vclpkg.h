...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_POOL__TZ12_TBZ61__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_POOL__TZ12_TBZ61__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz61__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz61> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz61__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz61__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz61__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz61> &get_global_pool__Vfuncrtn);
};
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz61 : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<std::string, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_barrier>> __PVT__pool;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_pool__Tz12_TBz61"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz61(*this); }
    ...
    virtual void __VnoInFunc_add(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string key, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_barrier> item);
  ...
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz61() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_pool__Tz12_TBz61();
};
