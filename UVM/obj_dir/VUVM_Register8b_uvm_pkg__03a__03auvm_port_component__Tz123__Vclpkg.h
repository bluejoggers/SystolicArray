...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_PORT_COMPONENT__TZ123__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_PORT_COMPONENT__TZ123__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_port_component__Tz123__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_port_component__Tz123__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_port_component__Tz123__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_port_component__Tz123__Vclpkg);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_port_component__Tz123 : public VUVM_Register8b_uvm_pkg__03a__03auvm_port_component_base {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_port_base__Tz122> __PVT__m_port;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_port_component__Tz123"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_port_component__Tz123(*this); }
    ...
    void __VnoInFunc_get_port(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_port_base__Tz122> &get_port__Vfuncrtn);
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_port_component__Tz123() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> parent, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_port_base__Tz122> port);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_port_component__Tz123();
};
