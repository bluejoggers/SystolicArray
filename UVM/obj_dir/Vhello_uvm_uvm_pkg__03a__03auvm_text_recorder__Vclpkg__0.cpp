...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder__Vclpkg::__VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi24> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi24__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, get_type__Vfuncrtn);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_object_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi24> __Vfunc_get__0__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi24__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vfunc_get__0__Vfuncout);
    get_object_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder> tmp;
    if ((""s == name)) {
        tmp = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder, vlProcess, vlSymsp, "unnamed-uvm_text_recorder"s);
    } else {
        tmp = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder, vlProcess, vlSymsp, name);
    }
    create__Vfuncrtn = tmp;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_type_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_text_recorder"s;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc____05Fm_uvm_field_automation(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> tmp_data___05F, IData/*31:0*/ what___05F, std::string str___05F) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc____05Fm_uvm_field_automation\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_1;
    CData/*0:0*/ __VlefCall_0__m_do_cycle_check;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder> unnamedblk1__DOT__local_data___05F;
    {
        if ((((0x00020006U == what___05F) | (0x00020008U 
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_object__Vclpkg.__PVT_____05Fm_uvm_status_container, "../../uvm/distrib/src/base/uvm_recorder.svh", 731)->__VnoInFunc_m_do_cycle_check(vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder>{this}, __VlefCall_0__m_do_cycle_check);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name) {
    Vhello_uvm_uvm_pkg__03a__03auvm_recorder::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    _ctor_var_reset(vlSymsp);
    this->__PVT__scope = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_scope_stack, vlSymsp);
    /*super.new*/;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_open(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> stream, QData/*63:0*/ open_time, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_open\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    IData/*31:0*/ __VlefExpr_1;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_database> __VlefCall_0__get_db;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_close(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ close_time) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_close\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_free(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_free\n"); );
    // Body
    IData/*31:0*/ __VlefCall_1__get_handle;
    CData/*0:0*/ __VlefCall_0__open_db;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field\n"); );
    // Body
    ...
    if ((1U & (~ (0U != radix)))) {
        radix = Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__PVT__default_radix;
    }
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_int(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_int\n"); );
    // Body
    std::string __VlefCall_0__get;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_real(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, double value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_field_real\n"); );
    // Body
    std::string __VlefCall_0__get;
    QData/*63:0*/ ival;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_object(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_object\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    std::string str;
    {
        v = 0U;
        str = ""s;
        if (Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__PVT__identifier) {
            if ((VlNull{} != value)) {
        ...
        if ((0x00001000U != Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__PVT__policy)) {
            if ((VlNull{} != value)) {
                ...
                VL_NULL_CHECK(value, "../../uvm/distrib/src/base/uvm_recorder.svh", 886)->__VnoInFunc_record(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder>{this});
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_string(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_string\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_time(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_time\n"); );
    // Body
    std::string __VlefCall_0__get;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_generic(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string value, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_do_record_generic\n"); );
    // Locals
...
extern const VlWide<128>/*4095:0*/ Vhello_uvm__ConstPool__CONST_h1958c06c_0;

void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute(Vhello_uvm__Syms* __restrict vlSymsp, std::string nm, VlWide<128>/*4095:0*/ value, IData/*31:0*/ radix, IData/*31:0*/ numbits) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute\n"); );
    // Locals
    ...
    if (VL_UNLIKELY((__VlefCall_0__open_db))) {
        ...
        }
        {
            ...
            VL_SHIFTL_WWI(4096,4096,32, __Vtemp_2, Vhello_uvm__ConstPool__CONST_h1958c06c_0, __Vfunc_uvm_bitstream_to_string__45__size);
            VL_SUB_W(128, __Vtemp_3, __Vtemp_2, Vhello_uvm__ConstPool__CONST_h1958c06c_0);
        ...
        __Vtemp_4 = Vhello_uvm___024unit::__Venumtab_enum_name15
            .at(radix);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute_int(Vhello_uvm__Syms* __restrict vlSymsp, std::string nm, QData/*63:0*/ value, IData/*31:0*/ radix, IData/*31:0*/ numbits) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_write_attribute_int\n"); );
    // Locals
    ...
    if (VL_UNLIKELY((__VlefCall_0__open_db))) {
        ...
        __Vtemp_1 = Vhello_uvm___024unit::__Venumtab_enum_name15
            .at(radix);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_open_file(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &open_file__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_open_file\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create_stream(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string t, std::string scope, IData/*31:0*/ &create_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_create_stream\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_2;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __VlefCall_1__open_stream;
    CData/*0:0*/ __VlefCall_0__open_file;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_text_tr_stream> stream;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_m_set_attribute(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ txh, std::string nm, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_m_set_attribute\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__open_file;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_set_attribute(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ txh, std::string nm, VlWide<32>/*1023:0*/ value, IData/*31:0*/ radix, IData/*31:0*/ numbits) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_set_attribute\n"); );
    // Locals
    ...
    if (VL_UNLIKELY((__VlefCall_0__open_file))) {
        ...
        }
        {
            ...
            VL_SHIFTL_WWI(4096,4096,32, __Vtemp_2, Vhello_uvm__ConstPool__CONST_h1958c06c_0, __Vfunc_uvm_bitstream_to_string__56__size);
            VL_SUB_W(128, __Vtemp_3, __Vtemp_2, Vhello_uvm__ConstPool__CONST_h1958c06c_0);
            __Vfunc_uvm_bitstream_to_string__56__value[0U] 
                = (__Vfunc_uvm_bitstream_to_string__56__value[0U] 
                   & __Vtemp_3[0U]);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_check_handle_kind(Vhello_uvm__Syms* __restrict vlSymsp, std::string htype, IData/*31:0*/ handle, IData/*31:0*/ &check_handle_kind__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_check_handle_kind\n"); );
    // Body
    CData/*0:0*/ __VlefLogOr_2;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __VlefCall_1__get_stream_from_handle;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_recorder> __VlefCall_0__get_recorder_from_handle;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_begin_tr(Vhello_uvm__Syms* __restrict vlSymsp, std::string txtype, IData/*31:0*/ stream, std::string nm, std::string label, std::string desc, QData/*63:0*/ begin_time, IData/*31:0*/ &begin_tr__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_begin_tr\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__open_file;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> unnamedblk4__DOT__stream_obj;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_recorder> unnamedblk4__DOT__recorder;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_end_tr(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ handle, QData/*63:0*/ end_time) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_end_tr\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__open_file;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_recorder> unnamedblk5__DOT__record;
    this->__VnoInFunc_open_file(vlSymsp, __VlefCall_0__open_file);
    if (__VlefCall_0__open_file) {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_link_tr(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ h1, IData/*31:0*/ h2, std::string relation) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_link_tr\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__open_file;
    this->__VnoInFunc_open_file(vlSymsp, __VlefCall_0__open_file);
    if (VL_UNLIKELY((__VlefCall_0__open_file))) {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_free_tr(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ handle) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_free_tr\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__open_file;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_recorder> unnamedblk6__DOT__record;
    this->__VnoInFunc_open_file(vlSymsp, __VlefCall_0__open_file);
    if (__VlefCall_0__open_file) {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::_ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__filename_set = 0;
}

Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::~Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_text_recorder::~\n"); );
}
