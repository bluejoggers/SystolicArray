...
void Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::init(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam_cfg> cfg, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> mem) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    this->__PVT__for_each_idx = 0xffffffffU;
    this->__PVT__cfg = cfg;
    this->__PVT__memory = mem;
    this->__PVT__default_alloc = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam_policy, vlSymsp);
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reconfigure(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam_cfg> cfg, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam_cfg> &reconfigure__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reconfigure\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reserve_region(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ start_offset, IData/*31:0*/ n_bytes, std::string fname, IData/*31:0*/ lineno, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_region> &reserve_region__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reserve_region\n"); );
    // Locals
    ...
    QData/*63:0*/ end_offset;
    {
        ...
        if ((start_offset < VL_NULL_CHECK(this->__PVT__cfg, "../../uvm/distrib/src/reg/uvm_mem_mam.svh", 709)
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__19__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if ((0U != __VlefCall_3__uvm_report_enabled)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__39__Vfuncout);
        ...
        while (VL_LTS_III(32, unnamedblk394__DOT__i, this->__PVT__in_use.size())) {
            ...
            if (__VlefLogAnd_6) {
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__45__Vfuncout);
                vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
            ...
            if ((start_offset > __VlefCall_9__get_start_offset)) {
                reserve_region__Vfuncrtn = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_mem_region, vlSymsp, start_offset, end_offset, 
                                                  ((IData)(1U) 
                                                   + 
                                                   ((IData)(end_offset) 
                                                    - (IData)(start_offset))), n_bytes, 
                                                  VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam>{this});
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_request_region(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ n_bytes, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam_policy> alloc, std::string fname, IData/*31:0*/ lineno, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_region> &request_region__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_request_region\n"); );
    // Locals
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_region(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_region> region) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_region\n"); );
    // Locals
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_all_regions(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_all_regions\n"); );
    // Body
    this->__PVT__in_use.clear();
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_convert2string(Vuvm_pkg__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_convert2string\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_for_each(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ reset, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_region> &for_each__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_for_each\n"); );
    // Body
    {
        if (reset) {
            this->__PVT__for_each_idx = 0xffffffffU;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_get_memory(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> &get_memory__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_get_memory\n"); );
    // Body
    get_memory__Vfuncrtn = this->__PVT__memory;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::_ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam::_ctor_var_reset\n"); );
    // Body
