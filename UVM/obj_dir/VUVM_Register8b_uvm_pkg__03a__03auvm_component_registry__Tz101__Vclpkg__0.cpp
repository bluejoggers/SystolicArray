...
void VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    ...
    if ((VlNull{} == this->__PVT__me)) {
        ...
        this->__PVT__me = VL_NEW(VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101, vlSymsp);
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101__Vclpkg::__VnoInFunc_create(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_sequencer_> &create__Vfuncrtn) {
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101> __VlefCall_0__get;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101__Vclpkg::__VnoInFunc_set_type_override(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101> __VlefCall_0__get;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101__Vclpkg::__VnoInFunc_set_inst_override(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101> __VlefCall_1__get;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101::__VnoInFunc_create_component(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> parent, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> &create_component__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101::__VnoInFunc_create_component\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101::__VnoInFunc_get_type_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "<unknown>"s;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101::init(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VUVM_Register8b_uvm_pkg__03a__03auvm_object_wrapper::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101::new\n"); );
    // Body
    /*super.new*/;
}

VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101::~VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz101::~\n"); );
}
