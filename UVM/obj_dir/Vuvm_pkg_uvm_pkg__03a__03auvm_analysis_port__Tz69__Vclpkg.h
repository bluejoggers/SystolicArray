...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_ANALYSIS_PORT__TZ69__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_ANALYSIS_PORT__TZ69__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_port__Tz69__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_port__Tz69__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_port__Tz69__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_port__Tz69__Vclpkg);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_port__Tz69 : public Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz97 {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_analysis_port__Tz69"; }
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_port__Tz69(*this); }
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_port__Tz69() = default;
    ...
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_port__Tz69();
};
