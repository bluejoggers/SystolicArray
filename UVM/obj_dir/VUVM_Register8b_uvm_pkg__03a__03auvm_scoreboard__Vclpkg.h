...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_SCOREBOARD__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_SCOREBOARD__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_scoreboard__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_scoreboard__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_scoreboard__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_scoreboard__Vclpkg);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_scoreboard : public VUVM_Register8b_uvm_pkg__03a__03auvm_component {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_scoreboard"; }
    ...
    VUVM_Register8b_uvm_pkg__03a__03auvm_scoreboard() = default;
    ...
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_scoreboard();
};
