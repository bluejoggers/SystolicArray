...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_REG_MEM_BUILT_IN_SEQ__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_REG_MEM_BUILT_IN_SEQ__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem_access_seq;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem_walk_seq;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_object;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi47;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_wrapper;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_access_seq;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_bit_bash_seq;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_hw_reset_seq;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_built_in_seq;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_built_in_seq__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_built_in_seq__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_built_in_seq__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_built_in_seq__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi47> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_built_in_seq : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_sequence_ {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_mem_built_in_seq"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_built_in_seq(*this); }
    ...
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_built_in_seq() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_mem_built_in_seq();
};
