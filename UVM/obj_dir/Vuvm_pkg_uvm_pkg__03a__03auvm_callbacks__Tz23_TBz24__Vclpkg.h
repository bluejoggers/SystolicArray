...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_CALLBACKS__TZ23_TBZ24__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_CALLBACKS__TZ23_TBZ24__VCLPKG_H_  // guard
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24;
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_typeid__Tz24;
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24__Vclpkg final {
  public:
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24> __PVT__m_inst;
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24__Vclpkg);
    ...
    void __VnoInFunc_get(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24> &get__Vfuncrtn);
    void __VnoInFunc_get_first(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field_cbs> &get_prev__Vfuncrtn);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24 : public Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz23 {
  public:
    ...
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24(*this); }
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz23_TBz24();
};
