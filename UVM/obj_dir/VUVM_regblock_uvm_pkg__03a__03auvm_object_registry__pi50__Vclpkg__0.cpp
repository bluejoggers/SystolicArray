...
void VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    ...
    if ((VlNull{} == this->__PVT__me)) {
        ...
        this->__PVT__me = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50, vlSymsp);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50__Vclpkg::__VnoInFunc_create(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem_walk_seq> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50> __VlefCall_0__get;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50__Vclpkg::__VnoInFunc_set_type_override(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50__Vclpkg::__VnoInFunc_set_inst_override(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50> __VlefCall_1__get;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50::__VnoInFunc_create_object(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> &create_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50::__VnoInFunc_create_object\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem_walk_seq> obj;
    if ((""s == name)) {
        obj = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_mem_walk_seq, vlProcess, vlSymsp, "uvm_mem_walk_seq"s);
    } else {
        obj = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_mem_walk_seq, vlProcess, vlSymsp, name);
    }
    create_object__Vfuncrtn = obj;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50::__VnoInFunc_get_type_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_mem_walk_seq"s;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50::init(VUVM_regblock__Syms* __restrict vlSymsp) {
    VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50::new\n"); );
    // Body
    /*super.new*/;
}

VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50::~VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi50::~\n"); );
}
