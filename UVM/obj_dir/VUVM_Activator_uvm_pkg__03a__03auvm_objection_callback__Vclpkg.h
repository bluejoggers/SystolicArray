...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_OBJECTION_CALLBACK__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_OBJECTION_CALLBACK__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_objection_callback__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_objection_callback__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_objection_callback__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_objection_callback__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_objection_callback : public VUVM_Activator_uvm_pkg__03a__03auvm_callback {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_objection_callback"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_objection_callback(*this); }
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_objection_callback() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_objection_callback();
};
