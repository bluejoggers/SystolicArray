...
void VUVM_regblock_uvm_pkg__03a__03auvm_printer_knobs::__VnoInFunc_get_radix_str(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ radix, std::string &get_radix_str__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_printer_knobs::__VnoInFunc_get_radix_str\n"); );
    // Body
    {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_printer_knobs::init(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_printer_knobs::new\n"); );
    // Body
