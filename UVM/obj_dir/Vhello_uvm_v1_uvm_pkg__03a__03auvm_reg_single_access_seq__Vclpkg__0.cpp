...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq__Vclpkg::__VnoInFunc_get_type(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi41> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc_get_object_type(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi41> __Vfunc_get__0__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc_create(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc_create\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq> tmp;
    if ((""s == name)) {
        tmp = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq, vlProcess, vlSymsp, "uvm_reg_single_access_seq"s);
    } else {
        tmp = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq, vlProcess, vlSymsp, name);
    }
    create__Vfuncrtn = tmp;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc_get_type_name(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_single_access_seq"s;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc____05Fm_uvm_field_automation(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> tmp_data___05F, IData/*31:0*/ what___05F, std::string str___05F) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc____05Fm_uvm_field_automation\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_1;
    CData/*0:0*/ __VlefCall_0__m_do_cycle_check;
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq> unnamedblk1__DOT__local_data___05F;
    {
        if ((((0x00020006U == what___05F) | (0x00020008U 
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_object__Vclpkg.__PVT_____05Fm_uvm_status_container, "../../uvm/distrib/src/reg/sequences/uvm_reg_access_seq.svh", 68)->__VnoInFunc_m_do_cycle_check(vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq>{this}, __VlefCall_0__m_do_cycle_check);
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name) {
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_sequence_::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
VlCoroutine Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc_body\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> __VlefCall_25__backdoor;
    ...
    VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_field>> unnamedblk2__DOT__fields;
    ...
    VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map>> maps;
    {
        ...
        while (VL_LTS_III(32, unnamedblk6__DOT__j, maps.size())) {
            ...
            co_await VL_NULL_CHECK(this->__PVT__rg, "../../uvm/distrib/src/reg/sequences/uvm_reg_access_seq.svh", 141)->__VnoInFunc_write(vlProcess, vlSymsp, __Vtask_write__34__status, 
                                                                                ...
                                                                                VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq>{this}, 0xffffffffU, VlNull{}, ""s, 0U);
                    ...
                    this->__VnoInFunc_uvm_report_error(vlProcess, vlSymsp, "uvm_reg_access_seq"s, 
                                                       VL_CVT_PACK_STR_NN(
                                                                          VL_CONCATN_NNN(
                                                                                ...
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN("Status was '"s, Vhello_uvm_v1___024unit::__Venumtab_enum_name73
                                                                                [
                                                                                (3U 
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc_randomize(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc___Vsetup_constraints(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc___Vsetup_constraints\n"); );
    // Body
    this->__VnoInFunc_pick_sequence_setup_constraint(vlSymsp);
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc___VBasicRand(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::_ctor_var_reset(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::~Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_single_access_seq::~\n"); );
}
