...
#ifndef VERILATED_VUVM_REGISTER8B___024UNIT__03A__03AREG_MONITOR__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B___024UNIT__03A__03AREG_MONITOR__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_monitor;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b___024unit__03a__03areg_monitor__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b___024unit__03a__03areg_monitor__Vclpkg();
    ~VUVM_Register8b___024unit__03a__03areg_monitor__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b___024unit__03a__03areg_monitor__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi13> &get_type__Vfuncrtn);
};

#include "VUVM_Register8b_uvm_pkg__03a__03auvm_monitor__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b___024unit__03a__03areg_monitor : public VUVM_Register8b_uvm_pkg__03a__03auvm_monitor {
  public:

    // DESIGN SPECIFIC STATE
    VUVM_Register8b_reg_if* __PVT__vif;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz61> __PVT__monitor_analysis_port;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "$unit::reg_monitor"; }
    VlClass* clone() const { return new VUVM_Register8b___024unit__03a__03areg_monitor(*this); }
  ...
  public:
    VUVM_Register8b___024unit__03a__03areg_monitor() = default;
    ...
    virtual ~VUVM_Register8b___024unit__03a__03areg_monitor();
};
