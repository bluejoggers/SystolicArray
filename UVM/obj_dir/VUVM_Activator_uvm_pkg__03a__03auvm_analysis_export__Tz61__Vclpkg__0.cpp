...
void VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61::init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> parent) {
    VUVM_Activator_uvm_pkg__03a__03auvm_port_base__Tz78::init(vlProcess, vlSymsp, name, parent, 1U, 1U, 0xffffffffU);
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    _ctor_var_reset(vlSymsp);
    /*super.new*/;
    VUVM_Activator_uvm_pkg__03a__03auvm_port_base__Tz78::__PVT__m_if_mask = 0x00000100U;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61::__VnoInFunc_get_type_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_analysis_export"s;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61::__VnoInFunc_write(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61::__VnoInFunc_write\n"); );
    // Locals
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_port_base__Tz78> __Vfunc_get_if__2__Vfuncout;
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_if_base__Tz61_TBz61> tif;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61::_ctor_var_reset(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61::~VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_Activator_uvm_pkg__03a__03auvm_analysis_export__Tz61::~\n"); );
}
