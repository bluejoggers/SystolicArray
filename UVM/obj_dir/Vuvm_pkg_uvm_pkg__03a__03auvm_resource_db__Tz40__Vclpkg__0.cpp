...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_get_by_type(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_0__get_type;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_get_by_name(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_default(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40> &set_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_default\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40> r;
    r = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40, vlProcess, vlSymsp, name, scope);
    VL_NULL_CHECK(r, "../../uvm/distrib/src/base/uvm_resource_db.svh", 96)->__VnoInFunc_set(vlSymsp);
    set_default__Vfuncrtn = r;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_m_show_msg(Vuvm_pkg__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_m_show_msg\n"); );
    // Locals
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ val, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40> rsrc;
    rsrc = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40, vlProcess, vlSymsp, name, scope);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_anonymous(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, CData/*0:0*/ val, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_anonymous\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40> rsrc;
    rsrc = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40, vlProcess, vlSymsp, ""s, scope);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ val, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override_type(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ val, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ val, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_read_by_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ &val, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_read_by_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_read_by_type(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, CData/*0:0*/ &val, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_read_by_type\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40> rsrc;
    {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_write_by_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ val, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_write_by_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_write_by_type(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, CData/*0:0*/ val, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_write_by_type\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz40> rsrc;
    {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_dump(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_dump\n"); );
    // Body
