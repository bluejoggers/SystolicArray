...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SEQUENCE_LIBRARY_CFG__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SEQUENCE_LIBRARY_CFG__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_sequence_library_cfg__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_sequence_library_cfg__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_sequence_library_cfg__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_sequence_library_cfg__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi25> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_uvm_pkg__03a__03auvm_sequence_library_cfg : public Vhello_uvm_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_sequence_library_cfg(*this); }
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_sequence_library_cfg() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ mode, IData/*31:0*/ min, IData/*31:0*/ max);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_sequence_library_cfg();
};
