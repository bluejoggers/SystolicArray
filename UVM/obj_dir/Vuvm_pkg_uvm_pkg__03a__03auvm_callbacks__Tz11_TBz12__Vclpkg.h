...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_CALLBACKS__TZ11_TBZ12__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_CALLBACKS__TZ11_TBZ12__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vuvm_pkg_uvm_pkg__03a__03auvm_callback;
class Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11;
class Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12;
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz11;
class Vuvm_pkg_uvm_pkg__03a__03auvm_typeid__Tz11;
class Vuvm_pkg_uvm_pkg__03a__03auvm_typeid__Tz12;
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12__Vclpkg final {
  public:
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12> __PVT__m_inst;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11> __PVT__m_base_inst;
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_add(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering);
    ...
    void __VnoInFunc_delete(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback> cb);
    ...
    void __VnoInFunc_display(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> obj);
    void __VnoInFunc_get(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12> &get__Vfuncrtn);
    void __VnoInFunc_get_first(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase_cb> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase_cb> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase_cb> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase_cb> &get_prev__Vfuncrtn);
    void __VnoInFunc_m_get_q(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_queue__Tz34> &q, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> obj);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12 : public Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz11 {
  public:
    ...
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12(*this); }
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz11_TBz12();
};
