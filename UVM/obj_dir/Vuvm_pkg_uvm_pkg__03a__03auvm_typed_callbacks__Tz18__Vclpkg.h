...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ18__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ18__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz18__Vclpkg final {
  public:
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz18> __PVT__m_t_inst;
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz18__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz18__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz18__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz18> &m_initialize__Vfuncrtn);
};
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz18 : public Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks_base {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_typed_callbacks__Tz18"; }
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz18(*this); }
    ...
    Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz18() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz18();
};
