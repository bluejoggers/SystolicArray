...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_SIMPLE_SEQUENCE__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_SIMPLE_SEQUENCE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_simple_sequence__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_simple_sequence__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_simple_sequence__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_simple_sequence__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi40> &get_type__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_simple_sequence : public VUVM_Register8b_uvm_pkg__03a__03auvm_sequence_ {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_sequence_item> __PVT__item;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_simple_sequence"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_simple_sequence(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_simple_sequence() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_simple_sequence();
};
