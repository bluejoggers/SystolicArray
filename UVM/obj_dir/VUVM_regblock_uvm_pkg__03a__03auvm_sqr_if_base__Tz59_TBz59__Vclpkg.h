...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ59_TBZ59__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ59_TBZ59__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz59_TBz59__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz59_TBz59__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz59_TBz59__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz59_TBz59__Vclpkg);
...
class VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz59_TBz59 : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_sqr_if_base__Tz59_TBz59"; }
    ...
    virtual void __VnoInFunc_item_done(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock___024unit__03a__03areg_txn_base> t);
    ...
    virtual void __VnoInFunc_put_response(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock___024unit__03a__03areg_txn_base> t);
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz59_TBz59() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz59_TBz59();
};
