...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_RELATED_LINK__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_RELATED_LINK__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_related_link__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_related_link__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_related_link__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_related_link__Vclpkg);
    ...
    void __VnoInFunc_get_link(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> lhs, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> rhs, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_related_link> &get_link__Vfuncrtn);
    void __VnoInFunc_get_type(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi11> &get_type__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_related_link : public VUVM_Register8b_uvm_pkg__03a__03auvm_link_base {
  public:
    ...
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_related_link(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_related_link() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_related_link();
};
