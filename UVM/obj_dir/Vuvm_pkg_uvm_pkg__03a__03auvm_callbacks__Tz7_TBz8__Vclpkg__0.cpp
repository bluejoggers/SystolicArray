...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz7> __Vtask_m_initialize__1__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_typeid__Tz34> __Vfunc_get__2__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_typeid__Tz8> __Vfunc_get__3__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_typeid__Tz7> __Vfunc_get__4__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7> __Vfunc_get__6__Vfuncout;
    ...
    if ((VlNull{} == this->__PVT__m_inst)) {
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__VnoInFunc_m_initialize(vlProcess, vlSymsp, __Vtask_m_initialize__1__Vfuncout);
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz8__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__3__Vfuncout);
        this->__PVT__m_cb_typeid = __Vfunc_get__3__Vfuncout;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid__Tz7__Vclpkg.__VnoInFunc_get(vlSymsp, __Vfunc_get__4__Vfuncout);
        this->__PVT__m_typeid = __Vfunc_get__4__Vfuncout;
        this->__PVT__m_inst = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8, vlProcess, vlSymsp);
        if (VL_UNLIKELY(((unnamedblk1__DOT__cb_base_type 
                          == this->__PVT__m_cb_typeid)))) {
            VL_WRITEF_NX("[%0t] %%Error: uvm_callback.svh:521: Assertion failed in %m: '$cast' failed.\n",3, 'M',vlSymsp->name(),"uvm_pkg.uvm_callbacks__Tz7_TBz8.get.unnamedblk1", 'T',-12
                         , '#',64,VL_TIME_UNITED_Q(1));
            VL_STOP_MT("../../uvm/distrib/src/base/uvm_callback.svh", 521, "");
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__PVT__m_t_inst 
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz7__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vfunc_get__6__Vfuncout);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_m_register_pair(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string tname, std::string cbname, CData/*0:0*/ &m_register_pair__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_m_register_pair\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> inst;
    m_register_pair__Vfuncrtn = 0U;
    this->__VnoInFunc_get(vlProcess, vlSymsp, inst);
    this->__PVT__m_typename = tname;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__PVT__m_typename 
        = tname;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_add(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_add\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> __Vtask_get__16__Vfuncout;
    ...
    std::string tnm;
    {
        ...
        if ((VlNull{} == cb)) {
            ...
            if ((""s != vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz7__Vclpkg.__PVT__m_typename)) {
                tnm = vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz7__Vclpkg.__PVT__m_typename;
            } else if ((VlNull{} != obj)) {
        ...
        if ((VlNull{} == obj)) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__PVT__m_tw_cb_q, cb, __VlefCall_3__m_cb_find);
            if ((0xffffffffU != __VlefCall_3__m_cb_find)) {
                tnm = ((""s != vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz7__Vclpkg.__PVT__m_typename)
                        ? vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz7__Vclpkg.__PVT__m_typename
                        : "uvm_object"s);
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__PVT__m_t_inst, "../../uvm/distrib/src/base/uvm_callback.svh", 650)->__VnoInFunc_m_add_tw_cbs(vlSymsp, cb, ordering);
            }
        } else {
            ...
            if ((0U == __VlefCall_5__size)) {
                ...
                unnamedblk2__DOT__unnamedblk5__DOT__i = 0U;
                while (true) {
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__PVT__m_tw_cb_q, "../../uvm/distrib/src/base/uvm_callback.svh", 679)->__VnoInFunc_size(vlSymsp, __VlefCall_8__size);
                    if (!(VL_LTS_III(32, unnamedblk2__DOT__unnamedblk5__DOT__i, __VlefCall_8__size))) break;
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__PVT__m_tw_cb_q, "../../uvm/distrib/src/base/uvm_callback.svh", 680)->__VnoInFunc_get(vlProcess, vlSymsp, unnamedblk2__DOT__unnamedblk5__DOT__i, __VlefCall_9__get);
            ...
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, q, cb, __VlefCall_10__m_cb_find);
            if ((0xffffffffU != __VlefCall_10__m_cb_find)) {
                ...
                vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__VnoInFunc_m_cb_find_name(vlSymsp, q, 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_add_by_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> root, IData/*31:0*/ ordering) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_add_by_name\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> __Vtask_get__62__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_object> t;
    {
        cq.clear();
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_delete(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback> cb) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_delete\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> __Vtask_get__76__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__84__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__85__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_0__get_name;
    ...
    if ((VlNull{} == obj)) {
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__PVT__m_t_inst, "../../uvm/distrib/src/base/uvm_callback.svh", 761)->__VnoInFunc_m_delete_tw_cbs(vlSymsp, cb, found);
    } else {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, q, cb, pos);
        if ((0xffffffffU != pos)) {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_delete_by_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback> cb, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> root) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_delete_by_name\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> __Vtask_get__87__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__93__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__94__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_0__get_name;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_m_get_q(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_queue__Tz34> &q, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_object> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_m_get_q\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    if ((0U != __VlefCall_0__exists)) {
        ...
        if ((VlNull{} == obj)) {
            __VlefCall_1__m_get_tw_cb_q = vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__PVT__m_tw_cb_q;
        } else {
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__PVT__m_t_inst, "../../uvm/distrib/src/base/uvm_callback.svh", 825)->__VnoInFunc_m_get_tw_cb_q(vlSymsp, obj, __VlefCall_1__m_get_tw_cb_q);
        }
        q = __VlefCall_1__m_get_tw_cb_q;
    }
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_get_first(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_catcher> &get_first__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_get_first\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> __Vtask_get__102__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_queue__Tz34> q;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_catcher> cb;
    {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_get_last(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_catcher> &get_last__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_get_last\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> __Vtask_get__107__Vfuncout;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_get_next(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_catcher> &get_next__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_get_next\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> __Vtask_get__112__Vfuncout;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_get_prev(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_catcher> &get_prev__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_get_prev\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> __Vtask_get__117__Vfuncout;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_display(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_object> obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8__Vclpkg::__VnoInFunc_display\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8> __Vtask_get__121__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    this->__VnoInFunc_get(vlProcess, vlSymsp, __Vtask_get__121__Vfuncout);
    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz7__Vclpkg.__VnoInFunc_display(vlSymsp, obj);
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::__VnoInFunc_m_is_registered(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_registered__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::__VnoInFunc_m_is_registered\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::__VnoInFunc_m_is_for_me(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_is_for_me__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::__VnoInFunc_m_is_for_me\n"); );
    // Body
    IData/*31:0*/ __VlefExpr_0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_report_catcher> this_cb;
    __VlefExpr_0 = VL_CAST_DYNAMIC(cb, this_cb);
    m_is_for_me__Vfuncrtn = (1U & __VlefExpr_0);
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp) {
    Vuvm_pkg_uvm_pkg__03a__03auvm_typed_callbacks__Tz7::init(vlProcess, vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::__VnoInFunc_randomize(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::__VnoInFunc_randomize\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::__VnoInFunc___Vsetup_constraints(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::__VnoInFunc___VBasicRand(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::_ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_registered = 0;
}

Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::~Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_callbacks__Tz7_TBz8::~\n"); );
}
