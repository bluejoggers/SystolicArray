...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_VISITOR_ADAPTER___VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_VISITOR_ADAPTER___VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_visitor_adapter___Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_visitor_adapter___Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_visitor_adapter___Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_visitor_adapter___Vclpkg);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_visitor_adapter_ : public VUVM_Register8b_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VUVM_Register8b_uvm_pkg__03a__03auvm_visitor_adapter_() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_visitor_adapter_();
};
