...
#ifndef VERILATED_VHELLO_UVM_V1___024UNIT__03A__03ATEST__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1___024UNIT__03A__03ATEST__VCLPKG_H_  // guard
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_test;


class Vhello_uvm_v1__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1___024unit__03a__03atest__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1___024unit__03a__03atest__Vclpkg();
    ~Vhello_uvm_v1___024unit__03a__03atest__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1___024unit__03a__03atest__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi2> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_v1___024unit__03a__03atest : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_test {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vhello_uvm_v1___024unit__03a__03aenv> __PVT__top_env;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "$unit::test"; }
    VlClass* clone() const { return new Vhello_uvm_v1___024unit__03a__03atest(*this); }
  ...
  public:
    Vhello_uvm_v1___024unit__03a__03atest() = default;
    ...
    virtual ~Vhello_uvm_v1___024unit__03a__03atest();
};
