...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_CALLBACKS__TZ68_TBZ66__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_CALLBACKS__TZ68_TBZ66__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_callback;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66;
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_typed_callbacks__Tz68;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_typeid__Tz51;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_typeid__Tz66;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_typeid__Tz68;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_typeid_base;


class Vhello_uvm_v1__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66__Vclpkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66> __PVT__m_inst;
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68> __PVT__m_base_inst;
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_add(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering);
    ...
    void __VnoInFunc_delete(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callback> cb);
    ...
    void __VnoInFunc_display(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> obj);
    void __VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66> &get__Vfuncrtn);
    void __VnoInFunc_get_first(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_cbs> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_cbs> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_cbs> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_cbs> &get_prev__Vfuncrtn);
    void __VnoInFunc_m_get_q(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz51> &q, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_mem> obj);
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66 : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_typed_callbacks__Tz68 {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_callbacks__Tz68_TBz66"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66(*this); }
  ...
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz68_TBz66();
};
