...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_BARRIER__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_BARRIER__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_barrier__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_barrier__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_barrier__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_barrier__Vclpkg);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_barrier : public VUVM_Register8b_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_barrier(*this); }
    ...
    virtual void __VnoInFunc_get_threshold(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &get_threshold__Vfuncrtn);
    virtual void __VnoInFunc_get_type_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn);
    VlCoroutine __VnoInFunc_m_trigger(VUVM_Register8b__Syms* __restrict vlSymsp);
    ...
    virtual void __VnoInFunc_set_auto_reset(VUVM_Register8b__Syms* __restrict vlSymsp, CData/*0:0*/ value);
    virtual void __VnoInFunc_set_threshold(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ threshold);
    virtual VlCoroutine __VnoInFunc_wait_for(VUVM_Register8b__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp);
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_barrier() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ threshold);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_barrier();
};
