...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_COMPONENT_REGISTRY__PI1__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_COMPONENT_REGISTRY__PI1__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vhello_uvm_v1___024unit__03a__03aenv;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi1__Vclpkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi1> __PVT__me;
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi1__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi1__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi1__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_create(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vhello_uvm_v1___024unit__03a__03aenv> &create__Vfuncrtn);
    void __VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi1> &get__Vfuncrtn);
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi1 : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_wrapper {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_component_registry__pi1"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi1(*this); }
    ...
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi1() = default;
    void init(Vhello_uvm_v1__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_component_registry__pi1();
};
