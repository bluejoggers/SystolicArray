...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SET_GET_DAP_BASE__TZ40__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SET_GET_DAP_BASE__TZ40__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz40__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz40__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz40__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz40__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz40 : public Vhello_uvm_uvm_pkg__03a__03auvm_object {
  public:
    ...
    Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz40() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_set_get_dap_base__Tz40();
};
