...
void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name) {
    VUVM_Activator_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::new\n"); );
    // Body
...
VlCoroutine VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_wait_on(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ delta) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_wait_on\n"); );
    // Locals
...
VlCoroutine VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_wait_off(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ delta) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_wait_off\n"); );
    // Locals
...
VlCoroutine VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_wait_trigger(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_wait_trigger\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    this->__PVT__num_waiters = ((IData)(1U) + this->__PVT__num_waiters);
...
VlCoroutine VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_wait_ptrigger(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_wait_ptrigger\n"); );
    // Body
    VL_KEEP_THIS;
    {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_get_trigger_time(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ &get_trigger_time__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_get_trigger_time\n"); );
    // Body
    get_trigger_time__Vfuncrtn = this->__PVT__trigger_time;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_is_on(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &is_on__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_is_on\n"); );
    // Body
    is_on__Vfuncrtn = this->__PVT__on;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_is_off(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &is_off__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_is_off\n"); );
    // Body
    is_off__Vfuncrtn = (1U & (~ (IData)(this->__PVT__on)));
}

void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_reset(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ wakeup) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_reset\n"); );
    // Body
    VlAssignableEvent e;
    if (wakeup) {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_cancel(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_cancel\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_get_num_waiters(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_waiters__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_get_num_waiters\n"); );
    // Body
    get_num_waiters__Vfuncrtn = this->__PVT__num_waiters;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_get_type_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_event_base"s;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_do_print(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_do_print\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_do_copy(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_do_copy\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_0;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_event_base> e;
    {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_randomize(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc___Vsetup_constraints(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc___VBasicRand(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_event_base::_ctor_var_reset(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::_ctor_var_reset\n"); );
    // Body
...
VUVM_Activator_uvm_pkg__03a__03auvm_event_base::~VUVM_Activator_uvm_pkg__03a__03auvm_event_base() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_event_base::~\n"); );
}
