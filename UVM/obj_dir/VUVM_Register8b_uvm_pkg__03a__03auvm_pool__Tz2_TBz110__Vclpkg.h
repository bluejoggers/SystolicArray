...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ110__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ110__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz110__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz110> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz110__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz110__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz110__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz110> &get_global_pool__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz110 : public VUVM_Register8b_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<std::string, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2>> __PVT__pool;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_pool__Tz2_TBz110"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz110(*this); }
    ...
    virtual void __VnoInFunc_add(VUVM_Register8b__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2> item);
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz110() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz110();
};
