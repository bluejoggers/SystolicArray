...
#ifndef VERILATED_VUVM_ACTIVATOR___024UNIT_H_
#define VERILATED_VUVM_ACTIVATOR___024UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator___024unit final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator___024unit();
    ~VUVM_Activator___024unit();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator___024unit);
