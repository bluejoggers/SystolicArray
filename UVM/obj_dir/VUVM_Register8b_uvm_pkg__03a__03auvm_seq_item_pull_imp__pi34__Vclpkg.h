...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_IMP__PI34__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_SEQ_ITEM_PULL_IMP__PI34__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi34__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi34__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi34__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi34__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
};

#include "VUVM_Register8b_uvm_pkg__03a__03auvm_port_base__Tz124__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi34 : public VUVM_Register8b_uvm_pkg__03a__03auvm_port_base__Tz124 {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_sequencer__Tz114_TBz114> __PVT__m_imp;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_seq_item_pull_imp__pi34"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi34(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi34() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_sequencer__Tz114_TBz114> imp);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_seq_item_pull_imp__pi34();
};
