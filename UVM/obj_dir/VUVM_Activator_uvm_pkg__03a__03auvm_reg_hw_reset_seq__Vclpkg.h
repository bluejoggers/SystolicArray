...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_REG_HW_RESET_SEQ__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_REG_HW_RESET_SEQ__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_reg_hw_reset_seq__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_reg_hw_reset_seq__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_reg_hw_reset_seq__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_reg_hw_reset_seq__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi45> &get_type__Vfuncrtn);
};
...
class VUVM_Activator_uvm_pkg__03a__03auvm_reg_hw_reset_seq : public VUVM_Activator_uvm_pkg__03a__03auvm_reg_sequence_ {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_hw_reset_seq"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_reg_hw_reset_seq(*this); }
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_reg_hw_reset_seq() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_reg_hw_reset_seq();
};
