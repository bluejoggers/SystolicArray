...
void VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_domains(VUVM_Register8b__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_domain>> &domains) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_domains\n"); );
    // Body
    domains = this->__PVT__m_domains;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_uvm_schedule(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> &get_uvm_schedule__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_uvm_schedule\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_domain> __Vtask_get_uvm_domain__0__Vfuncout;
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_common_domain(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_domain> &get_common_domain__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_common_domain\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> __Vtask_find__21__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> __Vtask_find__23__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> __Vtask_find__25__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> __Vtask_find__27__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> __Vtask_find__29__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> __Vtask_find__31__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> __Vtask_find__33__Vfuncout;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> __Vtask_find__35__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> __VlefCall_18__find;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_run_phase> __VlefCall_17__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_report_phase> __VlefCall_16__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_check_phase> __VlefCall_15__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_extract_phase> __VlefCall_14__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_run_phase> __VlefCall_13__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_start_of_simulation_phase> __VlefCall_12__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_end_of_elaboration_phase> __VlefCall_11__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_connect_phase> __VlefCall_10__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_build_phase> __VlefCall_9__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_final_phase> __VlefCall_8__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_report_phase> __VlefCall_7__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_check_phase> __VlefCall_6__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_extract_phase> __VlefCall_5__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_run_phase> __VlefCall_4__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_start_of_simulation_phase> __VlefCall_3__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_end_of_elaboration_phase> __VlefCall_2__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_connect_phase> __VlefCall_1__get;
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_domain> domain;
    {
        ...
        domain = VL_NEW(VUVM_Register8b_uvm_pkg__03a__03auvm_domain, vlProcess, vlSymsp, "common"s);
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_add_uvm_phases(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> schedule) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_add_uvm_phases\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_post_shutdown_phase> __VlefCall_11__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_shutdown_phase> __VlefCall_10__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_pre_shutdown_phase> __VlefCall_9__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_post_main_phase> __VlefCall_8__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_main_phase> __VlefCall_7__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_pre_main_phase> __VlefCall_6__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_post_configure_phase> __VlefCall_5__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_configure_phase> __VlefCall_4__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_pre_configure_phase> __VlefCall_3__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_post_reset_phase> __VlefCall_2__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reset_phase> __VlefCall_1__get;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_pre_reset_phase> __VlefCall_0__get;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_uvm_domain(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_domain> &get_uvm_domain__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_get_uvm_domain\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    if ((VlNull{} == this->__PVT__m_uvm_domain)) {
        this->__PVT__m_uvm_domain = VL_NEW(VUVM_Register8b_uvm_pkg__03a__03auvm_domain, vlProcess, vlSymsp, "uvm"s);
        this->__PVT__m_uvm_schedule = VL_NEW(VUVM_Register8b_uvm_pkg__03a__03auvm_phase, vlProcess, vlSymsp, "uvm_sched"s, 3U, VlNull{});
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_jump_all(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_domain__Vclpkg::__VnoInFunc_jump_all\n"); );
    // Locals
    VlAssocArray<std::string, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_domain>> __Vtask_get_domains__68__domains;
    // Body
    ...
    VlAssocArray<std::string, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_domain>> domains;
    domains.clear();
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_domain::init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name) {
    VUVM_Register8b_uvm_pkg__03a__03auvm_phase::init(vlProcess, vlSymsp, name, 4U, VlNull{});
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_domain::new\n"); );
    // Locals
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_domain__Vclpkg.__PVT__m_domains.at(name) 
        = VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_domain>{this};
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_domain::__VnoInFunc_jump(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_domain::__VnoInFunc_jump\n"); );
    // Locals
    ...
    VlQueue<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase>> phases;
    phases.clear();
    this->__VnoInFunc_m_get_transitive_children(vlSymsp, phases);
    phases = phases.find([&](IData/*31:0*/ item__DOT__index, 
                             VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_phase> item) -> 
                         CData/*31:0*/ {
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_domain::__VnoInFunc_randomize(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_domain::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_domain::__VnoInFunc___Vsetup_constraints(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_domain::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_domain::__VnoInFunc___VBasicRand(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_domain::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_domain::_ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_domain::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

VUVM_Register8b_uvm_pkg__03a__03auvm_domain::~VUVM_Register8b_uvm_pkg__03a__03auvm_domain() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_domain::~\n"); );
}
