...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_TOPDOWN_PHASE__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_TOPDOWN_PHASE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_topdown_phase__Vclpkg);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_topdown_phase : public Vuvm_pkg_uvm_pkg__03a__03auvm_phase {
  public:
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_topdown_phase() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_topdown_phase();
};
