...
void VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26::init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> parent) {
    VUVM_Register8b_uvm_pkg__03a__03auvm_port_base__Tz115::init(vlProcess, vlSymsp, name, parent, 0U, 0U, 0xffffffffU);
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26::new\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26::__VnoInFunc_get_type_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_analysis_port"s;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26::__VnoInFunc_write(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26::__VnoInFunc_write\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26::_ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26::~VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_port__Tz26::~\n"); );
}
