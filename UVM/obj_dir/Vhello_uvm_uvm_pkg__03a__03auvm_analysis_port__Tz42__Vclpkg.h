...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_ANALYSIS_PORT__TZ42__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_ANALYSIS_PORT__TZ42__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz42__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz42__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz42__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz42__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz42 : public Vhello_uvm_uvm_pkg__03a__03auvm_port_base__Tz82 {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_analysis_port__Tz42"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz42(*this); }
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz42() = default;
    ...
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_analysis_port__Tz42();
};
