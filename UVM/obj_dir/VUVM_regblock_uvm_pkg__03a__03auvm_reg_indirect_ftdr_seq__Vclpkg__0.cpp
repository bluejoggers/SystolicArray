...
void VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> addr_reg, IData/*31:0*/ idx, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg> data_reg) {
    VUVM_regblock_uvm_pkg__03a__03auvm_reg_frontdoor::init(vlProcess, vlSymsp, "uvm_reg_indirect_ftdr_seq"s);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::new\n"); );
    // Body
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc_body(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc_body\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    IData/*31:0*/ __VlefExpr_3;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> __VlefCall_2__clone;
    ...
    {
        VL_NULL_CHECK(VUVM_regblock_uvm_pkg__03a__03auvm_reg_frontdoor::__PVT__rw_info, "../../uvm/distrib/src/reg/uvm_reg_indirect.svh", 300)->__VnoInFunc_clone(vlProcess, vlSymsp, __VlefCall_0__clone);
        ...
        VL_NULL_CHECK(VUVM_regblock_uvm_pkg__03a__03auvm_reg_frontdoor::__PVT__rw_info, "../../uvm/distrib/src/reg/uvm_reg_indirect.svh", 313)->__VnoInFunc_clone(vlProcess, vlSymsp, __VlefCall_2__clone);
        ...
        if ((1U == VL_NULL_CHECK(VUVM_regblock_uvm_pkg__03a__03auvm_reg_frontdoor::__PVT__rw_info, "../../uvm/distrib/src/reg/uvm_reg_indirect.svh", 316)
             ->__PVT__kind)) {
            ...
            VL_NULL_CHECK(VUVM_regblock_uvm_pkg__03a__03auvm_reg_frontdoor::__PVT__rw_info, "../../uvm/distrib/src/reg/uvm_reg_indirect.svh", 320)->__PVT__value.atWrite(0U) 
        ...
        VL_NULL_CHECK(VUVM_regblock_uvm_pkg__03a__03auvm_reg_frontdoor::__PVT__rw_info, "../../uvm/distrib/src/reg/uvm_reg_indirect.svh", 326)->__PVT__status 
...
void VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc_randomize(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc___Vsetup_constraints(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc___Vsetup_constraints\n"); );
    // Body
    this->__VnoInFunc_pick_sequence_setup_constraint(vlSymsp);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::_ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__m_idx = 0;
}

VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::~VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq::~\n"); );
}
