...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_RECORDER__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_RECORDER__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_recorder__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__m_id;
    VlAssocArray<VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder>, IData/*31:0*/> __PVT__m_ids_by_recorder;
    VlAssocArray<IData/*31:0*/, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder>> __PVT__m_recorders_by_id;
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_recorder__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_recorder__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_recorder__Vclpkg);
    ...
    void __VnoInFunc_get_recorder_from_handle(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ id, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> &get_recorder_from_handle__Vfuncrtn);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_recorder : public VUVM_Activator_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21> __PVT__m_stream_dap;
    ...
    void __VnoInFunc_close(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ close_time);
    ...
    void __VnoInFunc_free(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ close_time);
    virtual void __VnoInFunc_free_tr(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ handle);
    void __VnoInFunc_get_close_time(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ &get_close_time__Vfuncrtn);
    void __VnoInFunc_get_handle(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_handle__Vfuncrtn);
    void __VnoInFunc_get_open_time(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ &get_open_time__Vfuncrtn);
    virtual void __VnoInFunc_get_record_attribute_handle(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_record_attribute_handle__Vfuncrtn);
    void __VnoInFunc_get_stream(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream> &get_stream__Vfuncrtn);
    ...
    void __VnoInFunc_m_do_open(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream> stream, QData/*63:0*/ open_time, std::string type_name);
    ...
    void __VnoInFunc_record_field(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix);
    void __VnoInFunc_record_field_int(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix);
    void __VnoInFunc_record_field_real(VUVM_Activator__Syms* __restrict vlSymsp, std::string name, double value);
    void __VnoInFunc_record_generic(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, std::string value, std::string type_name);
    void __VnoInFunc_record_object(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> value);
    void __VnoInFunc_record_string(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, std::string value);
    void __VnoInFunc_record_time(VUVM_Activator__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value);
    ...
    virtual void __VnoInFunc_use_record_attribute(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &use_record_attribute__Vfuncrtn);
  private:
    void _ctor_var_reset(VUVM_Activator__Syms* __restrict vlSymsp);
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_recorder() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_recorder();
};
