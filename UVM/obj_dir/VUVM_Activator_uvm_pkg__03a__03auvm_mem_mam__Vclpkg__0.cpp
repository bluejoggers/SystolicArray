...
void VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::init(VUVM_Activator__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam_cfg> cfg, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem> mem) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    this->__PVT__for_each_idx = 0xffffffffU;
    this->__PVT__cfg = cfg;
    this->__PVT__memory = mem;
    this->__PVT__default_alloc = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam_policy, vlSymsp);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reconfigure(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam_cfg> cfg, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam_cfg> &reconfigure__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reconfigure\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reserve_region(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ start_offset, IData/*31:0*/ n_bytes, std::string fname, IData/*31:0*/ lineno, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_region> &reserve_region__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_reserve_region\n"); );
    // Locals
    ...
    QData/*63:0*/ end_offset;
    {
        ...
        while (VL_LTS_III(32, unnamedblk394__DOT__i, this->__PVT__in_use.size())) {
            ...
            if ((start_offset > __VlefCall_9__get_start_offset)) {
                reserve_region__Vfuncrtn = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_mem_region, vlSymsp, start_offset, end_offset, 
                                                  ((IData)(1U) 
                                                   + 
                                                   ((IData)(end_offset) 
                                                    - (IData)(start_offset))), n_bytes, 
                                                  VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam>{this});
...
void VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_request_region(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ n_bytes, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam_policy> alloc, std::string fname, IData/*31:0*/ lineno, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_region> &request_region__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_request_region\n"); );
    // Locals
...
void VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_region(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_region> region) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_region\n"); );
    // Locals
...
void VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_all_regions(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_release_all_regions\n"); );
    // Body
    this->__PVT__in_use.clear();
}

void VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_convert2string(VUVM_Activator__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_convert2string\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_for_each(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ reset, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_region> &for_each__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_for_each\n"); );
    // Body
    {
        if (reset) {
            this->__PVT__for_each_idx = 0xffffffffU;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_get_memory(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem> &get_memory__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::__VnoInFunc_get_memory\n"); );
    // Body
    get_memory__Vfuncrtn = this->__PVT__memory;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::_ctor_var_reset(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam::_ctor_var_reset\n"); );
    // Body
