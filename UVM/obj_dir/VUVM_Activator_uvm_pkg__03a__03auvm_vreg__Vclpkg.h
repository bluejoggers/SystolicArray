...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_VREG__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_VREG__VCLPKG_H_  // guard
...
class VUVM_Activator_uvm_pkg__03a__03auvm_callback_iter__Tz97_TBz98;
...
class VUVM_Activator_uvm_pkg__03a__03auvm_vreg_cbs;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_vreg__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_vreg__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_vreg__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_vreg__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_vreg : public VUVM_Activator_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlQueue<VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field>> __PVT__fields;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem> __PVT__mem;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_region> __PVT__region;
    VlClassRef<VUVM_Activator_std__03a__03asemaphore> __PVT__atomic;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_vreg"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_vreg(*this); }
    VlCoroutine __VnoInFunc_XatomicX(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ on);
    ...
    void __VnoInFunc_add_field(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> field);
    virtual void __VnoInFunc_allocate(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ n, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam> mam, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_mam_policy> alloc, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_region> &allocate__Vfuncrtn);
    ...
    void __VnoInFunc_configure(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_block> parent, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ size, QData/*63:0*/ offset, IData/*31:0*/ incr);
    ...
    virtual void __VnoInFunc_get_address(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ idx, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_field_by_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> &get_field_by_name__Vfuncrtn);
    virtual void __VnoInFunc_get_fields(VUVM_Activator__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field>> &fields);
    ...
    virtual void __VnoInFunc_get_incr(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_incr__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_memory(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem> &get_memory__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_n_memlocs(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_memlocs__Vfuncrtn);
    virtual void __VnoInFunc_get_offset_in_memory(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ &get_offset_in_memory__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_region(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem_region> &get_region__Vfuncrtn);
    virtual void __VnoInFunc_get_rights(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_rights__Vfuncrtn);
    virtual void __VnoInFunc_get_size(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_size__Vfuncrtn);
    virtual void __VnoInFunc_implement(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ n, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ offset, IData/*31:0*/ incr, CData/*0:0*/ &implement__Vfuncrtn);
    ...
    virtual void __VnoInFunc_peek(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual void __VnoInFunc_poke(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    ...
    virtual void __VnoInFunc_release_region(VUVM_Activator__Syms* __restrict vlSymsp);
    void __VnoInFunc_reset(VUVM_Activator__Syms* __restrict vlSymsp, std::string kind);
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_vreg() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ n_bits);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_vreg();
};
