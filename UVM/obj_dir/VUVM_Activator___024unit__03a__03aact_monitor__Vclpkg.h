...
#ifndef VERILATED_VUVM_ACTIVATOR___024UNIT__03A__03AACT_MONITOR__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR___024UNIT__03A__03AACT_MONITOR__VCLPKG_H_  // guard
...
class VUVM_Activator_uvm_pkg__03a__03auvm_monitor;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator___024unit__03a__03aact_monitor__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator___024unit__03a__03aact_monitor__Vclpkg();
    ~VUVM_Activator___024unit__03a__03aact_monitor__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator___024unit__03a__03aact_monitor__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__pi13> &get_type__Vfuncrtn);
};
...
class VUVM_Activator___024unit__03a__03aact_monitor : public VUVM_Activator_uvm_pkg__03a__03auvm_monitor {
  public:

    // DESIGN SPECIFIC STATE
    VUVM_Activator_act_if* __PVT__vif;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_analysis_port__Tz61> __PVT__monitor_analysis_port;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "$unit::act_monitor"; }
    VlClass* clone() const { return new VUVM_Activator___024unit__03a__03aact_monitor(*this); }
  ...
  public:
    VUVM_Activator___024unit__03a__03aact_monitor() = default;
    ...
    virtual ~VUVM_Activator___024unit__03a__03aact_monitor();
};
