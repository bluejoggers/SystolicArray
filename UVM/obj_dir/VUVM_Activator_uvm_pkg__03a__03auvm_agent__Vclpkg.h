...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_AGENT__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_AGENT__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_agent__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_agent__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_agent__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_agent__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_agent : public VUVM_Activator_uvm_pkg__03a__03auvm_component {
  public:
    ...
    virtual void __VnoInFunc_get_is_active(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &get_is_active__Vfuncrtn);
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_agent() = default;
    ...
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_agent();
};
