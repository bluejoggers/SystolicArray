...
void Vuvm_pkg_uvm_pkg__03a__03auvm_tree_printer::init(Vuvm_pkg__Syms* __restrict vlSymsp) {
    Vuvm_pkg_uvm_pkg__03a__03auvm_printer::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_tree_printer::new\n"); );
    // Body
    this->__PVT__newline = "\n"s;
    /*super.new*/;
    VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1132)->__PVT__size = 0U;
    VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1133)->__PVT__type_name = 0U;
    VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1134)->__PVT__header = 0U;
    VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1135)->__PVT__footer = 0U;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_emit(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string &emit__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_tree_printer::__VnoInFunc_emit\n"); );
    // Body
    ...
    Vuvm_pkg_uvm_printer_row_info__struct__0 unnamedblk47__DOT__unnamedblk48__DOT__row;
    ...
    std::string linefeed;
    s = VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1144)
        ->__PVT__prefix;
    space = "                                                                                                   "s;
    user_format = ""s;
    linefeed = (((""s == this->__PVT__newline) | (" "s 
                                                  == this->__PVT__newline))
                 ? this->__PVT__newline : VL_CONCATN_NNN(this->__PVT__newline, VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1148)
                                                         ->__PVT__prefix));
    if (VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1151)
        ->__PVT__header) {
    ...
    while (VL_LTS_III(32, unnamedblk47__DOT__i, Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.size())) {
        unnamedblk47__DOT__i__Vloopsize = Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.size();
        {
            unnamedblk47__DOT__unnamedblk48__DOT__row 
                = Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.at(unnamedblk47__DOT__i);
            ...
            if ((""s == user_format)) {
                ...
                unnamedblk47__DOT__unnamedblk48__DOT__unnamedblk49__DOT__indent_str 
                    = VL_SUBSTR_N(space,1U,VL_MULS_III(32, unnamedblk47__DOT__unnamedblk48__DOT__row
                                                       .__PVT__level, VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1162)
                                                       ->__PVT__indent));
                if (VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1165)
                    ->__PVT__identifier) {
                ...
                if ((0x40U == VL_GETC_N(unnamedblk47__DOT__unnamedblk48__DOT__row
                    ...
                    s = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                      ...
                                                      .__PVT__val), ") "s);
                } else if ((VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1175)
                            ->__PVT__type_name && (
                                                   ((""s 
                                                     != unnamedblk47__DOT__unnamedblk48__DOT__row
                                                     .__PVT__type_name) 
                ...
                if (VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1182)
                    ->__PVT__size) {
                    if (((""s != unnamedblk47__DOT__unnamedblk48__DOT__row
                ...
                if (VL_LTS_III(32, unnamedblk47__DOT__i, 
                               (Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.size() 
                                - (IData)(1U)))) {
                    if (VL_GTS_III(32, Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.at(
                                                                                ((IData)(1U) 
                        ...
                        s = VL_CONCATN_NNN(VL_CONCATN_NNN(s, 
                                                          VL_CVT_PACK_STR_NI(
                                                                             VL_GETC_N(VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1189)
                ...
                if (VL_LTES_III(32, unnamedblk47__DOT__i, 
                    ...
                    unnamedblk47__DOT__unnamedblk48__DOT__unnamedblk49__DOT__unnamedblk50__DOT__end_level 
                        = ((unnamedblk47__DOT__i == 
                            (Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.size() 
                             - (IData)(1U))) ? 0U : Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.at(
                                                                                ((IData)(1U) 
                                                                                + unnamedblk47__DOT__i))
                           .__PVT__level);
                        ...
                        while (VL_GTES_III(32, unnamedblk47__DOT__unnamedblk48__DOT__unnamedblk49__DOT__unnamedblk50__DOT__unnamedblk51__DOT__unnamedblk52__DOT__l, unnamedblk47__DOT__unnamedblk48__DOT__unnamedblk49__DOT__unnamedblk50__DOT__end_level)) {
                            unnamedblk47__DOT__unnamedblk48__DOT__unnamedblk49__DOT__unnamedblk50__DOT__unnamedblk51__DOT__indent_str 
                                = VL_SUBSTR_N(space,1U,
                                              VL_MULS_III(32, unnamedblk47__DOT__unnamedblk48__DOT__unnamedblk49__DOT__unnamedblk50__DOT__unnamedblk51__DOT__unnamedblk52__DOT__l, VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1207)
                                                          ->__PVT__indent));
                            s = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                              ...
                                                              VL_CVT_PACK_STR_NI(
                                                                                VL_GETC_N(VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1208)
        ...
        if ((unnamedblk47__DOT__i__Vloopsize <= Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.size())) {
            unnamedblk47__DOT__i = ((IData)(1U) + unnamedblk47__DOT__i);
        }
    }
    if (VL_NULL_CHECK(Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1219)
        ->__PVT__footer) {
...
Vuvm_pkg_uvm_pkg__03a__03auvm_tree_printer::~Vuvm_pkg_uvm_pkg__03a__03auvm_tree_printer() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_tree_printer::~\n"); );
}
