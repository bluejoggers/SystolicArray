...
void Vhello_uvm_std__03a__03asemaphore::init(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_std__03a__03asemaphore::new\n"); );
    // Body
...
void Vhello_uvm_std__03a__03asemaphore::__VnoInFunc_put(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_std__03a__03asemaphore::__VnoInFunc_put\n"); );
    // Body
    this->__PVT__m_keyCount = (this->__PVT__m_keyCount 
                               + keyCount);
}

VlCoroutine Vhello_uvm_std__03a__03asemaphore::__VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_std__03a__03asemaphore::__VnoInFunc_get\n"); );
    // Locals
...
void Vhello_uvm_std__03a__03asemaphore::__VnoInFunc_try_get(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount, IData/*31:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_std__03a__03asemaphore::__VnoInFunc_try_get\n"); );
    // Body
    {
...
void Vhello_uvm_std__03a__03asemaphore::_ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_std__03a__03asemaphore::_ctor_var_reset\n"); );
    // Body
