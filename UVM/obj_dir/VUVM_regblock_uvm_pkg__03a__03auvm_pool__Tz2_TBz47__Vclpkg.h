...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ47__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ47__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_global(VUVM_regblock__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource_> &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47> &get_global_pool__Vfuncrtn);
};
...
class VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47 : public VUVM_regblock_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource_>> __PVT__pool;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_pool__Tz2_TBz47"; }
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47(*this); }
    virtual void __VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(VUVM_regblock__Syms* __restrict vlSymsp);
    virtual void __VnoInFunc_add(VUVM_regblock__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource_> item);
    ...
    virtual void __VnoInFunc_get(VUVM_regblock__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource_> &get__Vfuncrtn);
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz47();
};
