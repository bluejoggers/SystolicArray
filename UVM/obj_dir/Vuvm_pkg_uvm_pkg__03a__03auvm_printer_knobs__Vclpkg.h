...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_PRINTER_KNOBS__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_PRINTER_KNOBS__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_printer_knobs : public virtual VlClass {
  public:
    ...
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_printer_knobs(*this); }
    void __VnoInFunc_get_radix_str(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ radix, std::string &get_radix_str__Vfuncrtn);
    Vuvm_pkg_uvm_pkg__03a__03auvm_printer_knobs() = default;
    void init(Vuvm_pkg__Syms* __restrict vlSymsp);
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_printer_knobs() {}
};
