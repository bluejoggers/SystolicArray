...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ22__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ22__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_db__Tz22__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_db__Tz22__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_db__Tz22__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_db__Tz22__Vclpkg);
    ...
    void __VnoInFunc_get_by_type(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_> &get_by_type__Vfuncrtn);
    void __VnoInFunc_m_show_msg(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_> rsrc);
    ...
    void __VnoInFunc_set_default(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_> &set_default__Vfuncrtn);
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_db__Tz22 : public virtual VlClass {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_resource_db__Tz22"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_db__Tz22(*this); }
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_db__Tz22() = default;
    void init(Vhello_uvm_v1__Syms* __restrict vlSymsp) {}
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_db__Tz22();
};
