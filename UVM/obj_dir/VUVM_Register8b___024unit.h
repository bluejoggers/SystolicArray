...
#ifndef VERILATED_VUVM_REGISTER8B___024UNIT_H_
#define VERILATED_VUVM_REGISTER8B___024UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b___024unit final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b___024unit();
    ~VUVM_Register8b___024unit();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b___024unit);
