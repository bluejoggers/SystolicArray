...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ56__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ56__VCLPKG_H_  // guard
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__Tz86;
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz56;
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__Tz86> &get_type__Vfuncrtn);
};
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56 : public Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz56 {
  public:
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_tr_stream> __PVT__m_value;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_set_before_get_dap__Tz56"; }
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56(*this); }
    ...
    virtual void __VnoInFunc_get(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_tr_stream> &get__Vfuncrtn);
    ...
    virtual void __VnoInFunc_set(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_tr_stream> value);
    virtual void __VnoInFunc_try_get(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_tr_stream> &value, CData/*0:0*/ &try_get__Vfuncrtn);
    virtual void __VnoInFunc_try_set(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_tr_stream> value, CData/*0:0*/ &try_set__Vfuncrtn);
  private:
    void _ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp);
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56();
};
