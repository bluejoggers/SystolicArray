...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map__Vclpkg::__VnoInFunc_get_type(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi14> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi14__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, get_type__Vfuncrtn);
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map__Vclpkg::__VnoInFunc_backdoor(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> &backdoor__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map__Vclpkg::__VnoInFunc_backdoor\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    if ((VlNull{} == this->__PVT__m_backdoor)) {
        this->__PVT__m_backdoor = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map, vlProcess, vlSymsp, "Backdoor"s);
    }
    backdoor__Vfuncrtn = this->__PVT__m_backdoor;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_object_type(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi14> __Vfunc_get__0__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi14__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vfunc_get__0__Vfuncout);
    get_object_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_create(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_create\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> tmp;
    if ((""s == name)) {
        tmp = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map, vlProcess, vlSymsp, "uvm_reg_map"s);
    } else {
        tmp = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map, vlProcess, vlSymsp, name);
    }
    create__Vfuncrtn = tmp;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_type_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_map"s;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc____05Fm_uvm_field_automation(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> tmp_data___05F, IData/*31:0*/ what___05F, std::string str___05F) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc____05Fm_uvm_field_automation\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_1;
    CData/*0:0*/ __VlefCall_0__m_do_cycle_check;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk1__DOT__local_data___05F;
    {
        if ((((0x00020006U == what___05F) | (0x00020008U 
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_object__Vclpkg.__PVT_____05Fm_uvm_status_container, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 70)->__VnoInFunc_m_do_cycle_check(vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, __VlefCall_0__m_do_cycle_check);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_auto_predict(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ on) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_auto_predict\n"); );
    // Body
    this->__PVT__m_auto_predict = on;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_auto_predict(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ &get_auto_predict__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_auto_predict\n"); );
    // Body
    get_auto_predict__Vfuncrtn = this->__PVT__m_auto_predict;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_check_on_read(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ on) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_check_on_read\n"); );
    // Body
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk2__DOT__submap;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk2__DOT__submap__Vnext;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_check_on_read(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ &get_check_on_read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_check_on_read\n"); );
    // Body
    get_check_on_read__Vfuncrtn = this->__PVT__m_check_on_read;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_transaction_order_policy(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_transaction_order_policy> pol) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_transaction_order_policy\n"); );
    // Body
    this->__PVT__policy = pol;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_transaction_order_policy(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_transaction_order_policy> &get_transaction_order_policy__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_transaction_order_policy\n"); );
    // Body
    get_transaction_order_policy__Vfuncrtn = this->__PVT__policy;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name) {
    Vuvm_pkg_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, 
                                               VL_CVT_PACK_STR_NN(
                                                                  ((""s 
                                                                    == name)
                                                                    ? "default_map"s
                                                                    : name)));
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_configure(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> parent, QData/*63:0*/ base_addr, IData/*31:0*/ n_bytes, IData/*31:0*/ endian, CData/*0:0*/ byte_addressing) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_configure\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_add_reg(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> rg, QData/*63:0*/ offset, std::string rights, CData/*0:0*/ unmapped, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_frontdoor> frontdoor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_add_reg\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__20__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__21__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> __VlefCall_4__get_parent;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> __VlefCall_3__get_parent;
    std::string __VlefCall_2__get_name;
    std::string __VlefCall_1__get_name;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> unnamedblk488__DOT__info;
    {
        ...
        VL_NULL_CHECK(rg, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 727)->__VnoInFunc_add_map(vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this});
        unnamedblk488__DOT__info = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info, vlSymsp);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_m_set_reg_offset(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> rg, QData/*63:0*/ offset, CData/*0:0*/ unmapped) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_m_set_reg_offset\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__38__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__39__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__57__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__58__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__75__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__76__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> __Vtemp_1;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> unnamedblk489__DOT__info;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> unnamedblk489__DOT__blk;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk489__DOT__top_map;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk489__DOT__unnamedblk491__DOT__unnamedblk492__DOT__unnamedblk493__DOT__unnamedblk494__DOT__rg2;
    ...
    std::string unnamedblk489__DOT__unnamedblk491__DOT__unnamedblk492__DOT__unnamedblk493__DOT__unnamedblk496__DOT__unnamedblk497__DOT__a;
    {
        if ((! this->__PVT__m_regs_info.exists(rg))) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__33__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if (__VlefCall_3__is_locked) {
            ...
            if ((1U & (~ (IData)(unmapped)))) {
                VL_NULL_CHECK(rg, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 788)->__VnoInFunc_Xget_fields_accessX(vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, unnamedblk489__DOT__unnamedblk491__DOT__rg_acc);
                ...
                while (VL_LTS_III(32, unnamedblk489__DOT__unnamedblk491__DOT__unnamedblk492__DOT__i, unnamedblk489__DOT__addrs.size())) {
                    ...
                    if (VL_NULL_CHECK(unnamedblk489__DOT__top_map, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 796)
                        ...
                        VL_NULL_CHECK(unnamedblk489__DOT__unnamedblk491__DOT__unnamedblk492__DOT__unnamedblk493__DOT__unnamedblk494__DOT__rg2, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 799)->__VnoInFunc_Xget_fields_accessX(vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, unnamedblk489__DOT__unnamedblk491__DOT__unnamedblk492__DOT__unnamedblk493__DOT__unnamedblk494__DOT__rg2_acc);
                        if ((("RO"s == unnamedblk489__DOT__unnamedblk491__DOT__rg_acc) 
                            ...
                            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__58__Vfuncout);
                            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
                    ...
                    while (unnamedblk489__DOT__unnamedblk491__DOT__unnamedblk492__DOT__unnamedblk493__DOT__unnamedblk496__DOT__range__Vmore) {
                        ...
                        if (((unnamedblk489__DOT__addrs.at(unnamedblk489__DOT__unnamedblk491__DOT__unnamedblk492__DOT__i) 
                            ...
                            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__69__Vfuncout);
                            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_add_mem(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ offset, std::string rights, CData/*0:0*/ unmapped, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_frontdoor> frontdoor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_add_mem\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__85__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__86__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__91__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__92__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__97__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__98__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_7__get_full_name;
    ...
    std::string __VlefCall_1__get_name;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> unnamedblk498__DOT__info;
    {
        ...
        if ((__VlefCall_3__get_parent != __VlefCall_4__get_parent)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__92__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        VL_NULL_CHECK(mem, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 872)->__VnoInFunc_add_map(vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this});
        unnamedblk498__DOT__info = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info, vlSymsp);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_m_set_mem_offset(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ offset, CData/*0:0*/ unmapped) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_m_set_mem_offset\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__103__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__104__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__109__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__110__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__122__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__123__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__129__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__130__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__133__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__134__Vfuncout;
    ...
    std::string __VlefCall_1__get_full_name;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> unnamedblk499__DOT__info;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> unnamedblk499__DOT__blk;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk499__DOT__top_map;
    ...
    VlWide<5>/*159:0*/ unnamedblk499__DOT__unnamedblk501__DOT__unnamedblk506__DOT__range;
    {
        if ((! this->__PVT__m_mems_info.exists(mem))) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__104__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_add_submap(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> child_map, QData/*63:0*/ offset) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_add_submap\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__144__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__145__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__149__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__150__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__154__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__155__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__161__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__162__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__166__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__167__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__171__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__172__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__178__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__179__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__186__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__187__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__198__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__199__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> __VlefCall_9__get_parent;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> __VlefCall_8__get_parent;
    std::string __VlefCall_7__get_full_name;
    IData/*31:0*/ __VlefCall_6__uvm_report_enabled;
    ...
    std::string __VlefCall_1__get_full_name;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> parent_block_check__DOT__child_blk;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> parent_map;
    {
        if ((VlNull{} == child_map)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__145__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if ((VlNull{} != parent_map)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__155__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if ((VlNull{} == parent_block_check__DOT__child_blk)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__167__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if ((VlNull{} == parent_block_check__DOT__child_blk)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__179__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if ((this->__PVT__m_n_bytes > __VlefCall_16__get_n_bytes)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__192__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        VL_NULL_CHECK(child_map, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 1038)->__VnoInFunc_add_parent_map(vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, offset);
        this->__VnoInFunc_set_submap_offset(vlSymsp, child_map, offset);
        __Vlabel0: ;
    }
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_reset(Vuvm_pkg__Syms* __restrict vlSymsp, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_reset\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_add_parent_map(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> parent_map, QData/*63:0*/ offset) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_add_parent_map\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__206__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__207__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__211__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__212__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__215__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__216__Vfuncout;
    ...
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    {
        if ((VlNull{} == parent_map)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__207__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if ((VlNull{} != this->__PVT__m_parent_map)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__216__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
            ...
            if ((0U != __VlefCall_2__uvm_report_enabled)) {
                ...
                VL_NULL_CHECK(this->__PVT__m_parent_map, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 1072)->__VnoInFunc_get_submap_offset(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, __VlefCall_5__get_submap_offset);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_sequencer(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base> sequencer, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_adapter> adapter) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_sequencer\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__226__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__227__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__234__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__235__Vfuncout;
    ...
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    {
        if ((VlNull{} == sequencer)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__227__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if ((VlNull{} == adapter)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__235__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
            ...
            if ((0U != __VlefCall_1__uvm_report_enabled)) {
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__241__Vfuncout);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_parent(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> &get_parent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_parent\n"); );
    // Body
    get_parent__Vfuncrtn = this->__PVT__m_parent;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_parent_map(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> &get_parent_map__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_parent_map\n"); );
    // Body
    get_parent_map__Vfuncrtn = this->__PVT__m_parent_map;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_root_map(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> &get_root_map__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_root_map\n"); );
    // Body
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> __VlefCond_1;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> __VlefCall_0__get_root_map;
    if ((VlNull{} == this->__PVT__m_parent_map)) {
        __VlefCond_1 = VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this};
    } else {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_base_addr(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ hier, QData/*63:0*/ &get_base_addr__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_base_addr\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    QData/*63:0*/ __VlefCall_0__get_base_addr;
    {
        ...
        VL_NULL_CHECK(this->__PVT__m_parent_map, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 1136)->__VnoInFunc_get_submap_offset(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, get_base_addr__Vfuncrtn);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_n_bytes(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ hier, IData/*31:0*/ &get_n_bytes__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_n_bytes\n"); );
    // Body
    {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_addr_unit_bytes(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_addr_unit_bytes__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_addr_unit_bytes\n"); );
    // Body
    get_addr_unit_bytes__Vfuncrtn = ((IData)(this->__PVT__m_byte_addressing)
                                      ? 1U : this->__PVT__m_n_bytes);
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_endian(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ hier, IData/*31:0*/ &get_endian__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_endian\n"); );
    // Body
    {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_sequencer(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ hier, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base> &get_sequencer__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_sequencer\n"); );
    // Body
    {
        if (((0U == hier) | (VlNull{} == this->__PVT__m_parent_map))) {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_adapter(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ hier, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_adapter> &get_adapter__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_adapter\n"); );
    // Body
    {
        if (((0U == hier) | (VlNull{} == this->__PVT__m_parent_map))) {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_submaps(Vuvm_pkg__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>> &maps, IData/*31:0*/ hier) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_submaps\n"); );
    // Body
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk508__DOT__submap;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk508__DOT__submap__Vnext;
    CData/*0:0*/ unnamedblk508__DOT__submap__Vmore;
    unnamedblk508__DOT__submap__Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk509__DOT__submap_;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk509__DOT__submap___Vnext;
    CData/*0:0*/ unnamedblk509__DOT__submap___Vmore;
    unnamedblk509__DOT__submap___Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk509__DOT__unnamedblk510__DOT__submap;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_registers(Vuvm_pkg__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg>> &regs, IData/*31:0*/ hier) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_registers\n"); );
    // Body
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk511__DOT__rg;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk511__DOT__rg__Vnext;
    CData/*0:0*/ unnamedblk511__DOT__rg__Vmore;
    unnamedblk511__DOT__rg__Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk512__DOT__submap_;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk512__DOT__submap___Vnext;
    CData/*0:0*/ unnamedblk512__DOT__submap___Vmore;
    unnamedblk512__DOT__submap___Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk512__DOT__unnamedblk513__DOT__submap;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_fields(Vuvm_pkg__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_field>> &fields, IData/*31:0*/ hier) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_fields\n"); );
    // Body
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk514__DOT__rg_;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk514__DOT__rg___Vnext;
    CData/*0:0*/ unnamedblk514__DOT__rg___Vmore;
    unnamedblk514__DOT__rg___Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk514__DOT__unnamedblk515__DOT__rg;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk516__DOT__submap_;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk516__DOT__submap___Vnext;
    CData/*0:0*/ unnamedblk516__DOT__submap___Vmore;
    unnamedblk516__DOT__submap___Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk516__DOT__unnamedblk517__DOT__submap;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_memories(Vuvm_pkg__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem>> &mems, IData/*31:0*/ hier) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_memories\n"); );
    // Body
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> unnamedblk518__DOT__mem;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> unnamedblk518__DOT__mem__Vnext;
    CData/*0:0*/ unnamedblk518__DOT__mem__Vmore;
    unnamedblk518__DOT__mem__Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk519__DOT__submap_;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk519__DOT__submap___Vnext;
    CData/*0:0*/ unnamedblk519__DOT__submap___Vmore;
    unnamedblk519__DOT__submap___Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk519__DOT__unnamedblk520__DOT__submap;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_virtual_registers(Vuvm_pkg__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg>> &regs, IData/*31:0*/ hier) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_virtual_registers\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_virtual_fields(Vuvm_pkg__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field>> &fields, IData/*31:0*/ hier) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_virtual_fields\n"); );
    // Body
    ...
    VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg>> regs;
    regs.clear();
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_full_name\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_mem_map_info(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> mem, CData/*0:0*/ error, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> &get_mem_map_info__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_mem_map_info\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__261__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__262__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__267__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__268__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_2__get_name;
    std::string __VlefCall_1__get_name;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_reg_map_info(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> rg, CData/*0:0*/ error, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> &get_reg_map_info__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_reg_map_info\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__271__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__272__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__277__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__278__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__286__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__287__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    std::string __VlefCall_1__get_name;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> result;
    {
        if ((! this->__PVT__m_regs_info.exists(rg))) {
            if (error) {
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__272__Vfuncout);
                vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_base_addr(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ offset) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_base_addr\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_locked;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk523__DOT__top_map;
    if ((VlNull{} != this->__PVT__m_parent_map)) {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_size(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_size\n"); );
    // Body
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk524__DOT__rg_;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk524__DOT__rg___Vnext;
    CData/*0:0*/ unnamedblk524__DOT__rg___Vmore;
    unnamedblk524__DOT__rg___Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk524__DOT__unnamedblk525__DOT__rg;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> unnamedblk526__DOT__mem_;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> unnamedblk526__DOT__mem___Vnext;
    CData/*0:0*/ unnamedblk526__DOT__mem___Vmore;
    unnamedblk526__DOT__mem___Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> unnamedblk526__DOT__unnamedblk527__DOT__mem;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk528__DOT__submap_;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk528__DOT__submap___Vnext;
    CData/*0:0*/ unnamedblk528__DOT__submap___Vmore;
    unnamedblk528__DOT__submap___Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk528__DOT__unnamedblk529__DOT__submap;
    IData/*31:0*/ max_addr;
    IData/*31:0*/ addr;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_Xverify_map_configX(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_Xverify_map_configX\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__300__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__301__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__305__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__306__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__315__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__316__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__319__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__320__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__323__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__324__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_6__uvm_report_enabled;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base> __VlefCall_3__get_sequencer;
    std::string __VlefCall_2__get_full_name;
    IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_adapter> __VlefCall_0__get_adapter;
    CData/*0:0*/ error;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> root_map;
    error = 0U;
    ...
    if ((VlNull{} == __VlefCall_0__get_adapter)) {
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__301__Vfuncout);
        vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
    ...
    if (error) {
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__320__Vfuncout);
        vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_physical_addresses(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ base_addr, QData/*63:0*/ mem_offset, IData/*31:0*/ n_bytes, VlQueue<QData/*63:0*/> &addr, IData/*31:0*/ &get_physical_addresses__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_physical_addresses\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__332__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__333__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__337__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__338__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__342__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__343__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> up_map;
    ...
    IData/*31:0*/ multiplier;
    {
        ...
        if ((n_bytes <= bus_width)) {
            ...
            if ((1U == __VlefCall_1__get_endian)) {
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__338__Vfuncout);
                vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if ((VlNull{} == up_map)) {
            ...
            VL_NULL_CHECK(up_map, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 1482)->__VnoInFunc_get_submap_offset(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, unnamedblk536__DOT__base_addr);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_submap_offset(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> submap, QData/*63:0*/ offset) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_set_submap_offset\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__351__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__352__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__355__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__356__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_1__is_locked;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk540__DOT__root_map;
    {
        if ((VlNull{} == submap)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__352__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_submap_offset(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> submap, QData/*63:0*/ &get_submap_offset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_submap_offset\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__362__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__363__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__366__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__367__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__370__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__371__Vfuncout;
    ...
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    {
        ...
        if ((VlNull{} == submap)) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__363__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if ((! this->__PVT__m_submaps.exists(submap))) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__371__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_reg_by_offset(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ offset, CData/*0:0*/ read, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> &get_reg_by_offset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_reg_by_offset\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__381__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__382__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__386__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__387__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_2__get_full_name;
    ...
    CData/*0:0*/ __VlefCall_0__is_locked;
    {
        ...
        if ((1U & (~ (IData)(__VlefCall_0__is_locked)))) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__382__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_mem_by_offset(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> &get_mem_by_offset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_get_mem_by_offset\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__396__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__397__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_2__get_full_name;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_Xinit_address_mapX(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_Xinit_address_mapX\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__410__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__411__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__417__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__418__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__421__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__422__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__428__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__429__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__438__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__439__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__445__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__446__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__449__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__450__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__456__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__457__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_20__get_full_name;
    ...
    IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
    IData/*31:0*/ __VlefCall_0__get_n_bytes;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk542__DOT__l;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk542__DOT__l__Vnext;
    CData/*0:0*/ unnamedblk542__DOT__l__Vmore;
    unnamedblk542__DOT__l__Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> unnamedblk542__DOT__unnamedblk543__DOT__map;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk544__DOT__rg_;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk544__DOT__rg___Vnext;
    CData/*0:0*/ unnamedblk544__DOT__rg___Vmore;
    unnamedblk544__DOT__rg___Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk544__DOT__unnamedblk545__DOT__rg;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk544__DOT__unnamedblk545__DOT__unnamedblk546__DOT__unnamedblk547__DOT__unnamedblk548__DOT__unnamedblk549__DOT__rg2;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> unnamedblk553__DOT__mem_;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> unnamedblk553__DOT__mem___Vnext;
    CData/*0:0*/ unnamedblk553__DOT__mem___Vmore;
    unnamedblk553__DOT__mem___Vmore = 0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> unnamedblk553__DOT__unnamedblk554__DOT__mem;
    ...
    IData/*31:0*/ bus_width;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> top_map;
    bus_width = 0U;
    this->__VnoInFunc_get_root_map(vlSymsp, top_map);
    if ((VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this} 
         == top_map)) {
    ...
    while (unnamedblk544__DOT__rg___Vmore) {
        ...
        if ((1U & (~ VL_NULL_CHECK(this->__PVT__m_regs_info
            ...
            VL_NULL_CHECK(unnamedblk544__DOT__unnamedblk545__DOT__rg, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 1602)->__VnoInFunc_Xget_fields_accessX(vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, unnamedblk544__DOT__unnamedblk545__DOT__unnamedblk546__DOT__rg_acc);
            ...
            while (VL_LTS_III(32, unnamedblk544__DOT__unnamedblk545__DOT__unnamedblk546__DOT__unnamedblk547__DOT__i, unnamedblk544__DOT__unnamedblk545__DOT__unnamedblk546__DOT__addrs.size())) {
                ...
                if (VL_NULL_CHECK(top_map, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 1610)
                    ...
                    VL_NULL_CHECK(unnamedblk544__DOT__unnamedblk545__DOT__unnamedblk546__DOT__unnamedblk547__DOT__unnamedblk548__DOT__unnamedblk549__DOT__rg2, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 1613)->__VnoInFunc_Xget_fields_accessX(vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, unnamedblk544__DOT__unnamedblk545__DOT__unnamedblk546__DOT__unnamedblk547__DOT__unnamedblk548__DOT__unnamedblk549__DOT__rg2_acc);
                    if ((("RO"s == unnamedblk544__DOT__unnamedblk545__DOT__unnamedblk546__DOT__rg_acc) 
                        ...
                        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__411__Vfuncout);
                        vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
                ...
                while (unnamedblk544__DOT__unnamedblk545__DOT__unnamedblk546__DOT__unnamedblk547__DOT__unnamedblk548__DOT__unnamedblk551__DOT__range__Vmore) {
                    ...
                    if (((unnamedblk544__DOT__unnamedblk545__DOT__unnamedblk546__DOT__unnamedblk547__DOT__unnamedblk548__DOT__addr 
                        ...
                        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__422__Vfuncout);
                        vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if ((1U & (~ VL_NULL_CHECK(this->__PVT__m_mems_info
            ...
            while (unnamedblk553__DOT__unnamedblk554__DOT__unnamedblk555__DOT__unnamedblk556__DOT__reg_addr__Vmore) {
                ...
                if (((unnamedblk553__DOT__unnamedblk554__DOT__unnamedblk555__DOT__unnamedblk556__DOT__reg_addr 
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__439__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
            ...
            while (unnamedblk553__DOT__unnamedblk554__DOT__unnamedblk555__DOT__unnamedblk558__DOT__range__Vmore) {
                ...
                if (((((unnamedblk553__DOT__unnamedblk554__DOT__unnamedblk555__DOT__min 
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__450__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_Xget_bus_infoX(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> &map_info, IData/*31:0*/ &size, IData/*31:0*/ &lsb, IData/*31:0*/ &addr_skip) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_Xget_bus_infoX\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__460__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__461__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__465__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__466__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__471__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__472__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__476__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__477__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__482__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__483__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__487__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__488__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> __VlefCall_12__get_parent;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> unnamedblk561__DOT__mem;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg> unnamedblk562__DOT__rg;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_field> unnamedblk563__DOT__field;
    size = 0U;
    lsb = 0U;
    addr_skip = 0U;
    if ((2U == VL_NULL_CHECK(rw, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 1722)
        ...
        if (__VlefLogOr_1) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__461__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if (__VlefLogOr_5) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__472__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
        ...
        if (__VlefLogOr_9) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__483__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
...
VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_write(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_write\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> __VlefCall_1__new;
    IData/*31:0*/ __VlefExpr_0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> unnamedblk564__DOT__o;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> unnamedblk564__DOT__seq;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> tmp_parent_seq;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> system_map;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_adapter> adapter;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base> sequencer;
    ...
    if ((VlNull{} == VL_NULL_CHECK(rw, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 1772)
         ->__PVT__parent)) {
        __VlefCall_1__new = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base, vlProcess, vlSymsp, "default_parent_seq"s);
...
VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_read(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_read\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> __VlefCall_1__new;
    IData/*31:0*/ __VlefExpr_0;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> unnamedblk565__DOT__o;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> unnamedblk565__DOT__seq;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> tmp_parent_seq;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> system_map;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_adapter> adapter;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base> sequencer;
...
VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_bus_write(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base> sequencer, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_adapter> adapter) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_bus_write\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> __Vtask_Xget_bus_infoX__521__map_info;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__524__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__525__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__530__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__531__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> __Vtask_reg2bus__535__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__538__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__539__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__543__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__544__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> __Vtask_get_base_response__551__response;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__557__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__558__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__563__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__564__Vfuncout;
    ...
    Vuvm_pkg_uvm_reg_bus_op__struct__0 unnamedblk567__DOT__foreach_value__DOT__unnamedblk570__DOT__foreach_addr__DOT__rw_access;
    ...
    Vuvm_pkg_uvm_reg_bus_op__struct__0 unnamedblk567__DOT__foreach_value__DOT__unnamedblk572__DOT__unnamedblk573__DOT__rw_access;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> unnamedblk567__DOT__foreach_value__DOT__unnamedblk572__DOT__unnamedblk573__DOT__bus_req;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> unnamedblk567__DOT__foreach_value__DOT__unnamedblk572__DOT__unnamedblk573__DOT__unnamedblk574__DOT__bus_rsp;
    ...
    IData/*31:0*/ bus_width;
    CData/*7:0*/ byte_en;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> map_info;
    IData/*31:0*/ n_bits;
    IData/*31:0*/ lsb;
    IData/*31:0*/ skip;
    ...
    VlQueue<Vuvm_pkg_uvm_reg_bus_op__struct__0> accesses;
    addrs.clear();
    addrs.atDefault() = 0;
    this->__VnoInFunc_get_root_map(vlSymsp, system_map);
    ...
    while (VL_LTS_III(32, unnamedblk567__DOT__val_idx, VL_NULL_CHECK(rw, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 1860)
        ...
        while (VL_LTS_III(32, unnamedblk567__DOT__foreach_value__DOT__unnamedblk570__DOT__i, addrs.size())) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__525__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
            ...
            if ((0U != __VlefCall_1__uvm_report_enabled)) {
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__531__Vfuncout);
                vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__top 
        ...
        }
        {
            ...
            while (VL_LTS_III(32, unnamedblk567__DOT__foreach_value__DOT__unnamedblk572__DOT__i, accesses.size())) {
                ...
                if ((VlNull{} == unnamedblk567__DOT__foreach_value__DOT__unnamedblk572__DOT__unnamedblk573__DOT__bus_req)) {
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__539__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__558__Vfuncout);
                vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
                ...
                if ((0U != __VlefCall_7__uvm_report_enabled)) {
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__564__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__top 
...
VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_bus_read(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base> sequencer, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_adapter> adapter) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_bus_read\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map_info> __Vtask_Xget_bus_infoX__568__map_info;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__571__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__572__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> __Vtask_reg2bus__582__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__585__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__586__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__590__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__591__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> __Vtask_get_base_response__598__response;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__603__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__604__Vfuncout;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__609__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__610__Vfuncout;
    std::string __Vtemp_2;
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    ...
    Vuvm_pkg_uvm_reg_bus_op__struct__0 unnamedblk577__DOT__foreach_value__DOT__unnamedblk580__DOT__unnamedblk581__DOT__rw_access;
    ...
    Vuvm_pkg_uvm_reg_bus_op__struct__0 unnamedblk577__DOT__foreach_value__DOT__unnamedblk583__DOT__unnamedblk584__DOT__rw_access;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> unnamedblk577__DOT__foreach_value__DOT__unnamedblk583__DOT__unnamedblk584__DOT__bus_req;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_item> unnamedblk577__DOT__foreach_value__DOT__unnamedblk583__DOT__unnamedblk584__DOT__unnamedblk585__DOT__bus_rsp;
    ...
    while (VL_LTS_III(32, unnamedblk577__DOT__val_idx, VL_NULL_CHECK(rw, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 2004)
        ...
        while (VL_LTS_III(32, unnamedblk577__DOT__foreach_value__DOT__unnamedblk580__DOT__i, addrs.size())) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__572__Vfuncout);
            vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
            ...
            if ((0U != __VlefCall_1__uvm_report_enabled)) {
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__578__Vfuncout);
                vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__top 
        ...
        }
        {
            ...
            while (VL_LTS_III(32, unnamedblk577__DOT__foreach_value__DOT__unnamedblk583__DOT__i, accesses.size())) {
                ...
                if ((VlNull{} == unnamedblk577__DOT__foreach_value__DOT__unnamedblk583__DOT__unnamedblk584__DOT__bus_req)) {
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__586__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
                ...
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__604__Vfuncout);
                vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__top 
                ...
                if ((0U != __VlefCall_7__uvm_report_enabled)) {
                    ...
                    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__610__Vfuncout);
                    vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__top 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_print(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_print\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg>> regs;
    VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg>> vregs;
    VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem>> mems;
    IData/*31:0*/ endian;
    VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>> maps;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base> sqr;
    regs.clear();
    vregs.clear();
    mems.clear();
    endian = 0U;
    ...
    VL_NULL_CHECK(printer, "../../uvm/distrib/src/reg/uvm_reg_map.svh", 2149)->__VnoInFunc_print_generic(vlSymsp, "endian"s, ""s, 0xfffffffeU, 
                                                                                VL_CVT_PACK_STR_NN(Vuvm_pkg___024unit::__Venumtab_enum_name79
                                                                                [
                                                                                (7U 
                                                                                & endian)]), 0x2eU);
    if ((VlNull{} != sqr)) {
    ...
    while (VL_LTS_III(32, unnamedblk587__DOT__j, regs.size())) {
        ...
        VL_NULL_CHECK(regs.at(unnamedblk587__DOT__j), "../../uvm/distrib/src/reg/uvm_reg_map.svh", 2155)->__VnoInFunc_get_address(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, __VlefCall_5__get_address);
    ...
    while (VL_LTS_III(32, unnamedblk588__DOT__j, mems.size())) {
        ...
        VL_NULL_CHECK(mems.at(unnamedblk588__DOT__j), "../../uvm/distrib/src/reg/uvm_reg_map.svh", 2160)->__VnoInFunc_get_address(vlProcess, vlSymsp, 0ULL, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, __VlefCall_9__get_address);
    ...
    while (VL_LTS_III(32, unnamedblk589__DOT__j, vregs.size())) {
        ...
        VL_NULL_CHECK(vregs.at(unnamedblk589__DOT__j), "../../uvm/distrib/src/reg/uvm_reg_map.svh", 2164)->__VnoInFunc_get_address(vlProcess, vlSymsp, 0ULL, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map>{this}, __VlefCall_13__get_address);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_convert2string\n"); );
    // Locals
    ...
    __Vtemp_1 = Vuvm_pkg___024unit::__Venumtab_enum_name79
        [(7U & endian)];
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_clone(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_clone\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    clone__Vfuncrtn = VlNull{};
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_do_copy\n"); );
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_randomize(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc_randomize\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc___Vsetup_constraints(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc___VBasicRand(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::_ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::_ctor_var_reset\n"); );
    // Body
...
Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::~Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map::~\n"); );
}
