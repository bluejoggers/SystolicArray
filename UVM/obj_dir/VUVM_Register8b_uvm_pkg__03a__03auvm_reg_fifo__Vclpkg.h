...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_REG_FIFO__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_REG_FIFO__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_reg_fifo;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_reg_fifo__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_reg_fifo__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_reg_fifo__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_reg_fifo__Vclpkg);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_reg_fifo : public VUVM_Register8b_uvm_pkg__03a__03auvm_reg {
  public:
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_field> __PVT__value;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_fifo"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_reg_fifo(*this); }
    ...
    void __VnoInFunc_capacity(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &capacity__Vfuncrtn);
    ...
    void __VnoInFunc_valid_fifo_size_resize_constrained_array(VUVM_Register8b__Syms* __restrict vlSymsp);
    void __VnoInFunc_valid_fifo_size_setup_constraint(VUVM_Register8b__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp);
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_reg_fifo() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ size, IData/*31:0*/ n_bits, IData/*31:0*/ has_cover);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_reg_fifo();
};
