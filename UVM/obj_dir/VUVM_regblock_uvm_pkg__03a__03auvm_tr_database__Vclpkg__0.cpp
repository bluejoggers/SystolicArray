...
void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name) {
    VUVM_regblock_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::new\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_db(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &open_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_db\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_close_db(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &close_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_close_db\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_is_open(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &is_open__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_is_open\n"); );
    // Body
    is_open__Vfuncrtn = this->__PVT__m_is_opened;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_stream(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, std::string scope, std::string type_name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_stream> &open_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_stream\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__open_db;
    VlClassRef<VUVM_regblock_std__03a__03aprocess> unnamedblk1__DOT__p;
    ...
    if (__VlefCall_0__open_db) {
        ...
        if ((VlNull{} != open_stream__Vfuncrtn)) {
            ...
            VL_NULL_CHECK(open_stream__Vfuncrtn, "../../uvm/distrib/src/base/uvm_tr_database.svh", 157)->__VnoInFunc_m_do_open(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_database>{this}, scope, type_name);
        }
        if ((VlNull{} != unnamedblk1__DOT__p)) {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_m_free_stream(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_stream> stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_m_free_stream\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_get_streams(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_stream>> &q, CData/*0:0*/ &get_streams__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_get_streams\n"); );
    // Body
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_stream> unnamedblk2__DOT__idx;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_stream> unnamedblk2__DOT__idx__Vnext;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_establish_link(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_link_base> link) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_establish_link\n"); );
    // Locals
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_database> __VlefCall_17__get_db;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_database> __VlefCall_12__get_db;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_stream> s_lhs;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_stream> s_rhs;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_recorder> r_lhs;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_recorder> r_rhs;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> lhs;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> rhs;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_database> db;
    {
        ...
        if (__VlefLogAnd_13) {
            ...
            __VlefLogAnd_13 = (__VlefCall_12__get_db 
                               != VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_database>{this});
        }
        if (__VlefLogAnd_13) {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_db(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &do_open_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_db\n"); );
    // Body
    do_open_db__Vfuncrtn = 0U;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_close_db(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &do_close_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_close_db\n"); );
    // Body
    do_close_db__Vfuncrtn = 0U;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_stream(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, std::string scope, std::string type_name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_stream> &do_open_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_stream\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
}

void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_establish_link(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_link_base> link) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_establish_link\n"); );
}

void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_randomize(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc___Vsetup_constraints(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::_ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::_ctor_var_reset\n"); );
    // Body
...
VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::~VUVM_regblock_uvm_pkg__03a__03auvm_tr_database() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_tr_database::~\n"); );
}
