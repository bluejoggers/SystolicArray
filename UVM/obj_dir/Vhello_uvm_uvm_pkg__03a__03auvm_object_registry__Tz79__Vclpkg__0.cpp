...
void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    ...
    if ((VlNull{} == this->__PVT__me)) {
        ...
        this->__PVT__me = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79, vlSymsp);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79__Vclpkg::__VnoInFunc_create(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79> __VlefCall_0__get;
        ...
        unnamedblk2__DOT__msg = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                              VL_CONCATN_NNN(
                                                                             VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN("Factory did not return an object of type '<unknown>'. A component of type '"s, __VlefCall_2__get_type_name), "' was returned instead. Name="s), name), " Parent="s), __VlefCall_3__get_type_name), " contxt="s), contxt);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79__Vclpkg::__VnoInFunc_set_type_override(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79__Vclpkg::__VnoInFunc_set_inst_override(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79> __VlefCall_1__get;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79::__VnoInFunc_create_object(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> &create_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79::__VnoInFunc_create_object\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40> obj;
    if ((""s == name)) {
        obj = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40, vlProcess, vlSymsp, "unnamed-uvm_get_to_lock_dap#(T)"s);
    } else {
        obj = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40, vlProcess, vlSymsp, name);
    }
    create_object__Vfuncrtn = obj;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79::__VnoInFunc_get_type_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "<unknown>"s;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79::init(Vhello_uvm__Syms* __restrict vlSymsp) {
    Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79::new\n"); );
    // Body
    /*super.new*/;
}

Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79::~Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__Tz79::~\n"); );
}
