...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_type_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_default_report_server"s;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name) {
    Vhello_uvm_uvm_pkg__03a__03auvm_report_server::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::new\n"); );
    // Body
        ...
        __Vinline_0___VnoInFunc_reset_severity_counts_s = 0U;
        {
            while (true) {
                ...
                __Vinline_0___VnoInFunc_reset_severity_counts_s 
                    = Vhello_uvm___024unit::__Venumtab_enum_next21
                    [__Vinline_0___VnoInFunc_reset_severity_counts_s];
            }
            __Vlabel0: ;
        }
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_do_print(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_do_print\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_max_quit_count(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_max_quit_count__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_max_quit_count\n"); );
    // Body
    get_max_quit_count__Vfuncrtn = this->__PVT__m_max_quit_count;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_max_quit_count(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ count, CData/*0:0*/ overridable) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_max_quit_count\n"); );
    // Locals
    ...
    VlProcess::currentp(vlProcess.get());
    {
        if ((1U & (~ (IData)(this->__PVT__max_quit_overridable)))) {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__19__Vfuncout);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_quit_count(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_quit_count__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_quit_count\n"); );
    // Body
    get_quit_count__Vfuncrtn = this->__PVT__m_quit_count;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_quit_count(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ quit_count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_quit_count\n"); );
    // Body
    this->__PVT__m_quit_count = (VL_GTS_III(32, 0U, quit_count)
                                  ? 0U : quit_count);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_quit_count(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_quit_count\n"); );
    // Body
    this->__PVT__m_quit_count = ((IData)(1U) + this->__PVT__m_quit_count);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_quit_count(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_quit_count\n"); );
    // Body
    this->__PVT__m_quit_count = 0U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_is_quit_count_reached(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &is_quit_count_reached__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_is_quit_count_reached\n"); );
    // Body
    is_quit_count_reached__Vfuncrtn = VL_GTES_III(32, this->__PVT__m_quit_count, this->__PVT__m_max_quit_count);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_severity_count(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, IData/*31:0*/ &get_severity_count__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_severity_count\n"); );
    // Body
    get_severity_count__Vfuncrtn = this->__PVT__m_severity_count
        .at((IData)(severity));
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_severity_count(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, IData/*31:0*/ count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_severity_count\n"); );
    // Body
    this->__PVT__m_severity_count.at((IData)(severity)) 
        = (VL_GTS_III(32, 0U, count) ? 0U : count);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_severity_count(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_severity_count\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_severity_counts(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_reset_severity_counts\n"); );
    // Body
    CData/*1:0*/ s;
    s = 0U;
    {
        while (true) {
            ...
            s = Vhello_uvm___024unit::__Venumtab_enum_next21
                [s];
        }
        __Vlabel0: ;
    }
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_id_count(Vhello_uvm__Syms* __restrict vlSymsp, std::string id, IData/*31:0*/ &get_id_count__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_id_count\n"); );
    // Body
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_id_count(Vhello_uvm__Syms* __restrict vlSymsp, std::string id, IData/*31:0*/ count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_id_count\n"); );
    // Body
    this->__PVT__m_id_count.at(id) = (VL_GTS_III(32, 0U, count)
                                       ? 0U : count);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_id_count(Vhello_uvm__Syms* __restrict vlSymsp, std::string id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_incr_id_count\n"); );
    // Body
    IData/*31:0*/ __VlefExpr_0;
    if (this->__PVT__m_id_count.exists(id)) {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_message_database(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_database> database) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_set_message_database\n"); );
    // Body
    this->__PVT__m_message_db = database;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_message_database(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_database> &get_message_database__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_message_database\n"); );
    // Body
    get_message_database__Vfuncrtn = this->__PVT__m_message_db;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_severity_set(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<CData/*1:0*/> &q) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_severity_set\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_id_set(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<std::string> &q) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_get_id_set\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_f_display(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ file, std::string str) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_f_display\n"); );
    // Body
    if ((0U == file)) {
        VL_WRITEF_NX("%s\n",1, 'S',&(str));
    } else {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_process_report_message(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_message> report_message) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_process_report_message\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_object> __VlefCall_1__get_report_object;
    IData/*31:0*/ __VlefCall_0__get_action;
    std::string unnamedblk3__DOT__m;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> unnamedblk3__DOT__cs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_server> unnamedblk3__DOT__svr;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_handler> l_report_handler;
    ...
    VL_NULL_CHECK(report_message, "../../uvm/distrib/src/base/uvm_report_server.svh", 567)->__VnoInFunc_set_report_server(vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server>{this});
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_execute_report_message(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_message> report_message, std::string composed_message) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_execute_report_message\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> unnamedblk4__DOT__stream;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_object> unnamedblk4__DOT__ro;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_handler> unnamedblk4__DOT__rh;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_database> unnamedblk4__DOT__unnamedblk5__DOT__db;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> unnamedblk4__DOT__unnamedblk5__DOT__unnamedblk6__DOT__cs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_recorder> unnamedblk4__DOT__unnamedblk7__DOT__recorder;
    IData/*31:0*/ unnamedblk8__DOT__tmp_file;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> unnamedblk9__DOT__l_root;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> unnamedblk9__DOT__cs;
    VlClassRef<Vhello_uvm_std__03a__03aprocess> p;
    vlSymsp->TOP__std__03a__03aprocess__Vclpkg.__VnoInFunc_self(vlProcess, vlSymsp, p);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_compose_report_message(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_message> report_message, std::string report_object_name, std::string &compose_report_message__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_compose_report_message\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_container> el_container;
    std::string prefix;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_handler> l_report_handler;
    sev_string = ""s;
    l_severity = 0U;
    ...
    sev_string = Vhello_uvm___024unit::__Venumtab_enum_name21
        [l_severity];
    ...
    if (this->__PVT__show_verbosity) {
        ...
        if ((0U != __VlefCond_6)) {
            verbosity_str = Vhello_uvm___024unit::__Venumtab_enum_name25
                .at(l_verbosity);
        } else {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_report_summarize(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_report_summarize\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__106__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__107__Vfuncout;
    ...
    while (unnamedblk10__DOT__s__Vmore) {
        ...
        __Vtemp_1 = Vhello_uvm___024unit::__Venumtab_enum_name21
    ...
    VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__107__Vfuncout);
    ...
    if ((0U != __VlefCall_0__uvm_report_enabled)) {
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__112__Vfuncout);
        vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__top 
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_process_report(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string name, std::string id, std::string message, IData/*31:0*/ action, IData/*31:0*/ file, std::string filename, IData/*31:0*/ line, std::string composed_message, IData/*31:0*/ verbosity_level, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_object> client) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_process_report\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_handler> __VlefCall_0__get_report_handler;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_compose_message(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string name, std::string id, std::string message, std::string filename, IData/*31:0*/ line, std::string &compose_message__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_compose_message\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_message> l_report_message;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::_ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::_ctor_var_reset\n"); );
    // Body
...
Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::~Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_default_report_server::~\n"); );
}
