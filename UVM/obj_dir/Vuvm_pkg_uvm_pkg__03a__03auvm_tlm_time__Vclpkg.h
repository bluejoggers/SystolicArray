...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_TLM_TIME__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_TLM_TIME__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_tlm_time__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_tlm_time__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_tlm_time__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_tlm_time__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_set_time_resolution(Vuvm_pkg__Syms* __restrict vlSymsp, double res);
};


class Vuvm_pkg__Syms;

class Vuvm_pkg_uvm_pkg__03a__03auvm_tlm_time : public virtual VlClass {
  public:
    ...
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_tlm_time(*this); }
    void __VnoInFunc_decr(Vuvm_pkg__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs);
    void __VnoInFunc_get_abstime(Vuvm_pkg__Syms* __restrict vlSymsp, double secs, double &get_abstime__Vfuncrtn);
    void __VnoInFunc_get_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string &get_name__Vfuncrtn);
    void __VnoInFunc_get_realtime(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ scaled, double secs, double &get_realtime__Vfuncrtn);
    void __VnoInFunc_incr(Vuvm_pkg__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs);
    void __VnoInFunc_reset(Vuvm_pkg__Syms* __restrict vlSymsp);
    void __VnoInFunc_set_abstime(Vuvm_pkg__Syms* __restrict vlSymsp, double t, double secs);
    void __VnoInFunc_to_m_res(Vuvm_pkg__Syms* __restrict vlSymsp, double t, QData/*63:0*/ scaled, double secs, double &to_m_res__Vfuncrtn);
  private:
    void _ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp);
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_tlm_time() = default;
    void init(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, double res);
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_tlm_time() {}
};
