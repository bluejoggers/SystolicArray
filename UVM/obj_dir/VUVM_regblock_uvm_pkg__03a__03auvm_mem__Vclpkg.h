...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_MEM__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_MEM__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_callback_iter__Tz94_TBz92;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_mem__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_mem__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_mem__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_mem__Vclpkg);
...
class VUVM_regblock_uvm_pkg__03a__03auvm_mem : public VUVM_regblock_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg>, CData/*0:0*/> __PVT__m_vregs;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_mem_mam> __PVT__mam;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_mem"; }
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_mem(*this); }
    void __VnoInFunc_Xadd_vregX(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> vreg);
    void __VnoInFunc_Xcheck_accessX(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map_info> &map_info, std::string caller, CData/*0:0*/ &Xcheck_accessX__Vfuncrtn);
    void __VnoInFunc_Xdelete_vregX(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> vreg);
    ...
    virtual VlCoroutine __VnoInFunc_burst_read(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, VlQueue<QData/*63:0*/> &value, IData/*31:0*/ path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual VlCoroutine __VnoInFunc_burst_write(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, VlQueue<QData/*63:0*/> value, IData/*31:0*/ path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    ...
    virtual void __VnoInFunc_get_access(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_access__Vfuncrtn);
    virtual void __VnoInFunc_get_address(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn);
    virtual void __VnoInFunc_get_addresses(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, VlQueue<QData/*63:0*/> &addr, IData/*31:0*/ &get_addresses__Vfuncrtn);
    ...
    void __VnoInFunc_get_default_map(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string caller, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> &get_default_map__Vfuncrtn);
    ...
    void __VnoInFunc_get_local_map(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, std::string caller, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> &get_local_map__Vfuncrtn);
    ...
    void __VnoInFunc_get_n_bits(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bits__Vfuncrtn);
    void __VnoInFunc_get_n_bytes(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bytes__Vfuncrtn);
    virtual void __VnoInFunc_get_n_maps(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_maps__Vfuncrtn);
    virtual void __VnoInFunc_get_offset(VUVM_regblock__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_offset__Vfuncrtn);
    ...
    void __VnoInFunc_get_size(VUVM_regblock__Syms* __restrict vlSymsp, QData/*63:0*/ &get_size__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_virtual_fields(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg_field>> &fields);
    virtual void __VnoInFunc_get_virtual_registers(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg>> &regs);
    ...
    virtual void __VnoInFunc_get_vreg_by_offset(VUVM_regblock__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_vreg> &get_vreg_by_offset__Vfuncrtn);
    ...
    virtual void __VnoInFunc_pre_write(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_item> rw);
    virtual void __VnoInFunc_randomize(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn);
    virtual VlCoroutine __VnoInFunc_read(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    ...
    virtual VlCoroutine __VnoInFunc_write(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ value, IData/*31:0*/ path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
  private:
    void _ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp);
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_mem() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ size, IData/*31:0*/ n_bits, std::string access, IData/*31:0*/ has_coverage);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_mem();
};
