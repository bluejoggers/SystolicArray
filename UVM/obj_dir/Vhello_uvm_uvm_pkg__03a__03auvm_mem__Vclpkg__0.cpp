...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem__Vclpkg::__VnoInFunc_get_max_size(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_max_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_mem__Vclpkg::__VnoInFunc_get_max_size\n"); );
    // Body
    get_max_size__Vfuncrtn = this->__PVT__m_max_size;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_pre_write(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_pre_write\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_post_write(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_post_write\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_pre_read(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_pre_read\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_post_read(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_post_read\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_sample(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ offset, CData/*0:0*/ is_read, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_sample\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_XsampleX(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ addr, CData/*0:0*/ is_read, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_XsampleX\n"); );
    // Body
    this->__VnoInFunc_sample(vlSymsp, addr, (IData)(is_read), map);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ size, IData/*31:0*/ n_bits, std::string access, IData/*31:0*/ has_coverage) {
    Vhello_uvm_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::new\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_configure(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_block> parent, std::string hdl_path) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_configure\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__13__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__14__Vfuncout;
    ...
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam_cfg> unnamedblk431__DOT__cfg;
    if ((VlNull{} == parent)) {
    ...
    unnamedblk431__DOT__cfg = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam_cfg, vlSymsp);
    ...
    this->__PVT__mam = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam, vlSymsp, 
                              VL_CVT_PACK_STR_NN(__VlefCall_3__get_full_name), unnamedblk431__DOT__cfg, 
                              VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem>{this});
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_offset(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ offset, CData/*0:0*/ unmapped) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_offset\n"); );
    // Locals
    ...
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    {
        ...
        VL_NULL_CHECK(map, "../../uvm/distrib/src/reg/uvm_mem.svh", 1012)->__VnoInFunc_m_set_mem_offset(vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem>{this}, offset, (IData)(unmapped));
        __Vlabel0: ;
    }
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_map(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_map\n"); );
    // Body
    this->__PVT__m_maps.at(map) = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xlock_modelX(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xlock_modelX\n"); );
    // Body
    this->__PVT__m_locked = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_full_name\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_block(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_block> &get_block__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_block\n"); );
    // Body
    get_block__Vfuncrtn = this->__PVT__m_parent;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_maps(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_maps__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_maps\n"); );
    // Body
    get_n_maps__Vfuncrtn = this->__PVT__m_maps.size();
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_maps(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map>> &maps) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_maps\n"); );
    // Body
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk432__DOT__map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk432__DOT__map__Vnext;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_is_in_map(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, CData/*0:0*/ &is_in_map__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_is_in_map\n"); );
    // Body
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk433__DOT__l;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk433__DOT__l__Vnext;
    CData/*0:0*/ unnamedblk433__DOT__l__Vmore;
    unnamedblk433__DOT__l__Vmore = 0;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk433__DOT__unnamedblk434__DOT__local_map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk433__DOT__unnamedblk434__DOT__parent_map;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_local_map(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, std::string caller, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> &get_local_map__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_local_map\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__54__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__55__Vfuncout;
    ...
    std::string __VlefCall_1__get_full_name;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk435__DOT__l;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk435__DOT__l__Vnext;
    CData/*0:0*/ unnamedblk435__DOT__l__Vmore;
    unnamedblk435__DOT__l__Vmore = 0;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk435__DOT__unnamedblk436__DOT__local_map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk435__DOT__unnamedblk436__DOT__parent_map;
    {
        if ((VlNull{} == map)) {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_default_map(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string caller, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> &get_default_map__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_default_map\n"); );
    // Locals
    ...
    std::string __VlefCall_1__get_full_name;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk437__DOT__l;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk437__DOT__l__Vnext;
    CData/*0:0*/ unnamedblk437__DOT__l__Vmore;
    unnamedblk437__DOT__l__Vmore = 0;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk437__DOT__unnamedblk438__DOT__map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_block> unnamedblk437__DOT__unnamedblk438__DOT__blk;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk437__DOT__unnamedblk438__DOT__default_map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk437__DOT__unnamedblk438__DOT__unnamedblk439__DOT__local_map;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_access(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_access__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_access\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__89__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__90__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__98__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__99__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__108__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__109__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__113__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__114__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__117__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__118__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__123__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__124__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_rights(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_rights__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_rights\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map_info> info;
    {
        ...
        VL_NULL_CHECK(map, "../../uvm/distrib/src/reg/uvm_mem.svh", 1201)->__VnoInFunc_get_mem_map_info(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem>{this}, 1U, info);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_offset(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_offset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_offset\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__131__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__132__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__138__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__139__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_2__get_full_name;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> orig_map;
    {
        ...
        VL_NULL_CHECK(map, "../../uvm/distrib/src/reg/uvm_mem.svh", 1220)->__VnoInFunc_get_mem_map_info(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem>{this}, 1U, map_info);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_virtual_registers(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg>> &regs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_virtual_registers\n"); );
    // Body
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> unnamedblk440__DOT__vreg;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> unnamedblk440__DOT__vreg__Vnext;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_virtual_fields(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_field>> &fields) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_virtual_fields\n"); );
    // Body
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> unnamedblk441__DOT__l;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> unnamedblk441__DOT__l__Vnext;
    CData/*0:0*/ unnamedblk441__DOT__l__Vmore;
    unnamedblk441__DOT__l__Vmore = 0;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> unnamedblk441__DOT__unnamedblk442__DOT__vreg;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vfield_by_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_field> &get_vfield_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vfield_by_name\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__145__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__146__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__150__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__151__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_2__get_full_name;
    ...
    VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_field>> vfields;
    {
        vfields.clear();
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vreg_by_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> &get_vreg_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vreg_by_name\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__155__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__156__Vfuncout;
    ...
    IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
    std::string __VlefCall_0__get_name;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> unnamedblk444__DOT__l;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> unnamedblk444__DOT__l__Vnext;
    CData/*0:0*/ unnamedblk444__DOT__l__Vmore;
    unnamedblk444__DOT__l__Vmore = 0;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> unnamedblk444__DOT__unnamedblk445__DOT__vreg;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vreg_by_offset(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> &get_vreg_by_offset__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_vreg_by_offset\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__164__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__165__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__168__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__169__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_addresses(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, VlQueue<QData/*63:0*/> &addr, IData/*31:0*/ &get_addresses__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_addresses\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__174__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__175__Vfuncout;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_address(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ offset, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_address\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_size(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ &get_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_size\n"); );
    // Body
    get_size__Vfuncrtn = this->__PVT__m_size;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_bits(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bits__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_bits\n"); );
    // Body
    get_n_bits__Vfuncrtn = this->__PVT__m_n_bits;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_bytes(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_bytes__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_n_bytes\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_build_coverage(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ models, IData/*31:0*/ &build_coverage__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_build_coverage\n"); );
    // Locals
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz17__Vclpkg.__VnoInFunc_read_by_name(vlSymsp, 
                                                                                ...
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem>{this}, __Vtask_read_by_name__187__Vfuncout);
    build_coverage__Vfuncrtn = __Vtask_read_by_name__187__val;
    build_coverage__Vfuncrtn = (build_coverage__Vfuncrtn 
                                & models);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_coverage(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ models) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_coverage\n"); );
    // Body
    this->__PVT__m_has_cover = (this->__PVT__m_has_cover 
                                | models);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_has_coverage(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ models, CData/*0:0*/ &has_coverage__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_has_coverage\n"); );
    // Body
    has_coverage__Vfuncrtn = ((this->__PVT__m_has_cover 
                               & models) == models);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_coverage(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ is_on, IData/*31:0*/ &set_coverage__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_coverage\n"); );
    // Body
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_coverage(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ is_on, CData/*0:0*/ &get_coverage__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_coverage\n"); );
    // Body
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_read(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_read\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    std::string __VlefCall_0__get_full_name;
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_burst_write(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, VlQueue<QData/*63:0*/> value, IData/*31:0*/ path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_burst_write\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_burst_read(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, VlQueue<QData/*63:0*/> &value, IData/*31:0*/ path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_burst_read\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_write(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_write\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map_info> __Vfunc_Xcheck_accessX__202__map_info;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> __VlefCall_6__get_backdoor;
    std::string __VlefCond_5;
    std::string __VlefCall_4__get_full_name;
    IData/*31:0*/ __VlefCall_3__uvm_report_enabled;
    std::string __VlefCall_2__get_access;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequencer_base> __VlefCall_1__get_sequencer;
    CData/*0:0*/ __VlefCall_0__Xcheck_accessX;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk447__DOT__cb;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk448__DOT__system_map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_frontdoor> unnamedblk448__DOT__unnamedblk449__DOT__fd;
    QData/*63:0*/ unnamedblk448__DOT__unnamedblk450__DOT__idx;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> unnamedblk451__DOT__bkdr;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk452__DOT__cb;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callback_iter__Tz21_TBz19> cbs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map_info> map_info;
    {
        cbs = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_callback_iter__Tz21_TBz19, vlSymsp, 
                     VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem>{this});
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_read(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_read\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map_info> __Vfunc_Xcheck_accessX__233__map_info;
    ...
    VL_KEEP_THIS;
    std::string __VlefCall_6__get_full_name;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> __VlefCall_5__get_backdoor;
    std::string __VlefCond_4;
    std::string __VlefCall_3__get_full_name;
    IData/*31:0*/ __VlefCall_2__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequencer_base> __VlefCall_1__get_sequencer;
    CData/*0:0*/ __VlefCall_0__Xcheck_accessX;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk455__DOT__cb;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk456__DOT__system_map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_frontdoor> unnamedblk456__DOT__unnamedblk457__DOT__fd;
    QData/*63:0*/ unnamedblk456__DOT__unnamedblk458__DOT__idx;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> unnamedblk459__DOT__bkdr;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_cbs> unnamedblk460__DOT__cb;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xcheck_accessX(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map_info> &map_info, std::string caller, CData/*0:0*/ &Xcheck_accessX__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xcheck_accessX\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__264__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__265__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__269__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__270__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__276__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__277__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__288__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__289__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__294__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__295__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__299__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__300__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__311__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__312__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__317__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__318__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__321__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__322__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> __VlefCall_10__get_local_map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> __VlefCall_9__backdoor;
    std::string __VlefCall_8__get_full_name;
    IData/*31:0*/ __VlefCall_7__uvm_report_enabled;
    CData/*0:0*/ __VlefLogAnd_6;
    CData/*0:0*/ __VlefCall_5__has_hdl_path;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> __VlefCall_4__get_backdoor;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_poke(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ value, std::string kind, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_poke\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__331__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__332__Vfuncout;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_peek(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &status, QData/*63:0*/ offset, QData/*63:0*/ &value, std::string kind, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_peek\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__360__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__361__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__373__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__374__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_6__get_full_name;
    IData/*31:0*/ __VlefCall_5__uvm_report_enabled;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_frontdoor(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_frontdoor> ftdr, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_frontdoor\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__378__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__379__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__384__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__385__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_2__get_full_name;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_frontdoor(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_frontdoor> &get_frontdoor__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_frontdoor\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__390__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__391__Vfuncout;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_backdoor(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> bkdr, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_backdoor\n"); );
    // Body
    this->__PVT__m_fname = fname;
    this->__PVT__m_lineno = lineno;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_backdoor(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ inherited, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> &get_backdoor__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_backdoor\n"); );
    // Body
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_block> unnamedblk463__DOT__blk;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> unnamedblk463__DOT__bkdr;
    if (inherited) {
...
extern const VlWide<32>/*1023:0*/ Vhello_uvm__ConstPool__CONST_hd6b7ba52_0;
extern const VlWide<32>/*1023:0*/ Vhello_uvm__ConstPool__CONST_h2ae7f32a_0;

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_read_func(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> rw, IData/*31:0*/ &backdoor_read_func__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_read_func\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__409__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__410__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__414__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__415__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__423__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__424__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_hdl_path_concat> __Vfunc_uvm_hdl_concat2string__427__concat;
    ...
    Vhello_uvm_uvm_hdl_path_slice__struct__0 __Vfunc_uvm_hdl_concat2string__427__unnamedblk271__DOT__unnamedblk272__DOT__slice;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_hdl_path_concat> __Vfunc_uvm_hdl_concat2string__428__concat;
    ...
    Vhello_uvm_uvm_hdl_path_slice__struct__0 __Vfunc_uvm_hdl_concat2string__428__unnamedblk271__DOT__unnamedblk272__DOT__slice;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__430__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__431__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk464__DOT__unnamedblk465__DOT__unnamedblk466__DOT__unnamedblk467__DOT__hdl_concat;
    ...
    CData/*0:0*/ ok;
    {
        ...
        while (VL_LTS_III(32, unnamedblk464__DOT__mem_idx, VL_NULL_CHECK(rw, "../../uvm/distrib/src/reg/uvm_mem.svh", 2056)
            ...
            while (VL_LTS_III(32, unnamedblk464__DOT__unnamedblk465__DOT__unnamedblk466__DOT__i, paths.size())) {
                ...
                VL_ASSIGN_W(1024, val, Vhello_uvm__ConstPool__CONST_hd6b7ba52_0);
                ...
                VL_SHIFTL_WWI(1024,1024,32, __Vtemp_2, Vhello_uvm__ConstPool__CONST_h2ae7f32a_0, this->__PVT__m_n_bits);
                VL_SUB_W(32, __Vtemp_3, __Vtemp_2, Vhello_uvm__ConstPool__CONST_h2ae7f32a_0);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_read(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_read\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_write(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_backdoor_write\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__436__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__437__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__440__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__441__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk471__DOT__unnamedblk472__DOT__unnamedblk473__DOT__unnamedblk474__DOT__hdl_concat;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_clear_hdl_path(Vhello_uvm__Syms* __restrict vlSymsp, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_clear_hdl_path\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__457__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__458__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__461__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__462__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_hdl_path(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<Vhello_uvm_uvm_hdl_path_slice__struct__0> slices, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_hdl_path\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_hdl_path_slice(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ offset, IData/*31:0*/ size, CData/*0:0*/ first, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_add_hdl_path_slice\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_has_hdl_path(Vhello_uvm__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &has_hdl_path__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_has_hdl_path\n"); );
    // Body
    IData/*31:0*/ __VlefCall_0__exists;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_hdl_path(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_hdl_path_concat>> &paths, std::string kind) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_hdl_path\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__485__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__486__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_2__size;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk477__DOT__unnamedblk478__DOT__t;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_hdl_path_kinds(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<std::string> &kinds) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_hdl_path_kinds\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_hdl_path_concat>> &paths, std::string kind, std::string separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_full_hdl_path\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__496__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__497__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__500__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__501__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_2__size;
    IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
    CData/*0:0*/ __VlefCall_0__has_hdl_path;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz47> unnamedblk479__DOT__hdl_paths;
    VlQueue<std::string> unnamedblk479__DOT__parent_paths;
    IData/*31:0*/ unnamedblk479__DOT__unnamedblk480__DOT__i;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk479__DOT__unnamedblk480__DOT__unnamedblk481__DOT__hdl_concat;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_hdl_path_concat> unnamedblk479__DOT__unnamedblk480__DOT__unnamedblk481__DOT__unnamedblk482__DOT__unnamedblk483__DOT__t;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_parent(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_block> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_set_parent\n"); );
    // Body
    this->__PVT__m_parent = parent;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_parent(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_block> &get_parent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_get_parent\n"); );
    // Body
    this->__VnoInFunc_get_block(vlSymsp, get_parent__Vfuncrtn);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_convert2string\n"); );
    // Locals
    std::string __Vtemp_1;
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    std::string __VlefCall_0__get_full_name;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk485__DOT__map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk485__DOT__map__Vnext;
    CData/*0:0*/ unnamedblk485__DOT__map__Vmore;
    unnamedblk485__DOT__map__Vmore = 0;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk485__DOT__unnamedblk486__DOT__parent_map;
    IData/*31:0*/ unnamedblk485__DOT__unnamedblk486__DOT__offset;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> unnamedblk485__DOT__unnamedblk486__DOT__unnamedblk487__DOT__this_map;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_print(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_print\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    QData/*63:0*/ __VlefCall_1__get_size;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_clone(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_clone\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__528__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__529__Vfuncout;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_copy\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_compare(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_compare\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__544__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__545__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__548__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__549__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_pack(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_pack\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__552__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__553__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__556__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__557__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_unpack(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_do_unpack\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__560__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__561__Vfuncout;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xadd_vregX(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> vreg) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xadd_vregX\n"); );
    // Body
    this->__PVT__m_vregs.at(vreg) = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xdelete_vregX(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg> vreg) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_Xdelete_vregX\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_mem::_ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::_ctor_var_reset\n"); );
    // Body
...
Vhello_uvm_uvm_pkg__03a__03auvm_mem::~Vhello_uvm_uvm_pkg__03a__03auvm_mem() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_mem::~\n"); );
}
