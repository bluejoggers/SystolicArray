...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_REG_WRITE_ONLY_CBS__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_REG_WRITE_ONLY_CBS__VCLPKG_H_  // guard
...
class VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi44;
...
class VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs> __PVT__m_me;
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs__Vclpkg);
    ...
    void __VnoInFunc_add(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg> rg);
    void __VnoInFunc_get(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs> &get__Vfuncrtn);
    void __VnoInFunc_get_type(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi44> &get_type__Vfuncrtn);
    void __VnoInFunc_remove(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg> rg);
};
...
class VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs : public VUVM_Activator_uvm_pkg__03a__03auvm_reg_cbs {
  public:
    ...
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs(*this); }
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_reg_write_only_cbs();
};
