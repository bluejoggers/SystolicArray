...
void Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69::init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> parent) {
    Vuvm_pkg_uvm_pkg__03a__03auvm_port_base__Tz97::init(vlProcess, vlSymsp, name, parent, 1U, 1U, 0xffffffffU);
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69::new\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69::__VnoInFunc_get_type_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_analysis_export"s;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69::__VnoInFunc_write(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69::__VnoInFunc_write\n"); );
    // Locals
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69::_ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69::~Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    Vuvm_pkg_uvm_pkg__03a__03auvm_analysis_export__Tz69::~\n"); );
}
