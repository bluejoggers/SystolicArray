...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher__Vclpkg::__VnoInFunc_get_report_catcher(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher> &get_report_catcher__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher__Vclpkg::__VnoInFunc_get_report_catcher\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher__Vclpkg::__VnoInFunc_print_catcher(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher__Vclpkg::__VnoInFunc_print_catcher\n"); );
    // Body
    ...
    std::string enabled;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher> catcher;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher__Vclpkg::__VnoInFunc_debug_report_catcher(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ what) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher__Vclpkg::__VnoInFunc_debug_report_catcher\n"); );
    // Body
    this->__PVT__m_debug_flags = what;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher__Vclpkg::__VnoInFunc_process_all_report_catchers(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_message> rm, IData/*31:0*/ &process_all_report_catchers__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher__Vclpkg::__VnoInFunc_process_all_report_catchers\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher> __Vfunc_get_first__15__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher> __Vfunc_get_next__21__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher> __Vfunc_get_next__30__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> __VlefCall_0__clone;
    VlClassRef<VUVM_regblock_std__03a__03aprocess> unnamedblk3__DOT__p;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_object> l_report_object;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz51_TBz88__Vclpkg.__VnoInFunc_get_first(vlProcess, vlSymsp, iter, l_report_object, __Vfunc_get_first__15__Vfuncout);
            ...
            while ((VlNull{} != catcher)) {
                {
                    ...
                    if ((1U & (~ (IData)(__VlefCall_2__callback_mode)))) {
                        vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz51_TBz88__Vclpkg.__VnoInFunc_get_next(vlProcess, vlSymsp, iter, l_report_object, __Vfunc_get_next__21__Vfuncout);
                    ...
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz51_TBz88__Vclpkg.__VnoInFunc_get_next(vlProcess, vlSymsp, iter, l_report_object, __Vfunc_get_next__30__Vfuncout);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher__Vclpkg::__VnoInFunc_summarize(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher__Vclpkg::__VnoInFunc_summarize\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name) {
    VUVM_regblock_uvm_pkg__03a__03auvm_callback::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_client(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_object> &get_client__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_client\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_severity(VUVM_regblock__Syms* __restrict vlSymsp, CData/*1:0*/ &get_severity__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_severity\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_context(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_context__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_context\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_handler> unnamedblk1__DOT__rh;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_verbosity(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &get_verbosity__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_verbosity\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_id(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_id__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_id\n"); );
    // Body
    get_id__Vfuncrtn = ""s;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_message(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_message__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_message\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_action(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &get_action__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_action\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_fname(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_fname__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_fname\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_line(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &get_line__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_line\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_element_container(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_message_element_container> &get_element_container__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_get_element_container\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_severity(VUVM_regblock__Syms* __restrict vlSymsp, CData/*1:0*/ severity) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_severity\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_verbosity(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ verbosity) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_verbosity\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_id(VUVM_regblock__Syms* __restrict vlSymsp, std::string id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_id\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_message(VUVM_regblock__Syms* __restrict vlSymsp, std::string message) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_message\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_action(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ action) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_action\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_context(VUVM_regblock__Syms* __restrict vlSymsp, std::string context_str) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_set_context\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_add_int(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix, IData/*31:0*/ action) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_add_int\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_add_string(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, std::string value, IData/*31:0*/ action) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_add_string\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_add_object(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> obj, IData/*31:0*/ action) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_add_object\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_catch(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &catch__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_catch\n"); );
    // Body
    catch__Vfuncrtn = 0U;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_report_fatal(VUVM_regblock__Syms* __restrict vlSymsp, std::string id, std::string message, IData/*31:0*/ verbosity, std::string fname, IData/*31:0*/ line, std::string context_name, CData/*0:0*/ report_enabled_checked) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_report_fatal\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_report_error(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string id, std::string message, IData/*31:0*/ verbosity, std::string fname, IData/*31:0*/ line, std::string context_name, CData/*0:0*/ report_enabled_checked) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_report_error\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    this->__VnoInFunc_uvm_report(vlProcess, vlSymsp, 2U, id, message, 0U, fname, line, context_name, (IData)(report_enabled_checked));
}

void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_report_warning(VUVM_regblock__Syms* __restrict vlSymsp, std::string id, std::string message, IData/*31:0*/ verbosity, std::string fname, IData/*31:0*/ line, std::string context_name, CData/*0:0*/ report_enabled_checked) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_report_warning\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_report_info(VUVM_regblock__Syms* __restrict vlSymsp, std::string id, std::string message, IData/*31:0*/ verbosity, std::string fname, IData/*31:0*/ line, std::string context_name, CData/*0:0*/ report_enabled_checked) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_report_info\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_report(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, std::string message, IData/*31:0*/ verbosity, std::string fname, IData/*31:0*/ line, std::string context_name, CData/*0:0*/ report_enabled_checked) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_report\n"); );
    // Locals
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_process_report_message(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_message> msg) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_uvm_process_report_message\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_5__get_report_file_handle;
    std::string __VlefCall_4__get_id;
    CData/*1:0*/ __VlefCall_3__get_severity;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_handler> __VlefCall_2__get_report_handler;
    std::string __VlefCall_1__get_id;
    CData/*1:0*/ __VlefCall_0__get_severity;
    std::string unnamedblk2__DOT__composed_message;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_server> unnamedblk2__DOT__rs;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_object> ro;
    IData/*31:0*/ a;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_issue(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_issue\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_report_server> rs;
    composed_message = ""s;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_process_report_catcher(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &process_report_catcher__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_process_report_catcher\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_0__get_name;
    IData/*31:0*/ act;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_randomize(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc___Vsetup_constraints(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::_ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::~VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_report_catcher::~\n"); );
}
