...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_QUEUE__TZ2__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_QUEUE__TZ2__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2> __PVT__m_global_queue;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2__Vclpkg);
    ...
    void __VnoInFunc_get_global(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ index, std::string &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_queue(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2> &get_global_queue__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2 : public VUVM_Register8b_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2(*this); }
    ...
    virtual void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ index, std::string &get__Vfuncrtn);
    virtual void __VnoInFunc_get_type_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn);
    virtual void __VnoInFunc_insert(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ index, std::string item);
    virtual void __VnoInFunc_pop_back(VUVM_Register8b__Syms* __restrict vlSymsp, std::string &pop_back__Vfuncrtn);
    virtual void __VnoInFunc_pop_front(VUVM_Register8b__Syms* __restrict vlSymsp, std::string &pop_front__Vfuncrtn);
    virtual void __VnoInFunc_push_back(VUVM_Register8b__Syms* __restrict vlSymsp, std::string item);
    virtual void __VnoInFunc_push_front(VUVM_Register8b__Syms* __restrict vlSymsp, std::string item);
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2();
};
