...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_REG_ITEM__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_REG_ITEM__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vhello_uvm_uvm_pkg__03a__03auvm_object;
class Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi15;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_reg_item__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_reg_item__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_reg_item__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_reg_item__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi15> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_uvm_pkg__03a__03auvm_reg_item : public Vhello_uvm_uvm_pkg__03a__03auvm_sequence_item {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __PVT__element;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> __PVT__local_map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> __PVT__map;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> __PVT__parent;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __PVT__extension;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_item"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_reg_item(*this); }
    virtual void __VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    void __VnoInFunc___VrandCb_post(Vhello_uvm__Syms* __restrict vlSymsp) {}
    void __VnoInFunc___VrandCb_pre(Vhello_uvm__Syms* __restrict vlSymsp) {}
    ...
    void __VnoInFunc_max_values_resize_constrained_array(Vhello_uvm__Syms* __restrict vlSymsp);
    void __VnoInFunc_max_values_setup_constraint(Vhello_uvm__Syms* __restrict vlSymsp);
    virtual void __VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn);
  private:
    void _ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_reg_item() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_reg_item();
};
