...
#ifndef VERILATED_VUVM_REGBLOCK_STD_H_
#define VERILATED_VUVM_REGBLOCK_STD_H_  // guard
...
struct VUVM_regblock_vl_covergroup_options_t__struct__0 {
    ...
    bool operator==(const VUVM_regblock_vl_covergroup_options_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<VUVM_regblock_vl_covergroup_options_t__struct__0> : public std::true_type {};
struct VUVM_regblock_vl_covergroup_type_options_t__struct__0 {
    IData/*31:0*/ __PVT__weight;
    IData/*31:0*/ __PVT__goal;
    std::string __PVT__comment;
    ...
    bool operator==(const VUVM_regblock_vl_covergroup_type_options_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<VUVM_regblock_vl_covergroup_type_options_t__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_std final {
  public:
    ...
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_std);
