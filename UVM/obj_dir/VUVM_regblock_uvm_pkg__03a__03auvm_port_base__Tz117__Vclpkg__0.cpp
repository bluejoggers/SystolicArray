...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> parent, IData/*31:0*/ port_type, IData/*31:0*/ min_size, IData/*31:0*/ max_size) {
    VUVM_regblock_uvm_pkg__03a__03auvm_tlm_if_base__Tz26_TBz26::init(vlProcess, vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::new\n"); );
    // Locals
    ...
    this->__PVT__m_comp = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_port_component__Tz121, vlProcess, vlSymsp, name, parent, 
                                 VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117>{this});
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_name\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_full_name(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_full_name\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_parent(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> &get_parent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_parent\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_comp(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_component_base> &get_comp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_comp\n"); );
    // Body
    get_comp__Vfuncrtn = this->__PVT__m_comp;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_type_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_type_name\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_max_size(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &max_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_max_size\n"); );
    // Body
    max_size__Vfuncrtn = this->__PVT__m_max_size;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_min_size(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &min_size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_min_size\n"); );
    // Body
    min_size__Vfuncrtn = this->__PVT__m_min_size;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_is_unbounded(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &is_unbounded__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_is_unbounded\n"); );
    // Body
    is_unbounded__Vfuncrtn = (0xffffffffU == this->__PVT__m_max_size);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_is_port(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &is_port__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_is_port\n"); );
    // Body
    is_port__Vfuncrtn = (0U == this->__PVT__m_port_type);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_is_export(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &is_export__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_is_export\n"); );
    // Body
    is_export__Vfuncrtn = (1U == this->__PVT__m_port_type);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_is_imp(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &is_imp__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_is_imp\n"); );
    // Body
    is_imp__Vfuncrtn = (2U == this->__PVT__m_port_type);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_size(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_size\n"); );
    // Body
    size__Vfuncrtn = this->__PVT__m_imp_list.size();
}

void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_set_if(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ index) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_set_if\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_m_get_if_mask(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &m_get_if_mask__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_m_get_if_mask\n"); );
    // Body
    m_get_if_mask__Vfuncrtn = this->__PVT__m_if_mask;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_set_default_index(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ index) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_set_default_index\n"); );
    // Body
    this->__PVT__m_def_index = index;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_connect(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117> provider) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_connect\n"); );
    // Locals
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        ...
        if ((provider == VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117>{this})) {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_debug_connected_to(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ level, IData/*31:0*/ max_level) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_debug_connected_to\n"); );
    // Body
    ...
    IData/*31:0*/ curr_num;
    std::string s_sz;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117> port;
    {
        sz = 0U;
        num = 0U;
        curr_num = 0U;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_debug_provided_to(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ level, IData/*31:0*/ max_level) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_debug_provided_to\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_2__get_type_name;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_connected_to(VUVM_regblock__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_component_base>> &list) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_connected_to\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_provided_to(VUVM_regblock__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_component_base>> &list) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_provided_to\n"); );
    // Body
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_component_base> __VlefCall_0__get_comp;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_m_check_relationship(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117> provider, CData/*0:0*/ &m_check_relationship__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_m_check_relationship\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    std::string __VlefCall_0__get_type_name;
    std::string s;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117> from;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> to_gparent;
    {
        ...
        from = VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117>{this};
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_m_add_list(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117> provider) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_m_add_list\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_2__get_full_name;
    std::string __VlefCall_1__get_full_name;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117> imp;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_resolve_bindings(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_resolve_bindings\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117> unnamedblk8__DOT__unnamedblk9__DOT__port;
    {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_if(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117> &get_if__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::__VnoInFunc_get_if\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_2__size;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::_ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::_ctor_var_reset\n"); );
    // Body
...
VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::~VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz117::~\n"); );
}
