...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_VREG__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_VREG__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vhello_uvm_std__03a__03asemaphore;
class Vhello_uvm_uvm_pkg__03a__03auvm_callback_iter__Tz23_TBz24;
class Vhello_uvm_uvm_pkg__03a__03auvm_callback_iter__Tz25_TBz26;
...
class Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam_policy;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_vreg__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_vreg__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_vreg__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_vreg__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_vreg : public Vhello_uvm_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_field>> __PVT__fields;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem> __PVT__mem;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_region> __PVT__region;
    VlClassRef<Vhello_uvm_std__03a__03asemaphore> __PVT__atomic;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_vreg"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_vreg(*this); }
    VlCoroutine __VnoInFunc_XatomicX(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ on);
    ...
    void __VnoInFunc_add_field(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_field> field);
    virtual void __VnoInFunc_allocate(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ n, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam> mam, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam_policy> alloc, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_region> &allocate__Vfuncrtn);
    ...
    void __VnoInFunc_configure(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_block> parent, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ size, QData/*63:0*/ offset, IData/*31:0*/ incr);
    ...
    virtual void __VnoInFunc_get_access(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_access__Vfuncrtn);
    virtual void __VnoInFunc_get_address(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_field_by_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_field> &get_field_by_name__Vfuncrtn);
    virtual void __VnoInFunc_get_fields(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_vreg_field>> &fields);
    ...
    virtual void __VnoInFunc_get_incr(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_incr__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_memory(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem> &get_memory__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_n_memlocs(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_memlocs__Vfuncrtn);
    virtual void __VnoInFunc_get_offset_in_memory(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ &get_offset_in_memory__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_region(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_region> &get_region__Vfuncrtn);
    virtual void __VnoInFunc_get_rights(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_rights__Vfuncrtn);
    virtual void __VnoInFunc_get_size(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_size__Vfuncrtn);
    virtual void __VnoInFunc_implement(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ n, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ offset, IData/*31:0*/ incr, CData/*0:0*/ &implement__Vfuncrtn);
    ...
    virtual void __VnoInFunc_peek(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual void __VnoInFunc_poke(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual void __VnoInFunc_post_read(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ &rdat, IData/*31:0*/ path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, IData/*31:0*/ &status);
    virtual void __VnoInFunc_post_write(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ wdat, IData/*31:0*/ path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, IData/*31:0*/ &status);
    virtual void __VnoInFunc_pre_read(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> &map);
    virtual void __VnoInFunc_pre_write(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ &wdat, IData/*31:0*/ &path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> &map);
    virtual void __VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn);
    virtual VlCoroutine __VnoInFunc_read(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, IData/*31:0*/ path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual void __VnoInFunc_release_region(Vhello_uvm__Syms* __restrict vlSymsp);
    void __VnoInFunc_reset(Vhello_uvm__Syms* __restrict vlSymsp, std::string kind);
    ...
    virtual VlCoroutine __VnoInFunc_write(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, IData/*31:0*/ path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
  private:
    void _ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_vreg() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ n_bits);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_vreg();
};
