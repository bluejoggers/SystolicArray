...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_CALLBACKS__TZ67__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_CALLBACKS__TZ67__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz67__Vclpkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz67> __PVT__m_inst;
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz67__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz67__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz67__Vclpkg);
    ...
    void __VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz67> &get__Vfuncrtn);
    void __VnoInFunc_get_first(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_backdoor> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callback> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_backdoor> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callback> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_backdoor> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callback> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_backdoor> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callback> &get_prev__Vfuncrtn);
    void __VnoInFunc_m_get_q(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz51> &q, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_backdoor> obj);
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz67 : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_typed_callbacks__Tz67 {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_callbacks__Tz67"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz67(*this); }
  ...
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz67() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz67();
};
