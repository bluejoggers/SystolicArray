...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_VREG__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_VREG__VCLPKG_H_  // guard
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_callback_iter__Tz25_TBz26;
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam_policy;
class Vuvm_pkg_uvm_pkg__03a__03auvm_mem_region;
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_vreg__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_vreg__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_vreg__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_vreg__Vclpkg);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_vreg : public Vuvm_pkg_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field>> __PVT__fields;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> __PVT__mem;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_region> __PVT__region;
    VlClassRef<Vuvm_pkg_std__03a__03asemaphore> __PVT__atomic;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_vreg"; }
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_vreg(*this); }
    VlCoroutine __VnoInFunc_XatomicX(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ on);
    void __VnoInFunc_Xlock_modelX(Vuvm_pkg__Syms* __restrict vlSymsp);
    virtual void __VnoInFunc___VBasicRand(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(Vuvm_pkg__Syms* __restrict vlSymsp);
    void __VnoInFunc_add_field(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field> field);
    virtual void __VnoInFunc_allocate(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ n, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam> mam, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_mam_policy> alloc, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_region> &allocate__Vfuncrtn);
    ...
    void __VnoInFunc_configure(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_block> parent, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ size, QData/*63:0*/ offset, IData/*31:0*/ incr);
    ...
    virtual void __VnoInFunc_get_address(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ idx, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_field_by_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field> &get_field_by_name__Vfuncrtn);
    virtual void __VnoInFunc_get_fields(Vuvm_pkg__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_vreg_field>> &fields);
    ...
    virtual void __VnoInFunc_get_incr(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_incr__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_memory(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> &get_memory__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_n_memlocs(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_n_memlocs__Vfuncrtn);
    virtual void __VnoInFunc_get_offset_in_memory(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ idx, QData/*63:0*/ &get_offset_in_memory__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_region(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem_region> &get_region__Vfuncrtn);
    virtual void __VnoInFunc_get_rights(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_map> map, std::string &get_rights__Vfuncrtn);
    virtual void __VnoInFunc_get_size(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &get_size__Vfuncrtn);
    virtual void __VnoInFunc_implement(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ n, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_mem> mem, QData/*63:0*/ offset, IData/*31:0*/ incr, CData/*0:0*/ &implement__Vfuncrtn);
    ...
    virtual void __VnoInFunc_peek(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ &value, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual void __VnoInFunc_poke(Vuvm_pkg__Syms* __restrict vlSymsp, QData/*63:0*/ idx, IData/*31:0*/ &status, QData/*63:0*/ value, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    ...
    virtual void __VnoInFunc_release_region(Vuvm_pkg__Syms* __restrict vlSymsp);
    void __VnoInFunc_reset(Vuvm_pkg__Syms* __restrict vlSymsp, std::string kind);
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_vreg() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ n_bits);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_vreg();
};
