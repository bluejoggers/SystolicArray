...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_TASK_PHASE__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_TASK_PHASE__VCLPKG_H_  // guard
...
class VUVM_Activator_uvm_pkg__03a__03a__VDynScope_10;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_task_phase__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_task_phase__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_task_phase__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_task_phase__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_task_phase : public VUVM_Activator_uvm_pkg__03a__03auvm_phase {
  public:
  ...
  private:
    VlCoroutine __VnoInFunc_execute____Vfork_1__0(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03a__VDynScope_10> __VDynScope_execute_0);
  public:
    void __VnoInFunc_m_traverse(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> comp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_phase> phase, IData/*31:0*/ state);
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_task_phase() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_task_phase();
};
