...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> cntxt, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_objection> objection) {
    Vhello_uvm_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::new\n"); );
    // Locals
    ...
    this->__PVT__m_cb = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat_callback, vlProcess, vlSymsp, 
                               VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(name, "_cb"s)), this->__PVT__m_cntxt);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_mode(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ mode, IData/*31:0*/ &set_mode__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_mode\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_heartbeat(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_event_> e, VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component>> &comps) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_heartbeat\n"); );
    // Body
    IData/*31:0*/ unnamedblk1__DOT__i;
    unnamedblk1__DOT__i = 0;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> c;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_add(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> comp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_add\n"); );
    // Body
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> c;
    {
        c = comp;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_remove(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> comp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_remove\n"); );
    // Body
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> c;
    c = comp;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_start(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_event_> e) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_start\n"); );
    // Body
        ...
        }
        {
            ...
            __Vinline_0___VnoInFunc_m_enable_cb___Vtask_callback_mode__15__Vfuncout = 0;
            {
                ...
                if ((1U & (~ (IData)(this->__PVT__m_added)))) {
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz13_TBz15__Vclpkg.__VnoInFunc_add(vlSymsp, this->__PVT__m_objection, this->__PVT__m_cb, 0U);
                }
...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_stop(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_stop\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process\n"); );
    // Body
    {
        if (this->__PVT__m_started) {
            goto __Vlabel0;
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process____Vfork_1__0(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process____Vfork_1__0\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_enable_cb(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_enable_cb\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_disable_cb(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_disable_cb\n"); );
    // Locals
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03a__VDynScope_29> __VDynScope_m_hb_process_1;
    __VDynScope_m_hb_process_1 = VL_NEW(Vhello_uvm_uvm_pkg__03a__03a__VDynScope_29, vlSymsp);
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__1(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlForkSync __Vfork_2__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__1\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__0(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlForkSync __Vfork_2__sync, VlClassRef<Vhello_uvm_uvm_pkg__03a__03a__VDynScope_29> __VDynScope_m_hb_process_1) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__0\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03a__VDynScope_29> __Vtask___VforkTask_0__19____VDynScope_m_hb_process_1;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk2__DOT__idx;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk2__DOT__idx__Vnext;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk3__DOT__unnamedblk4__DOT__idx;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk3__DOT__unnamedblk4__DOT__idx__Vnext;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk5__DOT__unnamedblk6__DOT__idx;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk5__DOT__unnamedblk6__DOT__idx__Vnext;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk7__DOT__unnamedblk8__DOT__idx;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk7__DOT__unnamedblk8__DOT__idx__Vnext;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::_ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::_ctor_var_reset\n"); );
    // Body
...
Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::~Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_heartbeat::~\n"); );
}
