...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ12__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_SIMPLE_LOCK_DAP__TZ12__VCLPKG_H_  // guard
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz60;
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_set_get_dap_base__Tz12;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_simple_lock_dap__Tz12__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_simple_lock_dap__Tz12__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_simple_lock_dap__Tz12__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_simple_lock_dap__Tz12__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz60> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_simple_lock_dap__Tz12 : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_set_get_dap_base__Tz12 {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_simple_lock_dap__Tz12"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_simple_lock_dap__Tz12(*this); }
    ...
    virtual void __VnoInFunc_get(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string &get__Vfuncrtn);
    ...
    void __VnoInFunc_lock(Vhello_uvm_v1__Syms* __restrict vlSymsp);
    virtual void __VnoInFunc_randomize(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn);
    virtual void __VnoInFunc_set(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string value);
    virtual void __VnoInFunc_try_get(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string &value, CData/*0:0*/ &try_get__Vfuncrtn);
    virtual void __VnoInFunc_try_set(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string value, CData/*0:0*/ &try_set__Vfuncrtn);
    void __VnoInFunc_unlock(Vhello_uvm_v1__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset(Vhello_uvm_v1__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_simple_lock_dap__Tz12() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_simple_lock_dap__Tz12();
};
