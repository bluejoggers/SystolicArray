...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_TLM_FIFO__TZ112__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_TLM_FIFO__TZ112__VCLPKG_H_  // guard
...
class VUVM_Register8b_std__03a__03amailbox__Tz112;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_fifo__Tz112__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_fifo__Tz112__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_fifo__Tz112__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_fifo__Tz112__Vclpkg);
...
#include "VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz112__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_fifo__Tz112 : public VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz112 {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__m_size;
    IData/*31:0*/ __PVT__m_pending_blocked_gets;
    VlClassRef<VUVM_Register8b_std__03a__03amailbox__Tz112> __PVT__m;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_tlm_fifo__Tz112"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_fifo__Tz112(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_fifo__Tz112() = default;
    ...
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_fifo__Tz112();
};
