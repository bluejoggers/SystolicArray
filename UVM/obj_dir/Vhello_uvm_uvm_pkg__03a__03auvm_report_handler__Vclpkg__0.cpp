...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler__Vclpkg::__VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi11> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_report_handler__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler__Vclpkg::__VnoInFunc_format_action(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ action, std::string &format_action__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_report_handler__Vclpkg::__VnoInFunc_format_action\n"); );
    // Body
    std::string s;
    if ((0U == action)) {
        s = "NO ACTION"s;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_object_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi11> __Vfunc_get__0__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_create(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_create\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_handler> tmp;
    if ((""s == name)) {
        tmp = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_report_handler, vlProcess, vlSymsp, "uvm_report_handler"s);
    } else {
        tmp = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_report_handler, vlProcess, vlSymsp, name);
    }
    create__Vfuncrtn = tmp;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_type_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_report_handler"s;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc____05Fm_uvm_field_automation(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> tmp_data___05F, IData/*31:0*/ what___05F, std::string str___05F) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc____05Fm_uvm_field_automation\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_1;
    CData/*0:0*/ __VlefCall_0__m_do_cycle_check;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_handler> unnamedblk1__DOT__local_data___05F;
    {
        if ((((0x00020006U == what___05F) | (0x00020008U 
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_object__Vclpkg.__PVT_____05Fm_uvm_status_container, "../../uvm/distrib/src/base/uvm_report_handler.svh", 81)->__VnoInFunc_m_do_cycle_check(vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_handler>{this}, __VlefCall_0__m_do_cycle_check);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name) {
    Vhello_uvm_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    /*super.new*/;
    {
        ...
        this->__PVT__id_actions = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9, vlProcess, vlSymsp, ""s);
        this->__PVT__id_verbosities = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9, vlProcess, vlSymsp, ""s);
        this->__PVT__id_file_handles = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9, vlProcess, vlSymsp, ""s);
        this->__PVT__sev_overrides = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz10_TBz10, vlProcess, vlSymsp, ""s);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_do_print(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_do_print\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> unnamedblk3__DOT__unnamedblk5__DOT__id_v_ary;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> unnamedblk7__DOT__unnamedblk9__DOT__id_a_ary;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz10_TBz10> unnamedblk11__DOT__unnamedblk13__DOT__sev_o_ary;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> unnamedblk15__DOT__unnamedblk17__DOT__id_f_ary;
    ...
    idx = ""s;
    l_int = 0U;
    if (Vhello_uvm___024unit::__Venumtab_enum_valid25
    ...
    if ((0U != __VlefCond_0)) {
        __VlefExpr_1 = VL_CVT_PACK_STR_NN(Vhello_uvm___024unit::__Venumtab_enum_name25
                                          .at(l_verbosity));
    ...
    if ((0U != __VlefCall_2__first)) {
        ...
        do {
            ...
            if ((0U != __VlefCond_4)) {
                __VlefExpr_5 = VL_CVT_PACK_STR_NN(Vhello_uvm___024unit::__Venumtab_enum_name25
                                                  .at(l_verbosity));
            ...
            do {
                ...
                if ((0U != __VlefCall_9__first)) {
                    do {
                        ...
                        if ((0U != __VlefCond_10)) {
                            __VlefExpr_11 = VL_CVT_PACK_STR_NN(Vhello_uvm___024unit::__Venumtab_enum_name25
                                                               .at(l_verbosity));
                            __Vtemp_2 = Vhello_uvm___024unit::__Venumtab_enum_name21
                                [l_severity];
                            ...
                            VL_SFORMAT_NX(unnamedblk3__DOT__unnamedblk5__DOT__unnamedblk6__DOT__l_str
                                          ,"%0d",1, '~',32,l_int);
                            __Vtemp_3 = Vhello_uvm___024unit::__Venumtab_enum_name21
                                [l_severity];
    ...
    if (__VlefExpr_18) {
        ...
        do {
            ...
            __Vtemp_4 = Vhello_uvm___024unit::__Venumtab_enum_name21
                [l_severity];
            ...
            do {
                ...
                if ((0U != __VlefCall_23__first)) {
                    do {
                        ...
                        __Vtemp_5 = Vhello_uvm___024unit::__Venumtab_enum_name21
                            [l_severity];
    ...
    if ((0U != __VlefCall_28__first)) {
        ...
        do {
            ...
            __Vtemp_6 = Vhello_uvm___024unit::__Venumtab_enum_name21
                [l_severity];
            VL_NULL_CHECK(printer, "../../uvm/distrib/src/base/uvm_report_handler.svh", 225)->__VnoInFunc_print_generic(vlSymsp, VL_SFORMATF_N_NX("[%s]",1
                                                                                ...
                                                                                VL_CVT_PACK_STR_NN(Vhello_uvm___024unit::__Venumtab_enum_name21
            ...
            do {
                ...
                if ((0U != __VlefCall_33__first)) {
                    do {
                        ...
                        __Vtemp_7 = Vhello_uvm___024unit::__Venumtab_enum_name21
                            [l_severity];
    ...
    if (__VlefExpr_40) {
        ...
        do {
            VL_EXTENDS_WI(4096,32, __VlefExpr_41, this->__PVT__severity_file_handles
                          .at((IData)(l_severity)));
            __Vtemp_10 = Vhello_uvm___024unit::__Venumtab_enum_name21
                [l_severity];
            ...
            do {
                ...
                if ((0U != __VlefCall_45__first)) {
                    do {
                        ...
                        __Vtemp_11 = Vhello_uvm___024unit::__Venumtab_enum_name21
                            [l_severity];
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_process_report_message(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_message> report_message) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_process_report_message\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_server> srvr;
    std::string id;
    CData/*1:0*/ severity;
    ...
    VL_NULL_CHECK(report_message, "../../uvm/distrib/src/base/uvm_report_handler.svh", 331)->__VnoInFunc_set_report_handler(vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_handler>{this});
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_initialize(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_initialize\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    this->__VnoInFunc_set_default_file(vlSymsp, 0U);
    this->__PVT__m_max_verbosity_level = 0x000000c8U;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_severity_id_file(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, IData/*31:0*/ &get_severity_id_file__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_severity_id_file\n"); );
    // Body
    IData/*31:0*/ __VlefCall_1__exists;
    IData/*31:0*/ __VlefCall_0__exists;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> array;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_verbosity_level(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ verbosity_level) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_verbosity_level\n"); );
    // Body
    this->__PVT__m_max_verbosity_level = verbosity_level;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_verbosity_level(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, IData/*31:0*/ &get_verbosity_level__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_verbosity_level\n"); );
    // Body
    IData/*31:0*/ __VlefCall_1__exists;
    IData/*31:0*/ __VlefCall_0__exists;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> array;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_action(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, IData/*31:0*/ &get_action__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_action\n"); );
    // Body
    IData/*31:0*/ __VlefCall_1__exists;
    IData/*31:0*/ __VlefCall_0__exists;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> array;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_file_handle(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, IData/*31:0*/ &get_file_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_get_file_handle\n"); );
    // Body
    IData/*31:0*/ __VlefCall_0__exists;
    IData/*31:0*/ file;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_action(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, IData/*31:0*/ action) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_action\n"); );
    // Body
    this->__PVT__severity_actions.at((IData)(severity)) 
        = action;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_id_action(Vhello_uvm__Syms* __restrict vlSymsp, std::string id, IData/*31:0*/ action) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_id_action\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__id_actions, "../../uvm/distrib/src/base/uvm_report_handler.svh", 529)->__VnoInFunc_add(vlSymsp, id, action);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_id_action(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, IData/*31:0*/ action) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_id_action\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> __VlefCall_0__new;
    if ((! this->__PVT__severity_id_actions.exists(severity))) {
        __VlefCall_0__new = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9, vlProcess, vlSymsp, ""s);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_id_verbosity(Vhello_uvm__Syms* __restrict vlSymsp, std::string id, IData/*31:0*/ verbosity) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_id_verbosity\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_id_verbosity(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, IData/*31:0*/ verbosity) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_id_verbosity\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> __VlefCall_0__new;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_default_file(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_default_file\n"); );
    // Body
    this->__PVT__default_file_handle = file;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_file(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, IData/*31:0*/ file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_file\n"); );
    // Body
    this->__PVT__severity_file_handles.at((IData)(severity)) 
        = file;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_id_file(Vhello_uvm__Syms* __restrict vlSymsp, std::string id, IData/*31:0*/ file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_id_file\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_id_file(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string id, IData/*31:0*/ file) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_id_file\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> __VlefCall_0__new;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_override(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ cur_severity, CData/*1:0*/ new_severity) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_override\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_id_override(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ cur_severity, std::string id, CData/*1:0*/ new_severity) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_set_severity_id_override\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz10_TBz10> __VlefCall_0__new;
    if ((! this->__PVT__sev_id_overrides.exists(id))) {
        __VlefCall_0__new = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz10_TBz10, vlProcess, vlSymsp, ""s);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_report(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ severity, std::string name, std::string id, std::string message, IData/*31:0*/ verbosity_level, std::string filename, IData/*31:0*/ line, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_object> client) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_report\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__135__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__136__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_enabled__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 138)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__136__Vfuncout);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_run_hooks(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_object> client, CData/*1:0*/ severity, std::string id, std::string message, IData/*31:0*/ verbosity, std::string filename, IData/*31:0*/ line, CData/*0:0*/ &run_hooks__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_run_hooks\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_dump_state(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_dump_state\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__179__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__180__Vfuncout;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_server> unnamedblk30__DOT__srvr;
    IData/*31:0*/ file;
    std::string idx;
    VlQueue<std::string> q;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> id_a_ary;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> id_v_ary;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz9> id_f_ary;
    file = 0U;
    idx = ""s;
    q.clear();
    q.atDefault().clear();
    ...
    if ((0U != __VlefCall_0__first)) {
        do {
            ...
            __Vtemp_1 = Vhello_uvm___024unit::__Venumtab_enum_name25
    ...
    while (unnamedblk19__DOT__severity__Vmore) {
        ...
        if ((0U != __VlefCall_2__first)) {
            do {
                ...
                __Vtemp_3 = Vhello_uvm___024unit::__Venumtab_enum_name25
    ...
    if ((0U != __VlefCall_18__uvm_report_enabled)) {
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__180__Vfuncout);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::_ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::_ctor_var_reset\n"); );
    // Body
...
Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::~Vhello_uvm_uvm_pkg__03a__03auvm_report_handler() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_report_handler::~\n"); );
}
