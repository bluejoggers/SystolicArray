...
#ifndef VERILATED_VUVM_REGISTER8B___024UNIT__03A__03AREG_SEQUENCE__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B___024UNIT__03A__03AREG_SEQUENCE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b___024unit__03a__03areg_sequence__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b___024unit__03a__03areg_sequence__Vclpkg();
    ~VUVM_Register8b___024unit__03a__03areg_sequence__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b___024unit__03a__03areg_sequence__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi16> &get_type__Vfuncrtn);
};

#include "VUVM_Register8b_uvm_pkg__03a__03auvm_sequence__Tz61_TBz61__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b___024unit__03a__03areg_sequence : public VUVM_Register8b_uvm_pkg__03a__03auvm_sequence__Tz61_TBz61 {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "$unit::reg_sequence"; }
    VlClass* clone() const { return new VUVM_Register8b___024unit__03a__03areg_sequence(*this); }
    ...
    VUVM_Register8b___024unit__03a__03areg_sequence() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b___024unit__03a__03areg_sequence();
};
