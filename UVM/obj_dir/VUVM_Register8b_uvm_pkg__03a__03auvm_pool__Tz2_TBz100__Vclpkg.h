...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ100__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ100__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_global(VUVM_Register8b__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz2> &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100> &get_global_pool__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100 : public VUVM_Register8b_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<std::string, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz2>> __PVT__pool;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_pool__Tz2_TBz100"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100(*this); }
    ...
    virtual void __VnoInFunc_add(VUVM_Register8b__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz2> item);
    ...
    virtual void __VnoInFunc_get(VUVM_Register8b__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz2> &get__Vfuncrtn);
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_pool__Tz2_TBz100();
};
