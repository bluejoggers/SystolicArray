...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_REPORT_MESSAGE_ELEMENT_CONTAINER__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_REPORT_MESSAGE_ELEMENT_CONTAINER__VCLPKG_H_  // guard
...
class Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi12;
...
class Vhello_uvm_uvm_pkg__03a__03auvm_report_message_int_element;
class Vhello_uvm_uvm_pkg__03a__03auvm_report_message_object_element;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_container__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_container__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_container__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_container__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi12> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_container : public Vhello_uvm_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_base>> __PVT__elements;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_report_message_element_container"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_container(*this); }
    ...
    virtual void __VnoInFunc_delete_elements(Vhello_uvm__Syms* __restrict vlSymsp);
    ...
    virtual void __VnoInFunc_get_elements(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_base>> &get_elements__Vfuncrtn);
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_container() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_report_message_element_container();
};
