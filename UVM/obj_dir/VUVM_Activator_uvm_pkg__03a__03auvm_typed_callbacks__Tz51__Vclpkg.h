...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ51__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ51__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz51__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50> __PVT__m_tw_cb_q;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz51> __PVT__m_t_inst;
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz51__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz51__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz51__Vclpkg);
    ...
    void __VnoInFunc_m_cb_find(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50> q, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ &m_cb_find__Vfuncrtn);
    void __VnoInFunc_m_cb_find_name(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50> q, std::string name, std::string where, IData/*31:0*/ &m_cb_find_name__Vfuncrtn);
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz51> &m_initialize__Vfuncrtn);
};
...
class VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz51 : public VUVM_Activator_uvm_pkg__03a__03auvm_callbacks_base {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_typed_callbacks__Tz51"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz51(*this); }
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz51() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_typed_callbacks__Tz51();
};
