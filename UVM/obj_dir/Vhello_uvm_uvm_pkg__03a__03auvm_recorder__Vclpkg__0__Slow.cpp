...
VL_ATTR_COLD void Vhello_uvm_uvm_pkg__03a__03auvm_recorder__Vclpkg___ctor_var_reset(Vhello_uvm_uvm_pkg__03a__03auvm_recorder__Vclpkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_recorder__Vclpkg___ctor_var_reset\n"); );
