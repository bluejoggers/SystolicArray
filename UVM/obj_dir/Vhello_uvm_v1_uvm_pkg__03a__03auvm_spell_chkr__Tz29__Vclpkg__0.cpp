...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_spell_chkr__Tz29__Vclpkg::__VnoInFunc_check(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz8>> &strtab, std::string s, CData/*0:0*/ &check__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_spell_chkr__Tz29__Vclpkg::__VnoInFunc_check\n"); );
    // Locals
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_spell_chkr__Tz29__Vclpkg::__VnoInFunc_levenshtein_distance(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string s, std::string t, IData/*31:0*/ &levenshtein_distance__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_spell_chkr__Tz29__Vclpkg::__VnoInFunc_levenshtein_distance\n"); );
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_spell_chkr__Tz29__Vclpkg::__VnoInFunc_minimum(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ a, IData/*31:0*/ b, IData/*31:0*/ c, IData/*31:0*/ &minimum__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_spell_chkr__Tz29__Vclpkg::__VnoInFunc_minimum\n"); );
    // Body
    IData/*31:0*/ min;
    min = a;
