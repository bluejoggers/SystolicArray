...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_PORT_BASE__TZ82__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_PORT_BASE__TZ82__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_port_component__Tz84;
class VUVM_regblock_uvm_pkg__03a__03auvm_port_component_base;
class VUVM_regblock_uvm_pkg__03a__03auvm_root;
class VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz59_TBz59;


class VUVM_regblock__Syms;

class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
};

#include "VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz59_TBz59__Vclpkg.h"

class VUVM_regblock__Syms;

class VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82 : public VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz59_TBz59 {
  public:
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82> __PVT__m_if;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_component__Tz84> __PVT__m_comp;
    VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82>> __PVT__m_provided_by;
    VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82>> __PVT__m_provided_to;
    VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82>> __PVT__m_imp_list;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_port_base__Tz82"; }
    virtual void __VnoInFunc_connect(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82> provider);
    ...
    void __VnoInFunc_get_if(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82> &get_if__Vfuncrtn);
    ...
    void __VnoInFunc_m_add_list(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82> provider);
    void __VnoInFunc_m_check_relationship(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82> provider, CData/*0:0*/ &m_check_relationship__Vfuncrtn);
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82() = default;
    ...
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz82();
};
