...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_field_int(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ lhs, QData/*63:0*/ rhs, IData/*31:0*/ size, IData/*31:0*/ radix, CData/*0:0*/ &compare_field_int__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_field_int\n"); );
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_field_real(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, double lhs, double rhs, CData/*0:0*/ &compare_field_real__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_field_real\n"); );
    // Body
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_object(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> lhs, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> rhs, CData/*0:0*/ &compare_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_object\n"); );
    // Body
    {
        ...
        VL_NULL_CHECK(lhs, "../../uvm/distrib/src/base/uvm_comparer.svh", 304)->__VnoInFunc_compare(vlSymsp, rhs, 
                                                                                VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer>{this}, compare_object__Vfuncrtn);
...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_string(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, std::string lhs, std::string rhs, CData/*0:0*/ &compare_string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_string\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    std::string msg;
    {
        ...
        if ((lhs != rhs)) {
            ...
            void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_print_msg(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string msg) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_print_msg\n"); );
                // Body
                VlProcess::currentp(vlProcess.get());
                std::string __VlefCall_1__get;
                std::string __VlefCall_0__get;
                VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_root> root;
            ...
            void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_print_rollup(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> lhs) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_print_rollup\n"); );
                // Body
                VlProcessRef vlProcess = std::make_shared<VlProcess>();
                VlProcess::currentp(vlProcess.get());
            ...
            void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_print_msg_object(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> lhs, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> rhs) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_print_msg_object\n"); );
                // Body
                VlProcessRef vlProcess = std::make_shared<VlProcess>();
                VlProcess::currentp(vlProcess.get());
            ...
            void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::init(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::new\n"); );
                // Body
            ...
            void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::_ctor_var_reset(Vhello_uvm_v1__Syms* __restrict vlSymsp) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::_ctor_var_reset\n"); );
                // Body
