...
void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8__Vclpkg::__VnoInFunc_get_type(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    if ((VlNull{} == this->__PVT__my_type)) {
        this->__PVT__my_type = VL_NEW(VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8, vlProcess, vlSymsp, ""s, ""s);
    }
    get_type__Vfuncrtn = this->__PVT__my_type;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8__Vclpkg::__VnoInFunc_get_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8> rsrc;
    std::string msg;
    {
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8__Vclpkg::__VnoInFunc_get_by_type(VUVM_Register8b__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8__Vclpkg::__VnoInFunc_get_highest_precedence(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz5> &q, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8> &get_highest_precedence__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8__Vclpkg::__VnoInFunc_get_highest_precedence\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8> rsrc;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8> r;
    IData/*31:0*/ prec;
    IData/*31:0*/ first;
    {
        prec = 0U;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, std::string scope) {
    VUVM_Register8b_uvm_pkg__03a__03auvm_resource_base::init(vlProcess, vlSymsp, name, scope);
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::new\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_convert2string(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_convert2string\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_get_type_handle(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource_base> &get_type_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_get_type_handle\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8> __Vfunc_get_type__9__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz8__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __Vfunc_get_type__9__Vfuncout);
    get_type_handle__Vfuncrtn = __Vfunc_get_type__9__Vfuncout;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_set(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_set\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource_pool> rp;
    ...
    VL_NULL_CHECK(rp, "../../uvm/distrib/src/base/uvm_resource.svh", 1484)->__VnoInFunc_set(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8>{this}, 0U);
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_set_override(VUVM_Register8b__Syms* __restrict vlSymsp, CData/*1:0*/ __SYM__override) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_set_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource_pool> rp;
    ...
    VL_NULL_CHECK(rp, "../../uvm/distrib/src/base/uvm_resource.svh", 1499)->__VnoInFunc_set(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8>{this}, __SYM__override);
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_read(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_config_object_wrapper> &read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_read\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_write(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_config_object_wrapper> t, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_write\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_set_priority(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ pri) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_set_priority\n"); );
    // Body
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource_pool> rp;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_pool__Vclpkg.__VnoInFunc_get(vlSymsp, rp);
    VL_NULL_CHECK(rp, "../../uvm/distrib/src/base/uvm_resource.svh", 1640)->__VnoInFunc_set_priority(vlSymsp, 
                                                                                VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8>{this}, pri);
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_randomize(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc___Vsetup_constraints(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc___VBasicRand(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::_ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::~VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz8::~\n"); );
}
