...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_DEFAULT_FACTORY__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_DEFAULT_FACTORY__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_factory_queue_class;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_default_factory__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_default_factory__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_default_factory__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_default_factory__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
};

#include "VUVM_regblock_uvm_pkg__03a__03auvm_factory__Vclpkg.h"

class VUVM_regblock__Syms;

class VUVM_regblock_uvm_pkg__03a__03auvm_default_factory : public VUVM_regblock_uvm_pkg__03a__03auvm_factory {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper>, CData/*0:0*/> __PVT__m_types;
    ...
    VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper>> __PVT__m_type_names;
    VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_type_overrides;
    VlAssocArray<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper>, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_factory_queue_class>> __PVT__m_inst_override_queues;
    VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_factory_queue_class>> __PVT__m_inst_override_name_queues;
    VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_wildcard_inst_overrides;
    VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_override_info;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_default_factory"; }
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_default_factory(*this); }
    void __VnoInFunc_check_inst_override_exists(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> original_type, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string full_inst_path, CData/*0:0*/ &check_inst_override_exists__Vfuncrtn);
    ...
    void __VnoInFunc_m_debug_create(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string parent_inst_path, std::string name);
    void __VnoInFunc_m_debug_display(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> result, std::string full_inst_path);
    void __VnoInFunc_m_has_wildcard(VUVM_regblock__Syms* __restrict vlSymsp, std::string nm, CData/*0:0*/ &m_has_wildcard__Vfuncrtn);
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_default_factory() = default;
    void init(VUVM_regblock__Syms* __restrict vlSymsp);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_default_factory();
};
