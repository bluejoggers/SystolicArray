...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_MEM_MAM__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_MEM_MAM__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam : public virtual VlClass {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam_policy> __PVT__default_alloc;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem> __PVT__memory;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam_cfg> __PVT__cfg;
    ...
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam(*this); }
    void __VnoInFunc_convert2string(Vhello_uvm__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn);
    void __VnoInFunc_for_each(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ reset, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_region> &for_each__Vfuncrtn);
    ...
    void __VnoInFunc_reconfigure(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam_cfg> cfg, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam_cfg> &reconfigure__Vfuncrtn);
    void __VnoInFunc_release_all_regions(Vhello_uvm__Syms* __restrict vlSymsp);
    void __VnoInFunc_release_region(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_region> region);
    void __VnoInFunc_request_region(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ n_bytes, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam_policy> alloc, std::string fname, IData/*31:0*/ lineno, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_region> &request_region__Vfuncrtn);
    void __VnoInFunc_reserve_region(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ start_offset, IData/*31:0*/ n_bytes, std::string fname, IData/*31:0*/ lineno, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_region> &reserve_region__Vfuncrtn);
  private:
    void _ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam() = default;
    void init(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam_cfg> cfg, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem> mem);
    ~Vhello_uvm_uvm_pkg__03a__03auvm_mem_mam() {}
};
