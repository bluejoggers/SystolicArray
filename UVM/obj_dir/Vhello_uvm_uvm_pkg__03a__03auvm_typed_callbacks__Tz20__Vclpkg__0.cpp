...
void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg::__VnoInFunc_m_initialize(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20> &m_initialize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg::__VnoInFunc_m_initialize\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base> __Vtask_m_initialize__0__Vfuncout;
    // Body
    ...
    if ((VlNull{} == this->__PVT__m_t_inst)) {
        ...
        this->__PVT__m_t_inst = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20, vlProcess, vlSymsp);
        this->__PVT__m_tw_cb_q = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz34, vlProcess, vlSymsp, "typewide_queue"s);
    }
    m_initialize__Vfuncrtn = this->__PVT__m_t_inst;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg::__VnoInFunc_m_cb_find(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz34> q, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ &m_cb_find__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg::__VnoInFunc_m_cb_find\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg::__VnoInFunc_m_cb_find_name(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz34> q, std::string name, std::string where, IData/*31:0*/ &m_cb_find_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg::__VnoInFunc_m_cb_find_name\n"); );
    // Locals
    ...
    void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg::__VnoInFunc_display(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> obj) {
        VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg::__VnoInFunc_display\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> me;
        VlQueue<std::string> cbq;
        VlQueue<std::string> inst_q;
        VlQueue<std::string> mode_q;
        VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callback> cb;
        std::string blanks;
        VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> bobj;
    ...
    void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc_m_am_i_a(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ &m_am_i_a__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc_m_am_i_a\n"); );
        // Body
        IData/*31:0*/ __VlefExpr_0;
        VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> this_type;
        {
    ...
    void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc_m_get_tw_cb_q(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz34> &m_get_tw_cb_q__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc_m_get_tw_cb_q\n"); );
        // Body
        ...
        VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base> unnamedblk1__DOT__unnamedblk2__DOT__dt;
        {
            this->__VnoInFunc_m_am_i_a(vlSymsp, obj, __VlefCall_0__m_am_i_a);
            if (__VlefCall_0__m_am_i_a) {
                unnamedblk1__DOT__i = 0U;
                while (VL_LTS_III(32, unnamedblk1__DOT__i, Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
                    unnamedblk1__DOT__i__Vloopsize 
                        = Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size();
                    unnamedblk1__DOT__unnamedblk2__DOT__dt 
                        = vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid_base__Vclpkg.__PVT__typeid_map
                        .at(Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.at(unnamedblk1__DOT__i));
                    if (((VlNull{} != unnamedblk1__DOT__unnamedblk2__DOT__dt) 
                         & (unnamedblk1__DOT__unnamedblk2__DOT__dt 
                            != VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20>{this}))) {
                ...
                m_get_tw_cb_q__Vfuncrtn = vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__PVT__m_tw_cb_q;
            } else {
    ...
    void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc_m_add_tw_cbs(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc_m_add_tw_cbs\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base> cb_pair;
        VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> obj;
        VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_backdoor> me;
        CData/*0:0*/ warned;
        VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz34> q;
        warned = 0U;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__PVT__m_tw_cb_q, cb, __VlefCall_0__m_cb_find);
        if ((0xffffffffU == __VlefCall_0__m_cb_find)) {
            VL_NULL_CHECK(cb, "../../uvm/distrib/src/base/uvm_callback.svh", 253)
                        ->__VnoInFunc_get_name(vlSymsp, __VlefCall_1__get_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__VnoInFunc_m_cb_find_name(vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__PVT__m_tw_cb_q, 
                                                                                VL_CVT_PACK_STR_NN(__VlefCall_1__get_name), "type"s, __VlefCall_2__m_cb_find_name);
            warned = (1U & __VlefCall_2__m_cb_find_name);
            if ((0U == ordering)) {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__PVT__m_tw_cb_q, "../../uvm/distrib/src/base/uvm_callback.svh", 255)
                        ->__VnoInFunc_push_back(vlSymsp, cb);
            } else {
                VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__PVT__m_tw_cb_q, "../../uvm/distrib/src/base/uvm_callback.svh", 257)
        ...
        if ((0U != __VlefCall_3__first)) {
            do {
                ...
                if (__VlefExpr_4) {
                    ...
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, q, cb, __VlefCall_5__m_cb_find);
        ...
        while (VL_LTS_III(32, unnamedblk5__DOT__i, Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            unnamedblk5__DOT__i__Vloopsize = Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size();
            cb_pair = vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid_base__Vclpkg.__PVT__typeid_map
                .at(Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.at(unnamedblk5__DOT__i));
            if ((cb_pair != VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20>{this})) {
                VL_NULL_CHECK(cb_pair, "../../uvm/distrib/src/base/uvm_callback.svh", 282)
                        ->__VnoInFunc_m_add_tw_cbs(vlSymsp, cb, ordering);
            }
            if ((unnamedblk5__DOT__i__Vloopsize <= Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
    ...
    void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc_m_delete_tw_cbs(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_callback> cb, CData/*0:0*/ &m_delete_tw_cbs__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc_m_delete_tw_cbs\n"); );
        // Locals
        ...
        VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz34> q;
        IData/*31:0*/ pos;
        vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__VnoInFunc_m_cb_find(vlSymsp, vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__PVT__m_tw_cb_q, cb, pos);
        if ((0xffffffffU != pos)) {
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_typed_callbacks__Tz20__Vclpkg.__PVT__m_tw_cb_q, "../../uvm/distrib/src/base/uvm_callback.svh", 295)
        ...
        while (VL_LTS_III(32, unnamedblk6__DOT__i, Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
            unnamedblk6__DOT__i__Vloopsize = Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size();
            cb_pair = vlSymsp->TOP__uvm_pkg__03a__03auvm_typeid_base__Vclpkg.__PVT__typeid_map
                .at(Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.at(unnamedblk6__DOT__i));
            if ((cb_pair != VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20>{this})) {
            ...
            if ((unnamedblk6__DOT__i__Vloopsize <= Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::__PVT__m_derived_types.size())) {
    ...
    void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp) {
        Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base::init(vlProcess, vlSymsp);
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::new\n"); );
        // Body
        VlProcess::currentp(vlProcess.get());
        /*super.new*/;
    }

    void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc_randomize\n"); );
        // Body
    ...
    void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc___Vsetup_constraints\n"); );
    }

    void Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::__VnoInFunc___VBasicRand\n"); );
        // Body
        __VBasicRand__Vfuncrtn = 1U;
    }

    Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::~Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20() {
        VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz20::~\n"); );
    }
