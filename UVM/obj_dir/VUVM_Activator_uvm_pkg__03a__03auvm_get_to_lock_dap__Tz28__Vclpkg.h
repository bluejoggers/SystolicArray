...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ28__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ28__VCLPKG_H_  // guard
...
class VUVM_Activator_uvm_pkg__03a__03auvm_set_get_dap_base__Tz28;
class VUVM_Activator_uvm_pkg__03a__03auvm_status_container;


class VUVM_Activator__Syms;

class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz28__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz28__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz28__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz28__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__Tz55> &get_type__Vfuncrtn);
};
...
class VUVM_Activator_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz28 : public VUVM_Activator_uvm_pkg__03a__03auvm_set_get_dap_base__Tz28 {
  public:
    ...
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz28(*this); }
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz28() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz28();
};
