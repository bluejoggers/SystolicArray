...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> cntxt, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_objection> objection) {
    VUVM_Register8b_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::new\n"); );
    // Locals
    ...
    this->__PVT__m_cb = VL_NEW(VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat_callback, vlProcess, vlSymsp, 
                               VL_CVT_PACK_STR_NN(VL_CONCATN_NNN(name, "_cb"s)), this->__PVT__m_cntxt);
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_mode(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ mode, IData/*31:0*/ &set_mode__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_mode\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_heartbeat(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_event_> e, VlQueue<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component>> &comps) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_set_heartbeat\n"); );
    // Body
    IData/*31:0*/ unnamedblk1__DOT__i;
    unnamedblk1__DOT__i = 0;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> c;
    {
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_add(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> comp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_add\n"); );
    // Body
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> c;
    {
        c = comp;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_remove(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> comp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_remove\n"); );
    // Body
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> c;
    c = comp;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_start(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_event_> e) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_start\n"); );
    // Body
        ...
        }
        {
            ...
            __Vinline_0___VnoInFunc_m_enable_cb___Vtask_callback_mode__15__Vfuncout = 0;
            {
                ...
                if ((1U & (~ (IData)(this->__PVT__m_added)))) {
                    vlSymsp->TOP__uvm_pkg__03a__03auvm_callbacks__Tz17_TBz87__Vclpkg.__VnoInFunc_add(vlSymsp, this->__PVT__m_objection, this->__PVT__m_cb, 0U);
                }
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_stop(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_stop\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process\n"); );
    // Body
    {
        if (this->__PVT__m_started) {
            goto __Vlabel0;
...
VlCoroutine VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process____Vfork_1__0(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_start_hb_process____Vfork_1__0\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_enable_cb(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_enable_cb\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_disable_cb(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_disable_cb\n"); );
    // Locals
...
VlCoroutine VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03a__VDynScope_32> __VDynScope_m_hb_process_1;
    __VDynScope_m_hb_process_1 = VL_NEW(VUVM_Register8b_uvm_pkg__03a__03a__VDynScope_32, vlSymsp);
...
VlCoroutine VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__1(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlForkSync __Vfork_2__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__1\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
VlCoroutine VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__0(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlForkSync __Vfork_2__sync, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03a__VDynScope_32> __VDynScope_m_hb_process_1) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_m_hb_process____Vfork_2__0\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03a__VDynScope_32> __Vtask___VforkTask_0__19____VDynScope_m_hb_process_1;
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk2__DOT__idx;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk2__DOT__idx__Vnext;
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk3__DOT__unnamedblk4__DOT__idx;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk3__DOT__unnamedblk4__DOT__idx__Vnext;
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk5__DOT__unnamedblk6__DOT__idx;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk5__DOT__unnamedblk6__DOT__idx__Vnext;
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk7__DOT__unnamedblk8__DOT__idx;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> __Vtask___VforkTask_0__19__unnamedblk7__DOT__unnamedblk8__DOT__idx__Vnext;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_randomize(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___Vsetup_constraints(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___VBasicRand(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::_ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::_ctor_var_reset\n"); );
    // Body
...
VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::~VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_heartbeat::~\n"); );
}
