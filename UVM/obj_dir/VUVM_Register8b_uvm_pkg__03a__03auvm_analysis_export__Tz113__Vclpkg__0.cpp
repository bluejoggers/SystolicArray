...
void VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113::init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> parent) {
    VUVM_Register8b_uvm_pkg__03a__03auvm_port_base__Tz126::init(vlProcess, vlSymsp, name, parent, 1U, 1U, 0xffffffffU);
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    _ctor_var_reset(vlSymsp);
    /*super.new*/;
    VUVM_Register8b_uvm_pkg__03a__03auvm_port_base__Tz126::__PVT__m_if_mask = 0x00000100U;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113::__VnoInFunc_get_type_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_analysis_export"s;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113::__VnoInFunc_write(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113::__VnoInFunc_write\n"); );
    // Locals
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_port_base__Tz126> __Vfunc_get_if__2__Vfuncout;
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_tlm_if_base__Tz113_TBz113> tif;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113::_ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113::~VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VUVM_Register8b_uvm_pkg__03a__03auvm_analysis_export__Tz113::~\n"); );
}
