...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_REG_ITEM__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_REG_ITEM__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi33;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_reg_item__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_reg_item__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_reg_item__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_reg_item__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi33> &get_type__Vfuncrtn);
};
...
class VUVM_regblock_uvm_pkg__03a__03auvm_reg_item : public VUVM_regblock_uvm_pkg__03a__03auvm_sequence_item {
  public:
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> __PVT__element;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> __PVT__local_map;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_reg_map> __PVT__map;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> __PVT__parent;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> __PVT__extension;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_item"; }
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_reg_item(*this); }
    virtual void __VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    void __VnoInFunc___VrandCb_post(VUVM_regblock__Syms* __restrict vlSymsp) {}
    void __VnoInFunc___VrandCb_pre(VUVM_regblock__Syms* __restrict vlSymsp) {}
    ...
    void __VnoInFunc_max_values_resize_constrained_array(VUVM_regblock__Syms* __restrict vlSymsp);
    void __VnoInFunc_max_values_setup_constraint(VUVM_regblock__Syms* __restrict vlSymsp);
    virtual void __VnoInFunc_randomize(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn);
  private:
    void _ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp);
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_reg_item() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_reg_item();
};
