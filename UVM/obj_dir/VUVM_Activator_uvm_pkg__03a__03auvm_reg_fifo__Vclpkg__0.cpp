...
void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ size, IData/*31:0*/ n_bits, IData/*31:0*/ has_cover) {
    VUVM_Activator_uvm_pkg__03a__03auvm_reg::init(vlProcess, vlSymsp, name, n_bits, has_cover);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    _ctor_var_reset(vlSymsp);
    /*super.new*/;
    this->__PVT__m_size = size;
    VUVM_Activator_uvm_pkg__03a__03auvm_void::__PVT__constraint.write_var(this->__Vfifo_size, 0x0000000000000020ULL, 
                                                                          "__Vfifo_size", 0ULL);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_build(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_build\n"); );
    // Body
    IData/*31:0*/ __VlefCall_0__get_n_bits;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi29__Vclpkg.__VnoInFunc_create(vlSymsp, "value"s, VlNull{}, ""s, this->__PVT__value);
    ...
    VL_NULL_CHECK(this->__PVT__value, "../../uvm/distrib/src/reg/uvm_reg_fifo.svh", 79)->__VnoInFunc_configure(vlSymsp, 
                                                                                VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo>{this}, __VlefCall_0__get_n_bits, 0U, "RW"s, 0U, 0ULL, 1U, 0U, 1U);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_set_compare(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ check) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_set_compare\n"); );
    // Body
    VL_NULL_CHECK(this->__PVT__value, "../../uvm/distrib/src/reg/uvm_reg_fifo.svh", 91)->__VnoInFunc_set_compare(vlSymsp, check);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_size(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_size\n"); );
    // Body
    size__Vfuncrtn = this->__PVT__fifo.size();
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_capacity(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &capacity__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_capacity\n"); );
    // Body
    capacity__Vfuncrtn = this->__PVT__m_size;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_set(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ value, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_set\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_0__get_n_bits;
    {
        ...
        VUVM_Activator_uvm_pkg__03a__03auvm_reg::__VnoInFunc_set(vlProcess, vlSymsp, value, fname, lineno);
...
VlCoroutine VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_update(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ path, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_update\n"); );
    // Locals
    ...
    IData/*31:0*/ unnamedblk1__DOT__i;
    {
        ...
        VUVM_Activator_uvm_pkg__03a__03auvm_reg::__PVT__m_update_in_progress = 1U;
        ...
        VUVM_Activator_uvm_pkg__03a__03auvm_reg::__PVT__m_update_in_progress = 0U;
        __Vlabel0: ;
    }
    co_return;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_get(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string fname, IData/*31:0*/ lineno, QData/*63:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_get\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    get__Vfuncrtn = this->__PVT__fifo.at(0U);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_do_predict(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_item> rw, IData/*31:0*/ kind, CData/*7:0*/ be) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_do_predict\n"); );
    // Locals
    ...
    {
        VUVM_Activator_uvm_pkg__03a__03auvm_reg::__VnoInFunc_do_predict(vlProcess, vlSymsp, rw, kind, (IData)(be));
        ...
        if (((2U == kind) || (0U == kind))) {
            if (((this->__PVT__fifo.size() != this->__PVT__m_size) 
                 & (~ (IData)(VUVM_Activator_uvm_pkg__03a__03auvm_reg::__PVT__m_update_in_progress)))) {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_pre_write(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_pre_write\n"); );
    // Locals
    ...
    {
        if (((0U != this->__PVT__m_set_cnt) & (~ (IData)(VUVM_Activator_uvm_pkg__03a__03auvm_reg::__PVT__m_update_in_progress)))) {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_pre_read(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_item> rw) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_pre_read\n"); );
    // Body
    if ((0U == this->__PVT__fifo.size())) {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_post_randomize(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_post_randomize\n"); );
    // Body
    this->__PVT__m_set_cnt = 0U;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_valid_fifo_size_resize_constrained_array(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_valid_fifo_size_resize_constrained_array\n"); );
    // Body
    this->__PVT__fifo.resize(this->__Vfifo_size);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_randomize(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_valid_fifo_size_setup_constraint(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc_valid_fifo_size_setup_constraint\n"); );
    // Locals
    std::string __Vtemp_1;
    // Body
    VL_SFORMAT_NX(__Vtemp_1,"#x%x",1, '#',32,this->__PVT__m_size);
    VUVM_Activator_uvm_pkg__03a__03auvm_void::__PVT__constraint.hard(VL_SFORMATF_N_NX("(__Vbv (bvule __Vfifo_size %s))",1
                                                                                , 'S',&(__Vtemp_1)) , "../../uvm/distrib/src/reg/uvm_reg_fifo.svh", 0x00000032U, 
                                                                     "      fifo.size() <= m_size;");
    VUVM_Activator_uvm_pkg__03a__03auvm_void::__PVT__constraint.hard("(__Vbv (bvsge __Vfifo_size #x00000000))"s, "../../uvm/distrib/src/reg/uvm_reg_fifo.svh", 0x00000032U, 
                                                                     "      fifo.size() <= m_size;");
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc___Vresize_constrained_arrays(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc___Vresize_constrained_arrays\n"); );
    // Body
    {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc___Vsetup_constraints(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc___Vsetup_constraints\n"); );
    // Body
    this->__VnoInFunc_valid_fifo_size_setup_constraint(vlSymsp);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc___VBasicRand(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::__VnoInFunc___VBasicRand\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::_ctor_var_reset(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::_ctor_var_reset\n"); );
    // Body
...
VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::~VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_reg_fifo::~\n"); );
}
