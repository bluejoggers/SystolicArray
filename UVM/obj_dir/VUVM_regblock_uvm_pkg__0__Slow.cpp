...
VL_ATTR_COLD void VUVM_regblock_uvm_pkg___eval_static__TOP__uvm_pkg(VUVM_regblock_uvm_pkg* vlSelf, VlProcessRef vlProcess) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VUVM_regblock_uvm_pkg___eval_static__TOP__uvm_pkg\n"); );
    VUVM_regblock__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_table_printer> __PVT__uvm_default_table_printer;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tree_printer> __PVT__uvm_default_tree_printer;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_line_printer> __PVT__uvm_default_line_printer;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource_pool> __Vfunc_get__5__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vfunc_get__6__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_test_done_objection> __Vfunc_get__7__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_cmdline_processor> __Vfunc_get_inst__12__Vfuncout;
    // Body
    ...
    __PVT__uvm_default_table_printer = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_table_printer, vlSymsp);
    __PVT__uvm_default_tree_printer = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_tree_printer, vlSymsp);
    __PVT__uvm_default_line_printer = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_line_printer, vlSymsp);
    vlSelfRef.__PVT__uvm_default_printer = __PVT__uvm_default_table_printer;
    vlSelfRef.__PVT__uvm_default_packer = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_packer, vlSymsp);
    vlSelfRef.__PVT__uvm_default_comparer = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_comparer, vlSymsp);
...
VL_ATTR_COLD void VUVM_regblock_uvm_pkg___ctor_var_reset(VUVM_regblock_uvm_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VUVM_regblock_uvm_pkg___ctor_var_reset\n"); );
    VUVM_regblock__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
}
