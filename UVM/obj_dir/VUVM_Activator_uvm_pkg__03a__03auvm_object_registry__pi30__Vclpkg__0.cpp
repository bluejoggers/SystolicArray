...
void VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    ...
    if ((VlNull{} == this->__PVT__me)) {
        ...
        this->__PVT__me = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30, vlSymsp);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30__Vclpkg::__VnoInFunc_create(VUVM_Activator__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30> __VlefCall_0__get;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30__Vclpkg::__VnoInFunc_set_type_override(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30> __VlefCall_0__get;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30__Vclpkg::__VnoInFunc_set_inst_override(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30> __VlefCall_1__get;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30::__VnoInFunc_create_object(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> &create_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30::__VnoInFunc_create_object\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field> obj;
    if ((""s == name)) {
        obj = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field, vlProcess, vlSymsp, "uvm_vreg_field"s);
    } else {
        obj = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_vreg_field, vlProcess, vlSymsp, name);
    }
    create_object__Vfuncrtn = obj;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30::__VnoInFunc_get_type_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_vreg_field"s;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30::init(VUVM_Activator__Syms* __restrict vlSymsp) {
    VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30::new\n"); );
    // Body
    /*super.new*/;
}

VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30::~VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi30::~\n"); );
}
