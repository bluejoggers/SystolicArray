...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_PRE_RESET_PHASE__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_PRE_RESET_PHASE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_pre_reset_phase__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_pre_reset_phase> __PVT__m_inst;
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_pre_reset_phase__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_pre_reset_phase__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_pre_reset_phase__Vclpkg);
    ...
    void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_pre_reset_phase> &get__Vfuncrtn);
};
...
class VUVM_Activator_uvm_pkg__03a__03auvm_pre_reset_phase : public VUVM_Activator_uvm_pkg__03a__03auvm_task_phase {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_pre_reset_phase"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_pre_reset_phase(*this); }
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_pre_reset_phase() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_pre_reset_phase();
};
