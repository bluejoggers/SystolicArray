...
void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104__Vclpkg::__VnoInFunc_get_global_queue(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104> &get_global_queue__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104__Vclpkg::__VnoInFunc_get_global_queue\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    if ((VlNull{} == this->__PVT__m_global_queue)) {
        this->__PVT__m_global_queue = VL_NEW(VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104, vlProcess, vlSymsp, "global_queue"s);
    }
    get_global_queue__Vfuncrtn = this->__PVT__m_global_queue;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104__Vclpkg::__VnoInFunc_get_global(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_hdl_path_concat> &get_global__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104__Vclpkg::__VnoInFunc_get_global\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104> gqueue;
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name) {
    VUVM_Register8b_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_get(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_hdl_path_concat> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_get\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_hdl_path_concat> default_value;
    {
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_size(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &size__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_size\n"); );
    // Body
    size__Vfuncrtn = this->__PVT__queue.size();
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_insert(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_hdl_path_concat> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_insert\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_delete(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ index) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_delete\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_pop_front(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_hdl_path_concat> &pop_front__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_pop_front\n"); );
    // Body
    pop_front__Vfuncrtn = this->__PVT__queue.pop_front();
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_pop_back(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_hdl_path_concat> &pop_back__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_pop_back\n"); );
    // Body
    pop_back__Vfuncrtn = this->__PVT__queue.pop_back();
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_push_front(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_hdl_path_concat> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_push_front\n"); );
    // Body
    this->__PVT__queue.push_front(item);
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_push_back(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_hdl_path_concat> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_push_back\n"); );
    // Body
    this->__PVT__queue.push_back(item);
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_create(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_create\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104> v;
    v = VL_NEW(VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104, vlProcess, vlSymsp, name);
    create__Vfuncrtn = v;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_get_type_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_queue"s;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_do_copy(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_do_copy\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefLogOr_1;
    IData/*31:0*/ __VlefExpr_0;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104> p;
    {
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_convert2string(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_convert2string\n"); );
    // Locals
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_randomize(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc___Vsetup_constraints(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc___VBasicRand(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::_ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::~VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz104::~\n"); );
}
