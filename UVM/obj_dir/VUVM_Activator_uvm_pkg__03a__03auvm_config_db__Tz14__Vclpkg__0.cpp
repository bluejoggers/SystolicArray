...
void VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14__Vclpkg::__VnoInFunc_get(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper> &value, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __Vtask_get_root__2__Vfuncout;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz14> __Vfunc_get_highest_precedence__8__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_3__is_tracing;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz14> __VlefCall_2__get_type;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14__Vclpkg::__VnoInFunc_set(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz49> __VlefCall_2__new;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    ...
    CData/*0:0*/ exists;
    std::string lookup;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz49> pool;
    std::string rstate;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> cs;
    ...
    if ((! this->__PVT__m_rsc.exists(cntxt))) {
        __VlefCall_2__new = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_pool__Tz2_TBz49, vlProcess, vlSymsp, ""s);
    ...
    if ((0U != __VlefCall_3__exists)) {
        ...
        r = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz14, vlProcess, vlSymsp, field_name, inst_name);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14__Vclpkg::__VnoInFunc_exists(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, CData/*0:0*/ spell_chk, CData/*0:0*/ &exists__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14__Vclpkg::__VnoInFunc_exists\n"); );
    // Locals
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __Vtask_get_root__38__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz14> __VlefCall_2__get_by_name;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> cs;
    exists__Vfuncrtn = 0U;
...
VlCoroutine VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14__Vclpkg::__VnoInFunc_wait_modified(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14__Vclpkg::__VnoInFunc_wait_modified\n"); );
    // Locals
...
void VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14::init(VUVM_Activator__Syms* __restrict vlSymsp) {
    VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz14::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14::new\n"); );
    // Body
    /*super.new*/;
}

VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14::~VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              VUVM_Activator_uvm_pkg__03a__03auvm_config_db__Tz14::~\n"); );
}
