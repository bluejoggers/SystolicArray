...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_get_by_type(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_0__get_type;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz40__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __VlefCall_0__get_type);
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz40__Vclpkg.__VnoInFunc_get_by_type(vlSymsp, scope, __VlefCall_0__get_type, get_by_type__Vfuncrtn);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_get_by_name(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, scope, name, (IData)(rpterr), get_by_name__Vfuncrtn);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_default(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> &set_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_default\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> r;
    r = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40, vlProcess, vlSymsp, name, scope);
    VL_NULL_CHECK(r, "../../uvm/distrib/src/base/uvm_resource_db.svh", 96)->__VnoInFunc_set(vlSymsp);
    set_default__Vfuncrtn = r;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_m_show_msg(Vhello_uvm__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_m_show_msg\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ val, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> rsrc;
    rsrc = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40, vlProcess, vlSymsp, name, scope);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_anonymous(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, CData/*0:0*/ val, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_anonymous\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> rsrc;
    rsrc = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40, vlProcess, vlSymsp, ""s, scope);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ val, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override_type(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ val, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ val, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_set_override_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_read_by_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ &val, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_read_by_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_read_by_type(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, CData/*0:0*/ &val, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_read_by_type\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> rsrc;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_write_by_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ val, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_write_by_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_write_by_type(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, CData/*0:0*/ val, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_write_by_type\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> rsrc;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_dump(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg::__VnoInFunc_dump\n"); );
    // Body
