...
void Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq__Vclpkg::__VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi45> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi45__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, get_type__Vfuncrtn);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc_get_object_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi45> __Vfunc_get__0__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi45__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, __Vfunc_get__0__Vfuncout);
    get_object_type__Vfuncrtn = __Vfunc_get__0__Vfuncout;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc_create(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc_create\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq> tmp;
    if ((""s == name)) {
        tmp = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq, vlProcess, vlSymsp, "uvm_reg_mem_built_in_seq"s);
    } else {
        tmp = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq, vlProcess, vlSymsp, name);
    }
    create__Vfuncrtn = tmp;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc_get_type_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_mem_built_in_seq"s;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc____05Fm_uvm_field_automation(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> tmp_data___05F, IData/*31:0*/ what___05F, std::string str___05F) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc____05Fm_uvm_field_automation\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_1;
    CData/*0:0*/ __VlefCall_0__m_do_cycle_check;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq> unnamedblk1__DOT__local_data___05F;
    {
        if ((((0x00020006U == what___05F) | (0x00020008U 
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_object__Vclpkg.__PVT_____05Fm_uvm_status_container, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 33)->__VnoInFunc_m_do_cycle_check(vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq>{this}, __VlefCall_0__m_do_cycle_check);
            if (__VlefCall_0__m_do_cycle_check) {
                goto __Vlabel0;
            }
        }
        Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__VnoInFunc____05Fm_uvm_field_automation(vlProcess, vlSymsp, tmp_data___05F, what___05F, str___05F);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name) {
    Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc_body(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc_body\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    std::string __VlefCall_45__get_name;
    IData/*31:0*/ __VlefCall_44__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_43__get_by_name;
    std::string __VlefCall_42__get_full_name;
    CData/*0:0*/ __VlefLogAnd_41;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_40__get_by_name;
    std::string __VlefCall_39__get_full_name;
    std::string __VlefCall_38__get_name;
    IData/*31:0*/ __VlefCall_37__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_36__get_by_name;
    std::string __VlefCall_35__get_full_name;
    CData/*0:0*/ __VlefLogAnd_34;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_33__get_by_name;
    std::string __VlefCall_32__get_full_name;
    std::string __VlefCall_31__get_name;
    IData/*31:0*/ __VlefCall_30__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_29__get_by_name;
    std::string __VlefCall_28__get_full_name;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_27__get_by_name;
    std::string __VlefCall_26__get_full_name;
    CData/*0:0*/ __VlefLogAnd_25;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_24__get_by_name;
    std::string __VlefCall_23__get_full_name;
    std::string __VlefCall_22__get_name;
    IData/*31:0*/ __VlefCall_21__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_20__get_by_name;
    std::string __VlefCall_19__get_full_name;
    CData/*0:0*/ __VlefLogAnd_18;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_17__get_by_name;
    std::string __VlefCall_16__get_full_name;
    std::string __VlefCall_15__get_name;
    IData/*31:0*/ __VlefCall_14__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_13__get_by_name;
    std::string __VlefCall_12__get_full_name;
    CData/*0:0*/ __VlefLogAnd_11;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_10__get_by_name;
    std::string __VlefCall_9__get_full_name;
    std::string __VlefCall_8__get_name;
    IData/*31:0*/ __VlefCall_7__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_6__get_by_name;
    std::string __VlefCall_5__get_full_name;
    CData/*0:0*/ __VlefLogAnd_4;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz40> __VlefCall_3__get_by_name;
    std::string __VlefCall_2__get_full_name;
    std::string __VlefCall_1__get_name;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_hw_reset_seq> unnamedblk2__DOT__seq;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_bit_bash_seq> unnamedblk3__DOT__seq;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_access_seq> unnamedblk4__DOT__seq;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_access_seq> unnamedblk5__DOT__seq;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_shared_access_seq> unnamedblk6__DOT__seq;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_walk_seq> unnamedblk7__DOT__seq;
    {
        if ((VlNull{} == Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model)) {
        ...
        if (__VlefLogAnd_4) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 68)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_2__get_full_name);
        ...
        if (__VlefLogAnd_4) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 70)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_5__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_4) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi32__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "reg_hw_reset_seq"s, VlNull{}, ""s, unnamedblk2__DOT__seq);
            VL_NULL_CHECK(unnamedblk2__DOT__seq, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 73)->__PVT__model 
                = Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model;
            co_await VL_NULL_CHECK(unnamedblk2__DOT__seq, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 74)->__VnoInFunc_start(vlProcess, vlSymsp, VlNull{}, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq>{this}, 0xffffffffU, 1U);
        ...
        if (__VlefLogAnd_11) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 79)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_9__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_11) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 81)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_12__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_11) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi34__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "reg_bit_bash_seq"s, VlNull{}, ""s, unnamedblk3__DOT__seq);
        ...
        if (__VlefLogAnd_18) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 90)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_16__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_18) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 92)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_19__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_18) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi40__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "reg_access_seq"s, VlNull{}, ""s, unnamedblk4__DOT__seq);
        ...
        if (__VlefLogAnd_25) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 101)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_23__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_25) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 103)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_26__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_25) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 105)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_28__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_25) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi38__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "mem_access_seq"s, VlNull{}, ""s, unnamedblk5__DOT__seq);
        ...
        __VlefLogAnd_34 = (0U != (0x0000000000000010ULL 
                                  & this->__PVT__tests));
        if (__VlefLogAnd_34) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 114)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_32__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_34) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 116)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_35__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_34) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi44__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "shared_access_seq"s, VlNull{}, ""s, unnamedblk6__DOT__seq);
        ...
        __VlefLogAnd_41 = (0U != (0x0000000000000020ULL 
                                  & this->__PVT__tests));
        if (__VlefLogAnd_41) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 125)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_39__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_41) {
            VL_NULL_CHECK(Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_::__PVT__model, "../../uvm/distrib/src/reg/sequences/uvm_reg_mem_built_in_seq.svh", 127)->__VnoInFunc_get_full_name(vlProcess, vlSymsp, __VlefCall_42__get_full_name);
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz40__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, 
                                                                                VL_CVT_PACK_STR_NN(
        ...
        if (__VlefLogAnd_41) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_object_registry__pi36__Vclpkg.__VnoInFunc_create(vlProcess, vlSymsp, "mem_walk_seq"s, VlNull{}, ""s, unnamedblk7__DOT__seq);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc___Vsetup_constraints\n"); );
    // Body
    this->__VnoInFunc_pick_sequence_setup_constraint(vlSymsp);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::~Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_reg_mem_built_in_seq::~\n"); );
}
