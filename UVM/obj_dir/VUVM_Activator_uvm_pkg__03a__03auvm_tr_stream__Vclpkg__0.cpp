...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_get_stream_from_handle(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ id, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream> &get_stream_from_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_get_stream_from_handle\n"); );
    // Body
    {
        if ((0U == id)) {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_m_free_id(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream__Vclpkg::__VnoInFunc_m_free_id\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name) {
    VUVM_Activator_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    _ctor_var_reset(vlSymsp);
    /*super.new*/;
    this->__PVT__m_cfg_dap = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20, vlProcess, vlSymsp, "cfg_dap"s);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_db(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tr_database> &get_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_db\n"); );
    // Locals
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__2__value;
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03am_uvm_tr_stream_cfg> m_cfg;
    {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_scope(VUVM_Activator__Syms* __restrict vlSymsp, std::string &get_scope__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_scope\n"); );
    // Locals
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__12__value;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_stream_type_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string &get_stream_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_stream_type_name\n"); );
    // Locals
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__22__value;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_close(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_close\n"); );
    // Body
    CData/*0:0*/ __VlefCall_1__is_open;
    CData/*0:0*/ __VlefCall_0__is_open;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> unnamedblk1__DOT__idx;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> unnamedblk1__DOT__idx__Vnext;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_free(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_free\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    CData/*0:0*/ __VlefCall_0__is_open;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> unnamedblk2__DOT__idx;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> unnamedblk2__DOT__idx__Vnext;
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tr_database> db;
    {
        ...
        if (__VlefCall_2__is_open) {
            {
                ...
                VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> __Vinline_0___VnoInFunc_close_unnamedblk1__DOT__idx;
                VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> __Vinline_0___VnoInFunc_close_unnamedblk1__DOT__idx__Vnext;
        ...
        if (vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream.exists(
                                                                                VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream>{this})) {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_do_open(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tr_database> db, std::string scope, std::string stream_type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_do_open\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __Vtask_try_get__58__value;
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03am_uvm_tr_stream_cfg> m_cfg;
    {
        ...
        if (__VlefCall_2__try_get) {
            ...
            m_cfg = VL_NEW(VUVM_Activator_uvm_pkg__03a__03am_uvm_tr_stream_cfg, vlSymsp);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_open(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &is_open__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_open\n"); );
    // Body
    is_open__Vfuncrtn = this->__PVT__m_is_opened;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_closed(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &is_closed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_is_closed\n"); );
    // Body
    is_closed__Vfuncrtn = this->__PVT__m_is_closed;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_open_recorder(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ open_time, std::string type_name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> &open_recorder__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_open_recorder\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_open;
    ...
    if (__VlefCall_0__is_open) {
        ...
        if ((VlNull{} != open_recorder__Vfuncrtn)) {
            ...
            VL_NULL_CHECK(open_recorder__Vfuncrtn, "../../uvm/distrib/src/base/uvm_tr_stream.svh", 343)->__VnoInFunc_m_do_open(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream>{this}, m_time, type_name);
        }
        if ((VlNull{} != unnamedblk3__DOT__p)) {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_free_recorder(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> recorder) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_free_recorder\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_recorders(VUVM_Activator__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder>> &q, CData/*0:0*/ &get_recorders__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_recorders\n"); );
    // Body
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> unnamedblk4__DOT__idx;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> unnamedblk4__DOT__idx__Vnext;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_handle(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_get_handle\n"); );
    // Locals
    ...
    if ((1U & ((~ (IData)(__VlefCall_0__is_open)) & 
        ...
        if (__VlefExpr_2) {
            __VlefExpr_2 = (vlSymsp->TOP__uvm_pkg__03a__03auvm_tr_stream__Vclpkg.__PVT__m_ids_by_stream
                            .at(VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream>{this}) 
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_get_handle(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &m_get_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_m_get_handle\n"); );
    // Body
    m_get_handle__Vfuncrtn = 0;
    this->__VnoInFunc_get_handle(vlSymsp, m_get_handle__Vfuncrtn);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tr_database> db, std::string scope, std::string stream_type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open\n"); );
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_close(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_close\n"); );
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_free(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_free\n"); );
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open_recorder(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ open_time, std::string type_name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> &do_open_recorder__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_do_open_recorder\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    do_open_recorder__Vfuncrtn = VlNull{};
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_randomize(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___Vsetup_constraints(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___VBasicRand(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::_ctor_var_reset(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::_ctor_var_reset\n"); );
    // Body
...
VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::~VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tr_stream::~\n"); );
}
