...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ106__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_POOL__TZ2_TBZ106__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_global(VUVM_regblock__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz105> &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_pool(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106> &get_global_pool__Vfuncrtn);
};
...
class VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106 : public VUVM_regblock_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz105>> __PVT__pool;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_pool__Tz2_TBz106"; }
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106(*this); }
    virtual void __VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    virtual void __VnoInFunc___Vsetup_constraints(VUVM_regblock__Syms* __restrict vlSymsp);
    virtual void __VnoInFunc_add(VUVM_regblock__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz105> item);
    ...
    virtual void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string key, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_queue__Tz105> &get__Vfuncrtn);
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_pool__Tz2_TBz106();
};
