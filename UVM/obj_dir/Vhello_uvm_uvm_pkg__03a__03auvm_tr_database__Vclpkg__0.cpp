...
void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name) {
    Vhello_uvm_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::new\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_db(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &open_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_db\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_close_db(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &close_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_close_db\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_is_open(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &is_open__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_is_open\n"); );
    // Body
    is_open__Vfuncrtn = this->__PVT__m_is_opened;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_stream(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string scope, std::string type_name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> &open_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_open_stream\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__open_db;
    VlClassRef<Vhello_uvm_std__03a__03aprocess> unnamedblk1__DOT__p;
    ...
    if (__VlefCall_0__open_db) {
        ...
        if ((VlNull{} != open_stream__Vfuncrtn)) {
            ...
            VL_NULL_CHECK(open_stream__Vfuncrtn, "../../uvm/distrib/src/base/uvm_tr_database.svh", 157)->__VnoInFunc_m_do_open(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_database>{this}, scope, type_name);
        }
        if ((VlNull{} != unnamedblk1__DOT__p)) {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_m_free_stream(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> stream) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_m_free_stream\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_get_streams(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream>> &q, CData/*0:0*/ &get_streams__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_get_streams\n"); );
    // Body
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> unnamedblk2__DOT__idx;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> unnamedblk2__DOT__idx__Vnext;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_establish_link(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_link_base> link) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_establish_link\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_database> __VlefCall_17__get_db;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_database> __VlefCall_12__get_db;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> s_lhs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> s_rhs;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_database> db;
    {
        ...
        if (__VlefLogAnd_13) {
            ...
            __VlefLogAnd_13 = (__VlefCall_12__get_db 
                               != VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_database>{this});
        }
        if (__VlefLogAnd_13) {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_db(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &do_open_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_db\n"); );
    // Body
    do_open_db__Vfuncrtn = 0U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_close_db(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &do_close_db__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_close_db\n"); );
    // Body
    do_close_db__Vfuncrtn = 0U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_stream(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string scope, std::string type_name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> &do_open_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_open_stream\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
}

void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_establish_link(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_link_base> link) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_do_establish_link\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::_ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::_ctor_var_reset\n"); );
    // Body
...
Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::~Vhello_uvm_uvm_pkg__03a__03auvm_tr_database() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_tr_database::~\n"); );
}
