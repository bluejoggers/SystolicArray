...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool__Vclpkg::__VnoInFunc_get(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    if ((VlNull{} == this->__PVT__rp)) {
        this->__PVT__rp = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool, vlSymsp);
    }
    get__Vfuncrtn = this->__PVT__rp;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool__Vclpkg::__VnoInFunc_sort_by_precedence(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> &q) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool__Vclpkg::__VnoInFunc_sort_by_precedence\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_2__size;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> __VlefCall_1__new;
    ...
    VlAssocArray<IData/*31:0*/, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5>> all;
    ...
    while (true) {
        ...
        if ((! all.exists(VL_NULL_CHECK(r, "../../uvm/distrib/src/base/uvm_resource.svh", 959)
                          ->__PVT__precedence))) {
            __VlefCall_1__new = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5, vlProcess, vlSymsp, ""s);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::init(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_spell_check(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string s, CData/*0:0*/ &spell_check__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_spell_check\n"); );
    // Locals
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> rsrc, CData/*1:0*/ __SYM__override) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> rq;
    std::string name;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> type_handle;
    {
        name = ""s;
        if ((VlNull{} == rsrc)) {
            goto __Vlabel0;
        ...
        if ((""s != name)) {
            if (this->__PVT__rtab.exists(name)) {
                ...
                rq = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5, vlProcess, vlSymsp, ""s);
            }
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_override(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_override\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_name_override(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_name_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_type_override(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_type_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_push_get_record(VUVM_Activator__Syms* __restrict vlSymsp, std::string name, std::string scope, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_push_get_record\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_auditing;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03aget_t> impt;
    {
        ...
        impt = VL_NEW(VUVM_Activator_uvm_pkg__03a__03aget_t, vlSymsp);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_dump_get_records(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_dump_get_records\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03aget_t> record;
    CData/*0:0*/ success;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_lookup_name(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> type_handle, CData/*0:0*/ rpterr, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> &lookup_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_lookup_name\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> __VlefCall_1__get_type_handle;
    IData/*31:0*/ __VlefCall_0__size;
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> rq;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> q;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> r;
    {
        ...
        q = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5, vlProcess, vlSymsp, ""s);
        if ((VlNull{} != unnamedblk2__DOT__p)) {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_get_highest_precedence(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> &q, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> &get_highest_precedence__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_get_highest_precedence\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_1__size;
    IData/*31:0*/ __VlefCall_0__size;
    IData/*31:0*/ unnamedblk4__DOT__i;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> rsrc;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> r;
    IData/*31:0*/ prec;
    {
        prec = 0U;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_get_by_name(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> type_handle, CData/*0:0*/ rpterr, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_get_by_name\n"); );
    // Locals
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> __Vfunc_get_highest_precedence__40__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_0__size;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> q;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_lookup_type(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> &lookup_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_lookup_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_get_by_type(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_get_by_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_0__size;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_lookup_regex_names(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> &lookup_regex_names__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_lookup_regex_names\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    this->__VnoInFunc_lookup_name(vlProcess, vlSymsp, scope, name, type_handle, 0U, lookup_regex_names__Vfuncrtn);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_lookup_regex(VUVM_Activator__Syms* __restrict vlSymsp, std::string re, std::string scope, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> &lookup_regex__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_lookup_regex\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> rq;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> result_q;
    IData/*31:0*/ i;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> r;
    i = 0U;
    this->__Vfunc_uvm_glob_to_re__53__glob = re;
    re = this->__Vfunc_uvm_glob_to_re__53__glob;
    result_q = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5, vlProcess, vlSymsp, ""s);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_lookup_scope(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> &lookup_scope__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_lookup_scope\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_priority_queue(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> rsrc, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> &q, IData/*31:0*/ &pri) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_priority_queue\n"); );
    // Locals
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_priority_type(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> rsrc, IData/*31:0*/ pri) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_priority_type\n"); );
    // Locals
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_priority_name(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> rsrc, IData/*31:0*/ pri) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_priority_name\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__87__Vfuncout;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __Vtask_get_root__88__Vfuncout;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_priority(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> rsrc, IData/*31:0*/ pri) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_set_priority\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_find_unused_resources(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> &find_unused_resources__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_find_unused_resources\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_0__size;
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> q;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource_base> r;
    VUVM_Activator_access_t__struct__0 a;
    IData/*31:0*/ reads;
    IData/*31:0*/ writes;
    q = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5, vlProcess, vlSymsp, ""s);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_print_resources(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz5> rq, CData/*0:0*/ audit) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_print_resources\n"); );
    // Locals
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_dump(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ audit) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::__VnoInFunc_dump\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__125__Vfuncout;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_root> __Vtask_get_root__126__Vfuncout;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::_ctor_var_reset(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_resource_pool::_ctor_var_reset\n"); );
    // Body
