...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ40__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_GET_TO_LOCK_DAP__TZ40__VCLPKG_H_  // guard
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz40;
class Vuvm_pkg_uvm_pkg__03a__03auvm_status_container;


class Vuvm_pkg__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__Tz79> &get_type__Vfuncrtn);
};
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40 : public Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz40 {
  public:
    ...
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40(*this); }
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_get_to_lock_dap__Tz40();
};
