...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SCOREBOARD__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_SCOREBOARD__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_scoreboard__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_scoreboard__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_scoreboard__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_scoreboard__Vclpkg);
...
class Vhello_uvm_uvm_pkg__03a__03auvm_scoreboard : public Vhello_uvm_uvm_pkg__03a__03auvm_component {
  public:
    ...
    Vhello_uvm_uvm_pkg__03a__03auvm_scoreboard() = default;
    ...
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_scoreboard();
};
