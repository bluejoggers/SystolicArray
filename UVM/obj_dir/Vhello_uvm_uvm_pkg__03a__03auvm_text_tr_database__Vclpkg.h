...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_TEXT_TR_DATABASE__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_TEXT_TR_DATABASE__VCLPKG_H_  // guard
...
class Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi16;
...
class Vhello_uvm_uvm_pkg__03a__03auvm_simple_lock_dap__Tz5;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_text_tr_database__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_text_tr_database__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_text_tr_database__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_text_tr_database__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi16> &get_type__Vfuncrtn);
};

#include "Vhello_uvm_uvm_pkg__03a__03auvm_tr_database__Vclpkg.h"

class Vhello_uvm__Syms;

class Vhello_uvm_uvm_pkg__03a__03auvm_text_tr_database : public Vhello_uvm_uvm_pkg__03a__03auvm_tr_database {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_simple_lock_dap__Tz5> __PVT__m_filename_dap;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_text_tr_database"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_text_tr_database(*this); }
  ...
  private:
    VlCoroutine __VnoInFunc_do_close_db____Vfork_1__0(Vhello_uvm__Syms* __restrict vlSymsp);
  public:
    ...
    void __VnoInFunc_set_file_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string filename);
  private:
    void _ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_text_tr_database() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_text_tr_database();
};
