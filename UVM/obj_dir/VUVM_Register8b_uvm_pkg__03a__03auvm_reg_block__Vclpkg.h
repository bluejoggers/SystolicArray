...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_REG_BLOCK__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_REG_BLOCK__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz108;
class VUVM_Register8b_uvm_pkg__03a__03auvm_packer;
class VUVM_Register8b_uvm_pkg__03a__03auvm_printer;
class VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz2;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__id;
    VlAssocArray<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block>, CData/*0:0*/> __PVT__m_roots;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block__Vclpkg);
    ...
    void __VnoInFunc_check_data_width(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ width, CData/*0:0*/ &check_data_width__Vfuncrtn);
    void __VnoInFunc_find_block(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block> root, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block> &find_block__Vfuncrtn);
    void __VnoInFunc_find_blocks(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlQueue<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block>> &blks, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block> root, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> accessor, IData/*31:0*/ &find_blocks__Vfuncrtn);
    void __VnoInFunc_get_root_blocks(VUVM_Register8b__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block>> &blks);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block : public VUVM_Register8b_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlAssocArray<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map>, CData/*0:0*/> __PVT__maps;
    VlAssocArray<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block>, IData/*31:0*/> __PVT__blks;
    VlAssocArray<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg>, IData/*31:0*/> __PVT__regs;
    VlAssocArray<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_vreg>, IData/*31:0*/> __PVT__vregs;
    VlAssocArray<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_mem>, IData/*31:0*/> __PVT__mems;
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block> __PVT__parent;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_backdoor> __PVT__backdoor;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_string_pool__Tz108> __PVT__hdl_paths_pool;
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> __PVT__default_map;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_block"; }
    void __VnoInFunc_Xinit_address_mapsX(VUVM_Register8b__Syms* __restrict vlSymsp);
    ...
    void __VnoInFunc_add_block(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block> blk);
    virtual void __VnoInFunc_add_coverage(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ models);
    void __VnoInFunc_add_hdl_path(VUVM_Register8b__Syms* __restrict vlSymsp, std::string path, std::string kind);
    ...
    void __VnoInFunc_add_mem(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_mem> mem);
    void __VnoInFunc_add_reg(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg> rg);
    void __VnoInFunc_add_vreg(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_vreg> vreg);
    ...
    virtual void __VnoInFunc_create_map(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ base_addr, IData/*31:0*/ n_bytes, IData/*31:0*/ endian, CData/*0:0*/ byte_addressing, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> &create_map__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_block_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block> &get_block_by_name__Vfuncrtn);
    virtual void __VnoInFunc_get_blocks(VUVM_Register8b__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block>> &blks, IData/*31:0*/ hier);
    ...
    void __VnoInFunc_get_default_hdl_path(VUVM_Register8b__Syms* __restrict vlSymsp, std::string &get_default_hdl_path__Vfuncrtn);
    void __VnoInFunc_get_default_map(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> &get_default_map__Vfuncrtn);
    virtual void __VnoInFunc_get_default_path(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &get_default_path__Vfuncrtn);
    virtual void __VnoInFunc_get_field_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_field> &get_field_by_name__Vfuncrtn);
    ...
    void __VnoInFunc_get_full_hdl_path(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind, std::string separator);
    ...
    void __VnoInFunc_get_hdl_path(VUVM_Register8b__Syms* __restrict vlSymsp, VlQueue<std::string> &paths, std::string kind);
    virtual void __VnoInFunc_get_map_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> &get_map_by_name__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_mem_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_mem> &get_mem_by_name__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_reg_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg> &get_reg_by_name__Vfuncrtn);
    ...
    void __VnoInFunc_is_hdl_path_root(VUVM_Register8b__Syms* __restrict vlSymsp, std::string kind, CData/*0:0*/ &is_hdl_path_root__Vfuncrtn);
    void __VnoInFunc_is_locked(VUVM_Register8b__Syms* __restrict vlSymsp, CData/*0:0*/ &is_locked__Vfuncrtn);
    virtual void __VnoInFunc_lock_model(VUVM_Register8b__Syms* __restrict vlSymsp);
    virtual VlCoroutine __VnoInFunc_mirror(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ check, IData/*31:0*/ path, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    ...
    virtual void __VnoInFunc_sample_values(VUVM_Register8b__Syms* __restrict vlSymsp);
    ...
    void __VnoInFunc_set_default_hdl_path(VUVM_Register8b__Syms* __restrict vlSymsp, std::string kind);
    void __VnoInFunc_set_default_map(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map);
    void __VnoInFunc_set_hdl_path_root(VUVM_Register8b__Syms* __restrict vlSymsp, std::string path, std::string kind);
    ...
    virtual VlCoroutine __VnoInFunc_update(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &status, IData/*31:0*/ path, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual VlCoroutine __VnoInFunc_write_mem_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ offset, QData/*63:0*/ data, IData/*31:0*/ path, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual VlCoroutine __VnoInFunc_write_reg_by_name(VUVM_Register8b__Syms* __restrict vlSymsp, IData/*31:0*/ &status, std::string name, QData/*63:0*/ data, IData/*31:0*/ path, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_reg_map> map, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_sequence_base> parent, IData/*31:0*/ prior, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object> extension, std::string fname, IData/*31:0*/ lineno);
    virtual void __VnoInFunc_writememh(VUVM_Register8b__Syms* __restrict vlSymsp, std::string filename);
  private:
    void _ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp);
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ has_coverage);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_reg_block();
};
