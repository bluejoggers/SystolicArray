...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_REG_MEM_BUILT_IN_SEQ__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_REG_MEM_BUILT_IN_SEQ__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_reg_mem_built_in_seq__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_reg_mem_built_in_seq__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_reg_mem_built_in_seq__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_reg_mem_built_in_seq__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_object_registry__pi57> &get_type__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_reg_mem_built_in_seq : public VUVM_Register8b_uvm_pkg__03a__03auvm_reg_sequence_ {
  public:
    ...
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_reg_mem_built_in_seq(*this); }
    ...
    VUVM_Register8b_uvm_pkg__03a__03auvm_reg_mem_built_in_seq() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_reg_mem_built_in_seq();
};
