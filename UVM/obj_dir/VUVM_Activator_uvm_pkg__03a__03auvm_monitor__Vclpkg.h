...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_MONITOR__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_MONITOR__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_monitor__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_monitor__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_monitor__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_monitor__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_monitor : public VUVM_Activator_uvm_pkg__03a__03auvm_component {
  public:
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_monitor() = default;
    ...
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_monitor();
};
