...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_turn_on_tracing(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_turn_on_tracing\n"); );
    // Body
    ...
    if ((1U & (~ (IData)(this->__PVT__ready)))) {
        {
            ...
            VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_cmdline_processor> __Vinline_0___VnoInFunc_init_clp;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_turn_off_tracing(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_turn_off_tracing\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    if ((1U & (~ (IData)(this->__PVT__ready)))) {
        {
            ...
            VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_cmdline_processor> __Vinline_1___VnoInFunc_init_clp;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_is_tracing(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &is_tracing__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_is_tracing\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    if ((1U & (~ (IData)(this->__PVT__ready)))) {
        {
            ...
            VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_cmdline_processor> __Vinline_2___VnoInFunc_init_clp;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_init(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db_options__Vclpkg::__VnoInFunc_init\n"); );
    // Locals
