...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_RELATED_LINK__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_RELATED_LINK__VCLPKG_H_  // guard
...
class Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi19;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_related_link__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_related_link__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_related_link__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_related_link__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_link(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> lhs, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> rhs, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_related_link> &get_link__Vfuncrtn);
    void __VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi19> &get_type__Vfuncrtn);
};

#include "Vhello_uvm_uvm_pkg__03a__03auvm_link_base__Vclpkg.h"

class Vhello_uvm__Syms;

class Vhello_uvm_uvm_pkg__03a__03auvm_related_link : public Vhello_uvm_uvm_pkg__03a__03auvm_link_base {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __PVT__m_lhs;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> __PVT__m_rhs;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_related_link"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_related_link(*this); }
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_related_link() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_related_link();
};
