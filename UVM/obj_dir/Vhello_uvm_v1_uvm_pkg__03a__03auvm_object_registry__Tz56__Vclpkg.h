...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__TZ56__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__TZ56__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz56__Vclpkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz56> __PVT__me;
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz56__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz56__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz56__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_create(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21> &create__Vfuncrtn);
    void __VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz56> &get__Vfuncrtn);
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz56 : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_wrapper {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_object_registry__Tz56"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz56(*this); }
    ...
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz56() = default;
    void init(Vhello_uvm_v1__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__Tz56();
};
