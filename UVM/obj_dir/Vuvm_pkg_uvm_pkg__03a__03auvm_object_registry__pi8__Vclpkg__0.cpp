...
void Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    ...
    if ((VlNull{} == this->__PVT__me)) {
        ...
        this->__PVT__me = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8, vlSymsp);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg::__VnoInFunc_create(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_backdoor> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8> __VlefCall_0__get;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg::__VnoInFunc_set_type_override(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8> __VlefCall_0__get;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg::__VnoInFunc_set_inst_override(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8> __VlefCall_1__get;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8::__VnoInFunc_create_object(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> &create_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8::__VnoInFunc_create_object\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_reg_backdoor> obj;
    if ((""s == name)) {
        obj = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_reg_backdoor, vlProcess, vlSymsp, ""s);
    } else {
        obj = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_reg_backdoor, vlProcess, vlSymsp, name);
    }
    create_object__Vfuncrtn = obj;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8::__VnoInFunc_get_type_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_backdoor"s;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8::init(Vuvm_pkg__Syms* __restrict vlSymsp) {
    Vuvm_pkg_uvm_pkg__03a__03auvm_object_wrapper::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8::new\n"); );
    // Body
    /*super.new*/;
}

Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8::~Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi8::~\n"); );
}
