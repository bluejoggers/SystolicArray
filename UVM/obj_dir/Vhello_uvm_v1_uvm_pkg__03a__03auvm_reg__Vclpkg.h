...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_REG__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_REG__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_max_size(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &get_max_size__Vfuncrtn);
    void __VnoInFunc_include_coverage(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string scope, IData/*31:0*/ models, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> accessor);
};
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_file> __PVT__m_regfile_parent;
    VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_field>> __PVT__m_fields;
    VlClassRef<Vhello_uvm_v1_std__03a__03asemaphore> __PVT__m_atomic;
    VlClassRef<Vhello_uvm_v1_std__03a__03aprocess> __PVT__m_process;
    ...
    VlCoroutine __VnoInFunc_XatomicX(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, CData/*0:0*/ on);
    virtual void __VnoInFunc_Xcheck_accessX(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_item> rw, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map_info> &map_info, std::string caller, CData/*0:0*/ &Xcheck_accessX__Vfuncrtn);
    void __VnoInFunc_Xget_fields_accessX(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map, std::string &Xget_fields_accessX__Vfuncrtn);
    void __VnoInFunc_Xis_locked_by_fieldX(Vhello_uvm_v1__Syms* __restrict vlSymsp, CData/*0:0*/ &Xis_locked_by_fieldX__Vfuncrtn);
    ...
    void __VnoInFunc_XsampleX(Vhello_uvm_v1__Syms* __restrict vlSymsp, QData/*63:0*/ data, QData/*63:0*/ byte_en, CData/*0:0*/ is_read, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map);
    void __VnoInFunc_Xset_busyX(Vhello_uvm_v1__Syms* __restrict vlSymsp, CData/*0:0*/ busy);
    ...
    virtual void __VnoInFunc_backdoor_watch(Vhello_uvm_v1__Syms* __restrict vlSymsp);
    ...
    virtual void __VnoInFunc_do_check(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, QData/*63:0*/ expected, QData/*63:0*/ actual, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map, CData/*0:0*/ &do_check__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_address(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_address__Vfuncrtn);
    virtual void __VnoInFunc_get_addresses(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map, VlQueue<QData/*63:0*/> &addr, IData/*31:0*/ &get_addresses__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_default_map(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string caller, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> &get_default_map__Vfuncrtn);
    ...
    virtual void __VnoInFunc_get_fields(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_field>> &fields);
    ...
    virtual void __VnoInFunc_get_offset(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map, QData/*63:0*/ &get_offset__Vfuncrtn);
    ...
    void __VnoInFunc_is_busy(Vhello_uvm_v1__Syms* __restrict vlSymsp, CData/*0:0*/ &is_busy__Vfuncrtn);
    ...
    virtual void __VnoInFunc_pre_write(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_item> rw);
    virtual void __VnoInFunc_predict(Vhello_uvm_v1__Syms* __restrict vlSymsp, QData/*63:0*/ value, CData/*7:0*/ be, IData/*31:0*/ kind, IData/*31:0*/ path, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map, std::string fname, IData/*31:0*/ lineno, CData/*0:0*/ &predict__Vfuncrtn);
    ...
    virtual void __VnoInFunc_sample(Vhello_uvm_v1__Syms* __restrict vlSymsp, QData/*63:0*/ data, QData/*63:0*/ byte_en, CData/*0:0*/ is_read, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_map> map);
    ...
    virtual void __VnoInFunc_set_parent(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> blk_parent, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_file> regfile_parent);
  ...
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ n_bits, IData/*31:0*/ has_coverage);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg();
};
