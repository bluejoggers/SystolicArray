...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload__Vclpkg::__VnoInFunc_get_type(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi27> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_object_type(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_object_type\n"); );
    // Locals
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi27> __Vfunc_get__0__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_create(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_create\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload> tmp;
    if ((""s == name)) {
        tmp = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload, vlProcess, vlSymsp, ""s);
    } else {
        tmp = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload, vlProcess, vlSymsp, name);
    }
    create__Vfuncrtn = tmp;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_type_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_tlm_generic_payload"s;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc____05Fm_uvm_field_automation(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> tmp_data___05F, IData/*31:0*/ what___05F, std::string str___05F) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc____05Fm_uvm_field_automation\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_1;
    CData/*0:0*/ __VlefCall_0__m_do_cycle_check;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload> unnamedblk1__DOT__local_data___05F;
    {
        if ((((0x00020006U == what___05F) | (0x00020008U 
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_object__Vclpkg.__PVT_____05Fm_uvm_status_container, "../../uvm/distrib/src/tlm2/uvm_tlm2_generic_payload.svh", 364)->__VnoInFunc_m_do_cycle_check(vlSymsp, 
                                                                                VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload>{this}, __VlefCall_0__m_do_cycle_check);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name) {
    VUVM_Activator_uvm_pkg__03a__03auvm_sequence_item::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_print(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_print\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk3__DOT__unnamedblk4__DOT__ext_;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk3__DOT__unnamedblk4__DOT__ext___Vnext;
    CData/*0:0*/ unnamedblk3__DOT__unnamedblk4__DOT__ext___Vmore;
    unnamedblk3__DOT__unnamedblk4__DOT__ext___Vmore = 0;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__ext;
    CData/*7:0*/ be;
    be = 0U;
    VUVM_Activator_uvm_pkg__03a__03auvm_sequence_item::__VnoInFunc_do_print(vlProcess, vlSymsp, printer);
    ...
    VL_NULL_CHECK(printer, "../../uvm/distrib/src/tlm2/uvm_tlm2_generic_payload.svh", 390)->__VnoInFunc_print_generic(vlSymsp, "command"s, "uvm_tlm_command_e"s, 0x00000020U, 
                                                                                VL_CVT_PACK_STR_NN(VUVM_Activator___024unit::__Venumtab_enum_name63
                                                                                [
                                                                                (3U 
                                                                                & this->__PVT__m_command)]), 0x2eU);
    __VlefExpr_0 = VL_CVT_PACK_STR_NN(VUVM_Activator___024unit::__Venumtab_enum_name65
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_copy(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_copy\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_2;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> __VlefCall_1__clone;
    IData/*31:0*/ __VlefExpr_0;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk6__DOT__ext;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk6__DOT__ext__Vnext;
    CData/*0:0*/ unnamedblk6__DOT__ext__Vmore;
    unnamedblk6__DOT__ext__Vmore = 0;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload> gp;
    VUVM_Activator_uvm_pkg__03a__03auvm_transaction::__VnoInFunc_do_copy(vlProcess, vlSymsp, rhs);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_compare(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_compare\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk9__DOT__ext_;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk9__DOT__ext___Vnext;
    CData/*0:0*/ unnamedblk9__DOT__ext___Vmore;
    unnamedblk9__DOT__ext___Vmore = 0;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk9__DOT__unnamedblk10__DOT__ext;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk9__DOT__unnamedblk10__DOT__rhs_ext;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk11__DOT__ext_;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk11__DOT__ext___Vnext;
    CData/*0:0*/ unnamedblk11__DOT__ext___Vmore;
    unnamedblk11__DOT__ext___Vmore = 0;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk11__DOT__unnamedblk12__DOT__ext;
    std::string unnamedblk13__DOT__msg;
    do_compare__Vfuncrtn = 0U;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload> gp;
    VUVM_Activator_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_compare(vlSymsp, rhs, comparer, do_compare__Vfuncrtn);
    __VlefExpr_0 = VL_CAST_DYNAMIC(rhs, gp);
    if (VL_UNLIKELY(((! __VlefExpr_0)))) {
    ...
    if (((~ (IData)(do_compare__Vfuncrtn)) & (0U < VL_NULL_CHECK(comparer, "../../uvm/distrib/src/tlm2/uvm_tlm2_generic_payload.svh", 493)
                                              ->__PVT__show_max))) {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_pack(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_pack\n"); );
    // Locals
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_pack(vlSymsp, packer);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_unpack(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_packer> packer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_unpack\n"); );
    // Body
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_unpack(vlSymsp, packer);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_record(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_recorder> recorder) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_do_record\n"); );
    // Locals
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk42__DOT__ext;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk42__DOT__ext__Vnext;
    ...
    unnamedblk42__DOT__ext__Vmore = 0;
    {
        ...
        VUVM_Activator_uvm_pkg__03a__03auvm_transaction::__VnoInFunc_do_record(vlProcess, vlSymsp, recorder);
        ...
        if (__VlefCall_3__is_open) {
            ...
            if (__VlefCall_4__use_record_attribute) {
                __Vtemp_1 = VUVM_Activator___024unit::__Venumtab_enum_name63
        ...
        if (__VlefCall_9__is_open) {
            ...
            if (__VlefCall_10__use_record_attribute) {
                __Vtemp_2 = VUVM_Activator___024unit::__Venumtab_enum_name65
                    .at(this->__PVT__m_response_status);
                ...
                __VlefExpr_11 = VL_CVT_PACK_STR_NN(VUVM_Activator___024unit::__Venumtab_enum_name65
                                                   .at(this->__PVT__m_response_status));
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_convert2string(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_convert2string\n"); );
    // Locals
    std::string __Vtemp_1;
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    msg = ""s;
    s = ""s;
    VUVM_Activator_uvm_pkg__03a__03auvm_object::__VnoInFunc_convert2string(vlProcess, vlSymsp, __VlefCall_0__convert2string);
    __Vtemp_1 = VUVM_Activator___024unit::__Venumtab_enum_name63
        [(3U & this->__PVT__m_command)];
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_command(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_command__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_command\n"); );
    // Body
    get_command__Vfuncrtn = this->__PVT__m_command;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_command(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ command) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_command\n"); );
    // Body
    this->__PVT__m_command = command;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_is_read(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &is_read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_is_read\n"); );
    // Body
    is_read__Vfuncrtn = (0U == this->__PVT__m_command);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_read(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_read\n"); );
    // Body
    this->__VnoInFunc_set_command(vlSymsp, 0U);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_is_write(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &is_write__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_is_write\n"); );
    // Body
    is_write__Vfuncrtn = (1U == this->__PVT__m_command);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_write(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_write\n"); );
    // Body
    this->__VnoInFunc_set_command(vlSymsp, 1U);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_address(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ addr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_address\n"); );
    // Body
    this->__PVT__m_address = addr;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_address(VUVM_Activator__Syms* __restrict vlSymsp, QData/*63:0*/ &get_address__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_address\n"); );
    // Body
    get_address__Vfuncrtn = this->__PVT__m_address;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_data(VUVM_Activator__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &p) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_data\n"); );
    // Body
    p = this->__PVT__m_data;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_data(VUVM_Activator__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &p) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_data\n"); );
    // Body
    this->__PVT__m_data = p;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_data_length(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_data_length__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_data_length\n"); );
    // Body
    get_data_length__Vfuncrtn = this->__PVT__m_length;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_data_length(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ length) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_data_length\n"); );
    // Body
    this->__PVT__m_length = length;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_streaming_width(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_streaming_width__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_streaming_width\n"); );
    // Body
    get_streaming_width__Vfuncrtn = this->__PVT__m_streaming_width;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_streaming_width(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ width) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_streaming_width\n"); );
    // Body
    this->__PVT__m_streaming_width = width;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_byte_enable(VUVM_Activator__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &p) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_byte_enable\n"); );
    // Body
    p = this->__PVT__m_byte_enable;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_byte_enable(VUVM_Activator__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &p) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_byte_enable\n"); );
    // Body
    this->__PVT__m_byte_enable = p;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_byte_enable_length(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_byte_enable_length__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_byte_enable_length\n"); );
    // Body
    get_byte_enable_length__Vfuncrtn = this->__PVT__m_byte_enable_length;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_byte_enable_length(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ length) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_byte_enable_length\n"); );
    // Body
    this->__PVT__m_byte_enable_length = length;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_dmi_allowed(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ dmi) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_dmi_allowed\n"); );
    // Body
    this->__PVT__m_dmi = dmi;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_is_dmi_allowed(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &is_dmi_allowed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_is_dmi_allowed\n"); );
    // Body
    is_dmi_allowed__Vfuncrtn = this->__PVT__m_dmi;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_response_status(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_response_status__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_response_status\n"); );
    // Body
    get_response_status__Vfuncrtn = this->__PVT__m_response_status;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_response_status(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ status) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_response_status\n"); );
    // Body
    this->__PVT__m_response_status = status;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_is_response_ok(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &is_response_ok__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_is_response_ok\n"); );
    // Body
    is_response_ok__Vfuncrtn = VL_LTS_III(32, 0U, this->__PVT__m_response_status);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_is_response_error(VUVM_Activator__Syms* __restrict vlSymsp, CData/*0:0*/ &is_response_error__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_is_response_error\n"); );
    // Body
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_response_string(VUVM_Activator__Syms* __restrict vlSymsp, std::string &get_response_string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_response_string\n"); );
    // Body
    {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_extension(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> ext, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> &set_extension__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_set_extension\n"); );
    // Body
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> ext_handle;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_num_extensions(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &get_num_extensions__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_num_extensions\n"); );
    // Body
    get_num_extensions__Vfuncrtn = this->__PVT__m_extensions.size();
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_extension(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> ext_handle, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> &get_extension__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_get_extension\n"); );
    // Body
    {
        if ((! this->__PVT__m_extensions.exists(ext_handle))) {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_clear_extension(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> ext_handle) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_clear_extension\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_clear_extensions(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_clear_extensions\n"); );
    // Body
    this->__PVT__m_extensions.clear();
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_pre_randomize(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_pre_randomize\n"); );
    // Body
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk44__DOT__ext_;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk44__DOT__ext___Vnext;
    CData/*0:0*/ unnamedblk44__DOT__ext___Vmore;
    unnamedblk44__DOT__ext___Vmore = 0;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> unnamedblk44__DOT__unnamedblk45__DOT__ext;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_post_randomize(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_post_randomize\n"); );
    // Body
    this->__PVT__m_rand_exts.clear();
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_randomize(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc_randomize\n"); );
    // Body
    IData/*31:0*/ __VlefCall_0____VBasicRand;
    {
        // Inlined CFunc: __VnoInFunc_pre_randomize
        VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> __Vinline_0___VnoInFunc_pre_randomize_unnamedblk44__DOT__ext_;
        VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> __Vinline_0___VnoInFunc_pre_randomize_unnamedblk44__DOT__ext___Vnext;
        ...
        VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_tlm_extension_base> __Vinline_0___VnoInFunc_pre_randomize_unnamedblk44__DOT__unnamedblk45__DOT__ext;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc___Vsetup_constraints(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc___VBasicRand(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::__VnoInFunc___VBasicRand\n"); );
    // Body
    ...
    this->__PVT__m_command = VUVM_Activator___024unit::__Venumvaltab_0
    ...
    this->__PVT__m_response_status = VUVM_Activator___024unit::__Venumvaltab_1
...
void VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::_ctor_var_reset(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::_ctor_var_reset\n"); );
    // Body
...
VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::~VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Activator_uvm_pkg__03a__03auvm_tlm_generic_payload::~\n"); );
}
