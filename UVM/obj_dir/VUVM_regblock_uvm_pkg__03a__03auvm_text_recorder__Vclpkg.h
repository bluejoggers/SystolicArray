...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_TEXT_RECORDER__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_TEXT_RECORDER__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi38;
...
class VUVM_regblock_uvm_pkg__03a__03auvm_text_recorder;
class VUVM_regblock_uvm_pkg__03a__03auvm_text_tr_database;
class VUVM_regblock_uvm_pkg__03a__03auvm_text_tr_stream;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_text_recorder__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_text_recorder__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_text_recorder__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_text_recorder__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi38> &get_type__Vfuncrtn);
};

#include "VUVM_regblock_uvm_pkg__03a__03auvm_recorder__Vclpkg.h"

class VUVM_regblock__Syms;

class VUVM_regblock_uvm_pkg__03a__03auvm_text_recorder : public VUVM_regblock_uvm_pkg__03a__03auvm_recorder {
  public:
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_text_tr_database> __PVT__m_text_db;
    ...
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_text_recorder(*this); }
    ...
    void __VnoInFunc_write_attribute(VUVM_regblock__Syms* __restrict vlSymsp, std::string nm, VlWide<128>/*4095:0*/ value, IData/*31:0*/ radix, IData/*31:0*/ numbits);
    void __VnoInFunc_write_attribute_int(VUVM_regblock__Syms* __restrict vlSymsp, std::string nm, QData/*63:0*/ value, IData/*31:0*/ radix, IData/*31:0*/ numbits);
  private:
    void _ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp);
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_text_recorder() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_text_recorder();
};
