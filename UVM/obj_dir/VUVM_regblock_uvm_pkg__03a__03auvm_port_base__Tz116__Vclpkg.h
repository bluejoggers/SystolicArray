...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_PORT_BASE__TZ116__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_PORT_BASE__TZ116__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116;
class VUVM_regblock_uvm_pkg__03a__03auvm_port_component__Tz120;
class VUVM_regblock_uvm_pkg__03a__03auvm_port_component_base;
class VUVM_regblock_uvm_pkg__03a__03auvm_root;
class VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26;


class VUVM_regblock__Syms;

class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
};

#include "VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26__Vclpkg.h"

class VUVM_regblock__Syms;

class VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116 : public VUVM_regblock_uvm_pkg__03a__03auvm_sqr_if_base__Tz26_TBz26 {
  public:
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116> __PVT__m_if;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_component__Tz120> __PVT__m_comp;
    VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116>> __PVT__m_provided_by;
    VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116>> __PVT__m_provided_to;
    VlAssocArray<std::string, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116>> __PVT__m_imp_list;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_port_base__Tz116"; }
    virtual void __VnoInFunc_connect(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116> provider);
    ...
    void __VnoInFunc_get_if(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116> &get_if__Vfuncrtn);
    ...
    void __VnoInFunc_m_add_list(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116> provider);
    void __VnoInFunc_m_check_relationship(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116> provider, CData/*0:0*/ &m_check_relationship__Vfuncrtn);
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116() = default;
    ...
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz116();
};
