...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_RESOURCE__TZ52__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_RESOURCE__TZ52__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52__Vclpkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52> __PVT__my_type;
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52__Vclpkg);
    ...
    void __VnoInFunc_get_by_type(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52> &get_by_type__Vfuncrtn);
    void __VnoInFunc_get_highest_precedence(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz29> &q, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52> &get_highest_precedence__Vfuncrtn);
    void __VnoInFunc_get_type(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52 : public Vhello_uvm_uvm_pkg__03a__03auvm_resource_base {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_config_object_wrapper> __PVT__val;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_resource__Tz52"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52(*this); }
    ...
    void __VnoInFunc_read(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_config_object_wrapper> &read__Vfuncrtn);
    ...
    void __VnoInFunc_write(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_config_object_wrapper> t, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor);
  private:
    void _ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string scope);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz52();
};
