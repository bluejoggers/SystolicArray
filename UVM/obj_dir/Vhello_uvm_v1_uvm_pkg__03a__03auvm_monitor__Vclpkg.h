...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_MONITOR__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_MONITOR__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_monitor__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_monitor__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_monitor__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_monitor__Vclpkg);
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_monitor : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_component {
  public:
    ...
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_monitor() = default;
    ...
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_monitor();
};
