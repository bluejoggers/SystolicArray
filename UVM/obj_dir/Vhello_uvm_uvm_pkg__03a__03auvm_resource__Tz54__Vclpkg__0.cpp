...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54__Vclpkg::__VnoInFunc_get_type(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    if ((VlNull{} == this->__PVT__my_type)) {
        this->__PVT__my_type = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54, vlProcess, vlSymsp, ""s, ""s);
    }
    get_type__Vfuncrtn = this->__PVT__my_type;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54__Vclpkg::__VnoInFunc_get_by_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54> rsrc;
    std::string msg;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54__Vclpkg::__VnoInFunc_get_by_type(Vhello_uvm__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54__Vclpkg::__VnoInFunc_get_highest_precedence(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_queue__Tz29> &q, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54> &get_highest_precedence__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54__Vclpkg::__VnoInFunc_get_highest_precedence\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54> rsrc;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54> r;
    IData/*31:0*/ prec;
    IData/*31:0*/ first;
    {
        prec = 0U;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string scope) {
    Vhello_uvm_uvm_pkg__03a__03auvm_resource_base::init(vlProcess, vlSymsp, name, scope);
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::new\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_convert2string\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_get_type_handle(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource_base> &get_type_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_get_type_handle\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54> __Vfunc_get_type__9__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz54__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __Vfunc_get_type__9__Vfuncout);
    get_type_handle__Vfuncrtn = __Vfunc_get_type__9__Vfuncout;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_set(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_set\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource_pool> rp;
    ...
    VL_NULL_CHECK(rp, "../../uvm/distrib/src/base/uvm_resource.svh", 1484)->__VnoInFunc_set(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54>{this}, 0U);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_set_override(Vhello_uvm__Syms* __restrict vlSymsp, CData/*1:0*/ __SYM__override) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_set_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource_pool> rp;
    ...
    VL_NULL_CHECK(rp, "../../uvm/distrib/src/base/uvm_resource.svh", 1499)->__VnoInFunc_set(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54>{this}, __SYM__override);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_read(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor, IData/*31:0*/ &read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_read\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    read__Vfuncrtn = 0U;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_write(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ t, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_write\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_set_priority(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ pri) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_set_priority\n"); );
    // Body
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource_pool> rp;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_pool__Vclpkg.__VnoInFunc_get(vlSymsp, rp);
    VL_NULL_CHECK(rp, "../../uvm/distrib/src/base/uvm_resource.svh", 1640)->__VnoInFunc_set_priority(vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54>{this}, pri);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::_ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
    __PVT__val = 0;
}

Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::~Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz54::~\n"); );
}
