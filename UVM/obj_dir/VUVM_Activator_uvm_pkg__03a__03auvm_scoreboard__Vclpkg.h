...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_SCOREBOARD__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_SCOREBOARD__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_scoreboard__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_scoreboard__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_scoreboard__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_scoreboard__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_scoreboard : public VUVM_Activator_uvm_pkg__03a__03auvm_component {
  public:
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_scoreboard() = default;
    ...
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_scoreboard();
};
