...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_int(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix, CData/*7:0*/ scope_separator, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_int\n"); );
    // Body
    this->__VnoInFunc_print_field(vlSymsp, name, value, size, radix, (IData)(scope_separator), type_name);
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_format_header(Vuvm_pkg__Syms* __restrict vlSymsp, std::string &format_header__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_format_header\n"); );
    // Body
    format_header__Vfuncrtn = ""s;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_format_footer(Vuvm_pkg__Syms* __restrict vlSymsp, std::string &format_footer__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_format_footer\n"); );
    // Body
    format_footer__Vfuncrtn = ""s;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::init(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    this->__PVT__knobs = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_printer_knobs, vlSymsp);
    this->__PVT__m_scope = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_scope_stack, vlSymsp);
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_emit(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string &emit__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_emit\n"); );
    // Locals
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_format_row(Vuvm_pkg__Syms* __restrict vlSymsp, Vuvm_pkg_uvm_printer_row_info__struct__0 row, std::string &format_row__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_format_row\n"); );
    // Body
    format_row__Vfuncrtn = ""s;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_header(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ size, std::string arraytype, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_header\n"); );
    // Body
    std::string __VlefCall_2__adjust_name;
    std::string __VlefCall_1__get;
    IData/*31:0*/ __VlefCall_0__depth;
    Vuvm_pkg_uvm_printer_row_info__struct__0 row_info;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_footer(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ size) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_footer\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_range(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ min, IData/*31:0*/ max) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_array_range\n"); );
    // Body
    {
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object_header(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object_header\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> __Vfunc_uvm_object_value_str__27__v;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_object\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> comp;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> child_comp;
    ...
    if ((VlNull{} != value)) {
        ...
        if (((IData)(__VlefLogOr_1) && (! VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_object__Vclpkg.__PVT_____05Fm_uvm_status_container, "../../uvm/distrib/src/base/uvm_printer.svh", 761)
            ...
            VL_NULL_CHECK(value, "../../uvm/distrib/src/base/uvm_printer.svh", 781)->__VnoInFunc_sprint(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_printer>{this}, this->__Vtask_sprint__38__Vfuncout);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_istop(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ &istop__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_istop\n"); );
    // Body
    IData/*31:0*/ __VlefCall_0__depth;
    istop__Vfuncrtn = 0U;
...
extern const VlWide<256>/*8191:0*/ Vuvm_pkg__ConstPool__CONST_hbc4523fd_0;

void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_adjust_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string id, CData/*7:0*/ scope_separator, std::string &adjust_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_adjust_name\n"); );
    // Locals
    ...
    IData/*31:0*/ __VlefCall_0__depth;
    {
        ...
        vlSymsp->TOP__uvm_pkg.__PVT__uvm_leaf_scope__Vstatic__bracket_match 
            = (0x000000ffU & Vuvm_pkg__ConstPool__CONST_hbc4523fd_0
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_generic(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, std::string type_name, IData/*31:0*/ size, std::string value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_generic\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix, CData/*7:0*/ scope_separator, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field\n"); );
    // Locals
    ...
    }
    {
        ...
        VL_SHIFTL_WWI(4096,4096,32, __Vtemp_2, Vuvm_pkg__ConstPool__CONST_h1958c06c_0, __Vfunc_uvm_bitstream_to_string__51__size);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field_int(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix, CData/*7:0*/ scope_separator, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_field_int\n"); );
    // Locals
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_time(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_time\n"); );
    // Body
    this->__VnoInFunc_print_field_int(vlSymsp, name, value, 0x00000040U, 0x09000000U, (IData)(scope_separator), ""s);
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_string(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, std::string value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_string\n"); );
    // Body
    std::string __VlefCall_2__adjust_name;
    std::string __VlefCall_1__get;
    IData/*31:0*/ __VlefCall_0__depth;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_real(Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, double value, CData/*7:0*/ scope_separator) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_print_real\n"); );
    // Body
    std::string __VlefCall_2__adjust_name;
    std::string __VlefCall_1__get;
    IData/*31:0*/ __VlefCall_0__depth;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_index_string(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ index, std::string name, std::string &index_string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::__VnoInFunc_index_string\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_printer::_ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::_ctor_var_reset\n"); );
    // Body
...
Vuvm_pkg_uvm_pkg__03a__03auvm_printer::~Vuvm_pkg_uvm_pkg__03a__03auvm_printer() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_printer::~\n"); );
}
