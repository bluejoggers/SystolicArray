...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_CALLBACKS__TZ17_TBZ63__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_CALLBACKS__TZ17_TBZ63__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_callback;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63;
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_heartbeat_callback;
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_typed_callbacks__Tz17;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_typeid__Tz17;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_typeid__Tz51;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_typeid__Tz63;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_typeid_base;


class Vhello_uvm_v1__Syms;

class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63__Vclpkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63> __PVT__m_inst;
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17> __PVT__m_base_inst;
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_add(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callback> cb, IData/*31:0*/ ordering);
    ...
    void __VnoInFunc_delete(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callback> cb);
    ...
    void __VnoInFunc_display(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_objection> obj);
    void __VnoInFunc_get(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63> &get__Vfuncrtn);
    void __VnoInFunc_get_first(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_heartbeat_callback> &get_first__Vfuncrtn);
    void __VnoInFunc_get_last(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_heartbeat_callback> &get_last__Vfuncrtn);
    void __VnoInFunc_get_next(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_heartbeat_callback> &get_next__Vfuncrtn);
    void __VnoInFunc_get_prev(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &itr, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_objection> obj, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_heartbeat_callback> &get_prev__Vfuncrtn);
    void __VnoInFunc_m_get_q(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz51> &q, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_objection> obj);
    void __VnoInFunc_m_register_pair(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string tname, std::string cbname, CData/*0:0*/ &m_register_pair__Vfuncrtn);
};
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63 : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_typed_callbacks__Tz17 {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_callbacks__Tz17_TBz63"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63(*this); }
  ...
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_callbacks__Tz17_TBz63();
};
