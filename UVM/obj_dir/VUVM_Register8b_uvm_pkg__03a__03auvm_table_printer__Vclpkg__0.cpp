...
void VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer::init(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VUVM_Register8b_uvm_pkg__03a__03auvm_printer::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer::new\n"); );
    // Body
    _ctor_var_reset(vlSymsp);
    /*super.new*/;
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_calculate_max_widths(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_calculate_max_widths\n"); );
    // Body
    IData/*31:0*/ unnamedblk39__DOT__j;
    unnamedblk39__DOT__j = 0;
    IData/*31:0*/ unnamedblk39__DOT__unnamedblk40__DOT__name_len;
    VUVM_Register8b_uvm_printer_row_info__struct__0 unnamedblk39__DOT__unnamedblk40__DOT__row;
    ...
    while (VL_LTS_III(32, unnamedblk39__DOT__j, VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.size())) {
        unnamedblk39__DOT__unnamedblk40__DOT__name_len = 0U;
        unnamedblk39__DOT__unnamedblk40__DOT__row = VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.at(unnamedblk39__DOT__j);
        unnamedblk39__DOT__unnamedblk40__DOT__name_len 
            = (VL_MULS_III(32, VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1021)
...
void VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_emit(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string &emit__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer::__VnoInFunc_emit\n"); );
    // Body
    ...
    VUVM_Register8b_uvm_printer_row_info__struct__0 unnamedblk44__DOT__unnamedblk45__DOT__row;
    ...
    user_format = ""s;
    dashes = ""s;
    linefeed = VL_CONCATN_NNN("\n"s, VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1044)
                              ->__PVT__prefix);
    {
        ...
        VUVM_Register8b_uvm_printer_row_info__struct__0 __Vinline_0___VnoInFunc_calculate_max_widths_unnamedblk39__DOT__unnamedblk40__DOT__row;
        this->__PVT__m_max_name = 4U;
        this->__PVT__m_max_type = 4U;
        this->__PVT__m_max_size = 4U;
        this->__PVT__m_max_value = 5U;
        __Vinline_0___VnoInFunc_calculate_max_widths_unnamedblk39__DOT__j = 0U;
        while (VL_LTS_III(32, __Vinline_0___VnoInFunc_calculate_max_widths_unnamedblk39__DOT__j, VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.size())) {
            ...
            __Vinline_0___VnoInFunc_calculate_max_widths_unnamedblk39__DOT__unnamedblk40__DOT__row 
                = VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.at(__Vinline_0___VnoInFunc_calculate_max_widths_unnamedblk39__DOT__j);
    ...
    if (VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1062)
        ->__PVT__header) {
        unnamedblk42__DOT__header = ""s;
        this->__VnoInFunc_format_header(vlSymsp, user_format);
        if ((""s == user_format)) {
            if (VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1068)
                ->__PVT__identifier) {
            ...
            if (VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1072)
                ->__PVT__type_name) {
            ...
            if (VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1076)
                ->__PVT__size) {
                dashes = VL_CONCATN_NNN(dashes, VL_SUBSTR_N(vlSymsp->TOP__uvm_pkg__03a__03auvm_table_printer__Vclpkg.__PVT__emit__Vstatic__dash,1U,
                                                            ((IData)(2U) 
    ...
    while (VL_LTS_III(32, unnamedblk44__DOT__i, VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.size())) {
        unnamedblk44__DOT__i__Vloopsize = VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.size();
        unnamedblk44__DOT__unnamedblk45__DOT__row = VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.at(unnamedblk44__DOT__i);
        ...
        if ((""s == user_format)) {
            ...
            if (VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1095)
                ->__PVT__identifier) {
                    ...
                    = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                    VL_SUBSTR_N(vlSymsp->TOP__uvm_pkg__03a__03auvm_table_printer__Vclpkg.__PVT__emit__Vstatic__space,1U,
                                                                VL_MULS_III(32, unnamedblk44__DOT__unnamedblk45__DOT__row
                                                                            .__PVT__level, VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1096)
                                     ...
                                     VL_SUBSTR_N(vlSymsp->TOP__uvm_pkg__03a__03auvm_table_printer__Vclpkg.__PVT__emit__Vstatic__space,1U,
                                                 ((IData)(2U) 
                                                  ...
                                                  ((this->__PVT__m_max_name 
                                                   ...
                                                   - 
                                                   VL_MULS_III(32, unnamedblk44__DOT__unnamedblk45__DOT__row
                                                               .__PVT__level, VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1097)
                                                               ->__PVT__indent)))));
            }
            if (VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1098)
                ->__PVT__type_name) {
                unnamedblk44__DOT__unnamedblk45__DOT__unnamedblk46__DOT__row_str 
            ...
            if (VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1100)
                ->__PVT__size) {
                unnamedblk44__DOT__unnamedblk45__DOT__unnamedblk46__DOT__row_str 
                    = VL_CONCATN_NNN(VL_CONCATN_NNN(unnamedblk44__DOT__unnamedblk45__DOT__unnamedblk46__DOT__row_str, unnamedblk44__DOT__unnamedblk45__DOT__row
                                                    .__PVT__size), 
        ...
        if ((unnamedblk44__DOT__i__Vloopsize <= VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.size())) {
            unnamedblk44__DOT__i = ((IData)(1U) + unnamedblk44__DOT__i);
        }
    }
    if (VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1108)
        ->__PVT__footer) {
    ...
    emit__Vfuncrtn = VL_CONCATN_NNN(VL_NULL_CHECK(VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__knobs, "../../uvm/distrib/src/base/uvm_printer.svh", 1116)
                                    ->__PVT__prefix, s);
    VUVM_Register8b_uvm_pkg__03a__03auvm_printer::__PVT__m_rows.clear();
}

void VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer::_ctor_var_reset(VUVM_Register8b__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer::_ctor_var_reset\n"); );
    // Body
...
VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer::~VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_Register8b_uvm_pkg__03a__03auvm_table_printer::~\n"); );
}
