...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_RESOURCE__TZ55__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_RESOURCE__TZ55__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55__Vclpkg final {
  public:
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55> __PVT__my_type;
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_by_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55> &get_by_name__Vfuncrtn);
    void __VnoInFunc_get_by_type(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55> &get_by_type__Vfuncrtn);
    void __VnoInFunc_get_highest_precedence(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_queue__Tz29> &q, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55> &get_highest_precedence__Vfuncrtn);
    void __VnoInFunc_get_type(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55> &get_type__Vfuncrtn);
};
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55 : public Vuvm_pkg_uvm_pkg__03a__03auvm_resource_base {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_resource__Tz55"; }
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55(*this); }
    ...
    void __VnoInFunc_read(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read__Vfuncrtn);
    ...
    void __VnoInFunc_write(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ t, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor);
  private:
    void _ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp);
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, std::string scope);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz55();
};
