...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_get_by_type(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> __VlefCall_0__get_type;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_get_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set_default(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> &set_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set_default\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> r;
    r = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90, vlProcess, vlSymsp, name, scope);
    VL_NULL_CHECK(r, "../../uvm/distrib/src/base/uvm_resource_db.svh", 96)->__VnoInFunc_set(vlSymsp);
    set_default__Vfuncrtn = r;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_m_show_msg(VUVM_regblock__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_m_show_msg\n"); );
    // Locals
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ val, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> rsrc;
    rsrc = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90, vlProcess, vlSymsp, name, scope);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set_anonymous(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, IData/*31:0*/ val, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set_anonymous\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> rsrc;
    rsrc = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90, vlProcess, vlSymsp, ""s, scope);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set_override(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ val, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set_override_type(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ val, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set_override_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set_override_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ val, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_set_override_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_read_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ &val, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_read_by_name\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> rsrc;
    {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_read_by_type(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, IData/*31:0*/ &val, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_read_by_type\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> rsrc;
    {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_write_by_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, std::string name, IData/*31:0*/ val, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_write_by_name\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> rsrc;
    {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_write_by_type(VUVM_regblock__Syms* __restrict vlSymsp, std::string scope, IData/*31:0*/ val, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_write_by_type\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz90> rsrc;
    {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_dump(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_resource_db__Tz90__Vclpkg::__VnoInFunc_dump\n"); );
    // Body
