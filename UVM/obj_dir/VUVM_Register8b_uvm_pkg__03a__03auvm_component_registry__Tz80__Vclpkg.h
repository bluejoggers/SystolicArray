...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_COMPONENT_REGISTRY__TZ80__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_COMPONENT_REGISTRY__TZ80__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80> __PVT__me;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_create(VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_sequencer__Tz61_TBz61> &create__Vfuncrtn);
    void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80> &get__Vfuncrtn);
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80 : public VUVM_Register8b_uvm_pkg__03a__03auvm_object_wrapper {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_component_registry__Tz80"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80(*this); }
    ...
    VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80() = default;
    void init(VUVM_Register8b__Syms* __restrict vlSymsp);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__Tz80();
};
