...
void Vuvm_pkg_std__03a__03asemaphore::init(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_std__03a__03asemaphore::new\n"); );
    // Body
...
void Vuvm_pkg_std__03a__03asemaphore::__VnoInFunc_put(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_std__03a__03asemaphore::__VnoInFunc_put\n"); );
    // Body
    this->__PVT__m_keyCount = (this->__PVT__m_keyCount 
                               + keyCount);
}

VlCoroutine Vuvm_pkg_std__03a__03asemaphore::__VnoInFunc_get(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_std__03a__03asemaphore::__VnoInFunc_get\n"); );
    // Locals
...
void Vuvm_pkg_std__03a__03asemaphore::__VnoInFunc_try_get(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount, IData/*31:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_std__03a__03asemaphore::__VnoInFunc_try_get\n"); );
    // Body
    {
...
void Vuvm_pkg_std__03a__03asemaphore::_ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_std__03a__03asemaphore::_ctor_var_reset\n"); );
    // Body
