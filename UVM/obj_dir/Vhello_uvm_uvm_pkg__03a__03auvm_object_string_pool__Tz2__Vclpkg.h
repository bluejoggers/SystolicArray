...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_OBJECT_STRING_POOL__TZ2__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_OBJECT_STRING_POOL__TZ2__VCLPKG_H_  // guard
...
class Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2> __PVT__m_global_pool;
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2__Vclpkg);
    ...
    void __VnoInFunc_get_global_pool(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2> &get_global_pool__Vfuncrtn);
};

#include "Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz2__Vclpkg.h"

class Vhello_uvm__Syms;

class Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2 : public Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz2 {
  public:
    ...
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2(*this); }
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_object_string_pool__Tz2();
};
