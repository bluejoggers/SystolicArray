...
#ifndef VERILATED_VHELLO_UVM_V1___024UNIT_H_
#define VERILATED_VHELLO_UVM_V1___024UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1___024unit final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1___024unit();
    ~Vhello_uvm_v1___024unit();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1___024unit);
