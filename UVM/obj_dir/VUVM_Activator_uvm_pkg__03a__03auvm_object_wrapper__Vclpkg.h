...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_OBJECT_WRAPPER__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_OBJECT_WRAPPER__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper : public virtual VlClass {
  public:
    ...
    VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper() = default;
    void init(VUVM_Activator__Syms* __restrict vlSymsp) {}
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper();
};
