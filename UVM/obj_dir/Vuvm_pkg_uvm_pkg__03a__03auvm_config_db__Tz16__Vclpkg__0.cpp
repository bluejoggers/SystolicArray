...
void Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_get(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> &value, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__2__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz16> __Vfunc_get_highest_precedence__8__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_3__is_tracing;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz16> __VlefCall_2__get_type;
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> cs;
    {
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz16__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __VlefCall_2__get_type);
        ...
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz16__Vclpkg.__VnoInFunc_get_highest_precedence(vlSymsp, rq, __Vfunc_get_highest_precedence__8__Vfuncout);
        ...
        if (__VlefCall_3__is_tracing) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz16__Vclpkg.__VnoInFunc_m_show_msg(vlSymsp, "CFGDB/GET"s, "Configuration"s, "read"s, inst_name, field_name, cntxt, r);
        }
        if ((VlNull{} == r)) {
            get__Vfuncrtn = 0U;
            goto __Vlabel0;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_set(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequence_base> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz41> __VlefCall_2__new;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource_pool> unnamedblk1__DOT__rp;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03am_uvm_waiter> unnamedblk2__DOT__w;
    IData/*31:0*/ unnamedblk2__DOT__unnamedblk3__DOT__i;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> top;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_phase> curr_phase;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz16> r;
    CData/*0:0*/ exists;
    std::string lookup;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz41> pool;
    std::string rstate;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> cs;
    ...
    if ((! this->__PVT__m_rsc.exists(cntxt))) {
        __VlefCall_2__new = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_pool__Tz5_TBz41, vlProcess, vlSymsp, ""s);
    ...
    if ((0U != __VlefCall_3__exists)) {
        ...
        r = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz16, vlProcess, vlSymsp, field_name, inst_name);
    ...
    if (__VlefCall_11__is_tracing) {
        vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz16__Vclpkg.__VnoInFunc_m_show_msg(vlSymsp, "CFGDB/SET"s, "Configuration"s, "set"s, inst_name, field_name, cntxt, r);
    }
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_exists(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, CData/*0:0*/ spell_chk, CData/*0:0*/ &exists__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_exists\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__38__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource__Tz16> __VlefCall_2__get_by_name;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> cs;
    exists__Vfuncrtn = 0U;
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource_db__Tz16__Vclpkg.__VnoInFunc_get_by_name(vlProcess, vlSymsp, inst_name, field_name, (IData)(spell_chk), __VlefCall_2__get_by_name);
    exists__Vfuncrtn = (VlNull{} != __VlefCall_2__get_by_name);
}

VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_wait_modified(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_wait_modified\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __Vtask_get_root__46__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03am_uvm_waiter> __VlefCall_4__get;
    IData/*31:0*/ __VlefCall_3__size;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_queue__Tz28> __VlefCall_2__new;
    std::string __VlefCall_1__get_full_name;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_root> __VlefCall_0__get_root;
    IData/*31:0*/ unnamedblk4__DOT__i;
    VlClassRef<Vuvm_pkg_std__03a__03aprocess> p;
    std::string rstate;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03am_uvm_waiter> waiter;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> cs;
    vlSymsp->TOP__std__03a__03aprocess__Vclpkg.__VnoInFunc_self(vlProcess, vlSymsp, p);
    ...
    waiter = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03am_uvm_waiter, vlSymsp, inst_name, field_name);
    if ((! this->__PVT__m_waiters.exists(field_name))) {
        __VlefCall_2__new = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_queue__Tz28, vlProcess, vlSymsp, ""s);
    ...
    CData/*0:0*/ __VdynTrigger_h69dcc1c3__0;
    __VdynTrigger_h69dcc1c3__0 = 0;
    __VdynTrigger_h69dcc1c3__0 = 0U;
    if ((VlNull{} != waiter)) {
        VL_NULL_CHECK(waiter, "../../uvm/distrib/src/base/uvm_config_db.svh", 294)->__PVT__trigger.clearFired();
    }
    while ((1U & (~ (IData)(__VdynTrigger_h69dcc1c3__0)))) {
        co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                     vlProcess, 
                                                     "@([event] uvm_pkg::uvm_config_db__Tz16__Vclpkg.waiter.trigger)", 
                                                     "../../uvm/distrib/src/base/uvm_config_db.svh", 
                                                     294);
        __VdynTrigger_h69dcc1c3__0 = ((VlNull{} != waiter) 
                                      && VL_NULL_CHECK(waiter, "../../uvm/distrib/src/base/uvm_config_db.svh", 294)
                                      ->__PVT__trigger.isFired());
        vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_h69dcc1c3__0);
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16::init(Vuvm_pkg__Syms* __restrict vlSymsp) {
    Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz16::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16::new\n"); );
    // Body
    /*super.new*/;
}

Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16::~Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_config_db__Tz16::~\n"); );
}
