...
VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_objection__Vclpkg::__VnoInFunc_m_execute_scheduled_forks(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_objection__Vclpkg::__VnoInFunc_m_execute_scheduled_forks\n"); );
    // Body
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03a__VDynScope_19> unnamedblk5__DOT____VDynScope_unnamedblk5_2;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03a__VDynScope_20> unnamedblk5__DOT___Vwrapped_guard_3__DOT____VDynScope_guard_3;
    while (true) {
        while ((0U == this->__PVT__m_scheduled_list.size())) {
            Vuvm_pkg___024root____VbeforeTrig_h5af0e26d__0((&vlSymsp->TOP), 
        ...
        if ((0U != this->__PVT__m_scheduled_list.size())) {
            unnamedblk5__DOT____VDynScope_unnamedblk5_2 
                = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03a__VDynScope_19, vlSymsp);
            ...
            unnamedblk5__DOT___Vwrapped_guard_3__DOT____VDynScope_guard_3 
                = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03a__VDynScope_20, vlSymsp);
...
VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_objection__Vclpkg::__VnoInFunc_m_execute_scheduled_forks____Vfork_1__0(VlProcessRef vlProcess, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03a__VDynScope_20> unnamedblk5__DOT___Vwrapped_guard_3__DOT____VDynScope_guard_3) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_objection__Vclpkg::__VnoInFunc_m_execute_scheduled_forks____Vfork_1__0\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03a__VDynScope_20> __Vtask___VforkTask_0__3____VDynScope_guard_3;
    VlClassRef<Vuvm_pkg_std__03a__03aprocess> __Vtask___VforkTask_0__3____VlefCall_0__self;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection_context_object> __Vtask___VforkTask_0__3__unnamedblk6__DOT__ctxt;
    VlClassRef<Vuvm_pkg_std__03a__03aprocess> __Vfunc_self__4__Vfuncout;
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection__Vclpkg::__VnoInFunc_m_init_objections(Vuvm_pkg__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_objection__Vclpkg::__VnoInFunc_m_init_objections\n"); );
    // Body
    this->__VnoInFunc_m_init_objections____Vfork_2__0();
}

VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_objection__Vclpkg::__VnoInFunc_m_init_objections____Vfork_2__0() {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_objection__Vclpkg::__VnoInFunc_m_init_objections____Vfork_2__0\n"); );
    // Body
    co_await vlSymsp->TOP.__VdlySched.delay(0xffffffffffffffffULL, 
                                            nullptr, 
                                            "../../uvm/distrib/src/base/uvm_objection.svh", 
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection__Vclpkg::__VnoInFunc_get_type(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_registry__pi1> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_objection__Vclpkg::__VnoInFunc_get_type\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name) {
    Vuvm_pkg_uvm_pkg__03a__03auvm_report_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::new\n"); );
    // Locals
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_coreservice_t> cs_;
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_objection__Vclpkg.__PVT__m_objections.push_back(
                                                                                VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection>{this});
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_trace_mode(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ mode, CData/*0:0*/ &trace_mode__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_trace_mode\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_report(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count, std::string action) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_report\n"); );
    // Locals
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_get_parent(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> &m_get_parent__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_get_parent\n"); );
    // Locals
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> __Vtask_get_parent__16__Vfuncout;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_sequencer_base> __Vtask_get_sequencer__17__Vfuncout;
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_propagate(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count, CData/*0:0*/ raise, IData/*31:0*/ in_top_thread) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_propagate\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_set_propagate_mode(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ prop_mode) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_set_propagate_mode\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_3__get_full_name;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_propagate_mode(Vuvm_pkg__Syms* __restrict vlSymsp, CData/*0:0*/ &get_propagate_mode__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_propagate_mode\n"); );
    // Body
    get_propagate_mode__Vfuncrtn = this->__PVT__m_prop_mode;
}

void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_raise_objection(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, std::string description, IData/*31:0*/ count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_raise_objection\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    if ((VlNull{} == obj)) {
        obj = this->__PVT__m_top;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_raise(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_raise\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_1;
    IData/*31:0*/ __VlefExpr_0;
    ...
    IData/*31:0*/ idx;
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection_context_object> ctxt;
    {
        idx = 0U;
        if ((0U == count)) {
            goto __Vlabel0;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_drop_objection(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, std::string description, IData/*31:0*/ count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_drop_objection\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    if ((VlNull{} == obj)) {
        obj = this->__PVT__m_top;
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_drop(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count, IData/*31:0*/ in_top_thread) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_drop\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection_context_object> unnamedblk3__DOT__ctxt;
    {
        if ((0U == count)) {
            goto __Vlabel0;
        }
            ...
            if ((obj == source_obj)) {
                ...
                if (__VlefExpr_8) {
                    ...
                    if ((0U != vlSymsp->TOP__uvm_pkg__03a__03auvm_objection__Vclpkg.__PVT__m_context_pool.size())) {
                        ...
                        unnamedblk3__DOT__ctxt = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_objection_context_object, vlSymsp);
                    }
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_clear(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_clear\n"); );
            // Body
            VlProcess::currentp(vlProcess.get());
            std::string __VlefCall_2__get_name;
            CData/*0:0*/ __VlefLogAnd_1;
            IData/*31:0*/ __VlefCall_0__get_objection_total;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> unnamedblk4__DOT__o;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> unnamedblk4__DOT__o__Vnext;
            ...
            while (VL_LTS_III(32, idx, vlSymsp->TOP__uvm_pkg__03a__03auvm_objection__Vclpkg.__PVT__m_scheduled_list.size())) {
                if ((VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_objection__Vclpkg.__PVT__m_scheduled_list.at(idx), "../../uvm/distrib/src/base/uvm_objection.svh", 642)
                     ->__PVT__objection == VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection>{this})) {
        ...
        VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_forked_drain(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count, IData/*31:0*/ in_top_thread) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_forked_drain\n"); );
            // Locals
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_set_drain_time(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, QData/*63:0*/ drain) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_set_drain_time\n"); );
            // Body
            if ((VlNull{} == obj)) {
                obj = this->__PVT__m_top;
            }
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_raised(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_raised\n"); );
            // Body
            VlProcess::currentp(vlProcess.get());
            IData/*31:0*/ __VlefExpr_0;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback_iter__Tz13_TBz14> unnamedblk7__DOT__iter;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection_callback> unnamedblk7__DOT__cb;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> comp;
            __VlefExpr_0 = VL_CAST_DYNAMIC(obj, comp);
            if (__VlefExpr_0) {
                VL_NULL_CHECK(comp, "../../uvm/distrib/src/base/uvm_objection.svh", 829)
                                                       ->__VnoInFunc_raised(vlSymsp, 
                                                                            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection>{this}, source_obj, description, count);
            }
            unnamedblk7__DOT__iter = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_callback_iter__Tz13_TBz14, vlSymsp, 
                                            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection>{this});
            ...
            while ((VlNull{} != unnamedblk7__DOT__cb)) {
                VL_NULL_CHECK(unnamedblk7__DOT__cb, "../../uvm/distrib/src/base/uvm_objection.svh", 830)
                                                       ->__VnoInFunc_raised(vlSymsp, 
                                                                            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection>{this}, obj, source_obj, description, count);
                VL_NULL_CHECK(unnamedblk7__DOT__iter, "../../uvm/distrib/src/base/uvm_objection.svh", 830)
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_dropped(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_dropped\n"); );
            // Body
            VlProcess::currentp(vlProcess.get());
            IData/*31:0*/ __VlefExpr_0;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback_iter__Tz13_TBz14> unnamedblk8__DOT__iter;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection_callback> unnamedblk8__DOT__cb;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> comp;
            __VlefExpr_0 = VL_CAST_DYNAMIC(obj, comp);
            if (__VlefExpr_0) {
            ...
            unnamedblk8__DOT__iter = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_callback_iter__Tz13_TBz14, vlSymsp, 
                                            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection>{this});
        ...
        VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_all_dropped(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> source_obj, std::string description, IData/*31:0*/ count) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_all_dropped\n"); );
            // Body
            VlProcess::currentp(vlProcess.get());
            VL_KEEP_THIS;
            IData/*31:0*/ __VlefExpr_0;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_callback_iter__Tz13_TBz14> unnamedblk9__DOT__iter;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection_callback> unnamedblk9__DOT__cb;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_component> comp;
            __VlefExpr_0 = VL_CAST_DYNAMIC(obj, comp);
            if (__VlefExpr_0) {
            ...
            unnamedblk9__DOT__iter = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_callback_iter__Tz13_TBz14, vlSymsp, 
                                            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection>{this});
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_objectors(Vuvm_pkg__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object>> &list) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_objectors\n"); );
            // Body
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> unnamedblk10__DOT__obj;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> unnamedblk10__DOT__obj__Vnext;
        ...
        VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_wait_for(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ objt_event, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_wait_for\n"); );
            // Locals
            ...
            VlProcess::currentp(vlProcess.get());
            VL_KEEP_THIS;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection_events> __VlefCall_0__new;
            if ((VlNull{} == obj)) {
                obj = this->__PVT__m_top;
            }
            if ((! this->__PVT__m_events.exists(obj))) {
                __VlefCall_0__new = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_objection_events, vlSymsp);
        ...
        VlCoroutine Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_wait_for_total_count(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, IData/*31:0*/ count) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_wait_for_total_count\n"); );
            // Locals
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_objection_count(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, IData/*31:0*/ &get_objection_count__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_objection_count\n"); );
            // Body
            {
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_objection_total(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, IData/*31:0*/ &get_objection_total__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_objection_total\n"); );
            // Body
            if ((VlNull{} == obj)) {
                obj = this->__PVT__m_top;
            }
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_drain_time(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, QData/*63:0*/ &get_drain_time__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_drain_time\n"); );
            // Body
            {
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_display_objections(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ show_header, std::string &m_display_objections__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_m_display_objections\n"); );
            // Locals
            std::string __Vtemp_1;
            // Body
            VlProcess::currentp(vlProcess.get());
            ...
            std::string __VlefCall_1__get_full_name;
            CData/*0:0*/ __VlefExpr_0;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> unnamedblk11__DOT__o;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> unnamedblk11__DOT__o__Vnext;
            CData/*0:0*/ unnamedblk11__DOT__o__Vmore;
            unnamedblk11__DOT__o__Vmore = 0;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> unnamedblk11__DOT__unnamedblk12__DOT__theobj;
            IData/*31:0*/ unnamedblk13__DOT__i;
            unnamedblk13__DOT__i = 0;
            IData/*31:0*/ unnamedblk14__DOT__i;
            std::string s;
            IData/*31:0*/ total;
            VlAssocArray<std::string, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object>> list;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> curr_obj;
            IData/*31:0*/ depth;
            std::string name;
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_convert2string\n"); );
            // Body
            VlProcess::currentp(vlProcess.get());
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_display_objections(Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> obj, CData/*0:0*/ show_header) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_display_objections\n"); );
            // Body
            VlProcessRef vlProcess = std::make_shared<VlProcess>();
            VlProcess::currentp(vlProcess.get());
            IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_create(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_create\n"); );
            // Body
            VlProcess::currentp(vlProcess.get());
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection> tmp;
            tmp = VL_NEW(Vuvm_pkg_uvm_pkg__03a__03auvm_objection, vlProcess, vlSymsp, name);
            create__Vfuncrtn = tmp;
        }

        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_type_name(Vuvm_pkg__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_get_type_name\n"); );
            // Body
            get_type_name__Vfuncrtn = "uvm_objection"s;
        }

        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> rhs) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_do_copy\n"); );
            // Body
            VlProcess::currentp(vlProcess.get());
            IData/*31:0*/ __VlefExpr_0;
            VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_objection> _rhs;
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_randomize(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc_randomize\n"); );
            // Body
        ...
        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc___Vsetup_constraints(Vuvm_pkg__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc___Vsetup_constraints\n"); );
        }

        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc___VBasicRand(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::__VnoInFunc___VBasicRand\n"); );
            // Body
            __VBasicRand__Vfuncrtn = 1U;
        }

        void Vuvm_pkg_uvm_pkg__03a__03auvm_objection::_ctor_var_reset(Vuvm_pkg__Syms* __restrict vlSymsp) {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::_ctor_var_reset\n"); );
            // Body
        ...
        Vuvm_pkg_uvm_pkg__03a__03auvm_objection::~Vuvm_pkg_uvm_pkg__03a__03auvm_objection() {
            VL_DEBUG_IF(VL_DBG_MSGF("+            Vuvm_pkg_uvm_pkg__03a__03auvm_objection::~\n"); );
        }
