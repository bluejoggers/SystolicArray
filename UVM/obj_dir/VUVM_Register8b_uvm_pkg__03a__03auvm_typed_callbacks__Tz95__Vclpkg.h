...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ95__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ95__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz95> __PVT__m_t_inst;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz95__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz95> &m_initialize__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz95 : public VUVM_Register8b_uvm_pkg__03a__03auvm_callbacks_base {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_typed_callbacks__Tz95"; }
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz95(*this); }
    ...
    VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz95() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_typed_callbacks__Tz95();
};
