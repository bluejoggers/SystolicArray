...
void VUVM_regblock_std__03a__03asemaphore::init(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_std__03a__03asemaphore::new\n"); );
    // Body
...
void VUVM_regblock_std__03a__03asemaphore::__VnoInFunc_put(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_std__03a__03asemaphore::__VnoInFunc_put\n"); );
    // Body
    this->__PVT__m_keyCount = (this->__PVT__m_keyCount 
                               + keyCount);
}

VlCoroutine VUVM_regblock_std__03a__03asemaphore::__VnoInFunc_get(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_std__03a__03asemaphore::__VnoInFunc_get\n"); );
    // Locals
...
void VUVM_regblock_std__03a__03asemaphore::__VnoInFunc_try_get(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount, IData/*31:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_std__03a__03asemaphore::__VnoInFunc_try_get\n"); );
    // Body
    {
...
void VUVM_regblock_std__03a__03asemaphore::_ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_std__03a__03asemaphore::_ctor_var_reset\n"); );
    // Body
