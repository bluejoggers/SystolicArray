...
#ifndef VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_RESOURCE__TZ90__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B_UVM_PKG__03A__03AUVM_RESOURCE__TZ90__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90> __PVT__my_type;
    ...
    // CONSTRUCTORS
    VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90__Vclpkg();
    ~VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90__Vclpkg);
    ...
    void __VnoInFunc_get_by_type(VUVM_Register8b__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90> &get_by_type__Vfuncrtn);
    void __VnoInFunc_get_highest_precedence(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_queue__Tz5> &q, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90> &get_highest_precedence__Vfuncrtn);
    void __VnoInFunc_get_type(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90> &get_type__Vfuncrtn);
};
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90 : public VUVM_Register8b_uvm_pkg__03a__03auvm_resource_base {
  public:
    ...
    VlClass* clone() const { return new VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90(*this); }
  ...
  public:
    VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90() = default;
    void init(VlProcessRef vlProcess, VUVM_Register8b__Syms* __restrict vlSymsp, std::string name, std::string scope);
    virtual ~VUVM_Register8b_uvm_pkg__03a__03auvm_resource__Tz90();
};
