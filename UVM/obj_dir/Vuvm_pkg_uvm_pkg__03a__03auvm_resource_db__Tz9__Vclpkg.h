...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ9__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_RESOURCE_DB__TZ9__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz9__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz9__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz9__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz9__Vclpkg);
    ...
    void __VnoInFunc_get_by_type(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource_> &get_by_type__Vfuncrtn);
    void __VnoInFunc_m_show_msg(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource_> rsrc);
    ...
    void __VnoInFunc_set_default(Vuvm_pkg__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_resource_> &set_default__Vfuncrtn);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz9 : public virtual VlClass {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_resource_db__Tz9"; }
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz9(*this); }
    Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz9() = default;
    void init(Vuvm_pkg__Syms* __restrict vlSymsp) {}
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_resource_db__Tz9();
};
