...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_EXHAUSTIVE_SEQUENCE__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_EXHAUSTIVE_SEQUENCE__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_exhaustive_sequence__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_exhaustive_sequence__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_exhaustive_sequence__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_exhaustive_sequence__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi27> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_uvm_pkg__03a__03auvm_exhaustive_sequence : public Vhello_uvm_uvm_pkg__03a__03auvm_sequence_ {
  public:
    ...
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_exhaustive_sequence(*this); }
    virtual void __VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    void __VnoInFunc___Vrandwith_h2a239dab__0(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_exhaustive_sequence> __Vthis, IData/*31:0*/ &__Vrandwith_h2a239dab__0__Vfuncrtn);
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_exhaustive_sequence() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_exhaustive_sequence();
};
