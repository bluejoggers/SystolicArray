...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_RESOURCE__TZ85__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_RESOURCE__TZ85__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85__Vclpkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85> __PVT__my_type;
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85__Vclpkg);
    ...
    void __VnoInFunc_get_by_type(Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string scope, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_base> type_handle, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85> &get_by_type__Vfuncrtn);
    void __VnoInFunc_get_highest_precedence(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_queue__Tz8> &q, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85> &get_highest_precedence__Vfuncrtn);
    void __VnoInFunc_get_type(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85 : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource_base {
  public:
    ...
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> __PVT__val;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_resource__Tz85"; }
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85(*this); }
    ...
    void __VnoInFunc_read(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> &read__Vfuncrtn);
    ...
    void __VnoInFunc_write(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_reg_block> t, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object> accessor);
  private:
    void _ctor_var_reset(Vhello_uvm_v1__Syms* __restrict vlSymsp);
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, std::string scope);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_resource__Tz85();
};
