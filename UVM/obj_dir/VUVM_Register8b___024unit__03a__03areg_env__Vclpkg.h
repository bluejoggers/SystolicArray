...
#ifndef VERILATED_VUVM_REGISTER8B___024UNIT__03A__03AREG_ENV__VCLPKG_H_
#define VERILATED_VUVM_REGISTER8B___024UNIT__03A__03AREG_ENV__VCLPKG_H_  // guard
...
class VUVM_Register8b_uvm_pkg__03a__03auvm_env;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Register8b___024unit__03a__03areg_env__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Register8b___024unit__03a__03areg_env__Vclpkg();
    ~VUVM_Register8b___024unit__03a__03areg_env__Vclpkg();
    void ctor(VUVM_Register8b__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Register8b___024unit__03a__03areg_env__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Register8b__Syms* __restrict vlSymsp, VlClassRef<VUVM_Register8b_uvm_pkg__03a__03auvm_component_registry__pi18> &get_type__Vfuncrtn);
};

#include "VUVM_Register8b_uvm_pkg__03a__03auvm_env__Vclpkg.h"

class VUVM_Register8b__Syms;

class VUVM_Register8b___024unit__03a__03areg_env : public VUVM_Register8b_uvm_pkg__03a__03auvm_env {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<VUVM_Register8b___024unit__03a__03areg_agent> __PVT__agent_in_env;
    VlClassRef<VUVM_Register8b___024unit__03a__03areg_scoreboard> __PVT__scoreboard_in_env;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "$unit::reg_env"; }
    VlClass* clone() const { return new VUVM_Register8b___024unit__03a__03areg_env(*this); }
  ...
  public:
    VUVM_Register8b___024unit__03a__03areg_env() = default;
    ...
    virtual ~VUVM_Register8b___024unit__03a__03areg_env();
};
