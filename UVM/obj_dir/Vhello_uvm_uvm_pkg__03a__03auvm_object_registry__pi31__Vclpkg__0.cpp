...
void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    ...
    if ((VlNull{} == this->__PVT__me)) {
        ...
        this->__PVT__me = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31, vlSymsp);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31__Vclpkg::__VnoInFunc_create(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_write_only_cbs> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31> __VlefCall_0__get;
        ...
        unnamedblk2__DOT__msg = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                              VL_CONCATN_NNN(
                                                                             VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN("Factory did not return an object of type 'uvm_reg_write_only_cbs'. A component of type '"s, __VlefCall_2__get_type_name), "' was returned instead. Name="s), name), " Parent="s), __VlefCall_3__get_type_name), " contxt="s), contxt);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31__Vclpkg::__VnoInFunc_set_type_override(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31> __VlefCall_0__get;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31__Vclpkg::__VnoInFunc_set_inst_override(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31> __VlefCall_1__get;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31::__VnoInFunc_create_object(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> &create_object__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31::__VnoInFunc_create_object\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_reg_write_only_cbs> obj;
    if ((""s == name)) {
        obj = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_reg_write_only_cbs, vlProcess, vlSymsp, "uvm_reg_write_only_cbs"s);
    } else {
        obj = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_reg_write_only_cbs, vlProcess, vlSymsp, name);
    }
    create_object__Vfuncrtn = obj;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31::__VnoInFunc_get_type_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_reg_write_only_cbs"s;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31::init(Vhello_uvm__Syms* __restrict vlSymsp) {
    Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31::new\n"); );
    // Body
    /*super.new*/;
}

Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31::~Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31() {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi31::~\n"); );
}
