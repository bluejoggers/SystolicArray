...
VL_ATTR_COLD void Vuvm_pkg_uvm_pkg__03a__03auvm_recorder__Vclpkg___ctor_var_reset(Vuvm_pkg_uvm_pkg__03a__03auvm_recorder__Vclpkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_recorder__Vclpkg___ctor_var_reset\n"); );
