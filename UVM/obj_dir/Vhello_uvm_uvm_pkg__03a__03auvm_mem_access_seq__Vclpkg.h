...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_MEM_ACCESS_SEQ__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_MEM_ACCESS_SEQ__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_mem_access_seq__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_mem_access_seq__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_mem_access_seq__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_mem_access_seq__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_registry__pi38> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_uvm_pkg__03a__03auvm_mem_access_seq : public Vhello_uvm_uvm_pkg__03a__03auvm_reg_sequence_ {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_mem_single_access_seq> __PVT__mem_seq;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_mem_access_seq"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_mem_access_seq(*this); }
  ...
  public:
    Vhello_uvm_uvm_pkg__03a__03auvm_mem_access_seq() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_mem_access_seq();
};
