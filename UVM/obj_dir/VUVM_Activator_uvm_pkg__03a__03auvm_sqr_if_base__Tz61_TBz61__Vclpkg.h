...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ61_TBZ61__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_SQR_IF_BASE__TZ61_TBZ61__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61 : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_sqr_if_base__Tz61_TBz61"; }
    ...
    virtual void __VnoInFunc_item_done(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> t);
    virtual VlCoroutine __VnoInFunc_peek(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> &t);
    ...
    virtual void __VnoInFunc_put_response(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> t);
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_sqr_if_base__Tz61_TBz61();
};
