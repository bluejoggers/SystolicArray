...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_RANDOM_SEQUENCE__VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_RANDOM_SEQUENCE__VCLPKG_H_  // guard
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi28;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_wrapper;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_printer;
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence;
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence__Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence__Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_object_registry__pi28> &get_type__Vfuncrtn);
};
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequence_ {
  public:
    ...
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence(*this); }
    virtual void __VnoInFunc___VBasicRand(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn);
    void __VnoInFunc___Vrandwith_h509d7fc5__0(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence> __Vthis, IData/*31:0*/ &__Vrandwith_h509d7fc5__0__Vfuncrtn);
    void __VnoInFunc___Vrandwith_h509d7fc5__1(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence> __Vthis, IData/*31:0*/ &__Vrandwith_h509d7fc5__1__Vfuncrtn);
    ...
    void __VnoInFunc_get_count(Vhello_uvm_v1__Syms* __restrict vlSymsp, IData/*31:0*/ &get_count__Vfuncrtn);
  ...
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_random_sequence();
};
