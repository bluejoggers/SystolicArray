...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_REPORT_MESSAGE_ELEMENT_CONTAINER__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_REPORT_MESSAGE_ELEMENT_CONTAINER__VCLPKG_H_  // guard
...
class VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi8;
...
class VUVM_Activator_uvm_pkg__03a__03auvm_report_message_int_element;
class VUVM_Activator_uvm_pkg__03a__03auvm_report_message_object_element;
class VUVM_Activator_uvm_pkg__03a__03auvm_report_message_string_element;
class VUVM_Activator_uvm_pkg__03a__03auvm_status_container;


class VUVM_Activator__Syms;

class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_report_message_element_container__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_report_message_element_container__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_report_message_element_container__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_report_message_element_container__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi8> &get_type__Vfuncrtn);
};
...
class VUVM_Activator_uvm_pkg__03a__03auvm_report_message_element_container : public VUVM_Activator_uvm_pkg__03a__03auvm_object {
  public:

    // DESIGN SPECIFIC STATE
    VlQueue<VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_report_message_element_base>> __PVT__elements;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_report_message_element_container"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_report_message_element_container(*this); }
    ...
    virtual void __VnoInFunc_delete_elements(VUVM_Activator__Syms* __restrict vlSymsp);
    ...
    virtual void __VnoInFunc_get_elements(VUVM_Activator__Syms* __restrict vlSymsp, VlQueue<VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_report_message_element_base>> &get_elements__Vfuncrtn);
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_report_message_element_container() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_report_message_element_container();
};
