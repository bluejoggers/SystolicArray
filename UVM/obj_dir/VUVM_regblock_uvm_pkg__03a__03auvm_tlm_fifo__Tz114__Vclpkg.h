...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_TLM_FIFO__TZ114__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_TLM_FIFO__TZ114__VCLPKG_H_  // guard

#include "verilated.h"
#include "verilated_covergroup.h"
#include "verilated_timing.h"
#include "verilated_random.h"
class VUVM_regblock_std__03a__03amailbox__Tz114;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_tlm_fifo__Tz114__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_tlm_fifo__Tz114__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_tlm_fifo__Tz114__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_tlm_fifo__Tz114__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
};

#include "VUVM_regblock_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz114__Vclpkg.h"

class VUVM_regblock__Syms;

class VUVM_regblock_uvm_pkg__03a__03auvm_tlm_fifo__Tz114 : public VUVM_regblock_uvm_pkg__03a__03auvm_tlm_fifo_base__Tz114 {
  public:

    // DESIGN SPECIFIC STATE
    IData/*31:0*/ __PVT__m_size;
    IData/*31:0*/ __PVT__m_pending_blocked_gets;
    VlClassRef<VUVM_regblock_std__03a__03amailbox__Tz114> __PVT__m;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_tlm_fifo__Tz114"; }
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_tlm_fifo__Tz114(*this); }
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_tlm_fifo__Tz114() = default;
    ...
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_tlm_fifo__Tz114();
};
