...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_get_by_type(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> &get_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_get_by_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> __VlefCall_0__get_type;
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz110__Vclpkg.__VnoInFunc_get_type(vlProcess, vlSymsp, __VlefCall_0__get_type);
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz110__Vclpkg.__VnoInFunc_get_by_type(vlSymsp, scope, __VlefCall_0__get_type, get_by_type__Vfuncrtn);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_get_by_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, CData/*0:0*/ rpterr, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> &get_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_get_by_name\n"); );
    // Body
    vlSymsp->TOP__uvm_pkg__03a__03auvm_resource__Tz110__Vclpkg.__VnoInFunc_get_by_name(vlSymsp, scope, name, (IData)(rpterr), get_by_name__Vfuncrtn);
}

void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set_default(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> &set_default__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set_default\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> r;
    r = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110, vlProcess, vlSymsp, name, scope);
    VL_NULL_CHECK(r, "../../uvm/distrib/src/base/uvm_resource_db.svh", 96)->__VnoInFunc_set(vlSymsp);
    set_default__Vfuncrtn = r;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_m_show_msg(VUVM_Activator__Syms* __restrict vlSymsp, std::string id, std::string rtype, std::string action, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> accessor, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> rsrc) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_m_show_msg\n"); );
    // Locals
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_block> val, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> rsrc;
    rsrc = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110, vlProcess, vlSymsp, name, scope);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set_anonymous(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_block> val, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set_anonymous\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> rsrc;
    rsrc = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110, vlProcess, vlSymsp, ""s, scope);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set_override(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_block> val, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set_override_type(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_block> val, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set_override_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set_override_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_block> val, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> accessor) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_set_override_name\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_0__is_tracing;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_read_by_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_block> &val, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_read_by_name\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> rsrc;
    {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_read_by_type(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_block> &val, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &read_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_read_by_type\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> rsrc;
    {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_write_by_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_block> val, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_write_by_name\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> rsrc;
    {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_write_by_type(VUVM_Activator__Syms* __restrict vlSymsp, std::string scope, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_block> val, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object> accessor, CData/*0:0*/ &write_by_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_write_by_type\n"); );
    // Body
    CData/*0:0*/ __VlefCall_0__is_tracing;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_resource__Tz110> rsrc;
    {
...
void VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_dump(VUVM_Activator__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_resource_db__Tz110__Vclpkg::__VnoInFunc_dump\n"); );
    // Body
