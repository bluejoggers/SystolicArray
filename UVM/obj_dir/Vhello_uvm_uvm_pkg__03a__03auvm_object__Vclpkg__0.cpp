...
void Vhello_uvm_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_get_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper> &get_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_get_type\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_get_inst_count(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_inst_count__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_object__Vclpkg::__VnoInFunc_get_inst_count\n"); );
    // Body
    get_inst_count__Vfuncrtn = this->__PVT__m_inst_count;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_type_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "<unknown>"s;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_create(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_create\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    create__Vfuncrtn = VlNull{};
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name) {
    Vhello_uvm_uvm_pkg__03a__03auvm_void::init(vlProcess, vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::new\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_reseed(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_reseed\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_seed_map> __Vfunc_uvm_create_random_seed__3____VlefCall_0__new;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_inst_id(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_inst_id__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_inst_id\n"); );
    // Body
    get_inst_id__Vfuncrtn = this->__PVT__m_inst_id;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_object_type(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object_wrapper> &get_object_type__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_object_type\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_name(Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_name\n"); );
    // Body
    get_name__Vfuncrtn = this->__PVT__m_leaf_name;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_full_name(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string &get_full_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_get_full_name\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_name(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_name\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    this->__PVT__m_leaf_name = name;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_print(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_print\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__19__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__20__Vfuncout;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_sprint(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_printer> printer, std::string &sprint__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_sprint\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    CData/*0:0*/ __VlefCall_0__istop;
    {
        ...
        VL_NULL_CHECK(printer, "../../uvm/distrib/src/base/uvm_object.svh", 902)->__VnoInFunc_print_object(vlProcess, vlSymsp, 
                                                                                ...
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object>{this}, 0x2eU);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_convert2string(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_convert2string\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    convert2string__Vfuncrtn = ""s;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_int_local(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string field_name, VlWide<128>/*4095:0*/ value, CData/*0:0*/ recurse) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_int_local\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_object_local(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string field_name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> value, CData/*0:0*/ clone, CData/*0:0*/ recurse) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_object_local\n"); );
    // Locals
    ...
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> cc;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_string_local(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string field_name, std::string value, CData/*0:0*/ recurse) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_set_string_local\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__48__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__49__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_clone(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> &clone__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_clone\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__55__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__56__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_1__get_name;
    ...
    if ((VlNull{} == tmp)) {
        ...
        VL_NULL_CHECK(tmp, "../../uvm/distrib/src/base/uvm_object.svh", 1003)->__VnoInFunc_copy(vlProcess, vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object>{this});
    }
    clone__Vfuncrtn = tmp;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_copy(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_copy\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_copy(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> rhs) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_copy\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_compare(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &compare__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_compare\n"); );
    // Locals
    ...
    if ((1U & (~ (IData)(done)))) {
        ...
        if ((0U != __VlefCall_3__depth)) {
            VL_NULL_CHECK(comparer, "../../uvm/distrib/src/base/uvm_object.svh", 1071)->__VnoInFunc_print_msg_object(vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object>{this}, rhs);
        } else {
            ...
            VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg.uvm_report_info__Vstatic__cs, "../../uvm/distrib/src/base/uvm_globals.svh", 183)->__VnoInFunc_get_root(vlProcess, vlSymsp, __Vtask_get_root__77__Vfuncout);
    ...
    if (((1U & (~ (IData)(done))) && VL_NULL_CHECK(comparer, "../../uvm/distrib/src/base/uvm_object.svh", 1085)
        ...
        if (__VlefExpr_6) {
            VL_NULL_CHECK(comparer, "../../uvm/distrib/src/base/uvm_object.svh", 1087)->__VnoInFunc_print_msg_object(vlSymsp, 
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object>{this}, VL_NULL_CHECK(comparer, "../../uvm/distrib/src/base/uvm_object.svh", 1087)
                                                                                ->__PVT__compare_map
                                                                                .at(rhs));
        }
        done = 1U;
    ...
    if (__VlefLogAnd_9) {
        ...
        VL_NULL_CHECK(vlSymsp->TOP__uvm_pkg__03a__03auvm_object__Vclpkg.__PVT_____05Fm_uvm_status_container, "../../uvm/distrib/src/base/uvm_object.svh", 1093)->__PVT__stringv 
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_compare(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> rhs, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_comparer> comparer, CData/*0:0*/ &do_compare__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_compare\n"); );
                // Body
                do_compare__Vfuncrtn = 1U;
            }

            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc____05Fm_uvm_field_automation(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> tmp_data___05F, IData/*31:0*/ what___05F, std::string str___05F) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc____05Fm_uvm_field_automation\n"); );
            }

            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_print(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_printer> printer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_print\n"); );
            }

            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_pack(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> &packer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_pack\n"); );
                // Body
                VlProcessRef vlProcess = std::make_shared<VlProcess>();
                VlProcess::currentp(vlProcess.get());
                std::string __VlefCall_0__get_name;
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &bitstream, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &pack__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack\n"); );
                // Locals
                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> __Vtask_m_pack__97__packer;
                // Body
                pack__Vfuncrtn = 0U;
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack_bytes(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &bytestream, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &pack_bytes__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack_bytes\n"); );
                // Locals
                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> __Vtask_m_pack__100__packer;
                // Body
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack_ints(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &intstream, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &pack_ints__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_pack_ints\n"); );
                // Locals
                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> __Vtask_m_pack__103__packer;
                // Body
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_pack(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_pack\n"); );
            }

            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_unpack_pre(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> &packer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_unpack_pre\n"); );
                // Body
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_unpack_post(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_unpack_post\n"); );
                // Locals
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<CData/*0:0*/> &bitstream, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &unpack__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack\n"); );
                // Locals
                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> __Vtask_m_unpack_pre__119__packer;
                // Body
                unpack__Vfuncrtn = 0U;
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack_bytes(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<CData/*7:0*/> &bytestream, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &unpack_bytes__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack_bytes\n"); );
                // Locals
                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> __Vtask_m_unpack_pre__124__packer;
                // Body
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack_ints(Vhello_uvm__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> &intstream, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer, IData/*31:0*/ &unpack_ints__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_unpack_ints\n"); );
                // Locals
                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> __Vtask_m_unpack_pre__129__packer;
                // Body
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_unpack(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_packer> packer) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_unpack\n"); );
            }

            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_record(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_recorder> recorder) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_record\n"); );
                // Body
                VlProcess::currentp(vlProcess.get());
                {
                    if ((VlNull{} == recorder)) {
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_record(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_recorder> recorder) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_do_record\n"); );
            }

            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_get_report_object(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_report_object> &m_get_report_object__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_m_get_report_object\n"); );
                // Body
                m_get_report_object__Vfuncrtn = VlNull{};
            }

            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc_randomize\n"); );
                // Body
            ...
            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc___Vsetup_constraints\n"); );
            }

            void Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::__VnoInFunc___VBasicRand\n"); );
                // Body
                __VBasicRand__Vfuncrtn = 1U;
            }

            void Vhello_uvm_uvm_pkg__03a__03auvm_object::_ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp) {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::_ctor_var_reset\n"); );
                // Body
                (void)vlSymsp;  // Prevent unused variable warning
                __PVT__m_inst_id = 0;
            }

            Vhello_uvm_uvm_pkg__03a__03auvm_object::~Vhello_uvm_uvm_pkg__03a__03auvm_object() {
                VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_object::~\n"); );
            }
