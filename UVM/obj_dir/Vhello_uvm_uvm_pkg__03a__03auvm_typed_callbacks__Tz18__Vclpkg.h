...
#ifndef VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ18__VCLPKG_H_
#define VERILATED_VHELLO_UVM_UVM_PKG__03A__03AUVM_TYPED_CALLBACKS__TZ18__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz18__Vclpkg final {
  public:
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz18> __PVT__m_t_inst;
    ...
    // CONSTRUCTORS
    Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz18__Vclpkg();
    ~Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz18__Vclpkg();
    void ctor(Vhello_uvm__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz18__Vclpkg);
    ...
    void __VnoInFunc_m_initialize(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz18> &m_initialize__Vfuncrtn);
};
...
class Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz18 : public Vhello_uvm_uvm_pkg__03a__03auvm_callbacks_base {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_typed_callbacks__Tz18"; }
    VlClass* clone() const { return new Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz18(*this); }
    ...
    Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz18() = default;
    void init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp);
    virtual ~Vhello_uvm_uvm_pkg__03a__03auvm_typed_callbacks__Tz18();
};
