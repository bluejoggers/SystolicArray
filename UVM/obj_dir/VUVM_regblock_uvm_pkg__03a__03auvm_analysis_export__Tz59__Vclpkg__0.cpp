...
void VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> parent) {
    VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz79::init(vlProcess, vlSymsp, name, parent, 1U, 1U, 0xffffffffU);
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59::new\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59::__VnoInFunc_get_type_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_analysis_export"s;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59::__VnoInFunc_write(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock___024unit__03a__03areg_txn_base> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59::__VnoInFunc_write\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_port_base__Tz79> __Vfunc_get_if__2__Vfuncout;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tlm_if_base__Tz59_TBz59> tif;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59::_ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59::_ctor_var_reset\n"); );
    // Body
    (void)vlSymsp;  // Prevent unused variable warning
}

VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59::~VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VUVM_regblock_uvm_pkg__03a__03auvm_analysis_export__Tz59::~\n"); );
}
