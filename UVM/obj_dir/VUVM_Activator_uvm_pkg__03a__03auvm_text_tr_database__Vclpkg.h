...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_TEXT_TR_DATABASE__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_TEXT_TR_DATABASE__VCLPKG_H_  // guard
...
class VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi7;
...
class VUVM_Activator_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_text_tr_database__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_text_tr_database__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_text_tr_database__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_text_tr_database__Vclpkg);
    ...
    void __VnoInFunc_get_type(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_registry__pi7> &get_type__Vfuncrtn);
};
...
class VUVM_Activator_uvm_pkg__03a__03auvm_text_tr_database : public VUVM_Activator_uvm_pkg__03a__03auvm_tr_database {
  public:
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_simple_lock_dap__Tz2> __PVT__m_filename_dap;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_text_tr_database"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_text_tr_database(*this); }
  ...
  private:
    VlCoroutine __VnoInFunc_do_close_db____Vfork_1__0(VUVM_Activator__Syms* __restrict vlSymsp);
  public:
    ...
    void __VnoInFunc_set_file_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string filename);
  private:
    void _ctor_var_reset(VUVM_Activator__Syms* __restrict vlSymsp);
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_text_tr_database() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_text_tr_database();
};
