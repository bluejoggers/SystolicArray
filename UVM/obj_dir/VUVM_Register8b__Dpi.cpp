...
//    1. Call VUVM_Register8b::{export_function} instead,
//       and do not even bother to compile this file
// or 2. Compile all __Dpi.cpp files in the same compiler run,
//       and #ifdefs already inserted here will sort everything out.

#include "VUVM_Register8b__Dpi.h"
...
void m__uvm_report_dpi(int severity, const char* id, const char* message, int verbosity, const char* filename, int line) {
    ...
    return VUVM_Register8b::m__uvm_report_dpi(severity, id, message, verbosity, filename, line);
}
#endif
