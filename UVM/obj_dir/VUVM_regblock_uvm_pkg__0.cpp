...
void VUVM_regblock_uvm_pkg____Vdpiexp_m___05Fuvm_report_dpi_TOP__uvm_pkg(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ severity, std::string id, std::string message, IData/*31:0*/ verbosity, std::string filename, IData/*31:0*/ line) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VUVM_regblock_uvm_pkg____Vdpiexp_m___05Fuvm_report_dpi_TOP__uvm_pkg\n"); );
    // Locals
