...
#ifndef VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_SEQUENCER_ANALYSIS_FIFO___VCLPKG_H_
#define VERILATED_VHELLO_UVM_V1_UVM_PKG__03A__03AUVM_SEQUENCER_ANALYSIS_FIFO___VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequencer_analysis_fifo___Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequencer_analysis_fifo___Vclpkg();
    ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequencer_analysis_fifo___Vclpkg();
    void ctor(Vhello_uvm_v1__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequencer_analysis_fifo___Vclpkg);
...
class Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequencer_analysis_fifo_ : public Vhello_uvm_v1_uvm_pkg__03a__03auvm_tlm_fifo__Tz26 {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_analysis_imp__Tz26_TBz92> __PVT__analysis_export;
    ...
    VlClass* clone() const { return new Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequencer_analysis_fifo_(*this); }
  ...
  public:
    Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequencer_analysis_fifo_() = default;
    ...
    virtual ~Vhello_uvm_v1_uvm_pkg__03a__03auvm_sequencer_analysis_fifo_();
};
