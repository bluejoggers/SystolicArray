...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_QUEUE__TZ50__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_QUEUE__TZ50__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50__Vclpkg final {
  public:

    // DESIGN SPECIFIC STATE
    std::string __PVT__type_name;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50> __PVT__m_global_queue;
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50__Vclpkg);
    ...
    void __VnoInFunc_get_global(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback> &get_global__Vfuncrtn);
    void __VnoInFunc_get_global_queue(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50> &get_global_queue__Vfuncrtn);
};
...
class VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50 : public VUVM_Activator_uvm_pkg__03a__03auvm_object {
  public:
    ...
    VlQueue<VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback>> __PVT__queue;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_queue__Tz50"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50(*this); }
    ...
    virtual void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback> &get__Vfuncrtn);
    virtual void __VnoInFunc_get_type_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn);
    virtual void __VnoInFunc_insert(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ index, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback> item);
    virtual void __VnoInFunc_pop_back(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback> &pop_back__Vfuncrtn);
    virtual void __VnoInFunc_pop_front(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback> &pop_front__Vfuncrtn);
    virtual void __VnoInFunc_push_back(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback> item);
    virtual void __VnoInFunc_push_front(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_callback> item);
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_queue__Tz50();
};
