...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI7__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_OBJECT_REGISTRY__PI7__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi7__Vclpkg final {
  public:
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi7> __PVT__me;
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi7__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi7__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi7__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_create(VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_text_tr_database> &create__Vfuncrtn);
    void __VnoInFunc_get(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi7> &get__Vfuncrtn);
...
class VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi7 : public VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper {
  public:

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_object_registry__pi7"; }
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi7(*this); }
    ...
    VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi7() = default;
    void init(VUVM_regblock__Syms* __restrict vlSymsp);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__pi7();
};
