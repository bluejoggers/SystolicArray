...
void VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_coreservice_t> unnamedblk1__DOT__cs;
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_factory> unnamedblk1__DOT__factory;
    if ((VlNull{} == this->__PVT__me)) {
        ...
        this->__PVT__me = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122, vlSymsp);
...
void VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122__Vclpkg::__VnoInFunc_create(VUVM_Activator__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_sequencer__Tz113_TBz113> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> __Vtask_create_component_by_type__9__Vfuncout;
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122> __VlefCall_0__get;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122__Vclpkg::__VnoInFunc_set_type_override(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122> __VlefCall_0__get;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122__Vclpkg::__VnoInFunc_set_inst_override(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122> __VlefCall_1__get;
...
void VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122::__VnoInFunc_create_component(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> parent, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_component> &create_component__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122::__VnoInFunc_create_component\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_sequencer__Tz113_TBz113> obj;
    obj = VL_NEW(VUVM_Activator_uvm_pkg__03a__03auvm_sequencer__Tz113_TBz113, vlProcess, vlSymsp, name, parent);
    create_component__Vfuncrtn = obj;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122::__VnoInFunc_get_type_name(VUVM_Activator__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "<unknown>"s;
}

void VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122::init(VUVM_Activator__Syms* __restrict vlSymsp) {
    VUVM_Activator_uvm_pkg__03a__03auvm_object_wrapper::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+                  VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122::new\n"); );
    // Body
    /*super.new*/;
}

VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122::~VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122() {
    VL_DEBUG_IF(VL_DBG_MSGF("+                  VUVM_Activator_uvm_pkg__03a__03auvm_component_registry__Tz122::~\n"); );
}
