...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ20__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ20__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__Tz53;
...
class VUVM_regblock_uvm_pkg__03a__03auvm_set_get_dap_base__Tz20;
class VUVM_regblock_uvm_pkg__03a__03auvm_status_container;


class VUVM_regblock__Syms;

class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__Tz53> &get_type__Vfuncrtn);
};

#include "VUVM_regblock_uvm_pkg__03a__03auvm_set_get_dap_base__Tz20__Vclpkg.h"

class VUVM_regblock__Syms;

class VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20 : public VUVM_regblock_uvm_pkg__03a__03auvm_set_get_dap_base__Tz20 {
  public:
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03am_uvm_tr_stream_cfg> __PVT__m_value;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_set_before_get_dap__Tz20"; }
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20(*this); }
    ...
    virtual void __VnoInFunc_get(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03am_uvm_tr_stream_cfg> &get__Vfuncrtn);
    ...
    virtual void __VnoInFunc_set(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03am_uvm_tr_stream_cfg> value);
    virtual void __VnoInFunc_try_get(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03am_uvm_tr_stream_cfg> &value, CData/*0:0*/ &try_get__Vfuncrtn);
    virtual void __VnoInFunc_try_set(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03am_uvm_tr_stream_cfg> value, CData/*0:0*/ &try_set__Vfuncrtn);
  private:
    void _ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp);
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz20();
};
