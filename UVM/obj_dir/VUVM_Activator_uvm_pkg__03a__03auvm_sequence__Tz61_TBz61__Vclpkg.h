...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_SEQUENCE__TZ61_TBZ61__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_SEQUENCE__TZ61_TBZ61__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_sequence__Tz61_TBz61__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_sequence__Tz61_TBz61__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_sequence__Tz61_TBz61__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_sequence__Tz61_TBz61__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_sequence__Tz61_TBz61 : public VUVM_Activator_uvm_pkg__03a__03auvm_sequence_base {
  public:

    // DESIGN SPECIFIC STATE
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_sequencer_param_base__pi23> __PVT__param_sequencer;
    ...
    virtual VlCoroutine __VnoInFunc_get_response(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator___024unit__03a__03aact_txn> &response, IData/*31:0*/ transaction_id);
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_sequence__Tz61_TBz61() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_sequence__Tz61_TBz61();
};
