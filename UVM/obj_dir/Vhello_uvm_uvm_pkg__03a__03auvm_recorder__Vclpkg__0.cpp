...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder__Vclpkg::__VnoInFunc_m_free_id(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_recorder__Vclpkg::__VnoInFunc_m_free_id\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder__Vclpkg::__VnoInFunc_get_recorder_from_handle(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ id, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_recorder> &get_recorder_from_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_recorder__Vclpkg::__VnoInFunc_get_recorder_from_handle\n"); );
    // Body
    {
        if ((0U == id)) {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::init(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name) {
    Vhello_uvm_uvm_pkg__03a__03auvm_object::init(vlProcess, vlSymsp, name);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::new\n"); );
    // Body
    ...
    /*super.new*/;
    this->__PVT__m_stream_dap = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_set_before_get_dap__Tz56, vlProcess, vlSymsp, "stream_dap"s);
    this->__PVT__m_warn_null_stream = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_get_stream(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> &get_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_get_stream\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __Vtask_try_get__2__value;
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__9__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__10__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_close(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ close_time) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_close\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_free(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ close_time) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_free\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> stream;
    {
        ...
        if (vlSymsp->TOP__uvm_pkg__03a__03auvm_recorder__Vclpkg.__PVT__m_ids_by_recorder.exists(
                                                                                VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_recorder>{this})) {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_is_open(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &is_open__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_is_open\n"); );
    // Body
    is_open__Vfuncrtn = this->__PVT__m_is_opened;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_get_open_time(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ &get_open_time__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_get_open_time\n"); );
    // Body
    get_open_time__Vfuncrtn = this->__PVT__m_open_time;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_is_closed(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &is_closed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_is_closed\n"); );
    // Body
    is_closed__Vfuncrtn = this->__PVT__m_is_closed;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_get_close_time(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ &get_close_time__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_get_close_time\n"); );
    // Body
    get_close_time__Vfuncrtn = this->__PVT__m_close_time;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_m_do_open(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> stream, QData/*63:0*/ open_time, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_m_do_open\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __Vtask_try_get__35__value;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_get_handle(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_get_handle\n"); );
    // Locals
    ...
    if ((1U & ((~ (IData)(__VlefCall_0__is_open)) & 
        ...
        if (__VlefExpr_2) {
            __VlefExpr_2 = (vlSymsp->TOP__uvm_pkg__03a__03auvm_recorder__Vclpkg.__PVT__m_ids_by_recorder
                            .at(VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_recorder>{this}) 
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_field(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_field\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __VlefCall_0__get_stream;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_field_int(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_field_int\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __VlefCall_0__get_stream;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_field_real(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, double value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_field_real\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_object(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_object\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __VlefCall_0__get_stream;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_string(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_string\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __VlefCall_0__get_stream;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_time(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_time\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __VlefCall_0__get_stream;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_generic(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string value, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_record_generic\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> __VlefCall_0__get_stream;
    {
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_use_record_attribute(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &use_record_attribute__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_use_record_attribute\n"); );
    // Body
    use_record_attribute__Vfuncrtn = 0U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_get_record_attribute_handle(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &get_record_attribute_handle__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_get_record_attribute_handle\n"); );
    // Body
    get_record_attribute_handle__Vfuncrtn = 0;
    this->__VnoInFunc_get_handle(vlSymsp, get_record_attribute_handle__Vfuncrtn);
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_open(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_tr_stream> stream, QData/*63:0*/ open_time, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_open\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_close(Vhello_uvm__Syms* __restrict vlSymsp, QData/*63:0*/ close_time) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_close\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_free(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_free\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_field(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_field\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_field_int(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value, IData/*31:0*/ size, IData/*31:0*/ radix) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_field_int\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_field_real(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, double value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_field_real\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_object(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, std::string name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_object> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_object\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_string(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_string\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_time(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, QData/*63:0*/ value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_time\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_generic(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string value, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_do_record_generic\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_open_file(Vhello_uvm__Syms* __restrict vlSymsp, CData/*0:0*/ &open_file__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_open_file\n"); );
    // Body
    open_file__Vfuncrtn = 0U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_create_stream(Vhello_uvm__Syms* __restrict vlSymsp, std::string name, std::string t, std::string scope, IData/*31:0*/ &create_stream__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_create_stream\n"); );
    // Body
    create_stream__Vfuncrtn = 0xffffffffU;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_m_set_attribute(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ txh, std::string nm, std::string value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_m_set_attribute\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_set_attribute(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ txh, std::string nm, VlWide<32>/*1023:0*/ value, IData/*31:0*/ radix, IData/*31:0*/ numbits) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_set_attribute\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_check_handle_kind(Vhello_uvm__Syms* __restrict vlSymsp, std::string htype, IData/*31:0*/ handle, IData/*31:0*/ &check_handle_kind__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_check_handle_kind\n"); );
    // Body
    check_handle_kind__Vfuncrtn = 0U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_begin_tr(Vhello_uvm__Syms* __restrict vlSymsp, std::string txtype, IData/*31:0*/ stream, std::string nm, std::string label, std::string desc, QData/*63:0*/ begin_time, IData/*31:0*/ &begin_tr__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_begin_tr\n"); );
    // Body
    begin_tr__Vfuncrtn = 0xffffffffU;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_end_tr(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ handle, QData/*63:0*/ end_time) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_end_tr\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_link_tr(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ h1, IData/*31:0*/ h2, std::string relation) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_link_tr\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_free_tr(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ handle) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_free_tr\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_randomize(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc_randomize\n"); );
    // Body
...
void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc___Vsetup_constraints(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc___Vsetup_constraints\n"); );
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc___VBasicRand(Vhello_uvm__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

void Vhello_uvm_uvm_pkg__03a__03auvm_recorder::_ctor_var_reset(Vhello_uvm__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::_ctor_var_reset\n"); );
    // Body
...
Vhello_uvm_uvm_pkg__03a__03auvm_recorder::~Vhello_uvm_uvm_pkg__03a__03auvm_recorder() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_recorder::~\n"); );
}
