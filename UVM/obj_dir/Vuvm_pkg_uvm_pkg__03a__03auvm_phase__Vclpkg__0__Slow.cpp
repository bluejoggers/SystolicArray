...
VL_ATTR_COLD void Vuvm_pkg_uvm_pkg__03a__03auvm_phase__Vclpkg___eval_static__TOP__uvm_pkg__03a__03auvm_phase__Vclpkg(Vuvm_pkg_uvm_pkg__03a__03auvm_phase__Vclpkg* vlSelf, VlProcessRef vlProcess) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_phase__Vclpkg___eval_static__TOP__uvm_pkg__03a__03auvm_phase__Vclpkg\n"); );
    ...
    vlSelfRef.__PVT__m_phase_hopper = VL_NEW(Vuvm_pkg_std__03a__03amailbox__Tz11, vlSymsp, 0U);
    vlSelfRef.__PVT__m_print_successors__Vstatic__spaces = "                                                 "s;
    vlSelfRef.__PVT__m_print_successors__Vstatic__level = 0U;
}

VL_ATTR_COLD void Vuvm_pkg_uvm_pkg__03a__03auvm_phase__Vclpkg___ctor_var_reset(Vuvm_pkg_uvm_pkg__03a__03auvm_phase__Vclpkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_phase__Vclpkg___ctor_var_reset\n"); );
    Vuvm_pkg__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
