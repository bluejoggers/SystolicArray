...
#ifndef VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ21__VCLPKG_H_
#define VERILATED_VUVM_REGBLOCK_UVM_PKG__03A__03AUVM_SET_BEFORE_GET_DAP__TZ21__VCLPKG_H_  // guard
...
class VUVM_regblock_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21__Vclpkg();
    ~VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21__Vclpkg();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21__Vclpkg);

    // INTERNAL METHODS
    void __Vconfigure(bool first);
    void __VnoInFunc_get_type(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_registry__Tz54> &get_type__Vfuncrtn);
};

#include "VUVM_regblock_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21__Vclpkg.h"

class VUVM_regblock__Syms;

class VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21 : public VUVM_regblock_uvm_pkg__03a__03auvm_set_get_dap_base__Tz21 {
  public:
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_tr_stream> __PVT__m_value;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_set_before_get_dap__Tz21"; }
    VlClass* clone() const { return new VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21(*this); }
  ...
  public:
    VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21() = default;
    void init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name);
    virtual ~VUVM_regblock_uvm_pkg__03a__03auvm_set_before_get_dap__Tz21();
};
