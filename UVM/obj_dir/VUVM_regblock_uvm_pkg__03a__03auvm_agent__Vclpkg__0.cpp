...
void VUVM_regblock_uvm_pkg__03a__03auvm_agent::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> parent) {
    VUVM_regblock_uvm_pkg__03a__03auvm_component::init(vlProcess, vlSymsp, name, parent);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_agent::new\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc_build_phase(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc_build_phase\n"); );
    // Locals
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource_base> unnamedblk1__DOT__unnamedblk2__DOT__rsrc;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz11> unnamedblk1__DOT__unnamedblk2__DOT__rap;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz9> unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__rit;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz7> unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__unnamedblk4__DOT__rbs;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource_> unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__ri;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz10> unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__unnamedblk6__DOT__riu;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz2> unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__unnamedblk6__DOT__unnamedblk7__DOT__rs;
        ...
        while (true) {
            ...
            if (__VlefExpr_2) {
                VL_NULL_CHECK(unnamedblk1__DOT__unnamedblk2__DOT__rap, "../../uvm/distrib/src/comps/uvm_agent.svh", 75)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_agent>{this}, this->__PVT__is_active);
                goto __Vlabel0;
            } else {
                ...
                if (__VlefExpr_3) {
                    VL_NULL_CHECK(unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__rit, "../../uvm/distrib/src/comps/uvm_agent.svh", 81)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_agent>{this}, __VlefCall_4__read);
                    ...
                    if (__VlefExpr_5) {
                        VL_NULL_CHECK(unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__unnamedblk4__DOT__rbs, "../../uvm/distrib/src/comps/uvm_agent.svh", 87)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_agent>{this}, __VlefCall_6__read);
                        this->__PVT__is_active = (1U 
                        ...
                        if (__VlefExpr_7) {
                            VL_NULL_CHECK(unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__ri, "../../uvm/distrib/src/comps/uvm_agent.svh", 93)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_agent>{this}, __VlefCall_8__read);
                            ...
                            if (__VlefExpr_9) {
                                VL_NULL_CHECK(unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__unnamedblk6__DOT__riu, "../../uvm/distrib/src/comps/uvm_agent.svh", 99)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_agent>{this}, __VlefCall_10__read);
                                this->__PVT__is_active 
                                ...
                                if (__VlefExpr_11) {
                                    VL_NULL_CHECK(unnamedblk1__DOT__unnamedblk2__DOT__unnamedblk3__DOT__unnamedblk4__DOT__unnamedblk5__DOT__unnamedblk6__DOT__unnamedblk7__DOT__rs, "../../uvm/distrib/src/comps/uvm_agent.svh", 105)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_agent>{this}, __VlefCall_12__read);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc_get_type_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "uvm_agent"s;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc_get_is_active(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &get_is_active__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc_get_is_active\n"); );
    // Body
    get_is_active__Vfuncrtn = this->__PVT__is_active;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc_randomize(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc___Vsetup_constraints(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_agent::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
}

VUVM_regblock_uvm_pkg__03a__03auvm_agent::~VUVM_regblock_uvm_pkg__03a__03auvm_agent() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_agent::~\n"); );
}
