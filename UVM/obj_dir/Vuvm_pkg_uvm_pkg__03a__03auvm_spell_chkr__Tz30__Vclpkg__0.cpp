...
void Vuvm_pkg_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_check(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, VlAssocArray<std::string, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_queue__Tz29>> &strtab, std::string s, CData/*0:0*/ &check__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_check\n"); );
    // Locals
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_levenshtein_distance(Vuvm_pkg__Syms* __restrict vlSymsp, std::string s, std::string t, IData/*31:0*/ &levenshtein_distance__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_levenshtein_distance\n"); );
    // Body
...
void Vuvm_pkg_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_minimum(Vuvm_pkg__Syms* __restrict vlSymsp, IData/*31:0*/ a, IData/*31:0*/ b, IData/*31:0*/ c, IData/*31:0*/ &minimum__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vuvm_pkg_uvm_pkg__03a__03auvm_spell_chkr__Tz30__Vclpkg::__VnoInFunc_minimum\n"); );
    // Body
    IData/*31:0*/ min;
    min = a;
