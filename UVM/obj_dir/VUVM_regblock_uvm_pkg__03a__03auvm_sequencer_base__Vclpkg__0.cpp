...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_disable_auto_item_recording(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_disable_auto_item_recording\n"); );
    // Body
    this->__PVT__m_auto_item_recording = 0U;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_auto_item_recording_enabled(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &is_auto_item_recording_enabled__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_auto_item_recording_enabled\n"); );
    // Body
    is_auto_item_recording_enabled__Vfuncrtn = this->__PVT__m_auto_item_recording;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::init(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> parent) {
    VUVM_regblock_uvm_pkg__03a__03auvm_component::init(vlProcess, vlSymsp, name, parent);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::new\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_build_phase(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_build_phase\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VUVM_regblock_uvm_pkg__03a__03auvm_component::__VnoInFunc_build_phase(vlProcess, vlSymsp, phase);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_build(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_build\n"); );
    // Locals
    ...
    IData/*31:0*/ dummy;
    dummy = 0U;
    VUVM_regblock_uvm_pkg__03a__03auvm_component::__VnoInFunc_build(vlProcess, vlSymsp);
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_config_db__Tz2__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, 
                                                                              VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base>{this}, ""s, "default_sequence"s, this->__Vfunc_get__3__value, __VlefCall_0__get);
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, 
                                                                              VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base>{this}, ""s, "count"s, __Vfunc_get__6__value, __VlefCall_2__get);
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, 
                                                                              VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base>{this}, ""s, "max_random_count"s, __Vfunc_get__9__value, __VlefCall_4__get);
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, 
                                                                              VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base>{this}, ""s, "max_random_depth"s, __Vfunc_get__12__value, __VlefCall_6__get);
    ...
    vlSymsp->TOP__uvm_pkg__03a__03auvm_config_db__Tz7__Vclpkg.__VnoInFunc_get(vlProcess, vlSymsp, 
                                                                              VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base>{this}, ""s, "pound_zero_count"s, __Vfunc_get__15__value, __VlefCall_8__get);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_do_print(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_printer> printer) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_do_print\n"); );
    // Locals
    ...
    VUVM_regblock_uvm_pkg__03a__03auvm_component::__VnoInFunc_do_print(vlProcess, vlSymsp, printer);
    ...
    while (VL_LTS_III(32, unnamedblk231__DOT__i, this->__PVT__arb_sequence_q.size())) {
        ...
        __Vtemp_1 = VUVM_regblock___024unit::__Venumtab_enum_name61
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_update_lists(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_update_lists\n"); );
    // Body
    this->__PVT__m_lock_arb_size = ((IData)(1U) + this->__PVT__m_lock_arb_size);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_convert2string(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string &convert2string__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_convert2string\n"); );
    // Locals
    std::string __Vtemp_1;
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_find_number_driver_connections(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &m_find_number_driver_connections__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_find_number_driver_connections\n"); );
    // Body
    m_find_number_driver_connections__Vfuncrtn = 0U;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_register_sequence(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, IData/*31:0*/ &m_register_sequence__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_register_sequence\n"); );
    // Body
    IData/*31:0*/ __VlefCall_1__get_sequence_id;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_find_sequence(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ sequence_id, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> &m_find_sequence__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_find_sequence\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_unregister_sequence(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ sequence_id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_unregister_sequence\n"); );
    // Body
    {
        if ((! this->__PVT__reg_sequences.exists(sequence_id))) {
            goto __Vlabel0;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_user_priority_arbitration(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<IData/*31:0*/> avail_sequences, IData/*31:0*/ &user_priority_arbitration__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_user_priority_arbitration\n"); );
    // Body
    user_priority_arbitration__Vfuncrtn = avail_sequences.at(0U);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_grant_queued_locks(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_grant_queued_locks\n"); );
    // Locals
    ...
    VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request>> unnamedblk235__DOT__q;
    ...
    VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request>> unnamedblk237__DOT__leading_lock_reqs;
    VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request>> unnamedblk237__DOT__blocked_seqs;
    VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request>> unnamedblk237__DOT__not_blocked_seqs;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request> unnamedblk237__DOT__unnamedblk238__DOT__unnamedblk239__DOT__item;
    ...
    unnamedblk235__DOT__q = this->__PVT__arb_sequence_q.find(
                                                             [&](
                                                                 ...
                                                                 VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request> item) -> 
                                                             CData/*31:0*/ {
    ...
    if ((0U != unnamedblk237__DOT__b)) {
        ...
        this->__PVT__arb_sequence_q = (VL_GTS_III(32, unnamedblk237__DOT__b, 
                                        ...
                                        : VlQueue<VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request>>::consCC(this->__PVT__arb_sequence_q.slice(unnamedblk237__DOT__b, 
                                                                                (this->__PVT__arb_sequence_q.size() 
                                                                                - (IData)(1U))), 
                                                                                unnamedblk237__DOT__blocked_seqs));
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_select_sequence(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_select_sequence\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_choose_next_request(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &m_choose_next_request__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_choose_next_request\n"); );
    // Locals
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_arb_not_equal(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_arb_not_equal\n"); );
    // Locals
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    CData/*0:0*/ __VlefCall_1__is_relevant;
    CData/*0:0*/ __VlefCall_0__is_blocked;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03a__VDynScope_39> __VDynScope_m_wait_for_available_sequence_0;
    VlQueue<IData/*31:0*/> is_relevant_entries;
    __VDynScope_m_wait_for_available_sequence_0 = VL_NEW(VUVM_regblock_uvm_pkg__03a__03a__VDynScope_39, vlSymsp);
    {
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlForkSync __Vfork_1__sync, VlQueue<IData/*31:0*/> &is_relevant_entries, VlClassRef<VUVM_regblock_uvm_pkg__03a__03a__VDynScope_39> &__VDynScope_m_wait_for_available_sequence_0) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlForkSync __Vfork_2__sync, VlQueue<IData/*31:0*/> is_relevant_entries, VlClassRef<VUVM_regblock_uvm_pkg__03a__03a__VDynScope_39> __VDynScope_m_wait_for_available_sequence_0) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__1(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlForkSync __Vfork_3__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__1\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__0(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlForkSync __Vfork_3__sync) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__0\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03a__VDynScope_39> __Vtask___VforkTask_1__75____VDynScope_m_wait_for_available_sequence_0;
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    __Vfork_3__sync.onKill(vlProcess);
    ...
    while (VL_LTS_III(32, VL_NULL_CHECK(__Vtask___VforkTask_1__75____VDynScope_m_wait_for_available_sequence_0, "../../uvm/distrib/src/seq/uvm_sequencer_base.svh", 917)
        ...
        this->__Vtask___VforkTask_1__75___Vwrapped_unnamedblk241_6__DOT____VDynScope_unnamedblk241_6 
            = VL_NEW(VUVM_regblock_uvm_pkg__03a__03a__VDynScope_45, vlSymsp);
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__0____Vfork_4__0(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_available_sequence____Vfork_1__0____Vfork_2__0____Vfork_3__0____Vfork_4__0\n"); );
    // Locals
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03a__VDynScope_45> __Vtask___VforkTask_0__77____VDynScope_unnamedblk241_6;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_get_seq_item_priority(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request> seq_q_entry, IData/*31:0*/ &m_get_seq_item_priority__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_get_seq_item_priority\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_arbitration_completed(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ request_id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_wait_for_arbitration_completed\n"); );
    // Locals
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_set_arbitration_completed(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ request_id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_set_arbitration_completed\n"); );
    // Body
    this->__PVT__arb_completed.at(request_id) = 1U;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_child(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> parent, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> child, CData/*0:0*/ &is_child__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_child\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_1__get_inst_id;
    IData/*31:0*/ __VlefCall_0__get_inst_id;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> child_parent;
    {
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_execute_item(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_item> item) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_execute_item\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> seq;
    seq = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base, vlProcess, vlSymsp, "uvm_sequence"s);
    VL_NULL_CHECK(item, "../../uvm/distrib/src/seq/uvm_sequencer_base.svh", 1040)->__VnoInFunc_set_sequencer(vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base>{this});
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_grant(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, IData/*31:0*/ item_priority, CData/*0:0*/ lock_request) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_grant\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    VlClassRef<VUVM_regblock_std__03a__03aprocess> __VlefCall_1__self;
    VlClassRef<VUVM_regblock_std__03a__03aprocess> __VlefCall_0__self;
    IData/*31:0*/ __Vincrement4;
    __Vincrement4 = 0;
    IData/*31:0*/ __Vincrement3;
    __Vincrement3 = 0;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request> req_s;
    ...
    if (lock_request) {
        req_s = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request, vlSymsp);
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_item_done(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, IData/*31:0*/ transaction_id) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_item_done\n"); );
    // Locals
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_blocked(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, CData/*0:0*/ &is_blocked__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_blocked\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_has_lock(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, CData/*0:0*/ &has_lock__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_has_lock\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_1__get_inst_id;
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_lock_req(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, CData/*0:0*/ lock) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_lock_req\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    ...
    __Vincrement5 = 0;
    IData/*31:0*/ my_seq_id;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request> new_req;
    my_seq_id = 0U;
    if ((VlNull{} == sequence_ptr)) {
    ...
    this->__VnoInFunc_m_register_sequence(vlSymsp, sequence_ptr, my_seq_id);
    new_req = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_sequence_request, vlSymsp);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_unlock_req(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_unlock_req\n"); );
    // Locals
    ...
    unnamedblk244__DOT__q = this->__PVT__lock_list.find_first_index(
                                                                    [&](
                                                                        IData/*31:0*/ item__DOT__index, 
                                                                        VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> item) -> 
                                                                    CData/*31:0*/ {
            return ((([&]() {
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_lock(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_lock\n"); );
    // Body
    VL_KEEP_THIS;
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_grab(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_grab\n"); );
    // Body
    VL_KEEP_THIS;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_unlock(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_unlock\n"); );
    // Body
    this->__VnoInFunc_m_unlock_req(vlSymsp, sequence_ptr);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_ungrab(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_ungrab\n"); );
    // Body
    this->__VnoInFunc_m_unlock_req(vlSymsp, sequence_ptr);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_remove_sequence_from_queues(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_remove_sequence_from_queues\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_stop_sequences(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_stop_sequences\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> seq_ptr;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_sequence_exiting(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_sequence_exiting\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    this->__VnoInFunc_remove_sequence_from_queues(vlProcess, vlSymsp, sequence_ptr);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_kill_sequence(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_kill_sequence\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    this->__VnoInFunc_remove_sequence_from_queues(vlProcess, vlSymsp, sequence_ptr);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_grabbed(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &is_grabbed__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_is_grabbed\n"); );
    // Body
    is_grabbed__Vfuncrtn = (0U != this->__PVT__lock_list.size());
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_current_grabber(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> &current_grabber__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_current_grabber\n"); );
    // Body
    {
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_has_do_available(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ &has_do_available__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_has_do_available\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_set_arbitration(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_set_arbitration\n"); );
    // Body
    this->__PVT__m_arbitration = val;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_get_arbitration(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &get_arbitration__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_get_arbitration\n"); );
    // Body
    get_arbitration__Vfuncrtn = this->__PVT__m_arbitration;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_analysis_write(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_item> t) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_analysis_write\n"); );
}

VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences\n"); );
    // Locals
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences____Vfork_5__0(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences____Vfork_5__0\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    co_await vlSymsp->TOP.__VdlySched.delay(0xffffffffffffffffULL, 
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences____Vfork_5__0____Vfork_6__0(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ __Vintraval_h8b5250ea__4) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_wait_for_sequences____Vfork_5__0____Vfork_6__0\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    CData/*0:0*/ __VdynTrigger_h2615856f__8;
    __VdynTrigger_h2615856f__8 = 0;
    __VdynTrigger_h2615856f__8 = 0U;
    vlSymsp->TOP.__VnbaEvent.clearFired();
    while ((1U & (~ (IData)(__VdynTrigger_h2615856f__8)))) {
        co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                     vlProcess, 
                                                     "@([event] __VnbaEvent)", 
                                                     "../../uvm/distrib/src/base/uvm_globals.svh", 
                                                     460);
        __VdynTrigger_h2615856f__8 = vlSymsp->TOP.__VnbaEvent.isFired();
        vlSymsp->TOP.__VdynSched.anyTriggered(__VdynTrigger_h2615856f__8);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_send_request(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> sequence_ptr, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_item> t, CData/*0:0*/ rerandomize) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_send_request\n"); );
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_set_max_zero_time_wait_relevant_count(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ new_val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_set_max_zero_time_wait_relevant_count\n"); );
    // Body
    this->__PVT__m_max_zero_time_wait_relevant_count 
        = new_val;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_start_phase_sequence(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_start_phase_sequence\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> __VlefCall_13__create_object_by_type;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> __VlefCall_5__read;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource_base> unnamedblk246__DOT__unnamedblk247__DOT__rsrc;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz35> unnamedblk246__DOT__unnamedblk247__DOT__sbr;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_resource__Tz14> unnamedblk246__DOT__unnamedblk247__DOT__owr;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> unnamedblk246__DOT__unnamedblk247__DOT__unnamedblk248__DOT__wrapper;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03a__VDynScope_46> __VDynScope_start_phase_sequence_7;
    ...
    __VDynScope_start_phase_sequence_7 = VL_NEW(VUVM_regblock_uvm_pkg__03a__03a__VDynScope_46, vlSymsp);
        ...
        while (true) {
            ...
            if ((__VlefExpr_4 && (VlNull{} != unnamedblk246__DOT__unnamedblk247__DOT__sbr))) {
                VL_NULL_CHECK(unnamedblk246__DOT__unnamedblk247__DOT__sbr, "../../uvm/distrib/src/seq/uvm_sequencer_base.svh", 1456)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base>{this}, __VlefCall_5__read);
                ...
                if ((__VlefExpr_8 && (VlNull{} != unnamedblk246__DOT__unnamedblk247__DOT__owr))) {
                    VL_NULL_CHECK(unnamedblk246__DOT__unnamedblk247__DOT__owr, "../../uvm/distrib/src/seq/uvm_sequencer_base.svh", 1468)->__VnoInFunc_read(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base>{this}, unnamedblk246__DOT__unnamedblk247__DOT__unnamedblk248__DOT__wrapper);
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_start_phase_sequence____Vfork_7__0(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03a__VDynScope_46> __VDynScope_start_phase_sequence_7) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_start_phase_sequence____Vfork_7__0\n"); );
    // Locals
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03a__VDynScope_46> __Vtask___VforkTask_3__204____VDynScope_start_phase_sequence_7;
    ...
    VlClassRef<VUVM_regblock_std__03a__03aprocess> __Vtask___VforkTask_3__204____VlefCall_0__self;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_process_wrapper> __Vtask___VforkTask_3__204__w;
    VlClassRef<VUVM_regblock_std__03a__03aprocess> __Vfunc_self__206__Vfuncout;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_seed_map> __Vfunc_uvm_create_random_seed__209____VlefCall_0__new;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> __Vfunc_get__213__Vfuncout;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_root> __Vtask_get_root__214__Vfuncout;
    ...
    co_await vlSymsp->TOP.__VdlySched.delay(0xffffffffffffffffULL, 
                                            ...
                                            "../../uvm/distrib/src/seq/uvm_sequencer_base.svh", 
                                            1505);
    __Vtask___VforkTask_3__204__w = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_sequence_process_wrapper, vlSymsp);
    ...
    if ((! vlSymsp->TOP__uvm_pkg.__PVT__uvm_random_seed_table_lookup.exists(this->__Vfunc_uvm_create_random_seed__209__inst_id))) {
        __Vfunc_uvm_create_random_seed__209____VlefCall_0__new 
            = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_seed_map, vlSymsp);
    ...
    co_await VL_NULL_CHECK(VL_NULL_CHECK(__Vtask___VforkTask_3__204____VDynScope_start_phase_sequence_7, "../../uvm/distrib/src/seq/uvm_sequencer_base.svh", 1513)
                           ->__PVT__seq, "../../uvm/distrib/src/seq/uvm_sequencer_base.svh", 1513)->__VnoInFunc_start(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base>{this}, VlNull{}, 0xffffffffU, 1U);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_stop_phase_sequence(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_stop_phase_sequence\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_add_sequence(VUVM_regblock__Syms* __restrict vlSymsp, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_add_sequence\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    std::string __VlefCall_1__get_full_name;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_remove_sequence(VUVM_regblock__Syms* __restrict vlSymsp, std::string type_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_remove_sequence\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_set_sequences_queue(VUVM_regblock__Syms* __restrict vlSymsp, VlQueue<std::string> &sequencer_sequence_lib) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_set_sequences_queue\n"); );
    // Body
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_start_default_sequence(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_start_default_sequence\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> __VlefCall_6__create_object_by_name;
    std::string __VlefCall_5__get_full_name;
    std::string __VlefCall_4__get_full_name;
    IData/*31:0*/ __VlefCall_3__uvm_report_enabled;
    IData/*31:0*/ __VlefCall_2__uvm_report_enabled;
    ...
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> m_seq;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> cs;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_factory> factory;
    {
        ...
        if (((~ (IData)(this->__PVT__m_default_seq_set)) 
             & (VlNull{} != VUVM_regblock_uvm_pkg__03a__03auvm_component::__PVT__m_domain))) {
        ...
        if (__VlefCall_1__exists) {
            vlSymsp->TOP__uvm_pkg__03a__03auvm_config_db__Tz35__Vclpkg.__VnoInFunc_exists(vlProcess, vlSymsp, 
                                                                                VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base>{this}, "run_phase"s, "default_sequence"s, 0U, __VlefCall_1__exists);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_get_seq_kind(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string type_name, IData/*31:0*/ &get_seq_kind__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_get_seq_kind\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefCall_1__uvm_report_enabled;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_get_sequence(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ req_kind, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_sequence_base> &get_sequence__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_get_sequence\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    IData/*31:0*/ __VlefExpr_3;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object> __VlefCall_2__create_object_by_name;
    std::string __VlefCall_1__get_full_name;
    IData/*31:0*/ __VlefCall_0__uvm_report_enabled;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_coreservice_t> cs;
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_factory> factory;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_num_sequences(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &num_sequences__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_num_sequences\n"); );
    // Body
    num_sequences__Vfuncrtn = this->__PVT__sequences.size();
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_add_builtin_seqs(VUVM_regblock__Syms* __restrict vlSymsp, CData/*0:0*/ add_simple) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_m_add_builtin_seqs\n"); );
    // Body
...
VlCoroutine VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_run_phase(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_phase> phase) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_run_phase\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VL_KEEP_THIS;
    co_await VUVM_regblock_uvm_pkg__03a__03auvm_component::__VnoInFunc_run_phase(vlProcess, vlSymsp, phase);
    co_await this->__VnoInFunc_start_default_sequence(vlProcess, vlSymsp);
    co_return;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_randomize(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &randomize__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc_randomize\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc___Vsetup_constraints(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc___Vsetup_constraints\n"); );
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc___VBasicRand(VUVM_regblock__Syms* __restrict vlSymsp, IData/*31:0*/ &__VBasicRand__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::__VnoInFunc___VBasicRand\n"); );
    // Body
    __VBasicRand__Vfuncrtn = 1U;
    this->__PVT__seq_kind = VL_RANDOM_RNG_I(__Vm_rng);
}

void VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::_ctor_var_reset(VUVM_regblock__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::_ctor_var_reset\n"); );
    // Body
...
VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::~VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_sequencer_base::~\n"); );
}
