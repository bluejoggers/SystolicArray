...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_SET_GET_DAP_BASE__TZ11__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_SET_GET_DAP_BASE__TZ11__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11__Vclpkg);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11 : public Vuvm_pkg_uvm_pkg__03a__03auvm_object {
  public:
    ...
    Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11() = default;
    void init(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string name);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_set_get_dap_base__Tz11();
};
