...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_REG_INDIRECT_DATA__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_REG_INDIRECT_DATA__VCLPKG_H_  // guard
...
class VUVM_Activator_uvm_pkg__03a__03auvm_reg_indirect_data;
class VUVM_Activator_uvm_pkg__03a__03auvm_reg_indirect_ftdr_seq;
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_reg_indirect_data__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_reg_indirect_data__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_reg_indirect_data__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_reg_indirect_data__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_reg_indirect_data : public VUVM_Activator_uvm_pkg__03a__03auvm_reg {
  public:
    ...
    VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg> __PVT__m_idx;
    VlQueue<VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg>> __PVT__m_tbl;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_reg_indirect_data"; }
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_reg_indirect_data(*this); }
    ...
    void __VnoInFunc_add_frontdoors(VUVM_Activator__Syms* __restrict vlSymsp, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg_map> map);
    ...
    virtual void __VnoInFunc_get_indirect_reg(VUVM_Activator__Syms* __restrict vlSymsp, std::string fname, IData/*31:0*/ lineno, VlClassRef<VUVM_Activator_uvm_pkg__03a__03auvm_reg> &get_indirect_reg__Vfuncrtn);
  ...
  public:
    VUVM_Activator_uvm_pkg__03a__03auvm_reg_indirect_data() = default;
    void init(VlProcessRef vlProcess, VUVM_Activator__Syms* __restrict vlSymsp, std::string name, IData/*31:0*/ n_bits, IData/*31:0*/ has_cover);
    virtual ~VUVM_Activator_uvm_pkg__03a__03auvm_reg_indirect_data();
};
