...
#ifndef VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_DEFAULT_FACTORY__VCLPKG_H_
#define VERILATED_VUVM_PKG_UVM_PKG__03A__03AUVM_DEFAULT_FACTORY__VCLPKG_H_  // guard
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_factory_queue_class;
...
class alignas(VL_CACHE_LINE_BYTES) Vuvm_pkg_uvm_pkg__03a__03auvm_default_factory__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vuvm_pkg_uvm_pkg__03a__03auvm_default_factory__Vclpkg();
    ~Vuvm_pkg_uvm_pkg__03a__03auvm_default_factory__Vclpkg();
    void ctor(Vuvm_pkg__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vuvm_pkg_uvm_pkg__03a__03auvm_default_factory__Vclpkg);
...
class Vuvm_pkg_uvm_pkg__03a__03auvm_default_factory : public Vuvm_pkg_uvm_pkg__03a__03auvm_factory {
  public:

    // DESIGN SPECIFIC STATE
    VlAssocArray<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_wrapper>, CData/*0:0*/> __PVT__m_types;
    ...
    VlAssocArray<std::string, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_wrapper>> __PVT__m_type_names;
    VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_type_overrides;
    VlAssocArray<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_wrapper>, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_factory_queue_class>> __PVT__m_inst_override_queues;
    VlAssocArray<std::string, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_factory_queue_class>> __PVT__m_inst_override_name_queues;
    VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_wildcard_inst_overrides;
    VlQueue<VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_factory_override>> __PVT__m_override_info;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "uvm_pkg::uvm_default_factory"; }
    VlClass* clone() const { return new Vuvm_pkg_uvm_pkg__03a__03auvm_default_factory(*this); }
    ...
    void __VnoInFunc_m_debug_create(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_wrapper> requested_type, std::string parent_inst_path, std::string name);
    void __VnoInFunc_m_debug_display(VlProcessRef vlProcess, Vuvm_pkg__Syms* __restrict vlSymsp, std::string requested_type_name, VlClassRef<Vuvm_pkg_uvm_pkg__03a__03auvm_object_wrapper> result, std::string full_inst_path);
    void __VnoInFunc_m_has_wildcard(Vuvm_pkg__Syms* __restrict vlSymsp, std::string nm, CData/*0:0*/ &m_has_wildcard__Vfuncrtn);
  ...
  public:
    Vuvm_pkg_uvm_pkg__03a__03auvm_default_factory() = default;
    void init(Vuvm_pkg__Syms* __restrict vlSymsp);
    virtual ~Vuvm_pkg_uvm_pkg__03a__03auvm_default_factory();
};
