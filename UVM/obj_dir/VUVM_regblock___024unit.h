...
#ifndef VERILATED_VUVM_REGBLOCK___024UNIT_H_
#define VERILATED_VUVM_REGBLOCK___024UNIT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_regblock___024unit final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_regblock___024unit();
    ~VUVM_regblock___024unit();
    void ctor(VUVM_regblock__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_regblock___024unit);
