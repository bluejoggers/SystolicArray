...
#ifndef VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_PRINTER_KNOBS__VCLPKG_H_
#define VERILATED_VUVM_ACTIVATOR_UVM_PKG__03A__03AUVM_PRINTER_KNOBS__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VUVM_Activator_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    VUVM_Activator_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg();
    ~VUVM_Activator_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg();
    void ctor(VUVM_Activator__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(VUVM_Activator_uvm_pkg__03a__03auvm_printer_knobs__Vclpkg);
...
class VUVM_Activator_uvm_pkg__03a__03auvm_printer_knobs : public virtual VlClass {
  public:
    ...
    VlClass* clone() const { return new VUVM_Activator_uvm_pkg__03a__03auvm_printer_knobs(*this); }
    void __VnoInFunc_get_radix_str(VUVM_Activator__Syms* __restrict vlSymsp, IData/*31:0*/ radix, std::string &get_radix_str__Vfuncrtn);
    VUVM_Activator_uvm_pkg__03a__03auvm_printer_knobs() = default;
    void init(VUVM_Activator__Syms* __restrict vlSymsp);
    ~VUVM_Activator_uvm_pkg__03a__03auvm_printer_knobs() {}
};
