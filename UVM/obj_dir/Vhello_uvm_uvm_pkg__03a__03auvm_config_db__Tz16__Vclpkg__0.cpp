...
void Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_get(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> &value, CData/*0:0*/ &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_get\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__2__Vfuncout;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz16> __Vfunc_get_highest_precedence__8__Vfuncout;
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    CData/*0:0*/ __VlefCall_3__is_tracing;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz16> __VlefCall_2__get_type;
...
void Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_set(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_sequence_base> value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_set\n"); );
    // Locals
    ...
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz41> __VlefCall_2__new;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    ...
    CData/*0:0*/ exists;
    std::string lookup;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz41> pool;
    std::string rstate;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> cs;
    ...
    if ((! this->__PVT__m_rsc.exists(cntxt))) {
        __VlefCall_2__new = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_pool__Tz5_TBz41, vlProcess, vlSymsp, ""s);
    ...
    if ((0U != __VlefCall_3__exists)) {
        ...
        r = VL_NEW(Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz16, vlProcess, vlSymsp, field_name, inst_name);
...
void Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_exists(VlProcessRef vlProcess, Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name, CData/*0:0*/ spell_chk, CData/*0:0*/ &exists__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_exists\n"); );
    // Locals
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_root> __Vtask_get_root__38__Vfuncout;
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_resource__Tz16> __VlefCall_2__get_by_name;
    std::string __VlefCall_1__get_full_name;
    std::string __VlefCall_0__get_full_name;
    VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_coreservice_t> cs;
    exists__Vfuncrtn = 0U;
...
VlCoroutine Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_wait_modified(Vhello_uvm__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_uvm_pkg__03a__03auvm_component> cntxt, std::string inst_name, std::string field_name) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16__Vclpkg::__VnoInFunc_wait_modified\n"); );
    // Locals
...
void Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16::init(Vhello_uvm__Syms* __restrict vlSymsp) {
    Vhello_uvm_uvm_pkg__03a__03auvm_resource_db__Tz16::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16::new\n"); );
    // Body
    /*super.new*/;
}

Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16::~Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_uvm_pkg__03a__03auvm_config_db__Tz16::~\n"); );
}
