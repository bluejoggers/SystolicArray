...
void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_init(Vhello_uvm_v1__Syms* __restrict vlSymsp, VlClassRef<Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer> &init__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer__Vclpkg::__VnoInFunc_init\n"); );
    // Body
    if ((VlNull{} == vlSymsp->TOP__uvm_pkg.__PVT__uvm_default_comparer)) {
        vlSymsp->TOP__uvm_pkg.__PVT__uvm_default_comparer 
            = VL_NEW(Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer, vlSymsp);
    }
    init__Vfuncrtn = vlSymsp->TOP__uvm_pkg.__PVT__uvm_default_comparer;
}

extern const VlWide<128>/*4095:0*/ Vhello_uvm_v1__ConstPool__CONST_h8cd26482_0;

void Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_field(VlProcessRef vlProcess, Vhello_uvm_v1__Syms* __restrict vlSymsp, std::string name, VlWide<128>/*4095:0*/ lhs, VlWide<128>/*4095:0*/ rhs, IData/*31:0*/ size, IData/*31:0*/ radix, CData/*0:0*/ &compare_field__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vhello_uvm_v1_uvm_pkg__03a__03auvm_comparer::__VnoInFunc_compare_field\n"); );
    // Locals
    ...
    std::string msg;
    {
        ...
        VL_ASSIGN_W(4096, mask, Vhello_uvm_v1__ConstPool__CONST_h8cd26482_0);
