...
void VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15__Vclpkg::__VnoInFunc_get(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15> &get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15__Vclpkg::__VnoInFunc_get\n"); );
    // Body
    ...
    if ((VlNull{} == this->__PVT__me)) {
        ...
        this->__PVT__me = VL_NEW(VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15, vlSymsp);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15__Vclpkg::__VnoInFunc_create(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> parent, std::string contxt, VlClassRef<VUVM_regblock___024unit__03a__03areg_coverage> &create__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15__Vclpkg::__VnoInFunc_create\n"); );
    // Locals
    ...
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15> __VlefCall_0__get;
        ...
        unnamedblk2__DOT__msg = VL_CONCATN_NNN(VL_CONCATN_NNN(
                                                              VL_CONCATN_NNN(
                                                                             VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN(
                                                                                VL_CONCATN_NNN("Factory did not return a component of type 'reg_coverage'. A component of type '"s, __VlefCall_2__get_type_name), "' was returned instead. Name="s), name), " Parent="s), __VlefCall_3__get_type_name), " contxt="s), contxt);
...
void VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15__Vclpkg::__VnoInFunc_set_type_override(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> override_type, CData/*0:0*/ replace) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15__Vclpkg::__VnoInFunc_set_type_override\n"); );
    // Body
...
void VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15__Vclpkg::__VnoInFunc_set_inst_override(VUVM_regblock__Syms* __restrict vlSymsp, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper> override_type, std::string inst_path, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> parent) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15__Vclpkg::__VnoInFunc_set_inst_override\n"); );
    // Body
    VlProcessRef vlProcess = std::make_shared<VlProcess>();
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15> __VlefCall_1__get;
...
void VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15::__VnoInFunc_create_component(VlProcessRef vlProcess, VUVM_regblock__Syms* __restrict vlSymsp, std::string name, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> parent, VlClassRef<VUVM_regblock_uvm_pkg__03a__03auvm_component> &create_component__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15::__VnoInFunc_create_component\n"); );
    // Body
    VlProcess::currentp(vlProcess.get());
    VlClassRef<VUVM_regblock___024unit__03a__03areg_coverage> obj;
    obj = VL_NEW(VUVM_regblock___024unit__03a__03areg_coverage, vlProcess, vlSymsp, name, parent);
    create_component__Vfuncrtn = obj;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15::__VnoInFunc_get_type_name(VUVM_regblock__Syms* __restrict vlSymsp, std::string &get_type_name__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15::__VnoInFunc_get_type_name\n"); );
    // Body
    get_type_name__Vfuncrtn = "reg_coverage"s;
}

void VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15::init(VUVM_regblock__Syms* __restrict vlSymsp) {
    VUVM_regblock_uvm_pkg__03a__03auvm_object_wrapper::init(vlSymsp);
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15::new\n"); );
    // Body
    /*super.new*/;
}

VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15::~VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15() {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VUVM_regblock_uvm_pkg__03a__03auvm_component_registry__pi15::~\n"); );
}
